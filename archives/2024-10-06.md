...
`最后更新时间：2024-10-06 00:16:03 +0800`

## 今日热门仓库

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,315** &nbsp;&nbsp; folks: **44,718**  &nbsp;&nbsp; `1,938 stars today`

1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,704** &nbsp;&nbsp; folks: **3,077**  &nbsp;&nbsp; `158 stars today`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,555** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `830 stars today`
...
1. [TheAlgorithms / Rust](https://github.com/TheAlgorithms/Rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **22,331** &nbsp;&nbsp; folks: **2,180**  &nbsp;&nbsp; `61 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **271,558** &nbsp;&nbsp; folks: **45,800**  &nbsp;&nbsp; `85 stars today`
...
1. [fineanmol / Hacktoberfest2024](https://github.com/fineanmol/Hacktoberfest2024)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,168** &nbsp;&nbsp; folks: **7,179**  &nbsp;&nbsp; `122 stars today`

1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Low code platform for building business apps and workflows in minutes. Supports PostgreSQL, MySQL, MariaDB, MSSQL, MongoDB, Rest API, Docker, K8s, and more 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,032** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `11 stars today`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,706** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `5,016 stars this week`
...
1. [meta-llama / llama-stack](https://github.com/meta-llama/llama-stack)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,198** &nbsp;&nbsp; folks: **384**  &nbsp;&nbsp; `1,557 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,315** &nbsp;&nbsp; folks: **44,718**  &nbsp;&nbsp; `1,291 stars this week`
...
1. [tw93 / Pake](https://github.com/tw93/Pake)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,716** &nbsp;&nbsp; folks: **5,141**  &nbsp;&nbsp; `2,855 stars this week`
...
1. [DiceDB / dice](https://github.com/DiceDB/dice)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,648** &nbsp;&nbsp; folks: **813**  &nbsp;&nbsp; `814 stars this week`
...
1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,704** &nbsp;&nbsp; folks: **3,077**  &nbsp;&nbsp; `622 stars this week`
...
1. [meta-llama / llama-stack](https://github.com/meta-llama/llama-stack)
    - Model components of the Llama Stack APIs
    - language: **Python** &nbsp;&nbsp; stars: **3,198** &nbsp;&nbsp; folks: **384**  &nbsp;&nbsp; `2,847 stars this month`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **6,706** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `5,451 stars this month`
...
1. [gojue / ecapture](https://github.com/gojue/ecapture)
    ...
    - language: **C** &nbsp;&nbsp; stars: **13,043** &nbsp;&nbsp; folks: **1,379**  &nbsp;&nbsp; `3,828 stars this month`

1. [DiceDB / dice](https://github.com/DiceDB/dice)
    - DiceDB is an in-memory, real-time, and reactive database with Redis and SQL support optimized for modern hardware and building real-time applications.
    - language: **Go** &nbsp;&nbsp; stars: **5,648** &nbsp;&nbsp; folks: **813**  &nbsp;&nbsp; `2,403 stars this month`

1. [tw93 / Pake](https://github.com/tw93/Pake)
    - 🤱🏻 Turn any webpage into a desktop app with Rust. 🤱🏻 利用 Rust 轻松构建轻量级多端桌面应用
    - language: **Rust** &nbsp;&nbsp; stars: **29,716** &nbsp;&nbsp; folks: **5,141**  &nbsp;&nbsp; `4,400 stars this month`
