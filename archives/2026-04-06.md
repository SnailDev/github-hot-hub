...
`最后更新时间：2026-04-06 18:53:02 +0800`
...
1. [KeygraphHQ / shannon](https://github.com/KeygraphHQ/shannon)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **35,986** &nbsp;&nbsp; folks: **3,752**  &nbsp;&nbsp; `703 stars today`

1. [NousResearch / hermes-agent](https://github.com/NousResearch/hermes-agent)
    - The agent that grows with you
    - language: **Python** &nbsp;&nbsp; stars: **27,012** &nbsp;&nbsp; folks: **3,540**  &nbsp;&nbsp; `1,251 stars today`

1. [tobi / qmd](https://github.com/tobi/qmd)
    - mini cli search engine for your docs, knowledge bases, meeting notes, whatever. Tracking current sota approaches while being all local
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,291** &nbsp;&nbsp; folks: **1,115**  &nbsp;&nbsp; `298 stars today`

1. [TelegramMessenger / Telegram-iOS](https://github.com/TelegramMessenger/Telegram-iOS)
    - Telegram-iOS
    - language: **Swift** &nbsp;&nbsp; stars: **8,221** &nbsp;&nbsp; folks: **2,516**  &nbsp;&nbsp; `14 stars today`
...
1. [kepano / obsidian-skills](https://github.com/kepano/obsidian-skills)
    ...
    - language: **无** &nbsp;&nbsp; stars: **20,059** &nbsp;&nbsp; folks: **1,252**  &nbsp;&nbsp; `281 stars today`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.
    - language: **Go** &nbsp;&nbsp; stars: **167,384** &nbsp;&nbsp; folks: **15,371**  &nbsp;&nbsp; `164 stars today`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **101,721** &nbsp;&nbsp; folks: **16,430**  &nbsp;&nbsp; `244 stars today`

1. [siddharthvaddem / openscreen](https://github.com/siddharthvaddem/openscreen)
    - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,233** &nbsp;&nbsp; folks: **1,552**  &nbsp;&nbsp; `2,749 stars today`

1. [NVIDIA / personaplex](https://github.com/NVIDIA/personaplex)
    - PersonaPlex code.
    - language: **Python** &nbsp;&nbsp; stars: **6,966** &nbsp;&nbsp; folks: **1,048**  &nbsp;&nbsp; `295 stars today`
...
1. [Yeachan-Heo / oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,030** &nbsp;&nbsp; folks: **1,626**  &nbsp;&nbsp; `13,476 stars this week`

1. [siddharthvaddem / openscreen](https://github.com/siddharthvaddem/openscreen)
    - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,233** &nbsp;&nbsp; folks: **1,552**  &nbsp;&nbsp; `12,682 stars this week`

1. [luongnv89 / claude-howto](https://github.com/luongnv89/claude-howto)
    - A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.
    - language: **Python** &nbsp;&nbsp; stars: **20,820** &nbsp;&nbsp; folks: **2,480**  &nbsp;&nbsp; `15,128 stars this week`

1. [microsoft / VibeVoice](https://github.com/microsoft/VibeVoice)
    - Open-Source Frontier Voice AI
    - language: **Python** &nbsp;&nbsp; stars: **36,590** &nbsp;&nbsp; folks: **4,200**  &nbsp;&nbsp; `10,543 stars this week`

1. [google-research / timesfm](https://github.com/google-research/timesfm)
    - TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
    - language: **Python** &nbsp;&nbsp; stars: **15,045** &nbsp;&nbsp; folks: **1,315**  &nbsp;&nbsp; `4,702 stars this week`

1. [NousResearch / hermes-agent](https://github.com/NousResearch/hermes-agent)
    - The agent that grows with you
    - language: **Python** &nbsp;&nbsp; stars: **27,012** &nbsp;&nbsp; folks: **3,540**  &nbsp;&nbsp; `9,940 stars this week`

1. [onyx-dot-app / onyx](https://github.com/onyx-dot-app/onyx)
    - Open Source AI Platform - AI Chat with advanced features that works with every LLM
    - language: **Python** &nbsp;&nbsp; stars: **25,297** &nbsp;&nbsp; folks: **3,378**  &nbsp;&nbsp; `4,741 stars this week`

1. [google-ai-edge / gallery](https://github.com/google-ai-edge/gallery)
    - A gallery that showcases on-device ML/GenAI use cases and allows people to try and use models locally.
    - language: **Kotlin** &nbsp;&nbsp; stars: **17,439** &nbsp;&nbsp; folks: **1,610**  &nbsp;&nbsp; `1,286 stars this week`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **79,965** &nbsp;&nbsp; folks: **9,302**  &nbsp;&nbsp; `5,633 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **无** &nbsp;&nbsp; stars: **37,538** &nbsp;&nbsp; folks: **6,187**  &nbsp;&nbsp; `2,235 stars this week`
...
1. [vas3k / TaxHacker](https://github.com/vas3k/TaxHacker)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,752** &nbsp;&nbsp; folks: **729**  &nbsp;&nbsp; `2,204 stars this week`

1. [nvim-treesitter / nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)
    - Nvim Treesitter configurations and abstraction layer
    - language: **Tree-sitter Query** &nbsp;&nbsp; stars: **13,530** &nbsp;&nbsp; folks: **1,210**  &nbsp;&nbsp; `102 stars this week`
