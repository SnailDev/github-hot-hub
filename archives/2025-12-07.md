...
1. [oven-sh / bun](https://github.com/oven-sh/bun)
    - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
    - language: **Zig** &nbsp;&nbsp; stars: **84,326** &nbsp;&nbsp; folks: **3,731**  &nbsp;&nbsp; `1,664 stars this week`

1. [ostris / ai-toolkit](https://github.com/ostris/ai-toolkit)
    - The ultimate training toolkit for finetuning diffusion models
    - language: **Python** &nbsp;&nbsp; stars: **7,678** &nbsp;&nbsp; folks: **931**  &nbsp;&nbsp; `595 stars this week`

1. [anthropics / claude-quickstarts](https://github.com/anthropics/claude-quickstarts)
    - A collection of projects designed to help developers quickly get started with building deployable applications using the Claude API
    - language: **Python** &nbsp;&nbsp; stars: **10,764** &nbsp;&nbsp; folks: **1,960**  &nbsp;&nbsp; `240 stars this week`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.
    - language: **Rust** &nbsp;&nbsp; stars: **15,010** &nbsp;&nbsp; folks: **647**  &nbsp;&nbsp; `2,083 stars this week`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **95,873** &nbsp;&nbsp; folks: **10,832**  &nbsp;&nbsp; `987 stars this week`

1. [gunnarmorling / 1brc](https://github.com/gunnarmorling/1brc)
    - 1️⃣🐝🏎️ The One Billion Row Challenge -- A fun exploration of how quickly 1B rows from a text file can be aggregated with Java
    - language: **Java** &nbsp;&nbsp; stars: **7,745** &nbsp;&nbsp; folks: **2,139**  &nbsp;&nbsp; `129 stars this week`

1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    - Cybersecurity AI (CAI), the framework for AI Security
    - language: **Python** &nbsp;&nbsp; stars: **6,089** &nbsp;&nbsp; folks: **838**  &nbsp;&nbsp; `365 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,021** &nbsp;&nbsp; folks: **881**  &nbsp;&nbsp; `362 stars this week`
...
1. [microsoft / typescript-go](https://github.com/microsoft/typescript-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **23,108** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `148 stars this week`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **12,723** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `595 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **44,813** &nbsp;&nbsp; folks: **3,105**  &nbsp;&nbsp; `942 stars this week`
...
1. [sansan0 / TrendRadar](https://github.com/sansan0/TrendRadar)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,818** &nbsp;&nbsp; folks: **20,078**  &nbsp;&nbsp; `33,109 stars this month`

1. [kavishdevar / librepods](https://github.com/kavishdevar/librepods)
    - AirPods liberated from Apple's ecosystem.
    - language: **Kotlin** &nbsp;&nbsp; stars: **19,434** &nbsp;&nbsp; folks: **921**  &nbsp;&nbsp; `17,748 stars this month`

1. [usestrix / strix](https://github.com/usestrix/strix)
    - Open-source AI agents for penetration testing
    - language: **Python** &nbsp;&nbsp; stars: **16,882** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `14,617 stars this month`

1. [MemoriLabs / Memori](https://github.com/MemoriLabs/Memori)
    - Open-Source Memory Engine for LLMs, AI Agents & Multi-Agent Systems
    - language: **Python** &nbsp;&nbsp; stars: **9,444** &nbsp;&nbsp; folks: **675**  &nbsp;&nbsp; `7,870 stars this month`
...
1. [lzhoang2801 / OpCore-Simplify](https://github.com/lzhoang2801/OpCore-Simplify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,630** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `1,610 stars this month`
...
1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **61,062** &nbsp;&nbsp; folks: **13,558**  &nbsp;&nbsp; `6,770 stars this month`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,223** &nbsp;&nbsp; folks: **5,404**  &nbsp;&nbsp; `5,498 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **86,045** &nbsp;&nbsp; folks: **9,815**  &nbsp;&nbsp; `4,840 stars this month`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.
    - language: **Rust** &nbsp;&nbsp; stars: **15,010** &nbsp;&nbsp; folks: **647**  &nbsp;&nbsp; `3,005 stars this month`

1. [ValveSoftware / Proton](https://github.com/ValveSoftware/Proton)
    - Compatibility tool for Steam Play based on Wine and additional components
    - language: **C++** &nbsp;&nbsp; stars: **29,060** &nbsp;&nbsp; folks: **1,261**  &nbsp;&nbsp; `970 stars this month`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **TypeScript** &nbsp;&nbsp; stars: **104,636** &nbsp;&nbsp; folks: **4,688**  &nbsp;&nbsp; `6,530 stars this month`

1. [ostris / ai-toolkit](https://github.com/ostris/ai-toolkit)
    - The ultimate training toolkit for finetuning diffusion models
    - language: **Python** &nbsp;&nbsp; stars: **7,678** &nbsp;&nbsp; folks: **931**  &nbsp;&nbsp; `851 stars this month`

1. [QuantConnect / Lean](https://github.com/QuantConnect/Lean)
    - Lean Algorithmic Trading Engine by QuantConnect (Python, C#)
    - language: **C#** &nbsp;&nbsp; stars: **13,617** &nbsp;&nbsp; folks: **3,958**  &nbsp;&nbsp; `916 stars this month`
...
1. [farion1231 / cc-switch](https://github.com/farion1231/cc-switch)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,890** &nbsp;&nbsp; folks: **386**  &nbsp;&nbsp; `2,725 stars this month`

1. [playcanvas / engine](https://github.com/playcanvas/engine)
    - Powerful web graphics runtime built on WebGL, WebGPU, WebXR and glTF
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,113** &nbsp;&nbsp; folks: **1,668**  &nbsp;&nbsp; `3,119 stars this month`
