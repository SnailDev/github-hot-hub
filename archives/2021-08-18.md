...
`最后更新时间：2021-08-18 00:16:59 +0800`

## 今日热门仓库

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **28,724** &nbsp;&nbsp; folks: **4,528**  &nbsp;&nbsp; `235 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **20,348** &nbsp;&nbsp; folks: **454**  &nbsp;&nbsp; `88 stars today`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **23,861** &nbsp;&nbsp; folks: **1,763**  &nbsp;&nbsp; `313 stars today`
...
1. [alan2207 / bulletproof-react](https://github.com/alan2207/bulletproof-react)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,790** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `167 stars today`
...
1. [GuidoBartoli / sherloq](https://github.com/GuidoBartoli/sherloq)
    ...
    - language: **Perl** &nbsp;&nbsp; stars: **1,062** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `235 stars today`

1. [ms-jpq / coq_nvim](https://github.com/ms-jpq/coq_nvim)
    - Fast as FUCK nvim completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
    - language: **Python** &nbsp;&nbsp; stars: **554** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `162 stars today`
...
1. [tuvtran / project-based-learning](https://github.com/tuvtran/project-based-learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **54,607** &nbsp;&nbsp; folks: **8,498**  &nbsp;&nbsp; `90 stars today`
...
1. [NvChad / NvChad](https://github.com/NvChad/NvChad)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **3,493** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `236 stars today`
...
1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,901** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `1,200 stars this week`
...
1. [megaease / easegress](https://github.com/megaease/easegress)
    - A Cloud Native traffic orchestration system
    - language: **Go** &nbsp;&nbsp; stars: **3,398** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `411 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **20,348** &nbsp;&nbsp; folks: **454**  &nbsp;&nbsp; `1,163 stars this week`

1. [fuzhengwei / small-spring](https://github.com/fuzhengwei/small-spring)
    - 🌱《 Spring 手撸专栏》，本专栏以 Spring 源码学习为目的，通过手写简化版 Spring 框架，了解 Spring 核心原理。在手写的过程中会简化 Spring 源码，摘取整体框架中的核心逻辑，简化代码实现过程，保留核心功能，例如：IOC、AOP、Bean生命周期、上下文、作用域、资源处理等内容实现。
    - language: **Java** &nbsp;&nbsp; stars: **1,442** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `384 stars this week`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **149,287** &nbsp;&nbsp; folks: **17,141**  &nbsp;&nbsp; `3,532 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **28,724** &nbsp;&nbsp; folks: **4,528**  &nbsp;&nbsp; `727 stars this week`
...
1. [meilisearch / MeiliSearch](https://github.com/meilisearch/MeiliSearch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,837** &nbsp;&nbsp; folks: **524**  &nbsp;&nbsp; `414 stars this week`
