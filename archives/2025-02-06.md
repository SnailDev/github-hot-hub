...
1. [metabase / metabase](https://github.com/metabase/metabase)
    ...
    - language: **Clojure** &nbsp;&nbsp; stars: **40,314** &nbsp;&nbsp; folks: **5,325**  &nbsp;&nbsp; `242 stars today`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,913** &nbsp;&nbsp; folks: **1,166**  &nbsp;&nbsp; `105 stars today`
...
1. [llvm / llvm-project](https://github.com/llvm/llvm-project)
    ...
    - language: **LLVM** &nbsp;&nbsp; stars: **30,711** &nbsp;&nbsp; folks: **12,613**  &nbsp;&nbsp; `20 stars today`

1. [huggingface / lerobot](https://github.com/huggingface/lerobot)
    - 🤗 LeRobot: Making AI for Robotics more accessible with end-to-end learning
    - language: **Python** &nbsp;&nbsp; stars: **8,664** &nbsp;&nbsp; folks: **917**  &nbsp;&nbsp; `69 stars today`
...
1. [deepseek-ai / Janus](https://github.com/deepseek-ai/Janus)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,722** &nbsp;&nbsp; folks: **1,898**  &nbsp;&nbsp; `5,182 stars this week`

1. [QwenLM / Qwen2.5-VL](https://github.com/QwenLM/Qwen2.5-VL)
    - Qwen2.5-VL is the multimodal large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,655** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `1,967 stars this week`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **120,491** &nbsp;&nbsp; folks: **9,642**  &nbsp;&nbsp; `5,970 stars this week`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **17,826** &nbsp;&nbsp; folks: **1,945**  &nbsp;&nbsp; `2,663 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **68,250** &nbsp;&nbsp; folks: **8,078**  &nbsp;&nbsp; `5,529 stars this week`

1. [deepseek-ai / DeepSeek-Math](https://github.com/deepseek-ai/DeepSeek-Math)
    - DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models
    - language: **Python** &nbsp;&nbsp; stars: **2,164** &nbsp;&nbsp; folks: **394**  &nbsp;&nbsp; `530 stars this week`

1. [deepseek-ai / DeepSeek-LLM](https://github.com/deepseek-ai/DeepSeek-LLM)
    - DeepSeek LLM: Let there be answers
    - language: **Makefile** &nbsp;&nbsp; stars: **5,500** &nbsp;&nbsp; folks: **822**  &nbsp;&nbsp; `1,153 stars this week`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **21,856** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `1,144 stars this week`
...
1. [is-a-dev / register](https://github.com/is-a-dev/register)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,424** &nbsp;&nbsp; folks: **9,836**  &nbsp;&nbsp; `962 stars this week`

1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **7,620** &nbsp;&nbsp; folks: **917**  &nbsp;&nbsp; `1,739 stars this week`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    - The Self-hosted AI Starter Kit is an open-source template that quickly sets up a local AI environment. Curated by n8n, it provides essential tools for creating secure, self-hosted AI workflows.
    - language: **无** &nbsp;&nbsp; stars: **5,913** &nbsp;&nbsp; folks: **1,166**  &nbsp;&nbsp; `696 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **17,826** &nbsp;&nbsp; folks: **1,945**  &nbsp;&nbsp; `8,068 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **24,477** &nbsp;&nbsp; folks: **2,426**  &nbsp;&nbsp; `15,022 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **120,491** &nbsp;&nbsp; folks: **9,642**  &nbsp;&nbsp; `14,233 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The OS for your personal finances
    - language: **Ruby** &nbsp;&nbsp; stars: **39,257** &nbsp;&nbsp; folks: **2,784**  &nbsp;&nbsp; `4,390 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **68,250** &nbsp;&nbsp; folks: **8,078**  &nbsp;&nbsp; `13,281 stars this month`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **45,571** &nbsp;&nbsp; folks: **4,854**  &nbsp;&nbsp; `5,006 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **29,457** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `7,144 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **28,904** &nbsp;&nbsp; folks: **2,304**  &nbsp;&nbsp; `9,081 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,650** &nbsp;&nbsp; folks: **789**  &nbsp;&nbsp; `4,376 stars this month`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,300** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `3,275 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,809** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `2,553 stars this month`

1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    - PlayStation 4 emulator for Windows, Linux and macOS written in C++
    - language: **C++** &nbsp;&nbsp; stars: **17,481** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `4,798 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **58,592** &nbsp;&nbsp; folks: **11,826**  &nbsp;&nbsp; `4,763 stars this month`
