...
`最后更新时间：2021-04-25 00:27:43 +0800`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,314** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `188 stars today`

1. [ueberdosis / tiptap](https://github.com/ueberdosis/tiptap)
    - The headless editor framework for web artisans.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,895** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `483 stars today`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,923** &nbsp;&nbsp; folks: **7,962**  &nbsp;&nbsp; `384 stars today`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,108** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `477 stars today`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,659** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `446 stars today`

1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    - A list of awesome applications, software, tools and other materials for Linux distros.
    - language: **Python** &nbsp;&nbsp; stars: **15,267** &nbsp;&nbsp; folks: **1,578**  &nbsp;&nbsp; `144 stars today`
...
1. [ossu / computer-science](https://github.com/ossu/computer-science)
    ...
    - language: **无** &nbsp;&nbsp; stars: **81,767** &nbsp;&nbsp; folks: **11,658**  &nbsp;&nbsp; `217 stars today`
...
1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **102,000** &nbsp;&nbsp; folks: **40,887**  &nbsp;&nbsp; `111 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **221** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `159 stars today`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **183,667** &nbsp;&nbsp; folks: **41,695**  &nbsp;&nbsp; `282 stars today`
...
1. [RH12503 / triangula](https://github.com/RH12503/triangula)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,492** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `792 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,641** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `119 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **93** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `56 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,526** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `2,386 stars this week`
...
1. [nasa / fprime](https://github.com/nasa/fprime)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **7,741** &nbsp;&nbsp; folks: **890**  &nbsp;&nbsp; `848 stars this week`

1. [Netflix / consoleme](https://github.com/Netflix/consoleme)
    - A Central Control Plane for AWS Permissions and Access
    - language: **Python** &nbsp;&nbsp; stars: **2,284** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `498 stars this week`

1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    - Highly customizable library for building interactive node-based UIs, editors, flow charts and diagrams
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,191** &nbsp;&nbsp; folks: **243**  &nbsp;&nbsp; `2,085 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,923** &nbsp;&nbsp; folks: **7,962**  &nbsp;&nbsp; `2,193 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,239** &nbsp;&nbsp; folks: **45,687**  &nbsp;&nbsp; `2,476 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    ...
    - language: **C** &nbsp;&nbsp; stars: **53,310** &nbsp;&nbsp; folks: **4,809**  &nbsp;&nbsp; `1,094 stars this week`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,108** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `583 stars this week`
...
1. [CSSEGISandData / COVID-19](https://github.com/CSSEGISandData/COVID-19)
    ...
    - language: **无** &nbsp;&nbsp; stars: **26,335** &nbsp;&nbsp; folks: **16,836**  &nbsp;&nbsp; `241 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,526** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `3,744 stars this month`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,304** &nbsp;&nbsp; folks: **423**  &nbsp;&nbsp; `1,351 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,432** &nbsp;&nbsp; folks: **5,514**  &nbsp;&nbsp; `1,203 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,923** &nbsp;&nbsp; folks: **7,962**  &nbsp;&nbsp; `3,363 stars this month`
