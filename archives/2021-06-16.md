...
`最后更新时间：2021-06-16 00:21:45 +0800`

## 今日热门仓库

1. [jina-ai / jina](https://github.com/jina-ai/jina)
    - An easier way to build neural search on the cloud
    - language: **Python** &nbsp;&nbsp; stars: **5,194** &nbsp;&nbsp; folks: **502**  &nbsp;&nbsp; `470 stars today`

1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **26,600** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `34 stars today`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **54,935** &nbsp;&nbsp; folks: **29,127**  &nbsp;&nbsp; `116 stars today`
...
1. [RPwnage / pwn-my](https://github.com/RPwnage/pwn-my)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **475** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `5 stars today`
...
1. [discordjs / discord.js](https://github.com/discordjs/discord.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,323** &nbsp;&nbsp; folks: **2,568**  &nbsp;&nbsp; `23 stars today`

1. [atom / atom](https://github.com/atom/atom)
    - The hackable text editor
    - language: **JavaScript** &nbsp;&nbsp; stars: **55,442** &nbsp;&nbsp; folks: **16,176**  &nbsp;&nbsp; `12 stars today`

1. [thanos-io / thanos](https://github.com/thanos-io/thanos)
    - Highly available Prometheus setup with long term storage capabilities. A CNCF Incubating project.
    - language: **Go** &nbsp;&nbsp; stars: **8,642** &nbsp;&nbsp; folks: **1,272**  &nbsp;&nbsp; `6 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,395** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `95 stars today`
...
1. [madMAx43v3r / chia-plotter](https://github.com/madMAx43v3r/chia-plotter)
    - 无
    - language: **C** &nbsp;&nbsp; stars: **1,578** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `1,376 stars this week`
...
1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **3,996** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `583 stars this week`
...
1. [hashicorp / terraform](https://github.com/hashicorp/terraform)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,507** &nbsp;&nbsp; folks: **6,694**  &nbsp;&nbsp; `563 stars this week`
...
1. [jina-ai / jina](https://github.com/jina-ai/jina)
    - An easier way to build neural search on the cloud
    - language: **Python** &nbsp;&nbsp; stars: **5,194** &nbsp;&nbsp; folks: **502**  &nbsp;&nbsp; `1,542 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **131,400** &nbsp;&nbsp; folks: **15,790**  &nbsp;&nbsp; `2,202 stars this week`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **39,004** &nbsp;&nbsp; folks: **12,797**  &nbsp;&nbsp; `1,761 stars this month`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Shell** &nbsp;&nbsp; stars: **3,996** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `683 stars this month`
