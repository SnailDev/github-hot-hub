...
`最后更新时间：2021-09-08 00:17:11 +0800`
...
1. [bespoyasov / frontend-clean-architecture](https://github.com/bespoyasov/frontend-clean-architecture)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **587** &nbsp;&nbsp; folks: **40**  &nbsp;&nbsp; `194 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **116,860** &nbsp;&nbsp; folks: **31,449**  &nbsp;&nbsp; `345 stars today`
...
1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **472** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `81 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **59,966** &nbsp;&nbsp; folks: **3,285**  &nbsp;&nbsp; `213 stars today`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,730** &nbsp;&nbsp; folks: **2,354**  &nbsp;&nbsp; `265 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **83,230** &nbsp;&nbsp; folks: **8,925**  &nbsp;&nbsp; `538 stars today`

1. [orhun / git-cliff](https://github.com/orhun/git-cliff)
    - A highly customizable Changelog Generator that follows Conventional Commit specifications ⛰️
    - language: **Rust** &nbsp;&nbsp; stars: **1,864** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `237 stars today`
...
1. [alexeygrigorev / mlbookcamp-code](https://github.com/alexeygrigorev/mlbookcamp-code)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **452** &nbsp;&nbsp; folks: **95**  &nbsp;&nbsp; `227 stars today`
...
1. [andrecronje / rarity](https://github.com/andrecronje/rarity)
    ...
    - language: **Solidity** &nbsp;&nbsp; stars: **134** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `32 stars today`

1. [wangdoc / clang-tutorial](https://github.com/wangdoc/clang-tutorial)
    - C 语言教程
    - language: **无** &nbsp;&nbsp; stars: **304** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `171 stars today`
...
1. [streamich / react-use](https://github.com/streamich/react-use)
    - React Hooks — 👍
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,001** &nbsp;&nbsp; folks: **1,851**  &nbsp;&nbsp; `40 stars today`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,020** &nbsp;&nbsp; folks: **1,328**  &nbsp;&nbsp; `712 stars today`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **624** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `296 stars this week`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,730** &nbsp;&nbsp; folks: **2,354**  &nbsp;&nbsp; `1,604 stars this week`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,030** &nbsp;&nbsp; folks: **972**  &nbsp;&nbsp; `655 stars this week`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **15,402** &nbsp;&nbsp; folks: **4,080**  &nbsp;&nbsp; `1,252 stars this week`
...
1. [CyberPunkMetalHead / binance-trading-bot-new-coins](https://github.com/CyberPunkMetalHead/binance-trading-bot-new-coins)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **735** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `229 stars this week`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,630** &nbsp;&nbsp; folks: **702**  &nbsp;&nbsp; `352 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **83,230** &nbsp;&nbsp; folks: **8,925**  &nbsp;&nbsp; `1,015 stars this week`

1. [khanhas / spicetify-cli](https://github.com/khanhas/spicetify-cli)
    - Commandline tool to customize Spotify client. Supports Windows, MacOS and Linux.
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,940** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `496 stars this week`
...
1. [ent / ent](https://github.com/ent/ent)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,353** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `221 stars this week`
...
1. [NotLuksus / nft-art-generator](https://github.com/NotLuksus/nft-art-generator)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **279** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `167 stars this week`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,913** &nbsp;&nbsp; folks: **332**  &nbsp;&nbsp; `4,631 stars this month`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,048** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `2,214 stars this month`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **15,369** &nbsp;&nbsp; folks: **1,568**  &nbsp;&nbsp; `1,163 stars this month`
