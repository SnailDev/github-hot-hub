...
`最后更新时间：2022-03-24 00:18:06 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,562** &nbsp;&nbsp; folks: **4,216**  &nbsp;&nbsp; `462 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,790** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `294 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,064** &nbsp;&nbsp; folks: **1,491**  &nbsp;&nbsp; `792 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,374** &nbsp;&nbsp; folks: **610**  &nbsp;&nbsp; `329 stars today`
...
1. [nocodb / nocodb](https://github.com/nocodb/nocodb)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **23,954** &nbsp;&nbsp; folks: **1,439**  &nbsp;&nbsp; `277 stars today`
...
1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,252** &nbsp;&nbsp; folks: **3,112**  &nbsp;&nbsp; `237 stars today`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,733** &nbsp;&nbsp; folks: **1,302**  &nbsp;&nbsp; `138 stars today`
...
1. [guzzle / guzzle](https://github.com/guzzle/guzzle)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **21,611** &nbsp;&nbsp; folks: **2,281**  &nbsp;&nbsp; `10 stars today`

1. [home-assistant / core](https://github.com/home-assistant/core)
    - 🏡 Open source home automation that puts local control and privacy first.
    - language: **Python** &nbsp;&nbsp; stars: **50,979** &nbsp;&nbsp; folks: **17,573**  &nbsp;&nbsp; `230 stars today`

1. [mrd0x / BITB](https://github.com/mrd0x/BITB)
    - Browser In The Browser (BITB) Templates
    - language: **JavaScript** &nbsp;&nbsp; stars: **988** &nbsp;&nbsp; folks: **175**  &nbsp;&nbsp; `128 stars today`

1. [getActivity / AndroidGithubBoss](https://github.com/getActivity/AndroidGithubBoss)
    - 统计 Android 开源大佬
    - language: **无** &nbsp;&nbsp; stars: **205** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `28 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,542** &nbsp;&nbsp; folks: **207**  &nbsp;&nbsp; `2,485 stars this week`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,064** &nbsp;&nbsp; folks: **1,491**  &nbsp;&nbsp; `1,072 stars this week`
...
1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,790** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `1,125 stars this week`
...
1. [arthurspk / guiadevbrasil](https://github.com/arthurspk/guiadevbrasil)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,879** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `570 stars this week`
...
1. [cat-milk / Anime-Girls-Holding-Programming-Books](https://github.com/cat-milk/Anime-Girls-Holding-Programming-Books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,904** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `3,549 stars this month`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,562** &nbsp;&nbsp; folks: **4,216**  &nbsp;&nbsp; `15,491 stars this month`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,542** &nbsp;&nbsp; folks: **207**  &nbsp;&nbsp; `4,087 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,374** &nbsp;&nbsp; folks: **610**  &nbsp;&nbsp; `2,130 stars this month`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,733** &nbsp;&nbsp; folks: **1,302**  &nbsp;&nbsp; `812 stars this month`
...
1. [ultralytics / yolov5](https://github.com/ultralytics/yolov5)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,706** &nbsp;&nbsp; folks: **8,450**  &nbsp;&nbsp; `1,398 stars this month`
...
1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    ...
    - language: **无** &nbsp;&nbsp; stars: **136,166** &nbsp;&nbsp; folks: **12,947**  &nbsp;&nbsp; `4,087 stars this month`
