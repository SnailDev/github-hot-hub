...
`最后更新时间：2021-08-08 00:16:11 +0800`
...
1. [microsoft / vscode](https://github.com/microsoft/vscode)
    - Visual Studio Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **119,694** &nbsp;&nbsp; folks: **19,606**  &nbsp;&nbsp; `141 stars today`
...
1. [tannerlinsley / react-query](https://github.com/tannerlinsley/react-query)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,739** &nbsp;&nbsp; folks: **1,052**  &nbsp;&nbsp; `50 stars today`
...
1. [alyssaxuu / mapus](https://github.com/alyssaxuu/mapus)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,455** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `685 stars today`
...
1. [testjavascript / nodejs-integration-tests-best-practices](https://github.com/testjavascript/nodejs-integration-tests-best-practices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **553** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `326 stars today`

1. [metabase / metabase](https://github.com/metabase/metabase)
    - The simplest, fastest way to get business intelligence and analytics to everyone in your company 😋
    - language: **Clojure** &nbsp;&nbsp; stars: **25,586** &nbsp;&nbsp; folks: **3,448**  &nbsp;&nbsp; `29 stars today`

1. [Blinue / Magpie](https://github.com/Blinue/Magpie)
    - 使游戏窗口全屏显示
    - language: **HLSL** &nbsp;&nbsp; stars: **215** &nbsp;&nbsp; folks: **17**  &nbsp;&nbsp; `55 stars today`
...
1. [mrousavy / react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **1,262** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `38 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **27,750** &nbsp;&nbsp; folks: **5,340**  &nbsp;&nbsp; `755 stars today`
...
1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,187** &nbsp;&nbsp; folks: **3,641**  &nbsp;&nbsp; `282 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **27,750** &nbsp;&nbsp; folks: **5,340**  &nbsp;&nbsp; `1,690 stars this week`
...
1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,408** &nbsp;&nbsp; folks: **755**  &nbsp;&nbsp; `1,338 stars this week`
...
1. [kubernetes / kompose](https://github.com/kubernetes/kompose)
    - Go from Docker Compose to Kubernetes
    - language: **Go** &nbsp;&nbsp; stars: **6,588** &nbsp;&nbsp; folks: **553**  &nbsp;&nbsp; `133 stars this week`
...
1. [github / docs](https://github.com/github/docs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,756** &nbsp;&nbsp; folks: **22,607**  &nbsp;&nbsp; `320 stars this week`
...
1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **9,408** &nbsp;&nbsp; folks: **755**  &nbsp;&nbsp; `2,121 stars this month`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **8,007** &nbsp;&nbsp; folks: **1,883**  &nbsp;&nbsp; `3,070 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,603** &nbsp;&nbsp; folks: **5,277**  &nbsp;&nbsp; `869 stars this month`
...
1. [serverless-stack / serverless-stack](https://github.com/serverless-stack/serverless-stack)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,449** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `426 stars this month`
