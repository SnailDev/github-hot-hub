...
`最后更新时间：2021-05-24 00:26:28 +0800`

## 今日热门仓库

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,014** &nbsp;&nbsp; folks: **1,899**  &nbsp;&nbsp; `692 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,476** &nbsp;&nbsp; folks: **3,167**  &nbsp;&nbsp; `359 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,579** &nbsp;&nbsp; folks: **882**  &nbsp;&nbsp; `214 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **9,634** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `290 stars today`

1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **5,440** &nbsp;&nbsp; folks: **1,313**  &nbsp;&nbsp; `158 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **2,738** &nbsp;&nbsp; folks: **201**  &nbsp;&nbsp; `172 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,050** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `1,372 stars today`

1. [acidanthera / OpenCorePkg](https://github.com/acidanthera/OpenCorePkg)
    - OpenCore bootloader
    - language: **C** &nbsp;&nbsp; stars: **7,224** &nbsp;&nbsp; folks: **1,244**  &nbsp;&nbsp; `35 stars today`
...
1. [juce-framework / JUCE](https://github.com/juce-framework/JUCE)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,054** &nbsp;&nbsp; folks: **977**  &nbsp;&nbsp; `155 stars today`

1. [blazorhero / CleanArchitecture](https://github.com/blazorhero/CleanArchitecture)
    - Clean Architecture Template for Blazor WebAssembly Built with MudBlazor Components.
    - language: **C#** &nbsp;&nbsp; stars: **899** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `62 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,433** &nbsp;&nbsp; folks: **1,702**  &nbsp;&nbsp; `390 stars today`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,865** &nbsp;&nbsp; folks: **2,188**  &nbsp;&nbsp; `128 stars today`

1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,186** &nbsp;&nbsp; folks: **3,451**  &nbsp;&nbsp; `157 stars today`

1. [ageron / handson-ml2](https://github.com/ageron/handson-ml2)
    - A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,243** &nbsp;&nbsp; folks: **7,157**  &nbsp;&nbsp; `34 stars today`
...
1. [sonnysangha / Amazon-starter-template-nextjs](https://github.com/sonnysangha/Amazon-starter-template-nextjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **118** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `73 stars today`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **103,827** &nbsp;&nbsp; folks: **41,345**  &nbsp;&nbsp; `168 stars today`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,382** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `353 stars this week`

1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    - Recovers passwords from pixelized screenshots
    - language: **Python** &nbsp;&nbsp; stars: **18,865** &nbsp;&nbsp; folks: **2,188**  &nbsp;&nbsp; `450 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,014** &nbsp;&nbsp; folks: **1,899**  &nbsp;&nbsp; `1,219 stars this week`

1. [tensorflow / tfjs-models](https://github.com/tensorflow/tfjs-models)
    - Pretrained models for TensorFlow.js
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,040** &nbsp;&nbsp; folks: **2,800**  &nbsp;&nbsp; `82 stars this week`
...
1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **5,440** &nbsp;&nbsp; folks: **1,313**  &nbsp;&nbsp; `156 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,680** &nbsp;&nbsp; folks: **1,000**  &nbsp;&nbsp; `3,647 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,292** &nbsp;&nbsp; folks: **8,270**  &nbsp;&nbsp; `4,294 stars this month`
