...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,261** &nbsp;&nbsp; folks: **1,091**  &nbsp;&nbsp; `2,851 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,911** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `1,318 stars this week`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,588** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `3,590 stars this week`

1. [tursodatabase / limbo](https://github.com/tursodatabase/limbo)
    - Limbo is a work-in-progress, in-process OLTP database management system, compatible with SQLite.
    - language: **Rust** &nbsp;&nbsp; stars: **7,648** &nbsp;&nbsp; folks: **245**  &nbsp;&nbsp; `2,313 stars this week`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **112,806** &nbsp;&nbsp; folks: **6,646**  &nbsp;&nbsp; `578 stars this week`
...
1. [comet-ml / opik](https://github.com/comet-ml/opik)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,622** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `1,006 stars this week`

1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    - Neovim config for the lazy
    - language: **Lua** &nbsp;&nbsp; stars: **18,418** &nbsp;&nbsp; folks: **1,292**  &nbsp;&nbsp; `488 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,038** &nbsp;&nbsp; folks: **2,179**  &nbsp;&nbsp; `515 stars this week`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,946** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `458 stars this week`

1. [bigskysoftware / htmx](https://github.com/bigskysoftware/htmx)
    - </> htmx - high power tools for HTML
    - language: **JavaScript** &nbsp;&nbsp; stars: **41,784** &nbsp;&nbsp; folks: **1,352**  &nbsp;&nbsp; `2,763 stars this week`

1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,973** &nbsp;&nbsp; folks: **490**  &nbsp;&nbsp; `4,230 stars this week`
...
1. [RocketChat / Rocket.Chat](https://github.com/RocketChat/Rocket.Chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **41,439** &nbsp;&nbsp; folks: **10,917**  &nbsp;&nbsp; `509 stars this week`

1. [ByteByteGoHq / system-design-101](https://github.com/ByteByteGoHq/system-design-101)
    - Explain complex systems using visuals and simple terms. Help you prepare for system design interviews.
    - language: **无** &nbsp;&nbsp; stars: **66,949** &nbsp;&nbsp; folks: **7,021**  &nbsp;&nbsp; `1,459 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,677** &nbsp;&nbsp; folks: **47,134**  &nbsp;&nbsp; `1,650 stars this week`

1. [Saghen / blink.cmp](https://github.com/Saghen/blink.cmp)
    - Performant, batteries-included completion plugin for Neovim
    - language: **Lua** &nbsp;&nbsp; stars: **2,453** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `654 stars this week`

1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    - 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
    - language: **Rust** &nbsp;&nbsp; stars: **18,520** &nbsp;&nbsp; folks: **423**  &nbsp;&nbsp; `728 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,911** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `3,391 stars this month`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,716** &nbsp;&nbsp; folks: **1,684**  &nbsp;&nbsp; `3,741 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,261** &nbsp;&nbsp; folks: **1,091**  &nbsp;&nbsp; `3,817 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,588** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `7,629 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **66,011** &nbsp;&nbsp; folks: **8,024**  &nbsp;&nbsp; `5,708 stars this month`
...
1. [TEN-framework / TEN-Agent](https://github.com/TEN-framework/TEN-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,674** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `2,036 stars this month`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **104,005** &nbsp;&nbsp; folks: **13,044**  &nbsp;&nbsp; `4,709 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **40,259** &nbsp;&nbsp; folks: **4,538**  &nbsp;&nbsp; `5,149 stars this month`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,637** &nbsp;&nbsp; folks: **1,068**  &nbsp;&nbsp; `2,140 stars this month`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,402** &nbsp;&nbsp; folks: **10,725**  &nbsp;&nbsp; `4,768 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **16,349** &nbsp;&nbsp; folks: **834**  &nbsp;&nbsp; `5,776 stars this month`
...
1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **72,093** &nbsp;&nbsp; folks: **11,802**  &nbsp;&nbsp; `2,273 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **80,987** &nbsp;&nbsp; folks: **36,620**  &nbsp;&nbsp; `1,430 stars this month`

1. [jdx / mise](https://github.com/jdx/mise)
    - dev tools, env vars, task runner
    - language: **Rust** &nbsp;&nbsp; stars: **12,106** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `1,939 stars this month`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **32,856** &nbsp;&nbsp; folks: **6,581**  &nbsp;&nbsp; `1,944 stars this month`

1. [awslabs / multi-agent-orchestrator](https://github.com/awslabs/multi-agent-orchestrator)
    - Flexible and powerful framework for managing multiple AI agents and handling complex conversations
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,257** &nbsp;&nbsp; folks: **232**  &nbsp;&nbsp; `1,313 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,790** &nbsp;&nbsp; folks: **2,088**  &nbsp;&nbsp; `3,867 stars this month`
