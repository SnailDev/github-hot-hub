...
1. [D1rkMtr / DumpThatLSASS](https://github.com/D1rkMtr/DumpThatLSASS)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **206** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `139 stars today`

1. [nlohmann / json](https://github.com/nlohmann/json)
    - JSON for Modern C++
    - language: **C++** &nbsp;&nbsp; stars: **31,933** &nbsp;&nbsp; folks: **5,497**  &nbsp;&nbsp; `31 stars today`

1. [AppFlowy-IO / AppFlowy](https://github.com/AppFlowy-IO/AppFlowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Dart** &nbsp;&nbsp; stars: **27,773** &nbsp;&nbsp; folks: **1,508**  &nbsp;&nbsp; `77 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **210,052** &nbsp;&nbsp; folks: **24,059**  &nbsp;&nbsp; `158 stars today`
...
1. [squizlabs / PHP_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **9,702** &nbsp;&nbsp; folks: **1,467**  &nbsp;&nbsp; `20 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **18,079** &nbsp;&nbsp; folks: **3,783**  &nbsp;&nbsp; `107 stars today`

1. [prisma / prisma](https://github.com/prisma/prisma)
    - Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,796** &nbsp;&nbsp; folks: **924**  &nbsp;&nbsp; `68 stars today`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,901** &nbsp;&nbsp; folks: **580**  &nbsp;&nbsp; `1,070 stars this week`
...
1. [xkcoding / spring-boot-demo](https://github.com/xkcoding/spring-boot-demo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,988** &nbsp;&nbsp; folks: **9,477**  &nbsp;&nbsp; `342 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    - Stable Diffusion web UI
    - language: **Python** &nbsp;&nbsp; stars: **4,901** &nbsp;&nbsp; folks: **580**  &nbsp;&nbsp; `4,798 stars this month`

1. [AykutSarac / jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com)
    - 🔮 Seamlessly visualize your JSON data instantly into graphs; paste, import or fetch!
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,638** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `10,173 stars this month`

1. [CompVis / stable-diffusion](https://github.com/CompVis/stable-diffusion)
    - A latent text-to-image diffusion model
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **25,822** &nbsp;&nbsp; folks: **4,076**  &nbsp;&nbsp; `15,411 stars this month`

1. [sd-webui / stable-diffusion-webui](https://github.com/sd-webui/stable-diffusion-webui)
    - Stable Diffusion web UI
    - language: **Python** &nbsp;&nbsp; stars: **4,509** &nbsp;&nbsp; folks: **500**  &nbsp;&nbsp; `3,974 stars this month`
...
1. [alist-org / alist](https://github.com/alist-org/alist)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **9,585** &nbsp;&nbsp; folks: **1,516**  &nbsp;&nbsp; `1,451 stars this month`
...
1. [total-typescript / beginners-typescript-tutorial](https://github.com/total-typescript/beginners-typescript-tutorial)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,507** &nbsp;&nbsp; folks: **549**  &nbsp;&nbsp; `3,196 stars this month`
...
1. [SerenityOS / ladybird](https://github.com/SerenityOS/ladybird)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,257** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `751 stars this month`
...
1. [python-poetry / poetry](https://github.com/python-poetry/poetry)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,995** &nbsp;&nbsp; folks: **1,763**  &nbsp;&nbsp; `962 stars this month`
...
1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,032** &nbsp;&nbsp; folks: **1,607**  &nbsp;&nbsp; `1,730 stars this month`
