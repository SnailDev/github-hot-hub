...
1. [kon9chunkit / GitHub-Chinese-Top-Charts](https://github.com/kon9chunkit/GitHub-Chinese-Top-Charts)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **42,776** &nbsp;&nbsp; folks: **6,094**  &nbsp;&nbsp; `162 stars today`

1. [EmbarkStudios / kajiya](https://github.com/EmbarkStudios/kajiya)
    - 💡 Experimental real-time global illumination renderer 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **1,219** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `163 stars today`

1. [zeromicro / go-zero](https://github.com/zeromicro/go-zero)
    - go-zero is a web and rpc framework written in Go. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
    - language: **Go** &nbsp;&nbsp; stars: **13,346** &nbsp;&nbsp; folks: **1,629**  &nbsp;&nbsp; `72 stars today`

1. [jina-ai / jina](https://github.com/jina-ai/jina)
    - Cloud-native neural search framework for 𝙖𝙣𝙮 kind of data
    - language: **Python** &nbsp;&nbsp; stars: **12,840** &nbsp;&nbsp; folks: **1,733**  &nbsp;&nbsp; `131 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **89,448** &nbsp;&nbsp; folks: **9,527**  &nbsp;&nbsp; `149 stars today`
...
1. [louisfb01 / best_AI_papers_2021](https://github.com/louisfb01/best_AI_papers_2021)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,954** &nbsp;&nbsp; folks: **151**  &nbsp;&nbsp; `104 stars today`

1. [dani-garcia / vaultwarden](https://github.com/dani-garcia/vaultwarden)
    - Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs
    - language: **Rust** &nbsp;&nbsp; stars: **12,830** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `90 stars today`

1. [tiangolo / sqlmodel](https://github.com/tiangolo/sqlmodel)
    - SQL databases in Python, designed for simplicity, compatibility, and robustness.
    - language: **Python** &nbsp;&nbsp; stars: **6,310** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `125 stars today`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,878** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `324 stars today`
...
1. [cisagov / log4j-affected-db](https://github.com/cisagov/log4j-affected-db)
    ...
    - language: **无** &nbsp;&nbsp; stars: **894** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `262 stars this week`

1. [codenotary / immudb](https://github.com/codenotary/immudb)
    - immudb - world’s fastest immutable database, built on a zero trust model
    - language: **Go** &nbsp;&nbsp; stars: **5,316** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `1,842 stars this week`

1. [rui314 / mold](https://github.com/rui314/mold)
    - mold: A Modern Linker
    - language: **C++** &nbsp;&nbsp; stars: **4,838** &nbsp;&nbsp; folks: **135**  &nbsp;&nbsp; `607 stars this week`
...
1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **10,981** &nbsp;&nbsp; folks: **2,436**  &nbsp;&nbsp; `554 stars this week`

1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    - GFPGAN aims at developing Practical Algorithms for Real-world Face Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **13,575** &nbsp;&nbsp; folks: **2,016**  &nbsp;&nbsp; `2,783 stars this week`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,094** &nbsp;&nbsp; folks: **1,494**  &nbsp;&nbsp; `1,352 stars this week`
...
1. [picocss / pico](https://github.com/picocss/pico)
    ...
    - language: **SCSS** &nbsp;&nbsp; stars: **3,055** &nbsp;&nbsp; folks: **65**  &nbsp;&nbsp; `784 stars this week`

1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    - 清华大学计算机系课程攻略 Guidance for courses in Department of Computer Science and Technology, Tsinghua University
    - language: **HTML** &nbsp;&nbsp; stars: **20,788** &nbsp;&nbsp; folks: **5,681**  &nbsp;&nbsp; `591 stars this week`
...
1. [smartcontractkit / full-blockchain-solidity-course-py](https://github.com/smartcontractkit/full-blockchain-solidity-course-py)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,252** &nbsp;&nbsp; folks: **975**  &nbsp;&nbsp; `199 stars this week`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **14,930** &nbsp;&nbsp; folks: **3,185**  &nbsp;&nbsp; `878 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    - GFPGAN aims at developing Practical Algorithms for Real-world Face Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **13,575** &nbsp;&nbsp; folks: **2,016**  &nbsp;&nbsp; `9,862 stars this month`

1. [phoboslab / qoi](https://github.com/phoboslab/qoi)
    - The “Quite OK Image Format” for fast, lossless image compression
    - language: **C** &nbsp;&nbsp; stars: **3,710** &nbsp;&nbsp; folks: **155**  &nbsp;&nbsp; `2,904 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **181,387** &nbsp;&nbsp; folks: **26,053**  &nbsp;&nbsp; `5,226 stars this month`
...
1. [remix-run / remix](https://github.com/remix-run/remix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,421** &nbsp;&nbsp; folks: **560**  &nbsp;&nbsp; `4,591 stars this month`

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **13,726** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `5,898 stars this month`
...
1. [elastic / elasticsearch](https://github.com/elastic/elasticsearch)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **57,875** &nbsp;&nbsp; folks: **21,046**  &nbsp;&nbsp; `611 stars this month`
