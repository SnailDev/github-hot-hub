...
`更新时间：2026-01-21 02:30:43 +0800`

## 今日热门仓库

1. [microsoft / agent-lightning](https://github.com/microsoft/agent-lightning)
    - The absolute trainer to light up AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **10,667** &nbsp;&nbsp; folks: **870**  &nbsp;&nbsp; `43 stars today`
...
1. [obra / superpowers](https://github.com/obra/superpowers)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **30,785** &nbsp;&nbsp; folks: **2,301**  &nbsp;&nbsp; `11,341 stars this week`

1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **80,214** &nbsp;&nbsp; folks: **7,115**  &nbsp;&nbsp; `14,182 stars this week`

1. [iOfficeAI / AionUi](https://github.com/iOfficeAI/AionUi)
    - Free, local, open-source Cowork for Gemini CLI, Claude Code, Codex, Opencode, Qwen Code, Goose Cli, Auggie, and more | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,626** &nbsp;&nbsp; folks: **579**  &nbsp;&nbsp; `2,994 stars this week`

1. [permissionlesstech / bitchat](https://github.com/permissionlesstech/bitchat)
    - bluetooth mesh chat, IRC vibes
    - language: **Swift** &nbsp;&nbsp; stars: **24,454** &nbsp;&nbsp; folks: **2,282**  &nbsp;&nbsp; `493 stars this week`

1. [frankbria / ralph-claude-code](https://github.com/frankbria/ralph-claude-code)
    - Autonomous AI development loop for Claude Code with intelligent exit detection
    - language: **Shell** &nbsp;&nbsp; stars: **4,295** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,933 stars this week`
...
1. [alirezarezvani / claude-skills](https://github.com/alirezarezvani/claude-skills)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **977** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `272 stars this week`

1. [ahujasid / blender-mcp](https://github.com/ahujasid/blender-mcp)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **16,151** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `741 stars this week`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **78,621** &nbsp;&nbsp; folks: **11,463**  &nbsp;&nbsp; `1,139 stars this week`

1. [ComposioHQ / awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)
    - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows
    - language: **Python** &nbsp;&nbsp; stars: **22,620** &nbsp;&nbsp; folks: **2,258**  &nbsp;&nbsp; `3,699 stars this week`
...
1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **80,214** &nbsp;&nbsp; folks: **7,115**  &nbsp;&nbsp; `38,107 stars this month`

1. [BloopAI / vibe-kanban](https://github.com/BloopAI/vibe-kanban)
    - Get 10X more out of Claude Code, Codex or any coding agent
    - language: **Rust** &nbsp;&nbsp; stars: **17,828** &nbsp;&nbsp; folks: **1,645**  &nbsp;&nbsp; `10,661 stars this month`

1. [anthropics / skills](https://github.com/anthropics/skills)
    - Public repository for Agent Skills
    - language: **Python** &nbsp;&nbsp; stars: **46,643** &nbsp;&nbsp; folks: **4,399**  &nbsp;&nbsp; `23,268 stars this month`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **30,785** &nbsp;&nbsp; folks: **2,301**  &nbsp;&nbsp; `19,023 stars this month`

1. [rendercv / rendercv](https://github.com/rendercv/rendercv)
    - CV/resume generator for academics and engineers, YAML to PDF
    - language: **Python** &nbsp;&nbsp; stars: **15,033** &nbsp;&nbsp; folks: **1,016**  &nbsp;&nbsp; `10,996 stars this month`

1. [ComposioHQ / awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)
    - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows
    - language: **Python** &nbsp;&nbsp; stars: **22,620** &nbsp;&nbsp; folks: **2,258**  &nbsp;&nbsp; `14,089 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **58,601** &nbsp;&nbsp; folks: **4,330**  &nbsp;&nbsp; `11,417 stars this month`
...
1. [usememos / memos](https://github.com/usememos/memos)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **55,013** &nbsp;&nbsp; folks: **3,940**  &nbsp;&nbsp; `7,715 stars this month`
