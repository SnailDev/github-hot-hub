...
`更新时间：2024-10-06 11:21:55 +0800`

## 今日热门仓库

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,879** &nbsp;&nbsp; folks: **44,795**  &nbsp;&nbsp; `1,946 stars today`

1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,793** &nbsp;&nbsp; folks: **3,086**  &nbsp;&nbsp; `158 stars today`

1. [ocornut / imgui](https://github.com/ocornut/imgui)
    - Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies
    - language: **C++** &nbsp;&nbsp; stars: **59,975** &nbsp;&nbsp; folks: **10,188**  &nbsp;&nbsp; `31 stars today`
...
1. [fineanmol / Hacktoberfest2024](https://github.com/fineanmol/Hacktoberfest2024)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,214** &nbsp;&nbsp; folks: **7,208**  &nbsp;&nbsp; `121 stars today`

1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Low code platform for building business apps and workflows in minutes. Supports PostgreSQL, MySQL, MariaDB, MSSQL, MongoDB, Rest API, Docker, K8s, and more 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,168** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `15 stars today`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,385** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `7,009 stars this week`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,739** &nbsp;&nbsp; folks: **356**  &nbsp;&nbsp; `4,991 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,575** &nbsp;&nbsp; folks: **736**  &nbsp;&nbsp; `1,169 stars this week`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **9,589** &nbsp;&nbsp; folks: **511**  &nbsp;&nbsp; `2,384 stars this week`

1. [mainmatter / 100-exercises-to-learn-rust](https://github.com/mainmatter/100-exercises-to-learn-rust)
    - A self-paced course to learn Rust, one exercise at a time.
    - language: **Rust** &nbsp;&nbsp; stars: **4,966** &nbsp;&nbsp; folks: **858**  &nbsp;&nbsp; `1,023 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The OS for your personal finances
    - language: **Ruby** &nbsp;&nbsp; stars: **30,492** &nbsp;&nbsp; folks: **2,277**  &nbsp;&nbsp; `843 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,639** &nbsp;&nbsp; folks: **2,892**  &nbsp;&nbsp; `1,270 stars this week`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **47,360** &nbsp;&nbsp; folks: **2,413**  &nbsp;&nbsp; `1,288 stars this week`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,879** &nbsp;&nbsp; folks: **44,795**  &nbsp;&nbsp; `2,791 stars this week`
...
1. [tw93 / Pake](https://github.com/tw93/Pake)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,741** &nbsp;&nbsp; folks: **5,145**  &nbsp;&nbsp; `2,399 stars this week`
...
1. [DiceDB / dice](https://github.com/DiceDB/dice)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,662** &nbsp;&nbsp; folks: **840**  &nbsp;&nbsp; `693 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    ...
    - language: **C** &nbsp;&nbsp; stars: **71,248** &nbsp;&nbsp; folks: **5,882**  &nbsp;&nbsp; `627 stars this week`

1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,793** &nbsp;&nbsp; folks: **3,086**  &nbsp;&nbsp; `779 stars this week`
...
1. [RSSNext / Follow](https://github.com/RSSNext/Follow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,934** &nbsp;&nbsp; folks: **470**  &nbsp;&nbsp; `7,570 stars this month`

1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **6,739** &nbsp;&nbsp; folks: **356**  &nbsp;&nbsp; `5,537 stars this month`

1. [fishaudio / fish-speech](https://github.com/fishaudio/fish-speech)
    - Brand new TTS solution
    - language: **Python** &nbsp;&nbsp; stars: **12,892** &nbsp;&nbsp; folks: **964**  &nbsp;&nbsp; `5,633 stars this month`
...
1. [DiceDB / dice](https://github.com/DiceDB/dice)
    - DiceDB is a redis-compliant, in-memory, real-time, and reactive database optimized for modern hardware and building and scaling truly real-time applications.
    - language: **Go** &nbsp;&nbsp; stars: **5,662** &nbsp;&nbsp; folks: **840**  &nbsp;&nbsp; `2,436 stars this month`

1. [tw93 / Pake](https://github.com/tw93/Pake)
    - 🤱🏻 Turn any webpage into a desktop app with Rust. 🤱🏻 利用 Rust 轻松构建轻量级多端桌面应用
    - language: **Rust** &nbsp;&nbsp; stars: **29,741** &nbsp;&nbsp; folks: **5,145**  &nbsp;&nbsp; `4,464 stars this month`

1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    - ⚡ Open-source workflow automation platform. Orchestrate any language using YAML, hundreds of integrations. Alternative to Airflow, n8n, RunDeck, Camunda, Jenkins...
    - language: **Java** &nbsp;&nbsp; stars: **9,575** &nbsp;&nbsp; folks: **736**  &nbsp;&nbsp; `2,192 stars this month`

1. [mainmatter / 100-exercises-to-learn-rust](https://github.com/mainmatter/100-exercises-to-learn-rust)
    - A self-paced course to learn Rust, one exercise at a time.
    - language: **Rust** &nbsp;&nbsp; stars: **4,966** &nbsp;&nbsp; folks: **858**  &nbsp;&nbsp; `1,435 stars this month`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,895** &nbsp;&nbsp; folks: **1,710**  &nbsp;&nbsp; `4,468 stars this month`

1. [home-assistant / core](https://github.com/home-assistant/core)
    - 🏡 Open source home automation that puts local control and privacy first.
    - language: **Python** &nbsp;&nbsp; stars: **72,165** &nbsp;&nbsp; folks: **30,198**  &nbsp;&nbsp; `1,285 stars this month`

1. [continuedev / continue](https://github.com/continuedev/continue)
    - ⏩ Continue is the leading open-source AI code assistant. You can connect any models and any context to build custom autocomplete and chat experiences inside VS Code and JetBrains
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,669** &nbsp;&nbsp; folks: **1,367**  &nbsp;&nbsp; `2,416 stars this month`

1. [AykutSarac / jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com)
    - ✨ Innovative and open-source visualization application that transforms various data formats, such as JSON, YAML, XML, CSV and more, into interactive graphs.
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,609** &nbsp;&nbsp; folks: **1,964**  &nbsp;&nbsp; `837 stars this month`
...
1. [pytorch / ao](https://github.com/pytorch/ao)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,267** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `606 stars this month`
