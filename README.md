...
1. [mikeroyal / Self-Hosting-Guide](https://github.com/mikeroyal/Self-Hosting-Guide)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **2,352** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `674 stars today`

1. [Textualize / textual](https://github.com/Textualize/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **15,065** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `383 stars today`

1. [vercel / next.js](https://github.com/vercel/next.js)
    - The React Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,701** &nbsp;&nbsp; folks: **20,832**  &nbsp;&nbsp; `223 stars today`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **22,523** &nbsp;&nbsp; folks: **2,402**  &nbsp;&nbsp; `42 stars today`
...
1. [WalletConnect / web3modal](https://github.com/WalletConnect/web3modal)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,598** &nbsp;&nbsp; folks: **867**  &nbsp;&nbsp; `67 stars today`

1. [jaywcjlove / linux-command](https://github.com/jaywcjlove/linux-command)
    - Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
    - language: **Markdown** &nbsp;&nbsp; stars: **20,781** &nbsp;&nbsp; folks: **4,548**  &nbsp;&nbsp; `232 stars today`
...
1. [patriciogonzalezvivo / glslViewer](https://github.com/patriciogonzalezvivo/glslViewer)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,614** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `54 stars today`

1. [ethereum-optimism / optimism](https://github.com/ethereum-optimism/optimism)
    - Optimism is Ethereum, scaled.
    - language: **Go** &nbsp;&nbsp; stars: **1,734** &nbsp;&nbsp; folks: **499**  &nbsp;&nbsp; `39 stars today`
...
1. [aptos-labs / aptos-core](https://github.com/aptos-labs/aptos-core)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,435** &nbsp;&nbsp; folks: **2,348**  &nbsp;&nbsp; `369 stars this week`

1. [PrismLauncher / PrismLauncher](https://github.com/PrismLauncher/PrismLauncher)
    - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once (Fork of MultiMC)
    - language: **C++** &nbsp;&nbsp; stars: **2,093** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `723 stars this week`
...
1. [Textualize / textual](https://github.com/Textualize/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **15,065** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `1,093 stars this week`

1. [marcj / TypeRunner](https://github.com/marcj/TypeRunner)
    - High-performance TypeScript compiler
    - language: **C++** &nbsp;&nbsp; stars: **2,148** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `587 stars this week`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,155** &nbsp;&nbsp; folks: **5,330**  &nbsp;&nbsp; `648 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **35,723** &nbsp;&nbsp; folks: **6,008**  &nbsp;&nbsp; `397 stars this week`

1. [metabase / metabase](https://github.com/metabase/metabase)
    - The simplest, fastest way to get business intelligence and analytics to everyone in your company 😋
    - language: **Clojure** &nbsp;&nbsp; stars: **30,330** &nbsp;&nbsp; folks: **4,118**  &nbsp;&nbsp; `300 stars this week`
...
1. [rancher / rancher](https://github.com/rancher/rancher)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,098** &nbsp;&nbsp; folks: **2,677**  &nbsp;&nbsp; `133 stars this week`

1. [spacedriveapp / spacedrive](https://github.com/spacedriveapp/spacedrive)
    - Spacedrive is an open source cross-platform file explorer, powered by a virtual distributed filesystem written in Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **14,861** &nbsp;&nbsp; folks: **393**  &nbsp;&nbsp; `301 stars this week`
...
1. [HyNetwork / hysteria](https://github.com/HyNetwork/hysteria)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,820** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `120 stars this week`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **19,303** &nbsp;&nbsp; folks: **4,166**  &nbsp;&nbsp; `614 stars this week`
...
1. [JoePenna / Dreambooth-Stable-Diffusion](https://github.com/JoePenna/Dreambooth-Stable-Diffusion)
    - Implementation of Dreambooth (https://arxiv.org/abs/2208.12242) by way of Textual Inversion (https://arxiv.org/abs/2208.01618) for Stable Diffusion (https://arxiv.org/abs/2112.10752). Tweaks focused on training faces, objects, and styles.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,713** &nbsp;&nbsp; folks: **256**  &nbsp;&nbsp; `1,298 stars this month`

1. [firstcontributions / first-contributions](https://github.com/firstcontributions/first-contributions)
    - 🚀✨ Help beginners to contribute to open source projects
    - language: **无** &nbsp;&nbsp; stars: **29,463** &nbsp;&nbsp; folks: **53,436**  &nbsp;&nbsp; `3,192 stars this month`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,958** &nbsp;&nbsp; folks: **339**  &nbsp;&nbsp; `1,859 stars this month`

1. [BuilderIO / qwik](https://github.com/BuilderIO/qwik)
    - The HTML-first framework. Instant apps of any size with ~ 1kb JS
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,489** &nbsp;&nbsp; folks: **499**  &nbsp;&nbsp; `3,123 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,462** &nbsp;&nbsp; folks: **1,298**  &nbsp;&nbsp; `1,220 stars this month`
...
1. [xkcoding / spring-boot-demo](https://github.com/xkcoding/spring-boot-demo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **27,735** &nbsp;&nbsp; folks: **9,691**  &nbsp;&nbsp; `961 stars this month`
