...
1. [kabinspace / AstroVim](https://github.com/kabinspace/AstroVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **772** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `291 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **80,401** &nbsp;&nbsp; folks: **7,178**  &nbsp;&nbsp; `189 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **134,181** &nbsp;&nbsp; folks: **22,074**  &nbsp;&nbsp; `143 stars today`

1. [ethereum / EIPs](https://github.com/ethereum/EIPs)
    - The Ethereum Improvement Proposal repository
    - language: **Solidity** &nbsp;&nbsp; stars: **8,897** &nbsp;&nbsp; folks: **3,226**  &nbsp;&nbsp; `56 stars today`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **30,881** &nbsp;&nbsp; folks: **2,306**  &nbsp;&nbsp; `165 stars today`

1. [Kindelia / HVM](https://github.com/Kindelia/HVM)
    - A massively parallel, optimal functional runtime in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **2,929** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `490 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **135,414** &nbsp;&nbsp; folks: **20,501**  &nbsp;&nbsp; `179 stars today`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **68,268** &nbsp;&nbsp; folks: **3,836**  &nbsp;&nbsp; `220 stars today`
...
1. [serverless-stack / serverless-stack](https://github.com/serverless-stack/serverless-stack)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,886** &nbsp;&nbsp; folks: **327**  &nbsp;&nbsp; `75 stars today`
...
1. [tobspr / shapez.io](https://github.com/tobspr/shapez.io)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,674** &nbsp;&nbsp; folks: **952**  &nbsp;&nbsp; `111 stars today`

1. [danielkrupinski / Osiris](https://github.com/danielkrupinski/Osiris)
    - Free open-source game cheat for Counter-Strike: Global Offensive, written in modern C++. GUI powered by Dear ImGui.
    - language: **C++** &nbsp;&nbsp; stars: **1,959** &nbsp;&nbsp; folks: **773**  &nbsp;&nbsp; `42 stars today`
...
1. [psf / black](https://github.com/psf/black)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,225** &nbsp;&nbsp; folks: **1,600**  &nbsp;&nbsp; `634 stars this week`

1. [nextui-org / nextui](https://github.com/nextui-org/nextui)
    - 🚀 Beautiful, fast and modern React UI library.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,551** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `1,101 stars this week`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,087** &nbsp;&nbsp; folks: **86**  &nbsp;&nbsp; `535 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,215** &nbsp;&nbsp; folks: **5,739**  &nbsp;&nbsp; `884 stars this week`

1. [logseq / logseq](https://github.com/logseq/logseq)
    - A privacy-first, open-source platform for knowledge management and collaboration. Desktop app download link: https://github.com/logseq/logseq/releases, roadmap: https://trello.com/b/8txSM12G/roadmap
    - language: **Clojure** &nbsp;&nbsp; stars: **10,363** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `868 stars this week`
...
1. [github / copilot-docs](https://github.com/github/copilot-docs)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,841** &nbsp;&nbsp; folks: **830**  &nbsp;&nbsp; `546 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,202** &nbsp;&nbsp; folks: **783**  &nbsp;&nbsp; `165 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,554** &nbsp;&nbsp; folks: **3,194**  &nbsp;&nbsp; `3,809 stars this month`
...
1. [facebookresearch / mae](https://github.com/facebookresearch/mae)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,566** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `2,505 stars this month`

1. [wmjordan / PDFPatcher](https://github.com/wmjordan/PDFPatcher)
    - PDF补丁丁——PDF工具箱，可以编辑书签、剪裁旋转页面、解除限制、提取或合并文档，探查文档结构，提取图片、转成图片等等
    - language: **C#** &nbsp;&nbsp; stars: **3,634** &nbsp;&nbsp; folks: **678**  &nbsp;&nbsp; `2,435 stars this month`
...
1. [Textualize / rich](https://github.com/Textualize/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,768** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `2,875 stars this month`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,867** &nbsp;&nbsp; folks: **1,997**  &nbsp;&nbsp; `1,145 stars this month`

1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    - 你管这破玩意叫操作系统源码 — 像小说一样品读 Linux 0.11 核心代码
    - language: **C** &nbsp;&nbsp; stars: **6,900** &nbsp;&nbsp; folks: **749**  &nbsp;&nbsp; `3,451 stars this month`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **9,215** &nbsp;&nbsp; folks: **5,739**  &nbsp;&nbsp; `2,069 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,218** &nbsp;&nbsp; folks: **2,971**  &nbsp;&nbsp; `1,058 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **30,203** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `3,914 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **207,048** &nbsp;&nbsp; folks: **55,838**  &nbsp;&nbsp; `5,065 stars this month`
...
1. [octocat / Spoon-Knife](https://github.com/octocat/Spoon-Knife)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **10,752** &nbsp;&nbsp; folks: **122,781**  &nbsp;&nbsp; `111 stars this month`
