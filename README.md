...
`更新时间：2021-05-02 11:22:24 +0800`

## 今日热门仓库

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,881** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `1,009 stars today`

1. [Kotlin / kmm-production-sample](https://github.com/Kotlin/kmm-production-sample)
    - 无
    - language: **Kotlin** &nbsp;&nbsp; stars: **423** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `182 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **23,894** &nbsp;&nbsp; folks: **4,949**  &nbsp;&nbsp; `614 stars today`

1. [golang-standards / project-layout](https://github.com/golang-standards/project-layout)
    - Standard Go Project Layout
    - language: **Makefile** &nbsp;&nbsp; stars: **23,282** &nbsp;&nbsp; folks: **2,436**  &nbsp;&nbsp; `236 stars today`

1. [raydium-io / raydium-ui](https://github.com/raydium-io/raydium-ui)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **87** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `56 stars today`
...
1. [TritonHo / slides](https://github.com/TritonHo/slides)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,695** &nbsp;&nbsp; folks: **337**  &nbsp;&nbsp; `73 stars today`

1. [wuyouzhuguli / SpringAll](https://github.com/wuyouzhuguli/SpringAll)
    - 循序渐进，学习Spring Boot、Spring Boot & Shiro、Spring Batch、Spring Cloud、Spring Cloud Alibaba、Spring Security & Spring Security OAuth2，博客Spring系列源码：https://mrbird.cc
    - language: **Java** &nbsp;&nbsp; stars: **19,437** &nbsp;&nbsp; folks: **5,876**  &nbsp;&nbsp; `79 stars today`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,689** &nbsp;&nbsp; folks: **857**  &nbsp;&nbsp; `353 stars today`

1. [flashlight / flashlight](https://github.com/flashlight/flashlight)
    - A C++ standalone library for machine learning
    - language: **C++** &nbsp;&nbsp; stars: **3,318** &nbsp;&nbsp; folks: **307**  &nbsp;&nbsp; `177 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,888** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `75 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,947** &nbsp;&nbsp; folks: **17,500**  &nbsp;&nbsp; `526 stars today`

1. [nrwl / nx](https://github.com/nrwl/nx)
    - Powerful, Extensible Dev Tools
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,026** &nbsp;&nbsp; folks: **720**  &nbsp;&nbsp; `71 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,315** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `619 stars today`

1. [thedevdojo / wave](https://github.com/thedevdojo/wave)
    - Wave - The Software as a Service Starter Kit, designed to help you build the SAAS of your dreams 🚀 💰
    - language: **PHP** &nbsp;&nbsp; stars: **1,209** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `266 stars today`

1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    - 分享 GitHub 上有趣、入门级的开源项目
    - language: **Python** &nbsp;&nbsp; stars: **40,721** &nbsp;&nbsp; folks: **6,064**  &nbsp;&nbsp; `204 stars today`
...
1. [yuk1ty / learning-systems-programming-in-rust](https://github.com/yuk1ty/learning-systems-programming-in-rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **231** &nbsp;&nbsp; folks: **13**  &nbsp;&nbsp; `116 stars today`
...
1. [terraform-providers / terraform-provider-azurerm](https://github.com/terraform-providers/terraform-provider-azurerm)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,519** &nbsp;&nbsp; folks: **2,407**  &nbsp;&nbsp; `37 stars today`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,676** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,396 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **186,116** &nbsp;&nbsp; folks: **41,894**  &nbsp;&nbsp; `2,739 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,947** &nbsp;&nbsp; folks: **17,500**  &nbsp;&nbsp; `2,174 stars this week`
...
1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **51,107** &nbsp;&nbsp; folks: **6,283**  &nbsp;&nbsp; `957 stars this week`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,166** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `670 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,802** &nbsp;&nbsp; folks: **8,070**  &nbsp;&nbsp; `1,078 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,311** &nbsp;&nbsp; folks: **596**  &nbsp;&nbsp; `4,414 stars this month`
...
1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,906** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `1,473 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,802** &nbsp;&nbsp; folks: **8,070**  &nbsp;&nbsp; `3,840 stars this month`
