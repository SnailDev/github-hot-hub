...
`更新时间：2025-03-15 10:49:39 +0800`

## 今日热门仓库

1. [xpipe-io / xpipe](https://github.com/xpipe-io/xpipe)
    - Access your entire server infrastructure from your local desktop
    - language: **Java** &nbsp;&nbsp; stars: **7,374** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `795 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,396** &nbsp;&nbsp; folks: **39,296**  &nbsp;&nbsp; `297 stars today`

1. [glanceapp / glance](https://github.com/glanceapp/glance)
    - A self-hosted dashboard that puts all your feeds in one place
    - language: **Go** &nbsp;&nbsp; stars: **12,563** &nbsp;&nbsp; folks: **435**  &nbsp;&nbsp; `189 stars today`

1. [openai / openai-python](https://github.com/openai/openai-python)
    - The official Python library for the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **25,385** &nbsp;&nbsp; folks: **3,680**  &nbsp;&nbsp; `47 stars today`

1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **24,493** &nbsp;&nbsp; folks: **2,400**  &nbsp;&nbsp; `356 stars today`

1. [YaLTeR / niri](https://github.com/YaLTeR/niri)
    - A scrollable-tiling Wayland compositor.
    - language: **Rust** &nbsp;&nbsp; stars: **6,165** &nbsp;&nbsp; folks: **202**  &nbsp;&nbsp; `298 stars today`
...
1. [yuaotian / go-cursor-help](https://github.com/yuaotian/go-cursor-help)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,881** &nbsp;&nbsp; folks: **1,816**  &nbsp;&nbsp; `255 stars today`

1. [kern / filepizza](https://github.com/kern/filepizza)
    - 🍕 Peer-to-peer file transfers in your browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,329** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `454 stars today`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,827** &nbsp;&nbsp; folks: **2,929**  &nbsp;&nbsp; `3,724 stars this week`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **43,965** &nbsp;&nbsp; folks: **4,468**  &nbsp;&nbsp; `7,480 stars this week`

1. [geekan / MetaGPT](https://github.com/geekan/MetaGPT)
    - 🌟 The Multi-Agent Framework: First AI Software Company, Towards Natural Language Programming
    - language: **Python** &nbsp;&nbsp; stars: **52,375** &nbsp;&nbsp; folks: **6,195**  &nbsp;&nbsp; `2,619 stars this week`

1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **15,563** &nbsp;&nbsp; folks: **1,064**  &nbsp;&nbsp; `3,325 stars this week`
...
1. [CodePhiliaX / Chat2DB](https://github.com/CodePhiliaX/Chat2DB)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,564** &nbsp;&nbsp; folks: **2,269**  &nbsp;&nbsp; `985 stars this week`
...
1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,396** &nbsp;&nbsp; folks: **39,296**  &nbsp;&nbsp; `1,471 stars this week`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - The Memory layer for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **26,157** &nbsp;&nbsp; folks: **2,468**  &nbsp;&nbsp; `929 stars this week`

1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    - 🙌 OpenHands: Code Less, Make More
    - language: **Python** &nbsp;&nbsp; stars: **50,519** &nbsp;&nbsp; folks: **5,549**  &nbsp;&nbsp; `1,312 stars this week`

1. [mendableai / firecrawl-mcp-server](https://github.com/mendableai/firecrawl-mcp-server)
    - Official Firecrawl MCP Server - Adds powerful web scraping to Cursor, Claude and any other LLM clients.
    - language: **JavaScript** &nbsp;&nbsp; stars: **951** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `401 stars this week`

1. [KRTirtho / spotube](https://github.com/KRTirtho/spotube)
    - 🎧 Open source Spotify client that doesn't require Premium nor uses Electron! Available for both desktop & mobile!
    - language: **Dart** &nbsp;&nbsp; stars: **38,142** &nbsp;&nbsp; folks: **1,557**  &nbsp;&nbsp; `1,623 stars this week`
...
1. [refly-ai / refly](https://github.com/refly-ai/refly)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,497** &nbsp;&nbsp; folks: **197**  &nbsp;&nbsp; `488 stars this week`
...
1. [agno-agi / agno](https://github.com/agno-agi/agno)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,768** &nbsp;&nbsp; folks: **2,752**  &nbsp;&nbsp; `575 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **20,374** &nbsp;&nbsp; folks: **1,659**  &nbsp;&nbsp; `14,768 stars this month`

1. [geekan / MetaGPT](https://github.com/geekan/MetaGPT)
    - 🌟 The Multi-Agent Framework: First AI Software Company, Towards Natural Language Programming
    - language: **Python** &nbsp;&nbsp; stars: **52,375** &nbsp;&nbsp; folks: **6,195**  &nbsp;&nbsp; `6,328 stars this month`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **35,711** &nbsp;&nbsp; folks: **1,493**  &nbsp;&nbsp; `7,827 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,178** &nbsp;&nbsp; folks: **12,073**  &nbsp;&nbsp; `15,381 stars this month`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **357,178** &nbsp;&nbsp; folks: **33,113**  &nbsp;&nbsp; `24,252 stars this month`

1. [sinaptik-ai / pandas-ai](https://github.com/sinaptik-ai/pandas-ai)
    - Chat with your database or your datalake (SQL, CSV, parquet). PandasAI makes data analysis conversational using LLMs and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **17,967** &nbsp;&nbsp; folks: **1,681**  &nbsp;&nbsp; `3,554 stars this month`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **8,837** &nbsp;&nbsp; folks: **1,566**  &nbsp;&nbsp; `3,965 stars this month`

1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    - Automate the process of making money online.
    - language: **Python** &nbsp;&nbsp; stars: **11,222** &nbsp;&nbsp; folks: **1,070**  &nbsp;&nbsp; `4,618 stars this month`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,696** &nbsp;&nbsp; folks: **4,021**  &nbsp;&nbsp; `9,001 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **16,827** &nbsp;&nbsp; folks: **2,929**  &nbsp;&nbsp; `8,449 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **67,356** &nbsp;&nbsp; folks: **16,887**  &nbsp;&nbsp; `6,916 stars this month`
...
1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,109** &nbsp;&nbsp; folks: **2,643**  &nbsp;&nbsp; `5,427 stars this month`
...
1. [hiyouga / LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **44,172** &nbsp;&nbsp; folks: **5,405**  &nbsp;&nbsp; `3,822 stars this month`
