...
1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **46,769** &nbsp;&nbsp; folks: **2,844**  &nbsp;&nbsp; `923 stars this week`
...
1. [johannesjo / super-productivity](https://github.com/johannesjo/super-productivity)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,465** &nbsp;&nbsp; folks: **888**  &nbsp;&nbsp; `2,302 stars this month`

1. [ChrisTitusTech / linutil](https://github.com/ChrisTitusTech/linutil)
    - Chris Titus Tech's Linux Toolbox - Linutil is a distro-agnostic toolbox designed to simplify everyday Linux tasks.
    - language: **Shell** &nbsp;&nbsp; stars: **2,417** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `1,861 stars this month`
