...
`更新时间：2021-08-19 10:19:55 +0800`

## 今日热门仓库

1. [NvChad / NvChad](https://github.com/NvChad/NvChad)
    - An attempt to make neovim cli as functional as an IDE while being very beautiful , blazing fast.
    - language: **Lua** &nbsp;&nbsp; stars: **4,141** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `453 stars today`

1. [dotnet / aspnetcore](https://github.com/dotnet/aspnetcore)
    - ASP.NET Core is a cross-platform .NET framework for building modern cloud-based web applications on Windows, Mac, or Linux.
    - language: **C#** &nbsp;&nbsp; stars: **25,532** &nbsp;&nbsp; folks: **6,718**  &nbsp;&nbsp; `86 stars today`

1. [ms-jpq / coq_nvim](https://github.com/ms-jpq/coq_nvim)
    - Fast as FUCK nvim completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
    - language: **Python** &nbsp;&nbsp; stars: **890** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `255 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **127,663** &nbsp;&nbsp; folks: **18,346**  &nbsp;&nbsp; `269 stars today`

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **29,017** &nbsp;&nbsp; folks: **4,547**  &nbsp;&nbsp; `243 stars today`

1. [LaravelDaily / laravel-tips](https://github.com/LaravelDaily/laravel-tips)
    - Awesome tips for Laravel
    - language: **无** &nbsp;&nbsp; stars: **2,144** &nbsp;&nbsp; folks: **429**  &nbsp;&nbsp; `123 stars today`
...
1. [endless-sky / endless-sky](https://github.com/endless-sky/endless-sky)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,106** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `87 stars today`

1. [Azure / MachineLearningNotebooks](https://github.com/Azure/MachineLearningNotebooks)
    - Python notebooks with ML and deep learning examples with Azure Machine Learning Python SDK | Microsoft
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,562** &nbsp;&nbsp; folks: **1,839**  &nbsp;&nbsp; `95 stars today`
...
1. [labmlai / annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,877** &nbsp;&nbsp; folks: **246**  &nbsp;&nbsp; `256 stars today`
...
1. [NvChad / NvChad](https://github.com/NvChad/NvChad)
    - An attempt to make neovim cli as functional as an IDE while being very beautiful , blazing fast.
    - language: **Lua** &nbsp;&nbsp; stars: **4,141** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `1,229 stars this week`

1. [swc-project / swc](https://github.com/swc-project/swc)
    - swc is a super-fast compiler written in rust; producing widely-supported javascript from modern standards and typescript.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,328** &nbsp;&nbsp; folks: **389**  &nbsp;&nbsp; `1,093 stars this week`

1. [netless-io / flat](https://github.com/netless-io/flat)
    - Project flat is the Web, Windows and macOS client of Agora Flat open source classroom.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,683** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `641 stars this week`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **20,797** &nbsp;&nbsp; folks: **464**  &nbsp;&nbsp; `1,576 stars this week`
...
1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **50,167** &nbsp;&nbsp; folks: **13,127**  &nbsp;&nbsp; `346 stars this week`

1. [kingoflolz / mesh-transformer-jax](https://github.com/kingoflolz/mesh-transformer-jax)
    - Model parallel transformers in JAX and Haiku
    - language: **Python** &nbsp;&nbsp; stars: **2,858** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `256 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **29,017** &nbsp;&nbsp; folks: **4,547**  &nbsp;&nbsp; `1,021 stars this week`
...
1. [microsoft / gctoolkit](https://github.com/microsoft/gctoolkit)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **882** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `200 stars this week`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **3,959** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `688 stars this week`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **149,850** &nbsp;&nbsp; folks: **17,173**  &nbsp;&nbsp; `3,411 stars this week`
...
1. [xxlllq / system_architect](https://github.com/xxlllq/system_architect)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,953** &nbsp;&nbsp; folks: **763**  &nbsp;&nbsp; `241 stars this week`
...
1. [Qv2ray / Qv2ray](https://github.com/Qv2ray/Qv2ray)
    - ⭐ Linux / Windows / macOS 跨平台 V2Ray 客户端 | 支持 VMess / VLESS / SSR / Trojan / Trojan-Go / NaiveProxy / HTTP / HTTPS / SOCKS5 | 使用 C++ / Qt 开发 | 可拓展插件式设计 ⭐
    - language: **C++** &nbsp;&nbsp; stars: **12,026** &nbsp;&nbsp; folks: **2,071**  &nbsp;&nbsp; `276 stars this week`
...
1. [meilisearch / MeiliSearch](https://github.com/meilisearch/MeiliSearch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,877** &nbsp;&nbsp; folks: **526**  &nbsp;&nbsp; `421 stars this week`
...
1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **3,959** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `2,633 stars this month`
