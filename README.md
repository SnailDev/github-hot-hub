...
`更新时间：2026-07-19 02:57:52 +0800`

## 今日热门仓库

1. [Robbyant / lingbot-map](https://github.com/Robbyant/lingbot-map)
    - A feed-forward 3D foundation model for reconstructing scenes from streaming data
    - language: **Python** &nbsp;&nbsp; stars: **12,732** &nbsp;&nbsp; folks: **1,331**  &nbsp;&nbsp; `827 stars today`
...
1. [Nutlope / hallmark](https://github.com/Nutlope/hallmark)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **12,748** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `8,075 stars this week`

1. [OpenCut-app / OpenCut](https://github.com/OpenCut-app/OpenCut)
    - The open-source CapCut alternative
    - language: **TypeScript** &nbsp;&nbsp; stars: **75,345** &nbsp;&nbsp; folks: **7,584**  &nbsp;&nbsp; `12,718 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - 100+ AI Agent & RAG apps you can actually run — clone, customize, ship.
    - language: **Python** &nbsp;&nbsp; stars: **123,947** &nbsp;&nbsp; folks: **18,282**  &nbsp;&nbsp; `6,252 stars this week`

1. [HKUDS / Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)
    - "Vibe-Trading: Your Personal Trading Agent"
    - language: **Python** &nbsp;&nbsp; stars: **24,932** &nbsp;&nbsp; folks: **4,114**  &nbsp;&nbsp; `5,616 stars this week`

1. [HKUDS / DeepTutor](https://github.com/HKUDS/DeepTutor)
    - DeepTutor: Lifelong Personalized Tutoring. https://deeptutor.info/.
    - language: **Python** &nbsp;&nbsp; stars: **27,625** &nbsp;&nbsp; folks: **3,670**  &nbsp;&nbsp; `1,801 stars this week`

1. [iOfficeAI / OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)
    - OfficeCLI is the first and best Office suite purpose-built for AI agents to read, edit, and automate Word, Excel, and PowerPoint files. Free, open-source, single binary, no Office installation required.
    - language: **C#** &nbsp;&nbsp; stars: **19,229** &nbsp;&nbsp; folks: **1,294**  &nbsp;&nbsp; `4,611 stars this week`

1. [mattpocock / skills](https://github.com/mattpocock/skills)
    - Skills for Real Engineers. Straight from my .agents directory.
    - language: **Shell** &nbsp;&nbsp; stars: **176,428** &nbsp;&nbsp; folks: **15,114**  &nbsp;&nbsp; `11,325 stars this week`
...
1. [wonderwhy-er / DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,500** &nbsp;&nbsp; folks: **940**  &nbsp;&nbsp; `1,657 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **99,361** &nbsp;&nbsp; folks: **14,872**  &nbsp;&nbsp; `2,250 stars this week`

1. [openinterpreter / openinterpreter](https://github.com/openinterpreter/openinterpreter)
    - A coding agent for open models like Kimi K3
    - language: **Rust** &nbsp;&nbsp; stars: **66,636** &nbsp;&nbsp; folks: **5,722**  &nbsp;&nbsp; `2,009 stars this week`

1. [abseil / abseil-cpp](https://github.com/abseil/abseil-cpp)
    - Abseil Common Libraries (C++)
    - language: **C++** &nbsp;&nbsp; stars: **17,974** &nbsp;&nbsp; folks: **3,140**  &nbsp;&nbsp; `608 stars this week`

1. [stablyai / orca](https://github.com/stablyai/orca)
    - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop and mobile.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,699** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `5,409 stars this week`

1. [ibelick / ui-skills](https://github.com/ibelick/ui-skills)
    - Skills for Design Engineers
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,884** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `974 stars this week`

1. [Graphify-Labs / graphify](https://github.com/Graphify-Labs/graphify)
    - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable knowledge graph. App code + database schema + infrastructure in one graph.
    - language: **Python** &nbsp;&nbsp; stars: **90,822** &nbsp;&nbsp; folks: **8,857**  &nbsp;&nbsp; `8,379 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **58,828** &nbsp;&nbsp; folks: **9,605**  &nbsp;&nbsp; `15,885 stars this month`

1. [stablyai / orca](https://github.com/stablyai/orca)
    - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop and mobile.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,699** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `16,048 stars this month`

1. [ogulcancelik / herdr](https://github.com/ogulcancelik/herdr)
    - agent multiplexer that lives in your terminal.
    - language: **Rust** &nbsp;&nbsp; stars: **17,933** &nbsp;&nbsp; folks: **1,144**  &nbsp;&nbsp; `11,568 stars this month`
...
1. [Zackriya-Solutions / meetily](https://github.com/Zackriya-Solutions/meetily)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **25,423** &nbsp;&nbsp; folks: **2,550**  &nbsp;&nbsp; `12,699 stars this month`
...
1. [diegosouzapw / OmniRoute](https://github.com/diegosouzapw/OmniRoute)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,662** &nbsp;&nbsp; folks: **2,676**  &nbsp;&nbsp; `12,026 stars this month`

1. [alibaba / page-agent](https://github.com/alibaba/page-agent)
    - JavaScript in-page GUI agent. Control web interfaces with natural language.
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,015** &nbsp;&nbsp; folks: **2,364**  &nbsp;&nbsp; `8,521 stars this month`

1. [interviewstreet / hiring-agent](https://github.com/interviewstreet/hiring-agent)
    - AI agent to evaluate and score resumes.
    - language: **Python** &nbsp;&nbsp; stars: **6,078** &nbsp;&nbsp; folks: **1,081**  &nbsp;&nbsp; `4,955 stars this month`

1. [Panniantong / Agent-Reach](https://github.com/Panniantong/Agent-Reach)
    - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
    - language: **Python** &nbsp;&nbsp; stars: **57,714** &nbsp;&nbsp; folks: **4,622**  &nbsp;&nbsp; `25,126 stars this month`
...
1. [simplex-chat / simplex-chat](https://github.com/simplex-chat/simplex-chat)
    ...
    - language: **Haskell** &nbsp;&nbsp; stars: **18,723** &nbsp;&nbsp; folks: **1,174**  &nbsp;&nbsp; `7,662 stars this month`
...
1. [iOfficeAI / OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)
    - OfficeCLI is the first and best Office suite purpose-built for AI agents to read, edit, and automate Word, Excel, and PowerPoint files. Free, open-source, single binary, no Office installation required.
    - language: **C#** &nbsp;&nbsp; stars: **19,229** &nbsp;&nbsp; folks: **1,294**  &nbsp;&nbsp; `11,556 stars this month`

1. [wonderwhy-er / DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)
    - This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,500** &nbsp;&nbsp; folks: **940**  &nbsp;&nbsp; `2,389 stars this month`

1. [Nutlope / hallmark](https://github.com/Nutlope/hallmark)
    - Anti-AI-slop design skill for Claude Code, Cursor, and Codex.
    - language: **CSS** &nbsp;&nbsp; stars: **12,748** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `8,775 stars this month`

1. [OpenCut-app / OpenCut](https://github.com/OpenCut-app/OpenCut)
    - The open-source CapCut alternative
    - language: **TypeScript** &nbsp;&nbsp; stars: **75,345** &nbsp;&nbsp; folks: **7,584**  &nbsp;&nbsp; `18,999 stars this month`

1. [topoteretes / cognee](https://github.com/topoteretes/cognee)
    - Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions with a self-hosted knowledge graph engine.
    - language: **Python** &nbsp;&nbsp; stars: **28,143** &nbsp;&nbsp; folks: **2,689**  &nbsp;&nbsp; `10,292 stars this month`

1. [bradautomates / claude-video](https://github.com/bradautomates/claude-video)
    - Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude.
    - language: **Python** &nbsp;&nbsp; stars: **9,088** &nbsp;&nbsp; folks: **974**  &nbsp;&nbsp; `6,862 stars this month`
