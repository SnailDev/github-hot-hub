...
`更新时间：2022-02-23 16:14:30 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese).
    - language: **无** &nbsp;&nbsp; stars: **14,079** &nbsp;&nbsp; folks: **1,484**  &nbsp;&nbsp; `4,792 stars today`

1. [penpot / penpot](https://github.com/penpot/penpot)
    - Penpot - The Open-Source design & prototyping platform
    - language: **Clojure** &nbsp;&nbsp; stars: **8,249** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `243 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,010** &nbsp;&nbsp; folks: **6,069**  &nbsp;&nbsp; `288 stars today`

1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    - 🤓 Build your own (insert technology here)
    - language: **无** &nbsp;&nbsp; stars: **132,236** &nbsp;&nbsp; folks: **12,466**  &nbsp;&nbsp; `670 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **163,696** &nbsp;&nbsp; folks: **30,301**  &nbsp;&nbsp; `204 stars today`

1. [iamadamdev / bypass-paywalls-chrome](https://github.com/iamadamdev/bypass-paywalls-chrome)
    - Bypass Paywalls web browser extension for Chrome and Firefox.
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,466** &nbsp;&nbsp; folks: **1,635**  &nbsp;&nbsp; `72 stars today`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,876** &nbsp;&nbsp; folks: **1,615**  &nbsp;&nbsp; `219 stars today`
...
1. [microsoft / reverse-proxy](https://github.com/microsoft/reverse-proxy)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **5,027** &nbsp;&nbsp; folks: **447**  &nbsp;&nbsp; `92 stars today`
...
1. [lwthiker / curl-impersonate](https://github.com/lwthiker/curl-impersonate)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **929** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `131 stars today`
...
1. [GrowingGit / GitHub-Chinese-Top-Charts](https://github.com/GrowingGit/GitHub-Chinese-Top-Charts)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **44,423** &nbsp;&nbsp; folks: **6,375**  &nbsp;&nbsp; `68 stars today`
...
1. [evilbuffer / malware-and-exploitdev-resources](https://github.com/evilbuffer/malware-and-exploitdev-resources)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **199** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `32 stars today`
...
1. [mastodon / mastodon](https://github.com/mastodon/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **26,677** &nbsp;&nbsp; folks: **4,338**  &nbsp;&nbsp; `42 stars today`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **60,690** &nbsp;&nbsp; folks: **16,590**  &nbsp;&nbsp; `691 stars this week`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 150 supported car makes and models.
    - language: **Python** &nbsp;&nbsp; stars: **33,010** &nbsp;&nbsp; folks: **6,069**  &nbsp;&nbsp; `525 stars this week`
...
1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,095** &nbsp;&nbsp; folks: **3,165**  &nbsp;&nbsp; `4,118 stars this month`

1. [zadam / trilium](https://github.com/zadam/trilium)
    - Build your personal knowledge base with Trilium Notes
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,626** &nbsp;&nbsp; folks: **874**  &nbsp;&nbsp; `1,839 stars this month`

1. [veler / DevToys](https://github.com/veler/DevToys)
    - A Swiss Army knife for developers.
    - language: **C#** &nbsp;&nbsp; stars: **8,307** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `5,888 stars this month`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,511** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,220 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,690** &nbsp;&nbsp; folks: **3,067**  &nbsp;&nbsp; `1,225 stars this month`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,284** &nbsp;&nbsp; folks: **497**  &nbsp;&nbsp; `1,572 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **210,313** &nbsp;&nbsp; folks: **56,969**  &nbsp;&nbsp; `6,830 stars this month`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,285** &nbsp;&nbsp; folks: **4,689**  &nbsp;&nbsp; `2,025 stars this month`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **12,640** &nbsp;&nbsp; folks: **2,370**  &nbsp;&nbsp; `2,824 stars this month`
