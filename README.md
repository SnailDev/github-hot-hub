...
`更新时间：2024-06-22 14:17:02 +0800`

## 今日热门仓库

1. [omnivore-app / omnivore](https://github.com/omnivore-app/omnivore)
    - Omnivore is a complete, open source read-it-later solution for people who like reading.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,612** &nbsp;&nbsp; folks: **540**  &nbsp;&nbsp; `291 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop, and alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **67,089** &nbsp;&nbsp; folks: **7,405**  &nbsp;&nbsp; `258 stars today`
...
1. [danny-avila / LibreChat](https://github.com/danny-avila/LibreChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,180** &nbsp;&nbsp; folks: **2,398**  &nbsp;&nbsp; `786 stars today`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design LLMs/AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Bedrock / Azure / Mistral / Perplexity ), Multi-Modals (Vision/TTS) and plugin system. One-click FREE deployment of your private ChatGPT chat application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,230** &nbsp;&nbsp; folks: **7,838**  &nbsp;&nbsp; `76 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **61,992** &nbsp;&nbsp; folks: **8,393**  &nbsp;&nbsp; `236 stars today`
...
1. [tencentmusic / supersonic](https://github.com/tencentmusic/supersonic)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,143** &nbsp;&nbsp; folks: **188**  &nbsp;&nbsp; `141 stars today`
...
1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,122** &nbsp;&nbsp; folks: **1,751**  &nbsp;&nbsp; `6,608 stars this month`
...
1. [coollabsio / coolify](https://github.com/coollabsio/coolify)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,233** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `8,836 stars this month`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **276,276** &nbsp;&nbsp; folks: **25,993**  &nbsp;&nbsp; `13,067 stars this month`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,643** &nbsp;&nbsp; folks: **4,213**  &nbsp;&nbsp; `4,253 stars this month`

1. [xenova / transformers.js](https://github.com/xenova/transformers.js)
    - State-of-the-art Machine Learning for the web. Run 🤗 Transformers directly in your browser, with no need for a server!
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,600** &nbsp;&nbsp; folks: **567**  &nbsp;&nbsp; `1,788 stars this month`
...
1. [JanDeDobbeleer / oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,488** &nbsp;&nbsp; folks: **2,281**  &nbsp;&nbsp; `1,091 stars this month`
...
1. [ente-io / ente](https://github.com/ente-io/ente)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **9,715** &nbsp;&nbsp; folks: **543**  &nbsp;&nbsp; `1,987 stars this month`

1. [vanna-ai / vanna](https://github.com/vanna-ai/vanna)
    - 🤖 Chat with your SQL database 📊. Accurate Text-to-SQL Generation via LLMs using RAG 🔄.
    - language: **Python** &nbsp;&nbsp; stars: **8,560** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `1,281 stars this month`
