...
1. [bespoyasov / frontend-clean-architecture](https://github.com/bespoyasov/frontend-clean-architecture)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **717** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `223 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **117,065** &nbsp;&nbsp; folks: **31,464**  &nbsp;&nbsp; `373 stars today`

1. [bpierre / loot-rarity](https://github.com/bpierre/loot-rarity)
    - 🤍 💚 💙 💜 🧡 ❤️ Rarity levels for Loot.
    - language: **TypeScript** &nbsp;&nbsp; stars: **405** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `90 stars today`

1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    - Create generative art by using the canvas api and node js, feel free to contribute to this repo with new ideas.
    - language: **JavaScript** &nbsp;&nbsp; stars: **548** &nbsp;&nbsp; folks: **158**  &nbsp;&nbsp; `112 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **60,084** &nbsp;&nbsp; folks: **3,289**  &nbsp;&nbsp; `222 stars today`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **12,013** &nbsp;&nbsp; folks: **1,670**  &nbsp;&nbsp; `321 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,861** &nbsp;&nbsp; folks: **2,357**  &nbsp;&nbsp; `253 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **83,480** &nbsp;&nbsp; folks: **8,930**  &nbsp;&nbsp; `495 stars today`

1. [orhun / git-cliff](https://github.com/orhun/git-cliff)
    - A highly customizable Changelog Generator that follows Conventional Commit specifications ⛰️
    - language: **Rust** &nbsp;&nbsp; stars: **2,176** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `448 stars today`
...
1. [HXSecurity / DongTai](https://github.com/HXSecurity/DongTai)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **323** &nbsp;&nbsp; folks: **46**  &nbsp;&nbsp; `48 stars today`

1. [freefq / free](https://github.com/freefq/free)
    - 翻墙、免费翻墙、免费科学上网、免费节点、免费梯子、免费ss/v2ray/trojan节点、蓝灯、谷歌商店、翻墙梯子
    - language: **无** &nbsp;&nbsp; stars: **12,375** &nbsp;&nbsp; folks: **3,042**  &nbsp;&nbsp; `86 stars today`
...
1. [g-make-it / IG_Trading_Algo_Scripts_Python](https://github.com/g-make-it/IG_Trading_Algo_Scripts_Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **135** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `41 stars today`

1. [DayBreak-u / chineseocr_lite](https://github.com/DayBreak-u/chineseocr_lite)
    - 超轻量级中文ocr，支持竖排文字识别, 支持ncnn、mnn、tnn推理 ( dbnet(1.8M) + crnn(2.5M) + anglenet(378KB)) 总模型仅4.7M
    - language: **C++** &nbsp;&nbsp; stars: **7,558** &nbsp;&nbsp; folks: **1,564**  &nbsp;&nbsp; `84 stars today`
...
1. [girlscript / winter-of-contributing](https://github.com/girlscript/winter-of-contributing)
    ...
    - language: **无** &nbsp;&nbsp; stars: **288** &nbsp;&nbsp; folks: **152**  &nbsp;&nbsp; `54 stars today`

1. [streamich / react-use](https://github.com/streamich/react-use)
    - React Hooks — 👍
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,072** &nbsp;&nbsp; folks: **1,851**  &nbsp;&nbsp; `81 stars today`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,220** &nbsp;&nbsp; folks: **1,381**  &nbsp;&nbsp; `704 stars today`

1. [0voice / Introduction-to-Golang](https://github.com/0voice/Introduction-to-Golang)
    - 【未来服务器端编程语言】最全空降golang资料补给包（满血战斗），包含文章，书籍，作者论文，理论分析，开源框架，云原生，大佬视频，大厂实战分享ppt
    - language: **无** &nbsp;&nbsp; stars: **2,318** &nbsp;&nbsp; folks: **465**  &nbsp;&nbsp; `232 stars today`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **8,595** &nbsp;&nbsp; folks: **1,912**  &nbsp;&nbsp; `64 stars today`
...
1. [shenzhengfang / kkndme_tianya](https://github.com/shenzhengfang/kkndme_tianya)
    - 天涯 kkndme 神贴聊房价
    - language: **无** &nbsp;&nbsp; stars: **2,862** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `878 stars this week`

1. [jina-ai / jina](https://github.com/jina-ai/jina)
    - Cloud-native neural search framework for 𝙖𝙣𝙮 kind of data
    - language: **Python** &nbsp;&nbsp; stars: **10,616** &nbsp;&nbsp; folks: **1,141**  &nbsp;&nbsp; `1,277 stars this week`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,861** &nbsp;&nbsp; folks: **2,357**  &nbsp;&nbsp; `1,717 stars this week`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **57,094** &nbsp;&nbsp; folks: **15,648**  &nbsp;&nbsp; `782 stars this week`

1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    - Fig adds autocomplete to your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,054** &nbsp;&nbsp; folks: **978**  &nbsp;&nbsp; `650 stars this week`
...
1. [ent / ent](https://github.com/ent/ent)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,355** &nbsp;&nbsp; folks: **438**  &nbsp;&nbsp; `195 stars this week`
...
1. [microsoft / terminal](https://github.com/microsoft/terminal)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **77,087** &nbsp;&nbsp; folks: **6,898**  &nbsp;&nbsp; `370 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,086** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `2,253 stars this month`
...
1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    ...
    - language: **C** &nbsp;&nbsp; stars: **25,723** &nbsp;&nbsp; folks: **1,895**  &nbsp;&nbsp; `3,214 stars this month`
