...
1. [Z4nzu / hackingtool](https://github.com/Z4nzu/hackingtool)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **44,969** &nbsp;&nbsp; folks: **4,925**  &nbsp;&nbsp; `137 stars today`
...
1. [spotDL / spotify-downloader](https://github.com/spotDL/spotify-downloader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,236** &nbsp;&nbsp; folks: **1,527**  &nbsp;&nbsp; `38 stars today`
...
1. [deepset-ai / haystack](https://github.com/deepset-ai/haystack)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,803** &nbsp;&nbsp; folks: **1,787**  &nbsp;&nbsp; `54 stars today`

1. [XTLS / Xray-core](https://github.com/XTLS/Xray-core)
    - Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support. Fully compatible configuration.
    - language: **Go** &nbsp;&nbsp; stars: **23,934** &nbsp;&nbsp; folks: **3,771**  &nbsp;&nbsp; `24 stars today`
...
1. [Lightning-AI / LitServe](https://github.com/Lightning-AI/LitServe)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **970** &nbsp;&nbsp; folks: **51**  &nbsp;&nbsp; `349 stars today`

1. [AI4Finance-Foundation / FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)
    - FinGPT: Open-Source Financial Large Language Models! Revolutionize 🔥 We release the trained model on HuggingFace.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,138** &nbsp;&nbsp; folks: **1,856**  &nbsp;&nbsp; `69 stars today`
...
1. [goauthentik / authentik](https://github.com/goauthentik/authentik)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,093** &nbsp;&nbsp; folks: **824**  &nbsp;&nbsp; `2,155 stars this week`
...
1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **61,275** &nbsp;&nbsp; folks: **30,981**  &nbsp;&nbsp; `2,419 stars this week`
...
1. [nikitabobko / AeroSpace](https://github.com/nikitabobko/AeroSpace)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **4,950** &nbsp;&nbsp; folks: **75**  &nbsp;&nbsp; `323 stars this week`
...
1. [deepset-ai / haystack](https://github.com/deepset-ai/haystack)
    - 🔍 LLM orchestration framework to build customizable, production-ready LLM applications. Connect components (models, vector DBs, file converters) to pipelines or agents that can interact with your data. With advanced retrieval methods, it's best suited for building RAG, question answering, semantic search or conversational agent chatbots.
    - language: **Python** &nbsp;&nbsp; stars: **15,803** &nbsp;&nbsp; folks: **1,787**  &nbsp;&nbsp; `510 stars this week`
...
1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,421** &nbsp;&nbsp; folks: **1,341**  &nbsp;&nbsp; `6,293 stars this month`
...
1. [goauthentik / authentik](https://github.com/goauthentik/authentik)
    - The authentication glue you need.
    - language: **Python** &nbsp;&nbsp; stars: **12,093** &nbsp;&nbsp; folks: **824**  &nbsp;&nbsp; `4,128 stars this month`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **48,334** &nbsp;&nbsp; folks: **5,069**  &nbsp;&nbsp; `5,136 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,464** &nbsp;&nbsp; folks: **1,569**  &nbsp;&nbsp; `2,849 stars this month`
