...
1. [fenixsoft / awesome-fenix](https://github.com/fenixsoft/awesome-fenix)
    - 讨论如何构建一套可靠的大型分布式系统
    - language: **Vue** &nbsp;&nbsp; stars: **2,109** &nbsp;&nbsp; folks: **217**  &nbsp;&nbsp; `229 stars today`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **7,640** &nbsp;&nbsp; folks: **1,106**  &nbsp;&nbsp; `552 stars today`
...
1. [AstraZeneca / awesome-explainable-graph-reasoning](https://github.com/AstraZeneca/awesome-explainable-graph-reasoning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **162** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `23 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **138,308** &nbsp;&nbsp; folks: **25,301**  &nbsp;&nbsp; `99 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **18,546** &nbsp;&nbsp; folks: **4,136**  &nbsp;&nbsp; `67 stars today`
...
1. [taowen / awesome-lowcode](https://github.com/taowen/awesome-lowcode)
    - 国内低代码平台从业者交流
    - language: **无** &nbsp;&nbsp; stars: **5,311** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `56 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,549** &nbsp;&nbsp; folks: **8,635**  &nbsp;&nbsp; `404 stars today`

1. [Jack-Cherish / Machine-Learning](https://github.com/Jack-Cherish/Machine-Learning)
    - ⚡机器学习实战（Python3）：kNN、决策树、贝叶斯、逻辑回归、SVM、线性回归、树回归
    - language: **Python** &nbsp;&nbsp; stars: **4,587** &nbsp;&nbsp; folks: **3,781**  &nbsp;&nbsp; `98 stars today`
...
1. [o3de / o3de](https://github.com/o3de/o3de)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,898** &nbsp;&nbsp; folks: **604**  &nbsp;&nbsp; `1,878 stars this week`

1. [kean / Pulse](https://github.com/kean/Pulse)
    - Logger and network inspector for Apple platforms
    - language: **Swift** &nbsp;&nbsp; stars: **3,057** &nbsp;&nbsp; folks: **90**  &nbsp;&nbsp; `1,257 stars this week`
...
1. [tenacityteam / tenacity](https://github.com/tenacityteam/tenacity)
    ...
    - language: **C** &nbsp;&nbsp; stars: **4,443** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `1,626 stars this week`

1. [SmartKeyerror / Psyduck](https://github.com/SmartKeyerror/Psyduck)
    - Record CS knowlegement with XMind, version 2.0. 使用 XMind 记录 Linux 操作系统，网络，C++，Golang 以及数据库的一些设计
    - language: **Go** &nbsp;&nbsp; stars: **3,011** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `1,276 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 24 lessons, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,806** &nbsp;&nbsp; folks: **2,360**  &nbsp;&nbsp; `3,445 stars this week`

1. [PlummersSoftwareLLC / Primes](https://github.com/PlummersSoftwareLLC/Primes)
    - Prime Number Projects in C#/C++/Python
    - language: **C** &nbsp;&nbsp; stars: **1,196** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `374 stars this week`

1. [returntocorp / semgrep](https://github.com/returntocorp/semgrep)
    - Lightweight static analysis for many languages. Find bug variants with patterns that look like source code.
    - language: **Java** &nbsp;&nbsp; stars: **4,895** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `492 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,549** &nbsp;&nbsp; folks: **8,635**  &nbsp;&nbsp; `1,414 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **196,525** &nbsp;&nbsp; folks: **43,262**  &nbsp;&nbsp; `1,632 stars this week`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - An IDE layer for Neovim with sane defaults. Completely free and community driven.
    - language: **Lua** &nbsp;&nbsp; stars: **4,107** &nbsp;&nbsp; folks: **866**  &nbsp;&nbsp; `245 stars this week`
...
1. [donnemartin / interactive-coding-challenges](https://github.com/donnemartin/interactive-coding-challenges)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,104** &nbsp;&nbsp; folks: **3,721**  &nbsp;&nbsp; `127 stars this week`

1. [TheAlphamerc / flutter_ecommerce_app](https://github.com/TheAlphamerc/flutter_ecommerce_app)
    - E-Commerce App built in flutter
    - language: **Dart** &nbsp;&nbsp; stars: **1,685** &nbsp;&nbsp; folks: **686**  &nbsp;&nbsp; `208 stars this week`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **12,965** &nbsp;&nbsp; folks: **3,149**  &nbsp;&nbsp; `410 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **6,094** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `668 stars this week`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,129** &nbsp;&nbsp; folks: **4,037**  &nbsp;&nbsp; `4,123 stars this month`
...
1. [kdn251 / interviews](https://github.com/kdn251/interviews)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **53,027** &nbsp;&nbsp; folks: **11,241**  &nbsp;&nbsp; `1,408 stars this month`
...
1. [liupan1890 / aliyunpan](https://github.com/liupan1890/aliyunpan)
    - 阿里云盘小白羊版 阿里云盘PC版
    - language: **Dart** &nbsp;&nbsp; stars: **1,370** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `833 stars this month`
