...
`更新时间：2022-02-18 04:11:19 +0800`

## 今日热门仓库

1. [trickest / cve](https://github.com/trickest/cve)
    - Gather and update all available and newest CVEs with their PoC.
    - language: **无** &nbsp;&nbsp; stars: **1,629** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `481 stars today`

1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,908** &nbsp;&nbsp; folks: **3,096**  &nbsp;&nbsp; `779 stars today`
...
1. [OffcierCia / DeFi-Developer-Road-Map](https://github.com/OffcierCia/DeFi-Developer-Road-Map)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,145** &nbsp;&nbsp; folks: **443**  &nbsp;&nbsp; `127 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。
    - language: **无** &nbsp;&nbsp; stars: **1,274** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `406 stars today`
...
1. [penk / penkesu](https://github.com/penk/penkesu)
    ...
    - language: **无** &nbsp;&nbsp; stars: **988** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `216 stars today`
...
1. [rockerBOO / awesome-neovim](https://github.com/rockerBOO/awesome-neovim)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,828** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `30 stars today`

1. [LSPosed / MagiskOnWSA](https://github.com/LSPosed/MagiskOnWSA)
    - Integrate Magisk root and Google Apps (OpenGApps) into WSA (Windows Subsystem for Android)
    - language: **无** &nbsp;&nbsp; stars: **6,185** &nbsp;&nbsp; folks: **42,456**  &nbsp;&nbsp; `128 stars today`
...
1. [NVlabs / instant-ngp](https://github.com/NVlabs/instant-ngp)
    ...
    - language: **Cuda** &nbsp;&nbsp; stars: **2,731** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `75 stars today`
...
1. [huggingface / datasets](https://github.com/huggingface/datasets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,273** &nbsp;&nbsp; folks: **1,493**  &nbsp;&nbsp; `53 stars today`
...
1. [ocornut / imgui](https://github.com/ocornut/imgui)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **35,427** &nbsp;&nbsp; folks: **6,063**  &nbsp;&nbsp; `861 stars this week`

1. [ObuchiYuki / DevToysMac](https://github.com/ObuchiYuki/DevToysMac)
    - DevToys For mac
    - language: **Swift** &nbsp;&nbsp; stars: **4,023** &nbsp;&nbsp; folks: **91**  &nbsp;&nbsp; `2,019 stars this week`
...
1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,908** &nbsp;&nbsp; folks: **3,096**  &nbsp;&nbsp; `2,343 stars this week`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **42,091** &nbsp;&nbsp; folks: **4,681**  &nbsp;&nbsp; `902 stars this week`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,008** &nbsp;&nbsp; folks: **474**  &nbsp;&nbsp; `629 stars this week`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **136,572** &nbsp;&nbsp; folks: **20,740**  &nbsp;&nbsp; `521 stars this week`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **60,123** &nbsp;&nbsp; folks: **16,512**  &nbsp;&nbsp; `273 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,398** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `812 stars this week`

1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    - Headless Chrome Node.js API
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,312** &nbsp;&nbsp; folks: **8,119**  &nbsp;&nbsp; `181 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    - Build your personal knowledge base with Trilium Notes
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,398** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `1,680 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **209,457** &nbsp;&nbsp; folks: **56,712**  &nbsp;&nbsp; `6,985 stars this month`
...
1. [ocornut / imgui](https://github.com/ocornut/imgui)
    - Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies
    - language: **C++** &nbsp;&nbsp; stars: **35,427** &nbsp;&nbsp; folks: **6,063**  &nbsp;&nbsp; `1,414 stars this month`

1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,908** &nbsp;&nbsp; folks: **3,096**  &nbsp;&nbsp; `3,147 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **180,674** &nbsp;&nbsp; folks: **20,823**  &nbsp;&nbsp; `6,809 stars this month`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,518** &nbsp;&nbsp; folks: **3,036**  &nbsp;&nbsp; `1,105 stars this month`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **42,091** &nbsp;&nbsp; folks: **4,681**  &nbsp;&nbsp; `1,937 stars this month`
...
1. [medusajs / medusa](https://github.com/medusajs/medusa)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,633** &nbsp;&nbsp; folks: **427**  &nbsp;&nbsp; `2,687 stars this month`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,008** &nbsp;&nbsp; folks: **474**  &nbsp;&nbsp; `1,405 stars this month`
