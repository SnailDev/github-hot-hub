...
1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **452** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `64 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **26,455** &nbsp;&nbsp; folks: **5,298**  &nbsp;&nbsp; `194 stars today`

1. [org-roam / org-roam-ui](https://github.com/org-roam/org-roam-ui)
    - A graphical frontend for exploring your org-roam Zettelkasten
    - language: **JavaScript** &nbsp;&nbsp; stars: **375** &nbsp;&nbsp; folks: **6**  &nbsp;&nbsp; `98 stars today`

1. [apollographql / apollo-client](https://github.com/apollographql/apollo-client)
    - 🚀  A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,495** &nbsp;&nbsp; folks: **2,158**  &nbsp;&nbsp; `52 stars today`

1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    - Ergonomic and modular web framework built with Tokio, Tower, and Hyper
    - language: **Rust** &nbsp;&nbsp; stars: **919** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `229 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,329** &nbsp;&nbsp; folks: **4,381**  &nbsp;&nbsp; `470 stars today`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **13,498** &nbsp;&nbsp; folks: **275**  &nbsp;&nbsp; `235 stars today`
...
1. [electron / electron](https://github.com/electron/electron)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **95,934** &nbsp;&nbsp; folks: **12,550**  &nbsp;&nbsp; `357 stars today`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,122** &nbsp;&nbsp; folks: **5,210**  &nbsp;&nbsp; `49 stars today`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **5,793** &nbsp;&nbsp; folks: **1,446**  &nbsp;&nbsp; `83 stars today`
...
1. [Tib3rius / AutoRecon](https://github.com/Tib3rius/AutoRecon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,464** &nbsp;&nbsp; folks: **545**  &nbsp;&nbsp; `139 stars today`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - A sandbox tower defense game
    - language: **Java** &nbsp;&nbsp; stars: **11,048** &nbsp;&nbsp; folks: **1,619**  &nbsp;&nbsp; `155 stars today`
...
1. [prometheus / alertmanager](https://github.com/prometheus/alertmanager)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,195** &nbsp;&nbsp; folks: **1,580**  &nbsp;&nbsp; `40 stars today`
...
1. [bytebase / bytebase](https://github.com/bytebase/bytebase)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **748** &nbsp;&nbsp; folks: **33**  &nbsp;&nbsp; `120 stars today`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,744** &nbsp;&nbsp; folks: **3,519**  &nbsp;&nbsp; `570 stars today`
...
1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,311** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `1,680 stars this week`
...
1. [doocs / source-code-hunter](https://github.com/doocs/source-code-hunter)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,334** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `641 stars this week`

1. [alan2207 / bulletproof-react](https://github.com/alan2207/bulletproof-react)
    - 🛡️ ⚛️ A simple, scalable, and powerful architecture for building production ready React applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,854** &nbsp;&nbsp; folks: **155**  &nbsp;&nbsp; `695 stars this week`

1. [blueedgetechno / windows11](https://github.com/blueedgetechno/windows11)
    - windows 11 in react 💻🌈⚡
    - language: **CSS** &nbsp;&nbsp; stars: **3,121** &nbsp;&nbsp; folks: **206**  &nbsp;&nbsp; `485 stars this week`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,383** &nbsp;&nbsp; folks: **761**  &nbsp;&nbsp; `1,190 stars this week`
...
1. [Megvii-BaseDetection / YOLOX](https://github.com/Megvii-BaseDetection/YOLOX)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,005** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `460 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,744** &nbsp;&nbsp; folks: **3,519**  &nbsp;&nbsp; `12,365 stars this month`
