...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **7,825** &nbsp;&nbsp; folks: **1,127**  &nbsp;&nbsp; `483 stars today`
...
1. [AkashSingh3031 / The-Complete-FAANG-Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,318** &nbsp;&nbsp; folks: **563**  &nbsp;&nbsp; `92 stars today`

1. [sogou / workflow](https://github.com/sogou/workflow)
    - C++ Parallel Computing and Asynchronous Networking Engine
    - language: **C++** &nbsp;&nbsp; stars: **4,788** &nbsp;&nbsp; folks: **900**  &nbsp;&nbsp; `58 stars today`
...
1. [AstraZeneca / awesome-explainable-graph-reasoning](https://github.com/AstraZeneca/awesome-explainable-graph-reasoning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **388** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `176 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **138,444** &nbsp;&nbsp; folks: **25,318**  &nbsp;&nbsp; `147 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **18,622** &nbsp;&nbsp; folks: **4,141**  &nbsp;&nbsp; `94 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **40,299** &nbsp;&nbsp; folks: **7,377**  &nbsp;&nbsp; `65 stars today`
...
1. [Sangwan5688 / BlackHole](https://github.com/Sangwan5688/BlackHole)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **623** &nbsp;&nbsp; folks: **69**  &nbsp;&nbsp; `130 stars today`

1. [taowen / awesome-lowcode](https://github.com/taowen/awesome-lowcode)
    - 国内低代码平台从业者交流
    - language: **无** &nbsp;&nbsp; stars: **5,437** &nbsp;&nbsp; folks: **541**  &nbsp;&nbsp; `115 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,887** &nbsp;&nbsp; folks: **8,647**  &nbsp;&nbsp; `371 stars today`
...
1. [o3de / o3de](https://github.com/o3de/o3de)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,947** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `1,261 stars this week`

1. [kean / Pulse](https://github.com/kean/Pulse)
    - Logger and network inspector for Apple platforms
    - language: **Swift** &nbsp;&nbsp; stars: **3,077** &nbsp;&nbsp; folks: **92**  &nbsp;&nbsp; `1,106 stars this week`
...
1. [tenacityteam / tenacity](https://github.com/tenacityteam/tenacity)
    ...
    - language: **C** &nbsp;&nbsp; stars: **4,538** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `1,105 stars this week`

1. [SmartKeyerror / Psyduck](https://github.com/SmartKeyerror/Psyduck)
    - Record CS knowlegement with XMind, version 2.0. 使用 XMind 记录 Linux 操作系统，网络，C++，Golang 以及数据库的一些设计
    - language: **Go** &nbsp;&nbsp; stars: **3,089** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `1,152 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 24 lessons, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,449** &nbsp;&nbsp; folks: **2,611**  &nbsp;&nbsp; `3,718 stars this week`

1. [PlummersSoftwareLLC / Primes](https://github.com/PlummersSoftwareLLC/Primes)
    - Prime Number Projects in C#/C++/Python
    - language: **C** &nbsp;&nbsp; stars: **1,220** &nbsp;&nbsp; folks: **357**  &nbsp;&nbsp; `299 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,887** &nbsp;&nbsp; folks: **8,647**  &nbsp;&nbsp; `1,746 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **196,601** &nbsp;&nbsp; folks: **43,272**  &nbsp;&nbsp; `1,654 stars this week`
...
1. [MustangYM / WeChatExtension-ForMac](https://github.com/MustangYM/WeChatExtension-ForMac)
    ...
    - language: **Objective-C** &nbsp;&nbsp; stars: **18,253** &nbsp;&nbsp; folks: **2,793**  &nbsp;&nbsp; `604 stars this week`
...
1. [donnemartin / interactive-coding-challenges](https://github.com/donnemartin/interactive-coding-challenges)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,116** &nbsp;&nbsp; folks: **3,722**  &nbsp;&nbsp; `109 stars this week`

1. [TheAlphamerc / flutter_ecommerce_app](https://github.com/TheAlphamerc/flutter_ecommerce_app)
    - E-Commerce App built in flutter
    - language: **Dart** &nbsp;&nbsp; stars: **1,696** &nbsp;&nbsp; folks: **686**  &nbsp;&nbsp; `217 stars this week`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **13,013** &nbsp;&nbsp; folks: **3,166**  &nbsp;&nbsp; `411 stars this week`
...
1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **49,961** &nbsp;&nbsp; folks: **5,090**  &nbsp;&nbsp; `228 stars this week`

1. [nvim-telescope / telescope.nvim](https://github.com/nvim-telescope/telescope.nvim)
    - Find, Filter, Preview, Pick. All lua, all the time.
    - language: **Lua** &nbsp;&nbsp; stars: **2,664** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `115 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,770** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `4,617 stars this month`
...
1. [kdn251 / interviews](https://github.com/kdn251/interviews)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **53,044** &nbsp;&nbsp; folks: **11,245**  &nbsp;&nbsp; `1,412 stars this month`
