...
`更新时间：2021-09-14 16:13:30 +0800`

## 今日热门仓库

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **20,421** &nbsp;&nbsp; folks: **4,343**  &nbsp;&nbsp; `777 stars today`

1. [lockedbyte / CVE-2021-40444](https://github.com/lockedbyte/CVE-2021-40444)
    - CVE-2021-40444 PoC
    - language: **HTML** &nbsp;&nbsp; stars: **843** &nbsp;&nbsp; folks: **286**  &nbsp;&nbsp; `251 stars today`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented quantitative investment platform, which aims to realize the potential, empower the research, and create the value of AI technologies in quantitative investment. With Qlib, you can easily try your ideas to create better Quant investment strategies.
    - language: **Python** &nbsp;&nbsp; stars: **5,994** &nbsp;&nbsp; folks: **987**  &nbsp;&nbsp; `109 stars today`

1. [Aircoookie / WLED](https://github.com/Aircoookie/WLED)
    - Control WS2812B and many more types of digital RGB LEDs with an ESP8266 or ESP32 over WiFi!
    - language: **C++** &nbsp;&nbsp; stars: **6,696** &nbsp;&nbsp; folks: **1,284**  &nbsp;&nbsp; `67 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **118,962** &nbsp;&nbsp; folks: **19,616**  &nbsp;&nbsp; `236 stars today`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated interview preparation materials for busy engineers
    - language: **JavaScript** &nbsp;&nbsp; stars: **58,231** &nbsp;&nbsp; folks: **8,088**  &nbsp;&nbsp; `168 stars today`

1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    - Create generative art by using the canvas api and node js
    - language: **JavaScript** &nbsp;&nbsp; stars: **998** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `113 stars today`

1. [Python-World / python-mini-projects](https://github.com/Python-World/python-mini-projects)
    - A collection of simple python mini projects to enhance your python skills
    - language: **Python** &nbsp;&nbsp; stars: **1,884** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `320 stars today`
...
1. [TaKO8Ki / gobang](https://github.com/TaKO8Ki/gobang)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,192** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `280 stars today`
...
1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **723** &nbsp;&nbsp; folks: **249**  &nbsp;&nbsp; `285 stars this week`
...
1. [cloudwego / kitex](https://github.com/cloudwego/kitex)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,471** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `1,074 stars this week`

1. [lootproject / website](https://github.com/lootproject/website)
    - Loot Project website
    - language: **TypeScript** &nbsp;&nbsp; stars: **302** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `82 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **118,064** &nbsp;&nbsp; folks: **31,586**  &nbsp;&nbsp; `1,540 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **20,421** &nbsp;&nbsp; folks: **4,343**  &nbsp;&nbsp; `2,518 stars this week`

1. [GTAmodding / re3](https://github.com/GTAmodding/re3)
    - GTA III, Vice City
    - language: **C++** &nbsp;&nbsp; stars: **6,773** &nbsp;&nbsp; folks: **840**  &nbsp;&nbsp; `299 stars this week`
...
1. [metaplex-foundation / metaplex](https://github.com/metaplex-foundation/metaplex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,032** &nbsp;&nbsp; folks: **1,767**  &nbsp;&nbsp; `168 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **84,137** &nbsp;&nbsp; folks: **8,971**  &nbsp;&nbsp; `1,316 stars this week`
...
1. [solana-labs / solana-program-library](https://github.com/solana-labs/solana-program-library)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **603** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `86 stars this week`
...
1. [abseil / abseil-cpp](https://github.com/abseil/abseil-cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,307** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `241 stars this week`
...
1. [apache / incubator-doris](https://github.com/apache/incubator-doris)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,281** &nbsp;&nbsp; folks: **943**  &nbsp;&nbsp; `265 stars this week`

1. [LunarVim / LunarVim](https://github.com/LunarVim/LunarVim)
    - An IDE layer for Neovim with sane defaults. Completely free and community driven.
    - language: **Lua** &nbsp;&nbsp; stars: **5,226** &nbsp;&nbsp; folks: **957**  &nbsp;&nbsp; `182 stars this week`

1. [huggingface / datasets](https://github.com/huggingface/datasets)
    - 🤗 The largest hub of ready-to-use datasets for ML models with fast, easy-to-use and efficient data manipulation tools
    - language: **Python** &nbsp;&nbsp; stars: **9,779** &nbsp;&nbsp; folks: **1,156**  &nbsp;&nbsp; `884 stars this week`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    - Create generative art by using the canvas api and node js
    - language: **JavaScript** &nbsp;&nbsp; stars: **998** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `378 stars this week`
...
1. [filebrowser / filebrowser](https://github.com/filebrowser/filebrowser)
    - 📂 Web File Browser
    - language: **Go** &nbsp;&nbsp; stars: **12,737** &nbsp;&nbsp; folks: **1,645**  &nbsp;&nbsp; `2,263 stars this month`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **49,352** &nbsp;&nbsp; folks: **4,223**  &nbsp;&nbsp; `2,567 stars this month`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,859** &nbsp;&nbsp; folks: **2,596**  &nbsp;&nbsp; `1,519 stars this month`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,246** &nbsp;&nbsp; folks: **1,069**  &nbsp;&nbsp; `1,215 stars this month`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **29,532** &nbsp;&nbsp; folks: **4,624**  &nbsp;&nbsp; `1,583 stars this month`
