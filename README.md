...
1. [flashlight / flashlight](https://github.com/flashlight/flashlight)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,476** &nbsp;&nbsp; folks: **259**  &nbsp;&nbsp; `950 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **126,975** &nbsp;&nbsp; folks: **23,212**  &nbsp;&nbsp; `223 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,985** &nbsp;&nbsp; folks: **15,095**  &nbsp;&nbsp; `197 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,674** &nbsp;&nbsp; folks: **1,504**  &nbsp;&nbsp; `145 stars today`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **20,107** &nbsp;&nbsp; folks: **5,101**  &nbsp;&nbsp; `166 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **22,375** &nbsp;&nbsp; folks: **3,124**  &nbsp;&nbsp; `124 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,849** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,656 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,068** &nbsp;&nbsp; folks: **1,323**  &nbsp;&nbsp; `1,244 stars this week`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,280** &nbsp;&nbsp; folks: **5,495**  &nbsp;&nbsp; `796 stars this week`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,872** &nbsp;&nbsp; folks: **2,358**  &nbsp;&nbsp; `1,028 stars this week`

1. [foxlet / macOS-Simple-KVM](https://github.com/foxlet/macOS-Simple-KVM)
    - Tools to set up a quick macOS VM in QEMU, accelerated by KVM.
    - language: **Shell** &nbsp;&nbsp; stars: **10,529** &nbsp;&nbsp; folks: **863**  &nbsp;&nbsp; `542 stars this week`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **23,155** &nbsp;&nbsp; folks: **5,682**  &nbsp;&nbsp; `1,088 stars this week`
...
1. [goplus / gop](https://github.com/goplus/gop)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,792** &nbsp;&nbsp; folks: **364**  &nbsp;&nbsp; `242 stars this week`
...
1. [awesome-selfhosted / awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,524** &nbsp;&nbsp; folks: **4,426**  &nbsp;&nbsp; `925 stars this week`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,316** &nbsp;&nbsp; folks: **3,078**  &nbsp;&nbsp; `81 stars this week`

1. [scikit-learn / scikit-learn](https://github.com/scikit-learn/scikit-learn)
    - scikit-learn: machine learning in Python
    - language: **Python** &nbsp;&nbsp; stars: **45,415** &nbsp;&nbsp; folks: **21,332**  &nbsp;&nbsp; `276 stars this week`
...
1. [trustwallet / assets](https://github.com/trustwallet/assets)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **444** &nbsp;&nbsp; folks: **3,799**  &nbsp;&nbsp; `35 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **126,975** &nbsp;&nbsp; folks: **23,212**  &nbsp;&nbsp; `1,006 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,849** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `2,443 stars this month`
...
1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,486** &nbsp;&nbsp; folks: **568**  &nbsp;&nbsp; `708 stars this month`
...
1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,352** &nbsp;&nbsp; folks: **9,932**  &nbsp;&nbsp; `1,711 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,280** &nbsp;&nbsp; folks: **5,495**  &nbsp;&nbsp; `1,082 stars this month`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **HTML** &nbsp;&nbsp; stars: **3,097** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `2,039 stars this month`

1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    - 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识。
    - language: **无** &nbsp;&nbsp; stars: **24,201** &nbsp;&nbsp; folks: **5,457**  &nbsp;&nbsp; `1,198 stars this month`
...
1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **633** &nbsp;&nbsp; folks: **617**  &nbsp;&nbsp; `206 stars this month`
...
1. [alibaba / nacos](https://github.com/alibaba/nacos)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **17,245** &nbsp;&nbsp; folks: **6,742**  &nbsp;&nbsp; `579 stars this month`
