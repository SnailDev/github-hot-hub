...
`更新时间：2022-04-19 05:12:19 +0800`

## 今日热门仓库

1. [httpie / httpie](https://github.com/httpie/httpie)
    - As easy as /aitch-tee-tee-pie/ 🥧 Modern, user-friendly command-line HTTP client for the API era. JSON support, colors, sessions, downloads, plugins & more. https://twitter.com/httpie
    - language: **Python** &nbsp;&nbsp; stars: **14,813** &nbsp;&nbsp; folks: **3,587**  &nbsp;&nbsp; `1,463 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **175,038** &nbsp;&nbsp; folks: **32,096**  &nbsp;&nbsp; `479 stars today`
...
1. [trustwallet / assets](https://github.com/trustwallet/assets)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,718** &nbsp;&nbsp; folks: **12,871**  &nbsp;&nbsp; `6 stars today`
...
1. [bradtraversy / design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
    ...
    - language: **无** &nbsp;&nbsp; stars: **38,830** &nbsp;&nbsp; folks: **8,669**  &nbsp;&nbsp; `384 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,214** &nbsp;&nbsp; folks: **10,013**  &nbsp;&nbsp; `74 stars today`
...
1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **34,539** &nbsp;&nbsp; folks: **5,129**  &nbsp;&nbsp; `108 stars today`
...
1. [LSPosed / MagiskOnWSA](https://github.com/LSPosed/MagiskOnWSA)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,176** &nbsp;&nbsp; folks: **70,919**  &nbsp;&nbsp; `98 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **10,132** &nbsp;&nbsp; folks: **1,589**  &nbsp;&nbsp; `2,837 stars this week`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **57,519** &nbsp;&nbsp; folks: **4,649**  &nbsp;&nbsp; `2,112 stars this week`

1. [skyline-emu / skyline](https://github.com/skyline-emu/skyline)
    - Run Nintendo Switch homebrew & games on your Android device!
    - language: **C++** &nbsp;&nbsp; stars: **5,700** &nbsp;&nbsp; folks: **935**  &nbsp;&nbsp; `511 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **33,433** &nbsp;&nbsp; folks: **6,561**  &nbsp;&nbsp; `2,831 stars this week`
...
1. [medusajs / medusa](https://github.com/medusajs/medusa)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,015** &nbsp;&nbsp; folks: **556**  &nbsp;&nbsp; `1,000 stars this week`
...
1. [PipedreamHQ / pipedream](https://github.com/PipedreamHQ/pipedream)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,789** &nbsp;&nbsp; folks: **1,627**  &nbsp;&nbsp; `132 stars this week`
...
1. [goldbergyoni / javascript-testing-best-practices](https://github.com/goldbergyoni/javascript-testing-best-practices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,077** &nbsp;&nbsp; folks: **1,491**  &nbsp;&nbsp; `1,435 stars this week`

1. [httpie / httpie](https://github.com/httpie/httpie)
    - As easy as /aitch-tee-tee-pie/ 🥧 Modern, user-friendly command-line HTTP client for the API era. JSON support, colors, sessions, downloads, plugins & more. https://twitter.com/httpie
    - language: **Python** &nbsp;&nbsp; stars: **14,813** &nbsp;&nbsp; folks: **3,587**  &nbsp;&nbsp; `12,467 stars this week`

1. [lucidrains / DALLE2-pytorch](https://github.com/lucidrains/DALLE2-pytorch)
    - Implementation of DALL-E 2, OpenAI's updated text-to-image synthesis neural network, in Pytorch
    - language: **Python** &nbsp;&nbsp; stars: **1,416** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `793 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **175,038** &nbsp;&nbsp; folks: **32,096**  &nbsp;&nbsp; `3,055 stars this week`
...
1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **57,519** &nbsp;&nbsp; folks: **4,649**  &nbsp;&nbsp; `4,148 stars this month`
...
1. [nocodb / nocodb](https://github.com/nocodb/nocodb)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,235** &nbsp;&nbsp; folks: **1,590**  &nbsp;&nbsp; `3,675 stars this month`
...
1. [awesome-selfhosted / awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **85,545** &nbsp;&nbsp; folks: **5,712**  &nbsp;&nbsp; `5,377 stars this month`
