...
`更新时间：2022-02-02 05:10:17 +0800`

## 今日热门仓库

1. [psf / black](https://github.com/psf/black)
    - The uncompromising Python code formatter
    - language: **Python** &nbsp;&nbsp; stars: **24,818** &nbsp;&nbsp; folks: **1,582**  &nbsp;&nbsp; `116 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,827** &nbsp;&nbsp; folks: **5,644**  &nbsp;&nbsp; `245 stars today`
...
1. [hannahcode / word-guessing-game](https://github.com/hannahcode/word-guessing-game)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **873** &nbsp;&nbsp; folks: **489**  &nbsp;&nbsp; `155 stars today`

1. [jazzband / pip-tools](https://github.com/jazzband/pip-tools)
    - A set of tools to keep your pinned Python dependencies fresh.
    - language: **Python** &nbsp;&nbsp; stars: **5,552** &nbsp;&nbsp; folks: **488**  &nbsp;&nbsp; `43 stars today`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `174 stars today`

1. [ytdl-org / youtube-dl](https://github.com/ytdl-org/youtube-dl)
    - Command-line program to download videos from YouTube.com and other video sites
    - language: **Python** &nbsp;&nbsp; stars: **105,747** &nbsp;&nbsp; folks: **7,019**  &nbsp;&nbsp; `88 stars today`

1. [mui-org / material-ui](https://github.com/mui-org/material-ui)
    - MUI (formerly Material-UI) is the React UI library you always wanted. Follow your own design system, or start with Material Design.
    - language: **JavaScript** &nbsp;&nbsp; stars: **74,936** &nbsp;&nbsp; folks: **25,852**  &nbsp;&nbsp; `100 stars today`

1. [uutils / coreutils](https://github.com/uutils/coreutils)
    - Cross-platform Rust rewrite of the GNU coreutils
    - language: **Rust** &nbsp;&nbsp; stars: **10,491** &nbsp;&nbsp; folks: **797**  &nbsp;&nbsp; `137 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,680** &nbsp;&nbsp; folks: **4,709**  &nbsp;&nbsp; `194 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **18,344** &nbsp;&nbsp; folks: **1,305**  &nbsp;&nbsp; `224 stars today`

1. [cshum / imagor](https://github.com/cshum/imagor)
    - Fast, Docker-ready image processing server written in Go
    - language: **Go** &nbsp;&nbsp; stars: **1,856** &nbsp;&nbsp; folks: **43**  &nbsp;&nbsp; `94 stars today`
...
1. [netbox-community / netbox](https://github.com/netbox-community/netbox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,642** &nbsp;&nbsp; folks: **1,747**  &nbsp;&nbsp; `55 stars today`

1. [graviraja / MLOps-Basics](https://github.com/graviraja/MLOps-Basics)
    - 无
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,624** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `49 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **30,524** &nbsp;&nbsp; folks: **4,484**  &nbsp;&nbsp; `329 stars today`

1. [DataDog / stratus-red-team](https://github.com/DataDog/stratus-red-team)
    - ☁️ ⚡ Granular, Actionable Adversary Emulation for the Cloud.
    - language: **Go** &nbsp;&nbsp; stars: **491** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `52 stars today`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **10,040** &nbsp;&nbsp; folks: **1,788**  &nbsp;&nbsp; `147 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,406** &nbsp;&nbsp; folks: **40,549**  &nbsp;&nbsp; `60 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **160,624** &nbsp;&nbsp; folks: **29,712**  &nbsp;&nbsp; `152 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,827** &nbsp;&nbsp; folks: **5,644**  &nbsp;&nbsp; `1,248 stars this week`
...
1. [psf / black](https://github.com/psf/black)
    - The uncompromising Python code formatter
    - language: **Python** &nbsp;&nbsp; stars: **24,818** &nbsp;&nbsp; folks: **1,582**  &nbsp;&nbsp; `409 stars this week`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    - Project Cider. A new look into listening and enjoying Apple Music in style and performance. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `558 stars this week`
...
1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,382** &nbsp;&nbsp; folks: **597**  &nbsp;&nbsp; `398 stars this week`
...
1. [mantinedev / mantine](https://github.com/mantinedev/mantine)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,059** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `848 stars this week`
...
1. [files-community / Files](https://github.com/files-community/Files)
    - A modern file manager for Windows
    - language: **C#** &nbsp;&nbsp; stars: **19,516** &nbsp;&nbsp; folks: **1,063**  &nbsp;&nbsp; `4,206 stars this month`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,895** &nbsp;&nbsp; folks: **731**  &nbsp;&nbsp; `4,430 stars this month`
...
1. [adrianhajdin / project_web3.0](https://github.com/adrianhajdin/project_web3.0)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,322** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `909 stars this month`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **13,903** &nbsp;&nbsp; folks: **1,251**  &nbsp;&nbsp; `1,396 stars this month`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,827** &nbsp;&nbsp; folks: **5,644**  &nbsp;&nbsp; `1,778 stars this month`
...
1. [containers / podman](https://github.com/containers/podman)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **12,253** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `688 stars this month`
