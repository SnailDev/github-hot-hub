...
1. [ccfos / nightingale](https://github.com/ccfos/nightingale)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,666** &nbsp;&nbsp; folks: **1,580**  &nbsp;&nbsp; `205 stars today`

1. [mxrch / GHunt](https://github.com/mxrch/GHunt)
    - 🕵️‍♂️ Offensive Google framework.
    - language: **Python** &nbsp;&nbsp; stars: **17,427** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `216 stars today`
...
1. [agno-agi / agno](https://github.com/agno-agi/agno)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,115** &nbsp;&nbsp; folks: **4,218**  &nbsp;&nbsp; `80 stars today`

1. [aaPanel / BillionMail](https://github.com/aaPanel/BillionMail)
    - BillionMail gives you open-source MailServer, NewsLetter, Email Marketing — fully self-hosted, dev-friendly, and free from monthly fees. Join the discord: https://discord.gg/asfXzBUhZr
    - language: **Go** &nbsp;&nbsp; stars: **10,092** &nbsp;&nbsp; folks: **900**  &nbsp;&nbsp; `209 stars today`
...
1. [Azure / azure-sdk-for-python](https://github.com/Azure/azure-sdk-for-python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,088** &nbsp;&nbsp; folks: **3,107**  &nbsp;&nbsp; `1 star today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **83,474** &nbsp;&nbsp; folks: **23,146**  &nbsp;&nbsp; `498 stars today`

1. [Zie619 / n8n-workflows](https://github.com/Zie619/n8n-workflows)
    - all of the workflows of n8n i could find (also from the site itself)
    - language: **HTML** &nbsp;&nbsp; stars: **28,266** &nbsp;&nbsp; folks: **1,053**  &nbsp;&nbsp; `421 stars today`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **49,159** &nbsp;&nbsp; folks: **11,062**  &nbsp;&nbsp; `226 stars today`
...
1. [Physical-Intelligence / openpi](https://github.com/Physical-Intelligence/openpi)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,163** &nbsp;&nbsp; folks: **735**  &nbsp;&nbsp; `696 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,601** &nbsp;&nbsp; folks: **723**  &nbsp;&nbsp; `2,435 stars this week`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,867** &nbsp;&nbsp; folks: **5,661**  &nbsp;&nbsp; `1,716 stars this week`

1. [modelcontextprotocol / registry](https://github.com/modelcontextprotocol/registry)
    - A community driven registry service for Model Context Protocol (MCP) servers.
    - language: **Go** &nbsp;&nbsp; stars: **3,545** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `645 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,671** &nbsp;&nbsp; folks: **933**  &nbsp;&nbsp; `3,193 stars this week`

1. [uutils / coreutils](https://github.com/uutils/coreutils)
    - Cross-platform Rust rewrite of the GNU coreutils
    - language: **Rust** &nbsp;&nbsp; stars: **21,411** &nbsp;&nbsp; folks: **1,547**  &nbsp;&nbsp; `337 stars this week`
...
1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **18,242** &nbsp;&nbsp; folks: **763**  &nbsp;&nbsp; `1,702 stars this week`

1. [vercel / examples](https://github.com/vercel/examples)
    - Enjoy our curated collection of examples and solutions. Use these patterns to build your own robust and scalable applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,500** &nbsp;&nbsp; folks: **1,425**  &nbsp;&nbsp; `374 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **21,096** &nbsp;&nbsp; folks: **1,804**  &nbsp;&nbsp; `508 stars this week`

1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    - This is the Rust course used by the Android team at Google. It provides you the material to quickly teach Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **31,921** &nbsp;&nbsp; folks: **1,895**  &nbsp;&nbsp; `375 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,485** &nbsp;&nbsp; folks: **1,136**  &nbsp;&nbsp; `11,405 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **11,913** &nbsp;&nbsp; folks: **2,071**  &nbsp;&nbsp; `6,676 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,792** &nbsp;&nbsp; folks: **3,134**  &nbsp;&nbsp; `11,598 stars this month`

1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **9,166** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `5,801 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,080** &nbsp;&nbsp; folks: **833**  &nbsp;&nbsp; `7,046 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,736** &nbsp;&nbsp; folks: **1,827**  &nbsp;&nbsp; `7,679 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **45,124** &nbsp;&nbsp; folks: **3,280**  &nbsp;&nbsp; `8,399 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **40,161** &nbsp;&nbsp; folks: **4,662**  &nbsp;&nbsp; `6,443 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,712** &nbsp;&nbsp; folks: **901**  &nbsp;&nbsp; `4,135 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **4,111** &nbsp;&nbsp; folks: **407**  &nbsp;&nbsp; `2,685 stars this month`

1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    - Cybersecurity AI (CAI), the framework for AI Security
    - language: **Python** &nbsp;&nbsp; stars: **3,802** &nbsp;&nbsp; folks: **520**  &nbsp;&nbsp; `1,786 stars this month`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,582** &nbsp;&nbsp; folks: **1,605**  &nbsp;&nbsp; `1,631 stars this month`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,289** &nbsp;&nbsp; folks: **4,681**  &nbsp;&nbsp; `2,275 stars this month`
