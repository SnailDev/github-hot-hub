...
`更新时间：2021-04-19 14:18:34 +0800`

## 今日热门仓库

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,915** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `416 stars today`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,119** &nbsp;&nbsp; folks: **1,324**  &nbsp;&nbsp; `380 stars today`
...
1. [mpv-player / mpv](https://github.com/mpv-player/mpv)
    ...
    - language: **C** &nbsp;&nbsp; stars: **14,683** &nbsp;&nbsp; folks: **1,875**  &nbsp;&nbsp; `157 stars today`
...
1. [louisfb01 / start-machine-learning-in-2020](https://github.com/louisfb01/start-machine-learning-in-2020)
    ...
    - language: **无** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `162 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **127,000** &nbsp;&nbsp; folks: **23,218**  &nbsp;&nbsp; `250 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,014** &nbsp;&nbsp; folks: **15,103**  &nbsp;&nbsp; `231 stars today`

1. [frontierdotxyz / frontier-chain-testnets](https://github.com/frontierdotxyz/frontier-chain-testnets)
    - Frontier Chain Testnets
    - language: **无** &nbsp;&nbsp; stars: **65** &nbsp;&nbsp; folks: **1,463**  &nbsp;&nbsp; `33 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,695** &nbsp;&nbsp; folks: **1,505**  &nbsp;&nbsp; `167 stars today`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **20,124** &nbsp;&nbsp; folks: **5,101**  &nbsp;&nbsp; `81 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,915** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `1,708 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,119** &nbsp;&nbsp; folks: **1,324**  &nbsp;&nbsp; `1,289 stars this week`

1. [DualCoder / vgpu_unlock](https://github.com/DualCoder/vgpu_unlock)
    - Unlock vGPU functionality for consumer grade GPUs.
    - language: **C** &nbsp;&nbsp; stars: **1,940** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `660 stars this week`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,997** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `1,974 stars this week`

1. [openethereum / openethereum](https://github.com/openethereum/openethereum)
    - The fast, light, and robust client for the Ethereum mainnet.
    - language: **Rust** &nbsp;&nbsp; stars: **674** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `314 stars this week`

1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,282** &nbsp;&nbsp; folks: **5,496**  &nbsp;&nbsp; `787 stars this week`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,874** &nbsp;&nbsp; folks: **2,358**  &nbsp;&nbsp; `837 stars this week`

1. [foxlet / macOS-Simple-KVM](https://github.com/foxlet/macOS-Simple-KVM)
    - Tools to set up a quick macOS VM in QEMU, accelerated by KVM.
    - language: **Shell** &nbsp;&nbsp; stars: **10,530** &nbsp;&nbsp; folks: **864**  &nbsp;&nbsp; `519 stars this week`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **23,158** &nbsp;&nbsp; folks: **5,682**  &nbsp;&nbsp; `1,024 stars this week`

1. [open-mmlab / mmocr](https://github.com/open-mmlab/mmocr)
    - OpenMMLab Text Detection, Recognition and Understanding Toolbox
    - language: **Python** &nbsp;&nbsp; stars: **971** &nbsp;&nbsp; folks: **109**  &nbsp;&nbsp; `362 stars this week`
...
1. [go-kratos / kratos](https://github.com/go-kratos/kratos)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **12,314** &nbsp;&nbsp; folks: **2,614**  &nbsp;&nbsp; `238 stars this week`
...
1. [alibaba / formily](https://github.com/alibaba/formily)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,575** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `70 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **127,000** &nbsp;&nbsp; folks: **23,218**  &nbsp;&nbsp; `867 stars this week`

1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    - RandomX, CryptoNight, AstroBWT and Argon2 CPU/GPU miner
    - language: **C++** &nbsp;&nbsp; stars: **4,467** &nbsp;&nbsp; folks: **2,092**  &nbsp;&nbsp; `133 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,915** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `2,509 stars this month`

1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    - Simple command line tool for text to image generation using OpenAI's CLIP and Siren (Implicit neural representation network). Technique was originally created by https://twitter.com/advadnoun
    - language: **Python** &nbsp;&nbsp; stars: **3,218** &nbsp;&nbsp; folks: **207**  &nbsp;&nbsp; `2,635 stars this month`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,874** &nbsp;&nbsp; folks: **2,358**  &nbsp;&nbsp; `1,256 stars this month`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,997** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `2,672 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **8,436** &nbsp;&nbsp; folks: **988**  &nbsp;&nbsp; `3,077 stars this month`
...
1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,497** &nbsp;&nbsp; folks: **568**  &nbsp;&nbsp; `719 stars this month`
...
1. [LukeSmithxyz / based.cooking](https://github.com/LukeSmithxyz/based.cooking)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **1,287** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `881 stars this month`

1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,282** &nbsp;&nbsp; folks: **5,496**  &nbsp;&nbsp; `1,082 stars this month`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **HTML** &nbsp;&nbsp; stars: **3,108** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `2,016 stars this month`

1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    - 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识。
    - language: **无** &nbsp;&nbsp; stars: **24,213** &nbsp;&nbsp; folks: **5,459**  &nbsp;&nbsp; `1,205 stars this month`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **23,158** &nbsp;&nbsp; folks: **5,682**  &nbsp;&nbsp; `1,802 stars this month`
...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **126,261** &nbsp;&nbsp; folks: **41,000**  &nbsp;&nbsp; `2,830 stars this month`
...
1. [alibaba / nacos](https://github.com/alibaba/nacos)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **17,248** &nbsp;&nbsp; folks: **6,743**  &nbsp;&nbsp; `581 stars this month`
