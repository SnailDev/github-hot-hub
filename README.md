...
`更新时间：2021-02-22 15:08:33 +0800`

## 今日热门仓库

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **4,419** &nbsp;&nbsp; folks: **539**  &nbsp;&nbsp; `1,052 stars today`
...
1. [stypr / clubhouse-py](https://github.com/stypr/clubhouse-py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **993** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `324 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **11,065** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `840 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,592** &nbsp;&nbsp; folks: **33,654**  &nbsp;&nbsp; `192 stars today`

1. [ai-eks / OpenClubhouse](https://github.com/ai-eks/OpenClubhouse)
    - A third-part web application based on flask to play Clubhouse audio.
    - language: **JavaScript** &nbsp;&nbsp; stars: **609** &nbsp;&nbsp; folks: **188**  &nbsp;&nbsp; `294 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,920** &nbsp;&nbsp; folks: **1,318**  &nbsp;&nbsp; `75 stars today`
...
1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,852** &nbsp;&nbsp; folks: **1,016**  &nbsp;&nbsp; `66 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,536** &nbsp;&nbsp; folks: **13,564**  &nbsp;&nbsp; `111 stars today`

1. [data-science-on-aws / workshop](https://github.com/data-science-on-aws/workshop)
    - AI and Machine Learning with Kubeflow, Amazon EKS, and SageMaker
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,441** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `96 stars today`
...
1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **1,427** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `1,238 stars this week`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - The home for voice conversations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,769** &nbsp;&nbsp; folks: **190**  &nbsp;&nbsp; `969 stars this week`

1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **23,366** &nbsp;&nbsp; folks: **675**  &nbsp;&nbsp; `2,260 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **11,065** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `2,350 stars this week`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,976** &nbsp;&nbsp; folks: **414**  &nbsp;&nbsp; `662 stars this week`
...
1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,004** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `727 stars this week`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,619** &nbsp;&nbsp; folks: **669**  &nbsp;&nbsp; `1,549 stars this week`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,643** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `1,584 stars this week`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,377** &nbsp;&nbsp; folks: **1,829**  &nbsp;&nbsp; `387 stars this week`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,192** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `1,175 stars this week`

1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,594** &nbsp;&nbsp; folks: **1,620**  &nbsp;&nbsp; `190 stars this week`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,192** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `2,698 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **11,065** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `3,211 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **24,267** &nbsp;&nbsp; folks: **4,637**  &nbsp;&nbsp; `1,125 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,985** &nbsp;&nbsp; folks: **2,116**  &nbsp;&nbsp; `2,558 stars this month`
...
1. [justauth / JustAuth](https://github.com/justauth/JustAuth)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **10,706** &nbsp;&nbsp; folks: **1,888**  &nbsp;&nbsp; `809 stars this month`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,355** &nbsp;&nbsp; folks: **1,445**  &nbsp;&nbsp; `2,295 stars this month`
