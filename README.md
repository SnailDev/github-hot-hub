...
`更新时间：2025-12-29 17:27:07 +0800`

## 今日热门仓库

1. [Flowseal / zapret-discord-youtube](https://github.com/Flowseal/zapret-discord-youtube)
    - 无
    - language: **Batchfile** &nbsp;&nbsp; stars: **20,230** &nbsp;&nbsp; folks: **1,675**  &nbsp;&nbsp; `196 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **215,975** &nbsp;&nbsp; folks: **49,777**  &nbsp;&nbsp; `372 stars today`
...
1. [danielmiessler / Personal_AI_Infrastructure](https://github.com/danielmiessler/Personal_AI_Infrastructure)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,468** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `718 stars this week`

1. [makeplane / plane](https://github.com/makeplane/plane)
    - 🔥🔥🔥 Open-source Jira, Linear, Monday, and ClickUp alternative. Plane is a modern project management platform to manage tasks, sprints, docs, and triage.
    - language: **TypeScript** &nbsp;&nbsp; stars: **42,184** &nbsp;&nbsp; folks: **3,102**  &nbsp;&nbsp; `1,414 stars this week`

1. [sst / opencode](https://github.com/sst/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,526** &nbsp;&nbsp; folks: **3,728**  &nbsp;&nbsp; `2,418 stars this week`

1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    - Stable Diffusion web UI
    - language: **Python** &nbsp;&nbsp; stars: **159,428** &nbsp;&nbsp; folks: **29,652**  &nbsp;&nbsp; `327 stars this week`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **38,784** &nbsp;&nbsp; folks: **2,597**  &nbsp;&nbsp; `6,111 stars this month`

1. [datawhalechina / hello-agents](https://github.com/datawhalechina/hello-agents)
    - 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程
    - language: **Python** &nbsp;&nbsp; stars: **13,124** &nbsp;&nbsp; folks: **1,370**  &nbsp;&nbsp; `8,026 stars this month`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.
    - language: **Rust** &nbsp;&nbsp; stars: **18,496** &nbsp;&nbsp; folks: **797**  &nbsp;&nbsp; `6,810 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,626** &nbsp;&nbsp; folks: **3,071**  &nbsp;&nbsp; `6,149 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,526** &nbsp;&nbsp; folks: **3,728**  &nbsp;&nbsp; `9,042 stars this month`

1. [agentsmd / agents.md](https://github.com/agentsmd/agents.md)
    - AGENTS.md — a simple, open format for guiding coding agents
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,472** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `4,804 stars this month`

1. [anthropics / claude-quickstarts](https://github.com/anthropics/claude-quickstarts)
    - A collection of projects designed to help developers quickly get started with building deployable applications using the Claude API
    - language: **Python** &nbsp;&nbsp; stars: **12,965** &nbsp;&nbsp; folks: **2,171**  &nbsp;&nbsp; `2,544 stars this month`

1. [Tencent / WeKnora](https://github.com/Tencent/WeKnora)
    - LLM-powered framework for deep document understanding, semantic retrieval, and context-aware answers using RAG paradigm.
    - language: **Go** &nbsp;&nbsp; stars: **10,500** &nbsp;&nbsp; folks: **1,129**  &nbsp;&nbsp; `2,769 stars this month`

1. [microsoft / magentic-ui](https://github.com/microsoft/magentic-ui)
    - A research prototype of a human-centered web agent
    - language: **Python** &nbsp;&nbsp; stars: **9,507** &nbsp;&nbsp; folks: **963**  &nbsp;&nbsp; `1,447 stars this month`

1. [cocoindex-io / cocoindex](https://github.com/cocoindex-io/cocoindex)
    - Data transformation framework for AI. Ultra performant, with incremental processing. 🌟 Star if you like it!
    - language: **Rust** &nbsp;&nbsp; stars: **5,431** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `1,932 stars this month`

1. [oven-sh / bun](https://github.com/oven-sh/bun)
    - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
    - language: **Zig** &nbsp;&nbsp; stars: **85,723** &nbsp;&nbsp; folks: **3,852**  &nbsp;&nbsp; `3,485 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **49,461** &nbsp;&nbsp; folks: **3,499**  &nbsp;&nbsp; `5,557 stars this month`

1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    - SoTA open-source TTS
    - language: **Python** &nbsp;&nbsp; stars: **18,764** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `3,481 stars this month`
...
1. [FunAudioLLM / CosyVoice](https://github.com/FunAudioLLM/CosyVoice)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,537** &nbsp;&nbsp; folks: **2,064**  &nbsp;&nbsp; `1,109 stars this month`

1. [danielmiessler / Personal_AI_Infrastructure](https://github.com/danielmiessler/Personal_AI_Infrastructure)
    - Personal AI Infrastructure for upgrading humans.
    - language: **无** &nbsp;&nbsp; stars: **2,468** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `1,261 stars this month`
