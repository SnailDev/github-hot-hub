...
`更新时间：2021-03-07 11:10:32 +0800`

## 今日热门仓库

1. [dolthub / dolt](https://github.com/dolthub/dolt)
    - Dolt – It's Git for Data
    - language: **Go** &nbsp;&nbsp; stars: **4,027** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `632 stars today`

1. [openai / CLIP](https://github.com/openai/CLIP)
    - Contrastive Language-Image Pretraining
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,418** &nbsp;&nbsp; folks: **217**  &nbsp;&nbsp; `163 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,276** &nbsp;&nbsp; folks: **7,270**  &nbsp;&nbsp; `115 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **115,225** &nbsp;&nbsp; folks: **16,400**  &nbsp;&nbsp; `553 stars today`

1. [git / git](https://github.com/git/git)
    - Git Source Code Mirror - This is a publish-only repository and all pull requests are ignored. Please follow Documentation/SubmittingPatches procedure for any of your improvements.
    - language: **C** &nbsp;&nbsp; stars: **36,730** &nbsp;&nbsp; folks: **21,040**  &nbsp;&nbsp; `281 stars today`

1. [dwisiswant0 / apkleaks](https://github.com/dwisiswant0/apkleaks)
    - Scanning APK file for URIs, endpoints & secrets.
    - language: **Python** &nbsp;&nbsp; stars: **986** &nbsp;&nbsp; folks: **109**  &nbsp;&nbsp; `226 stars today`
...
1. [sarven / unit-testing-tips](https://github.com/sarven/unit-testing-tips)
    ...
    - language: **无** &nbsp;&nbsp; stars: **225** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `33 stars today`

1. [kilimchoi / engineering-blogs](https://github.com/kilimchoi/engineering-blogs)
    - A curated list of engineering blogs
    - language: **Ruby** &nbsp;&nbsp; stars: **18,628** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `160 stars today`
...
1. [MicrosoftLearning / AZ-104-MicrosoftAzureAdministrator](https://github.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **882** &nbsp;&nbsp; folks: **1,172**  &nbsp;&nbsp; `37 stars today`

1. [florinpop17 / app-ideas](https://github.com/florinpop17/app-ideas)
    - A Collection of application ideas which can be used to improve your coding skills.
    - language: **无** &nbsp;&nbsp; stars: **37,459** &nbsp;&nbsp; folks: **5,255**  &nbsp;&nbsp; `133 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **98,849** &nbsp;&nbsp; folks: **16,419**  &nbsp;&nbsp; `393 stars today`
...
1. [muguruzawang / jd_maotai_seckill](https://github.com/muguruzawang/jd_maotai_seckill)
    - 优化版本的京东茅台抢购神器
    - language: **Python** &nbsp;&nbsp; stars: **657** &nbsp;&nbsp; folks: **4,290**  &nbsp;&nbsp; `437 stars this week`

1. [android / compose-samples](https://github.com/android/compose-samples)
    - Official Jetpack Compose samples.
    - language: **Kotlin** &nbsp;&nbsp; stars: **6,016** &nbsp;&nbsp; folks: **989**  &nbsp;&nbsp; `367 stars this week`

1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    - 基于代码生成器的低代码平台，超越传统商业平台！前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis-plus，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新低代码开发模式OnlineCoding->代码生成->手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高开发效率，帮助公司节省成本，同时又不失灵活性。
    - language: **Java** &nbsp;&nbsp; stars: **20,374** &nbsp;&nbsp; folks: **7,872**  &nbsp;&nbsp; `591 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,276** &nbsp;&nbsp; folks: **7,270**  &nbsp;&nbsp; `568 stars this week`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **115,225** &nbsp;&nbsp; folks: **16,400**  &nbsp;&nbsp; `1,475 stars this week`
...
1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **98,772** &nbsp;&nbsp; folks: **34,061**  &nbsp;&nbsp; `685 stars this week`
...
1. [pyroscope-io / pyroscope](https://github.com/pyroscope-io/pyroscope)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,178** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `1,009 stars this week`
...
1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    ...
    - language: **无** &nbsp;&nbsp; stars: **22,746** &nbsp;&nbsp; folks: **5,066**  &nbsp;&nbsp; `236 stars this week`
...
1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,848** &nbsp;&nbsp; folks: **686**  &nbsp;&nbsp; `1,370 stars this month`
...
1. [bitwarden / server](https://github.com/bitwarden/server)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,240** &nbsp;&nbsp; folks: **621**  &nbsp;&nbsp; `513 stars this month`
...
1. [cuixiaorui / mini-vue](https://github.com/cuixiaorui/mini-vue)
    - 实现最简 vue3 模型
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,029** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `897 stars this month`
...
1. [airbnb / javascript](https://github.com/airbnb/javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,166** &nbsp;&nbsp; folks: **20,525**  &nbsp;&nbsp; `1,955 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,294** &nbsp;&nbsp; folks: **4,830**  &nbsp;&nbsp; `1,401 stars this month`
