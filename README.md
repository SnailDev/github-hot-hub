...
`更新时间：2021-11-09 04:12:39 +0800`

## 今日热门仓库

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **Java** &nbsp;&nbsp; stars: **18,349** &nbsp;&nbsp; folks: **6,348**  &nbsp;&nbsp; `71 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **Python** &nbsp;&nbsp; stars: **30,718** &nbsp;&nbsp; folks: **5,714**  &nbsp;&nbsp; `205 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **132,002** &nbsp;&nbsp; folks: **19,334**  &nbsp;&nbsp; `80 stars today`

1. [pi-hole / pi-hole](https://github.com/pi-hole/pi-hole)
    - A black hole for Internet advertisements
    - language: **Shell** &nbsp;&nbsp; stars: **33,372** &nbsp;&nbsp; folks: **2,122**  &nbsp;&nbsp; `119 stars today`
...
1. [Python-World / python-mini-projects](https://github.com/Python-World/python-mini-projects)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,575** &nbsp;&nbsp; folks: **1,612**  &nbsp;&nbsp; `51 stars today`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,638** &nbsp;&nbsp; folks: **1,334**  &nbsp;&nbsp; `394 stars today`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **11,515** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `54 stars today`

1. [AsyncBanana / microdiff](https://github.com/AsyncBanana/microdiff)
    - A fast, zero dependency object and array comparison library. Significantly faster than most other deep comparison libraries and has full TypeScript support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **918** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `227 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-py](https://github.com/smartcontractkit/full-blockchain-solidity-course-py)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,883** &nbsp;&nbsp; folks: **596**  &nbsp;&nbsp; `60 stars today`
...
1. [ixartz / Next-js-Boilerplate](https://github.com/ixartz/Next-js-Boilerplate)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **890** &nbsp;&nbsp; folks: **170**  &nbsp;&nbsp; `62 stars today`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **58,711** &nbsp;&nbsp; folks: **30,454**  &nbsp;&nbsp; `106 stars today`
...
1. [coofcookie / Windows11Upgrade](https://github.com/coofcookie/Windows11Upgrade)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **595** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `80 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **122,921** &nbsp;&nbsp; folks: **32,952**  &nbsp;&nbsp; `256 stars today`

1. [Kholid060 / automa](https://github.com/Kholid060/automa)
    - A chrome extension for automating your browser by connecting blocks
    - language: **Vue** &nbsp;&nbsp; stars: **600** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `192 stars today`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **38,795** &nbsp;&nbsp; folks: **4,435**  &nbsp;&nbsp; `77 stars today`
...
1. [CSSEGISandData / COVID-19](https://github.com/CSSEGISandData/COVID-19)
    ...
    - language: **无** &nbsp;&nbsp; stars: **27,679** &nbsp;&nbsp; folks: **17,770**  &nbsp;&nbsp; `26 stars today`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **Java** &nbsp;&nbsp; stars: **18,349** &nbsp;&nbsp; folks: **6,348**  &nbsp;&nbsp; `270 stars this week`
...
1. [github / copilot-docs](https://github.com/github/copilot-docs)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,505** &nbsp;&nbsp; folks: **447**  &nbsp;&nbsp; `2,715 stars this week`
...
1. [raywenderlich / flta-materials](https://github.com/raywenderlich/flta-materials)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **1,494** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `856 stars this month`
...
1. [louislam / uptime-kuma](https://github.com/louislam/uptime-kuma)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,274** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `4,039 stars this month`
