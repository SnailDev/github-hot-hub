...
1. [wuyouzhuguli / SpringAll](https://github.com/wuyouzhuguli/SpringAll)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,178** &nbsp;&nbsp; folks: **6,058**  &nbsp;&nbsp; `143 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **4,720** &nbsp;&nbsp; folks: **1,014**  &nbsp;&nbsp; `259 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,657** &nbsp;&nbsp; folks: **260**  &nbsp;&nbsp; `26 stars today`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,369** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `351 stars today`
...
1. [AMAI-GmbH / AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,348** &nbsp;&nbsp; folks: **1,016**  &nbsp;&nbsp; `247 stars today`
...
1. [bradtraversy / design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
    ...
    - language: **无** &nbsp;&nbsp; stars: **28,979** &nbsp;&nbsp; folks: **6,698**  &nbsp;&nbsp; `174 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,684** &nbsp;&nbsp; folks: **3,499**  &nbsp;&nbsp; `45 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,092** &nbsp;&nbsp; folks: **724**  &nbsp;&nbsp; `434 stars today`

1. [kon9chunkit / GitHub-Chinese-Top-Charts](https://github.com/kon9chunkit/GitHub-Chinese-Top-Charts)
    - 🇨🇳 GitHub中文排行榜，帮助你发现高分优秀中文项目、更高效地吸收国人的优秀经验成果；榜单每周更新一次，敬请关注！
    - language: **Java** &nbsp;&nbsp; stars: **33,875** &nbsp;&nbsp; folks: **4,891**  &nbsp;&nbsp; `102 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **189,274** &nbsp;&nbsp; folks: **42,330**  &nbsp;&nbsp; `275 stars today`

1. [inoyna11 / jd28](https://github.com/inoyna11/jd28)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **198** &nbsp;&nbsp; folks: **62**  &nbsp;&nbsp; `64 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **11,532** &nbsp;&nbsp; folks: **2,025**  &nbsp;&nbsp; `271 stars today`
...
1. [straightblast / My-PoC-Exploits](https://github.com/straightblast/My-PoC-Exploits)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **97** &nbsp;&nbsp; folks: **22**  &nbsp;&nbsp; `22 stars today`

1. [bee-san / pyWhat](https://github.com/bee-san/pyWhat)
    - 🐸 Identify anything. pyWhat easily lets you identify emails, IP addresses, and more. Feed it a .pcap file or some text and it'll tell you what it is! 🧙‍♀️
    - language: **Python** &nbsp;&nbsp; stars: **585** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `252 stars today`
...
1. [microsoft / winget-pkgs](https://github.com/microsoft/winget-pkgs)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **3,553** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `16 stars today`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,188** &nbsp;&nbsp; folks: **3,491**  &nbsp;&nbsp; `217 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **11,532** &nbsp;&nbsp; folks: **2,025**  &nbsp;&nbsp; `4,646 stars this month`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,871** &nbsp;&nbsp; folks: **1,054**  &nbsp;&nbsp; `3,066 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,442** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `1,702 stars this month`
...
1. [alacritty / alacritty](https://github.com/alacritty/alacritty)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **32,812** &nbsp;&nbsp; folks: **1,716**  &nbsp;&nbsp; `1,891 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,935** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `2,738 stars this month`

1. [solana-labs / solana](https://github.com/solana-labs/solana)
    - Web-Scale Blockchain for fast, secure, scalable, decentralized apps and marketplaces.
    - language: **Rust** &nbsp;&nbsp; stars: **2,146** &nbsp;&nbsp; folks: **467**  &nbsp;&nbsp; `494 stars this month`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **67,191** &nbsp;&nbsp; folks: **21,098**  &nbsp;&nbsp; `1,726 stars this month`

1. [whittlem / pycryptobot](https://github.com/whittlem/pycryptobot)
    - Python Crypto Bot
    - language: **Python** &nbsp;&nbsp; stars: **375** &nbsp;&nbsp; folks: **169**  &nbsp;&nbsp; `180 stars this month`
