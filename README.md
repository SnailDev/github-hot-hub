...
1. [AkashSingh3031 / The-Complete-FAANG-Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,158** &nbsp;&nbsp; folks: **381**  &nbsp;&nbsp; `340 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Free and open fair-code licensed node based Workflow Automation Tool. Easily automate tasks across different services.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,223** &nbsp;&nbsp; folks: **1,345**  &nbsp;&nbsp; `329 stars today`

1. [kwai / DouZero](https://github.com/kwai/DouZero)
    - [ICML 2021] DouZero: Mastering DouDizhu with Self-Play Deep Reinforcement Learning | 斗地主AI
    - language: **Python** &nbsp;&nbsp; stars: **750** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `224 stars today`

1. [vxunderground / MalwareSourceCode](https://github.com/vxunderground/MalwareSourceCode)
    - Collection of malware source code for a variety of platforms in an array of different programming languages.
    - language: **Assembly** &nbsp;&nbsp; stars: **5,946** &nbsp;&nbsp; folks: **579**  &nbsp;&nbsp; `247 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **135,868** &nbsp;&nbsp; folks: **24,711**  &nbsp;&nbsp; `186 stars today`

1. [v2fly / v2ray-core](https://github.com/v2fly/v2ray-core)
    - A platform for building proxies to bypass network restrictions.
    - language: **Go** &nbsp;&nbsp; stars: **9,803** &nbsp;&nbsp; folks: **1,636**  &nbsp;&nbsp; `122 stars today`
...
1. [abuanwar072 / Flutter-Responsive-Admin-Panel-or-Dashboard](https://github.com/abuanwar072/Flutter-Responsive-Admin-Panel-or-Dashboard)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **3,003** &nbsp;&nbsp; folks: **546**  &nbsp;&nbsp; `122 stars today`
...
1. [probml / pyprobml](https://github.com/probml/pyprobml)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,457** &nbsp;&nbsp; folks: **867**  &nbsp;&nbsp; `124 stars today`

1. [facebookresearch / AugLy](https://github.com/facebookresearch/AugLy)
    - A data augmentations library for audio, image, text, and video.
    - language: **Python** &nbsp;&nbsp; stars: **2,304** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `682 stars today`
...
1. [organicmaps / organicmaps](https://github.com/organicmaps/organicmaps)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,699** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `271 stars today`
...
1. [udacity / nd064_course_1](https://github.com/udacity/nd064_course_1)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **142** &nbsp;&nbsp; folks: **380**  &nbsp;&nbsp; `46 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **182,003** &nbsp;&nbsp; folks: **49,284**  &nbsp;&nbsp; `12,531 stars this month`

1. [ethersphere / bee](https://github.com/ethersphere/bee)
    - Bee is a Swarm client implemented in Go. It’s the basic building block for the Swarm network: a private; decentralized; and self-sustaining network for permissionless publishing and access to your (application) data.
    - language: **Go** &nbsp;&nbsp; stars: **1,123** &nbsp;&nbsp; folks: **250**  &nbsp;&nbsp; `715 stars this month`

1. [deepfakes / faceswap](https://github.com/deepfakes/faceswap)
    - Deepfakes Software For All
    - language: **Python** &nbsp;&nbsp; stars: **37,396** &nbsp;&nbsp; folks: **10,986**  &nbsp;&nbsp; `2,299 stars this month`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Java** &nbsp;&nbsp; stars: **4,133** &nbsp;&nbsp; folks: **1,040**  &nbsp;&nbsp; `855 stars this month`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,640** &nbsp;&nbsp; folks: **1,308**  &nbsp;&nbsp; `2,535 stars this month`
...
1. [siduck76 / NvChad](https://github.com/siduck76/NvChad)
    - Beautiful neovim setup configured in lua
    - language: **Lua** &nbsp;&nbsp; stars: **2,327** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `1,335 stars this month`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **2,816** &nbsp;&nbsp; folks: **1,808**  &nbsp;&nbsp; `1,295 stars this month`
...
1. [microsoft / winget-cli](https://github.com/microsoft/winget-cli)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,981** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `2,221 stars this month`
...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **132,899** &nbsp;&nbsp; folks: **42,699**  &nbsp;&nbsp; `4,174 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - Yet another remote desktop software
    - language: **Rust** &nbsp;&nbsp; stars: **7,159** &nbsp;&nbsp; folks: **514**  &nbsp;&nbsp; `4,680 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,871** &nbsp;&nbsp; folks: **759**  &nbsp;&nbsp; `2,831 stars this month`

1. [academind / react-complete-guide-code](https://github.com/academind/react-complete-guide-code)
    - Code snapshots and materials for our "React - The Complete Guide" course (https://acad.link/reactjs)
    - language: **无** &nbsp;&nbsp; stars: **748** &nbsp;&nbsp; folks: **1,535**  &nbsp;&nbsp; `359 stars this month`
