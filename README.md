...
1. [kabinspace / AstroVim](https://github.com/kabinspace/AstroVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **881** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `285 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **80,463** &nbsp;&nbsp; folks: **7,180**  &nbsp;&nbsp; `185 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **134,252** &nbsp;&nbsp; folks: **22,080**  &nbsp;&nbsp; `136 stars today`

1. [ethereum / EIPs](https://github.com/ethereum/EIPs)
    - The Ethereum Improvement Proposal repository
    - language: **Solidity** &nbsp;&nbsp; stars: **8,914** &nbsp;&nbsp; folks: **3,227**  &nbsp;&nbsp; `57 stars today`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **30,952** &nbsp;&nbsp; folks: **2,311**  &nbsp;&nbsp; `163 stars today`

1. [Kindelia / HVM](https://github.com/Kindelia/HVM)
    - A massively parallel, optimal functional runtime in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,038** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `535 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **135,461** &nbsp;&nbsp; folks: **20,504**  &nbsp;&nbsp; `171 stars today`
...
1. [Hack-with-Github / Awesome-Hacking](https://github.com/Hack-with-Github/Awesome-Hacking)
    ...
    - language: **无** &nbsp;&nbsp; stars: **49,148** &nbsp;&nbsp; folks: **7,643**  &nbsp;&nbsp; `157 stars today`

1. [mit-dci / opencbdc-tx](https://github.com/mit-dci/opencbdc-tx)
    - A transaction processor for a hypothetical, general-purpose, central bank digital currency
    - language: **C++** &nbsp;&nbsp; stars: **282** &nbsp;&nbsp; folks: **37**  &nbsp;&nbsp; `91 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **207,219** &nbsp;&nbsp; folks: **55,878**  &nbsp;&nbsp; `330 stars today`

1. [logseq / logseq](https://github.com/logseq/logseq)
    - A privacy-first, open-source platform for knowledge management and collaboration. Desktop app download link: https://github.com/logseq/logseq/releases, roadmap: https://trello.com/b/8txSM12G/roadmap
    - language: **Clojure** &nbsp;&nbsp; stars: **10,412** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `102 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,605** &nbsp;&nbsp; folks: **3,206**  &nbsp;&nbsp; `153 stars today`
...
1. [imDazui / Tvlist-awesome-m3u-m3u8](https://github.com/imDazui/Tvlist-awesome-m3u-m3u8)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,218** &nbsp;&nbsp; folks: **1,075**  &nbsp;&nbsp; `140 stars today`

1. [huginn / huginn](https://github.com/huginn/huginn)
    - Create agents that monitor and act on your behalf. Your agents are standing by!
    - language: **Ruby** &nbsp;&nbsp; stars: **34,601** &nbsp;&nbsp; folks: **3,179**  &nbsp;&nbsp; `176 stars today`

1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Budibase is an open-source low-code platform for creating internal apps in minutes. Supports PostgreSQL, MySQL, MSSQL, MongoDB, Rest API, Docker, K8s 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,965** &nbsp;&nbsp; folks: **511**  &nbsp;&nbsp; `237 stars today`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **68,338** &nbsp;&nbsp; folks: **3,835**  &nbsp;&nbsp; `219 stars today`
...
1. [tobspr / shapez.io](https://github.com/tobspr/shapez.io)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,735** &nbsp;&nbsp; folks: **953**  &nbsp;&nbsp; `101 stars today`

1. [danielkrupinski / Osiris](https://github.com/danielkrupinski/Osiris)
    - Free open-source game cheat for Counter-Strike: Global Offensive, written in modern C++. GUI powered by Dear ImGui.
    - language: **C++** &nbsp;&nbsp; stars: **2,003** &nbsp;&nbsp; folks: **772**  &nbsp;&nbsp; `44 stars today`
...
1. [nextui-org / nextui](https://github.com/nextui-org/nextui)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,602** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `1,029 stars this week`
...
1. [TheAlgorithms / Go](https://github.com/TheAlgorithms/Go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,444** &nbsp;&nbsp; folks: **1,598**  &nbsp;&nbsp; `619 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,244** &nbsp;&nbsp; folks: **5,749**  &nbsp;&nbsp; `827 stars this week`

1. [logseq / logseq](https://github.com/logseq/logseq)
    - A privacy-first, open-source platform for knowledge management and collaboration. Desktop app download link: https://github.com/logseq/logseq/releases, roadmap: https://trello.com/b/8txSM12G/roadmap
    - language: **Clojure** &nbsp;&nbsp; stars: **10,412** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `913 stars this week`
...
1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Budibase is an open-source low-code platform for creating internal apps in minutes. Supports PostgreSQL, MySQL, MSSQL, MongoDB, Rest API, Docker, K8s 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,965** &nbsp;&nbsp; folks: **511**  &nbsp;&nbsp; `1,251 stars this week`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **8,879** &nbsp;&nbsp; folks: **836**  &nbsp;&nbsp; `576 stars this week`
...
1. [Jxck-S / plane-notify](https://github.com/Jxck-S/plane-notify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,198** &nbsp;&nbsp; folks: **237**  &nbsp;&nbsp; `1,002 stars this week`

1. [ThioJoe / YT-Spammer-Purge](https://github.com/ThioJoe/YT-Spammer-Purge)
    - Allows you easily scan for and delete scam comments using several methods.
    - language: **Python** &nbsp;&nbsp; stars: **2,873** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `1,911 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,605** &nbsp;&nbsp; folks: **3,206**  &nbsp;&nbsp; `3,760 stars this month`
...
1. [facebookresearch / mae](https://github.com/facebookresearch/mae)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,582** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `2,057 stars this month`

1. [wmjordan / PDFPatcher](https://github.com/wmjordan/PDFPatcher)
    - PDF补丁丁——PDF工具箱，可以编辑书签、剪裁旋转页面、解除限制、提取或合并文档，探查文档结构，提取图片、转成图片等等
    - language: **C#** &nbsp;&nbsp; stars: **3,656** &nbsp;&nbsp; folks: **679**  &nbsp;&nbsp; `2,181 stars this month`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **6,933** &nbsp;&nbsp; folks: **752**  &nbsp;&nbsp; `3,481 stars this month`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **9,244** &nbsp;&nbsp; folks: **5,749**  &nbsp;&nbsp; `2,098 stars this month`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **30,239** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `3,843 stars this month`
