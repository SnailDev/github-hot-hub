...
1. [prometheus / client_python](https://github.com/prometheus/client_python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,032** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `14 stars today`

1. [dotnet / AspNetCore.Docs](https://github.com/dotnet/AspNetCore.Docs)
    - Documentation for ASP.NET Core
    - language: **C#** &nbsp;&nbsp; stars: **11,058** &nbsp;&nbsp; folks: **24,920**  &nbsp;&nbsp; `4 stars today`
...
1. [kubernetes / client-go](https://github.com/kubernetes/client-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,929** &nbsp;&nbsp; folks: **2,578**  &nbsp;&nbsp; `38 stars today`

1. [SoftwareBrothers / adminjs](https://github.com/SoftwareBrothers/adminjs)
    - AdminJS is an admin panel for apps written in node.js
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,839** &nbsp;&nbsp; folks: **468**  &nbsp;&nbsp; `62 stars today`
...
1. [mastodon / mastodon](https://github.com/mastodon/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **31,251** &nbsp;&nbsp; folks: **4,797**  &nbsp;&nbsp; `1,091 stars this week`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **16,612** &nbsp;&nbsp; folks: **902**  &nbsp;&nbsp; `1,868 stars this week`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,593** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `592 stars this week`
...
1. [jaywcjlove / linux-command](https://github.com/jaywcjlove/linux-command)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **21,291** &nbsp;&nbsp; folks: **4,611**  &nbsp;&nbsp; `387 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **237,632** &nbsp;&nbsp; folks: **63,549**  &nbsp;&nbsp; `1,201 stars this week`
...
1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **21,759** &nbsp;&nbsp; folks: **2,513**  &nbsp;&nbsp; `271 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,173** &nbsp;&nbsp; folks: **3,388**  &nbsp;&nbsp; `13,183 stars this month`

1. [vercel / turbo](https://github.com/vercel/turbo)
    - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turborepo and Turbopack.
    - language: **Rust** &nbsp;&nbsp; stars: **16,612** &nbsp;&nbsp; folks: **902**  &nbsp;&nbsp; `7,007 stars this month`
...
1. [mastodon / mastodon](https://github.com/mastodon/mastodon)
    - Your self-hosted, globally interconnected microblogging community
    - language: **Ruby** &nbsp;&nbsp; stars: **31,251** &nbsp;&nbsp; folks: **4,797**  &nbsp;&nbsp; `1,332 stars this month`
...
1. [nocodb / nocodb](https://github.com/nocodb/nocodb)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,222** &nbsp;&nbsp; folks: **1,969**  &nbsp;&nbsp; `1,985 stars this month`

1. [facebookincubator / AITemplate](https://github.com/facebookincubator/AITemplate)
    - AITemplate is a Python framework which renders neural network into high performance CUDA/HIP C++ code. Specialized for FP16 TensorCore (NVIDIA GPU) and MatrixCore (AMD GPU) inference.
    - language: **Python** &nbsp;&nbsp; stars: **2,529** &nbsp;&nbsp; folks: **153**  &nbsp;&nbsp; `1,851 stars this month`
...
1. [jaywcjlove / linux-command](https://github.com/jaywcjlove/linux-command)
    - Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
    - language: **Markdown** &nbsp;&nbsp; stars: **21,291** &nbsp;&nbsp; folks: **4,611**  &nbsp;&nbsp; `1,441 stars this month`
...
1. [AmazingAng / WTF-Solidity](https://github.com/AmazingAng/WTF-Solidity)
    ...
    - language: **Solidity** &nbsp;&nbsp; stars: **3,936** &nbsp;&nbsp; folks: **565**  &nbsp;&nbsp; `1,277 stars this month`

1. [alist-org / alist](https://github.com/alist-org/alist)
    - 🗂️A file list program that supports multiple storage, powered by Gin and Solidjs. / 一个支持多存储的文件列表程序，使用 Gin 和 Solidjs。
    - language: **Go** &nbsp;&nbsp; stars: **11,786** &nbsp;&nbsp; folks: **1,768**  &nbsp;&nbsp; `2,086 stars this month`
...
1. [The-Run-Philosophy-Organization / run](https://github.com/The-Run-Philosophy-Organization/run)
    ...
    - language: **无** &nbsp;&nbsp; stars: **22,488** &nbsp;&nbsp; folks: **1,807**  &nbsp;&nbsp; `1,713 stars this month`
...
1. [2dust / v2rayNG](https://github.com/2dust/v2rayNG)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **17,226** &nbsp;&nbsp; folks: **2,913**  &nbsp;&nbsp; `630 stars this month`
