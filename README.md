...
1. [stypr / clubhouse-py](https://github.com/stypr/clubhouse-py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **419** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `191 stars today`

1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    - 🌈 A UI Design Language and React UI library
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,729** &nbsp;&nbsp; folks: **26,641**  &nbsp;&nbsp; `717 stars today`

1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **9,917** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `511 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,233** &nbsp;&nbsp; folks: **13,527**  &nbsp;&nbsp; `88 stars today`
...
1. [surfcodes / surf](https://github.com/surfcodes/surf)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,417** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `459 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,227** &nbsp;&nbsp; folks: **33,561**  &nbsp;&nbsp; `117 stars today`

1. [elixir-nx / nx](https://github.com/elixir-nx/nx)
    - Numerical Elixir and Elixir XLA bindings for CPU/GPU/TPU
    - language: **Elixir** &nbsp;&nbsp; stars: **865** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `133 stars today`

1. [nodejs / undici](https://github.com/nodejs/undici)
    - An HTTP/1.1 client, written from scratch for Node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,246** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `156 stars today`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,957** &nbsp;&nbsp; folks: **1,061**  &nbsp;&nbsp; `293 stars today`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,887** &nbsp;&nbsp; folks: **415**  &nbsp;&nbsp; `135 stars today`
...
1. [raycast / script-commands](https://github.com/raycast/script-commands)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **926** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `52 stars today`
...
1. [itdevbooks / pdf](https://github.com/itdevbooks/pdf)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,253** &nbsp;&nbsp; folks: **1,012**  &nbsp;&nbsp; `118 stars today`
...
1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **1,083** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `944 stars this week`
...
1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,145** &nbsp;&nbsp; folks: **666**  &nbsp;&nbsp; `2,079 stars this week`

1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,952** &nbsp;&nbsp; folks: **1,049**  &nbsp;&nbsp; `967 stars this week`
...
1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,887** &nbsp;&nbsp; folks: **415**  &nbsp;&nbsp; `581 stars this week`

1. [conwnet / github1s](https://github.com/conwnet/github1s)
    - One second to read GitHub code with VS Code.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,015** &nbsp;&nbsp; folks: **329**  &nbsp;&nbsp; `2,894 stars this week`

1. [vlang / v](https://github.com/vlang/v)
    - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in <1s with zero library dependencies. https://vlang.io
    - language: **V** &nbsp;&nbsp; stars: **22,704** &nbsp;&nbsp; folks: **1,343**  &nbsp;&nbsp; `633 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **24,535** &nbsp;&nbsp; folks: **3,945**  &nbsp;&nbsp; `318 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,662** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `1,043 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of 5000+ publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **28,214** &nbsp;&nbsp; folks: **942**  &nbsp;&nbsp; `800 stars this week`

1. [JonnyBurger / remotion](https://github.com/JonnyBurger/remotion)
    - 🎥 Create videos programmatically in React
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,785** &nbsp;&nbsp; folks: **169**  &nbsp;&nbsp; `806 stars this week`
...
1. [ageron / handson-ml2](https://github.com/ageron/handson-ml2)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,306** &nbsp;&nbsp; folks: **6,304**  &nbsp;&nbsp; `266 stars this week`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,957** &nbsp;&nbsp; folks: **1,061**  &nbsp;&nbsp; `3,270 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    - 深度学习500问，以问答形式对常用的概率知识、线性代数、机器学习、深度学习、计算机视觉等热点问题进行阐述，以帮助自己及有需要的读者。 全书分为18个章节，50余万字。由于水平有限，书中不妥之处恳请广大读者批评指正。 未完待续............ 如有意合作，联系scutjy2015@163.com 版权所有，违权必究 Tan 2018.06
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,233** &nbsp;&nbsp; folks: **13,527**  &nbsp;&nbsp; `1,295 stars this month`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **24,172** &nbsp;&nbsp; folks: **4,615**  &nbsp;&nbsp; `1,068 stars this month`
