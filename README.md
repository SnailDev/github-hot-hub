...
1. [DidierRLopes / GamestonkTerminal](https://github.com/DidierRLopes/GamestonkTerminal)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,813** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `88 stars today`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **22,581** &nbsp;&nbsp; folks: **5,597**  &nbsp;&nbsp; `236 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **14,504** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `279 stars today`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,544** &nbsp;&nbsp; folks: **2,267**  &nbsp;&nbsp; `185 stars today`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,836** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `285 stars today`
...
1. [openwrt / openwrt](https://github.com/openwrt/openwrt)
    ...
    - language: **C** &nbsp;&nbsp; stars: **8,399** &nbsp;&nbsp; folks: **5,600**  &nbsp;&nbsp; `82 stars today`
...
1. [nordicgiant2 / awesome-landing-page](https://github.com/nordicgiant2/awesome-landing-page)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,574** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `298 stars today`

1. [microsoft / CyberBattleSim](https://github.com/microsoft/CyberBattleSim)
    - An experimentation and research platform to investigate the interaction of automated agents in an abstract simulated network environments.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **983** &nbsp;&nbsp; folks: **91**  &nbsp;&nbsp; `111 stars today`
...
1. [lydiahallie / javascript-questions](https://github.com/lydiahallie/javascript-questions)
    ...
    - language: **无** &nbsp;&nbsp; stars: **32,139** &nbsp;&nbsp; folks: **4,208**  &nbsp;&nbsp; `256 stars today`
...
1. [charmbracelet / lipgloss](https://github.com/charmbracelet/lipgloss)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,701** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `780 stars this week`
...
1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,112** &nbsp;&nbsp; folks: **444**  &nbsp;&nbsp; `570 stars this week`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,544** &nbsp;&nbsp; folks: **2,267**  &nbsp;&nbsp; `711 stars this week`
...
1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,836** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `1,183 stars this week`
...
1. [react-hook-form / react-hook-form](https://github.com/react-hook-form/react-hook-form)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,994** &nbsp;&nbsp; folks: **914**  &nbsp;&nbsp; `293 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **37,848** &nbsp;&nbsp; folks: **7,165**  &nbsp;&nbsp; `1,595 stars this week`
...
1. [signalapp / Signal-Android](https://github.com/signalapp/Signal-Android)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,354** &nbsp;&nbsp; folks: **4,835**  &nbsp;&nbsp; `115 stars this week`

1. [airbnb / javascript](https://github.com/airbnb/javascript)
    - JavaScript Style Guide
    - language: **JavaScript** &nbsp;&nbsp; stars: **107,867** &nbsp;&nbsp; folks: **20,790**  &nbsp;&nbsp; `600 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **1,418** &nbsp;&nbsp; folks: **144**  &nbsp;&nbsp; `295 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **1,418** &nbsp;&nbsp; folks: **144**  &nbsp;&nbsp; `1,045 stars this month`
...
1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,810** &nbsp;&nbsp; folks: **625**  &nbsp;&nbsp; `4,187 stars this month`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,244** &nbsp;&nbsp; folks: **1,091**  &nbsp;&nbsp; `3,315 stars this month`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,544** &nbsp;&nbsp; folks: **2,267**  &nbsp;&nbsp; `954 stars this month`

1. [wg / wrk](https://github.com/wg/wrk)
    - Modern HTTP benchmarking tool
    - language: **C** &nbsp;&nbsp; stars: **28,823** &nbsp;&nbsp; folks: **2,355**  &nbsp;&nbsp; `978 stars this month`
