...
`更新时间：2024-06-22 11:15:27 +0800`

## 今日热门仓库

1. [omnivore-app / omnivore](https://github.com/omnivore-app/omnivore)
    - Omnivore is a complete, open source read-it-later solution for people who like reading.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,574** &nbsp;&nbsp; folks: **539**  &nbsp;&nbsp; `291 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop, and alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **67,068** &nbsp;&nbsp; folks: **7,405**  &nbsp;&nbsp; `258 stars today`
...
1. [tencentmusic / supersonic](https://github.com/tencentmusic/supersonic)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,136** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `141 stars today`
...
1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,111** &nbsp;&nbsp; folks: **1,750**  &nbsp;&nbsp; `6,608 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Get answers to your questions, whether they be online or in your own notes. Use online AI models (e.g gpt4) or private, local LLMs (e.g llama3). Self-host locally or use our cloud instance. Access from Obsidian, Emacs, Desktop app, Web or Whatsapp.
    - language: **Python** &nbsp;&nbsp; stars: **11,623** &nbsp;&nbsp; folks: **580**  &nbsp;&nbsp; `6,712 stars this month`

1. [coollabsio / coolify](https://github.com/coollabsio/coolify)
    - An open-source & self-hostable Heroku / Netlify / Vercel alternative.
    - language: **PHP** &nbsp;&nbsp; stars: **25,225** &nbsp;&nbsp; folks: **1,282**  &nbsp;&nbsp; `8,836 stars this month`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **276,237** &nbsp;&nbsp; folks: **25,990**  &nbsp;&nbsp; `13,067 stars this month`
...
1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **15,042** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `1,595 stars this month`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,631** &nbsp;&nbsp; folks: **4,210**  &nbsp;&nbsp; `4,253 stars this month`
...
1. [k2-fsa / sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,992** &nbsp;&nbsp; folks: **258**  &nbsp;&nbsp; `1,042 stars this month`
...
1. [Stability-AI / StableSwarmUI](https://github.com/Stability-AI/StableSwarmUI)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **3,835** &nbsp;&nbsp; folks: **320**  &nbsp;&nbsp; `1,235 stars this month`

1. [hudy9x / namviek](https://github.com/hudy9x/namviek)
    - The open-source project manager for tiny teams
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,712** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `1,298 stars this month`
