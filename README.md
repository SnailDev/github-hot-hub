...
`更新时间：2021-08-01 08:42:45 +0800`

## 今日热门仓库

1. [apple / swift-algorithms](https://github.com/apple/swift-algorithms)
    - Commonly used sequence and collection algorithms for Swift
    - language: **Swift** &nbsp;&nbsp; stars: **3,327** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `101 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **327,484** &nbsp;&nbsp; folks: **26,231**  &nbsp;&nbsp; `595 stars today`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,245** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `344 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **23,299** &nbsp;&nbsp; folks: **7,735**  &nbsp;&nbsp; `183 stars today`

1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **8,769** &nbsp;&nbsp; folks: **733**  &nbsp;&nbsp; `765 stars today`

1. [tailscale / tailscale](https://github.com/tailscale/tailscale)
    - The easiest, most secure way to use WireGuard and 2FA.
    - language: **Go** &nbsp;&nbsp; stars: **5,030** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `247 stars today`

1. [electron / electron](https://github.com/electron/electron)
    - Build cross-platform desktop apps with JavaScript, HTML, and CSS
    - language: **C++** &nbsp;&nbsp; stars: **94,941** &nbsp;&nbsp; folks: **12,535**  &nbsp;&nbsp; `324 stars today`
...
1. [jonathandata1 / pegasus_spyware](https://github.com/jonathandata1/pegasus_spyware)
    ...
    - language: **Smali** &nbsp;&nbsp; stars: **230** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `163 stars today`
...
1. [openai / triton](https://github.com/openai/triton)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,328** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `647 stars today`
...
1. [mschweiger / orbiter](https://github.com/mschweiger/orbiter)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **951** &nbsp;&nbsp; folks: **65**  &nbsp;&nbsp; `345 stars today`
...
1. [pittcsc / Summer2022-Internships](https://github.com/pittcsc/Summer2022-Internships)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,967** &nbsp;&nbsp; folks: **489**  &nbsp;&nbsp; `280 stars today`

1. [unoplatform / uno](https://github.com/unoplatform/uno)
    - Build Mobile, Desktop and WebAssembly apps with C# and XAML. Today. Open source and professionally supported.
    - language: **C#** &nbsp;&nbsp; stars: **5,219** &nbsp;&nbsp; folks: **431**  &nbsp;&nbsp; `170 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **197,904** &nbsp;&nbsp; folks: **43,525**  &nbsp;&nbsp; `281 stars today`
...
1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **8,769** &nbsp;&nbsp; folks: **733**  &nbsp;&nbsp; `1,392 stars this week`
...
1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **327,484** &nbsp;&nbsp; folks: **26,231**  &nbsp;&nbsp; `1,075 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **188,935** &nbsp;&nbsp; folks: **50,680**  &nbsp;&nbsp; `3,311 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **23,299** &nbsp;&nbsp; folks: **7,735**  &nbsp;&nbsp; `272 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,240** &nbsp;&nbsp; folks: **2,742**  &nbsp;&nbsp; `495 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **144,952** &nbsp;&nbsp; folks: **16,815**  &nbsp;&nbsp; `12,345 stars this month`
...
1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    ...
    - language: **C** &nbsp;&nbsp; stars: **22,215** &nbsp;&nbsp; folks: **1,672**  &nbsp;&nbsp; `3,601 stars this month`
...
1. [microsoft / vscode](https://github.com/microsoft/vscode)
    - Visual Studio Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **119,367** &nbsp;&nbsp; folks: **19,553**  &nbsp;&nbsp; `1,731 stars this month`
