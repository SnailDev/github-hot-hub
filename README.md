...
`更新时间：2022-07-09 15:12:47 +0800`

## 今日热门仓库

1. [Jarred-Sumner / bun](https://github.com/Jarred-Sumner/bun)
    - Incredibly fast JavaScript runtime, bundler, transpiler and package manager – all in one.
    - language: **Zig** &nbsp;&nbsp; stars: **17,503** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `2,713 stars today`
...
1. [massCodeIO / massCode](https://github.com/massCodeIO/massCode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,852** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `356 stars today`

1. [jinfagang / yolov7](https://github.com/jinfagang/yolov7)
    - 🔥🔥🔥🔥 YOLO with Transformers and Instance Segmentation, with TensorRT acceleration! 🔥🔥🔥
    - language: **Python** &nbsp;&nbsp; stars: **2,035** &nbsp;&nbsp; folks: **284**  &nbsp;&nbsp; `154 stars today`
...
1. [infracost / vscode-infracost](https://github.com/infracost/vscode-infracost)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,012** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `313 stars today`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **58,053** &nbsp;&nbsp; folks: **5,593**  &nbsp;&nbsp; `509 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **148,456** &nbsp;&nbsp; folks: **14,127**  &nbsp;&nbsp; `467 stars today`

1. [facebook / flipper](https://github.com/facebook/flipper)
    - A desktop debugging platform for mobile developers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,761** &nbsp;&nbsp; folks: **828**  &nbsp;&nbsp; `73 stars today`
...
1. [t3-oss / create-t3-app](https://github.com/t3-oss/create-t3-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,963** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `233 stars today`

1. [robmarkcole / satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning)
    - Resources for deep learning with satellite & aerial imagery
    - language: **无** &nbsp;&nbsp; stars: **3,692** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `83 stars today`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **22,904** &nbsp;&nbsp; folks: **3,334**  &nbsp;&nbsp; `246 stars today`
...
1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,582** &nbsp;&nbsp; folks: **10,013**  &nbsp;&nbsp; `278 stars today`

1. [secretflow / secretflow](https://github.com/secretflow/secretflow)
    - A unified framework for privacy-preserving data analysis and machine learning
    - language: **Python** &nbsp;&nbsp; stars: **541** &nbsp;&nbsp; folks: **62**  &nbsp;&nbsp; `78 stars today`
...
1. [ultralytics / yolov5](https://github.com/ultralytics/yolov5)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,531** &nbsp;&nbsp; folks: **10,106**  &nbsp;&nbsp; `125 stars today`

1. [aquasecurity / chain-bench](https://github.com/aquasecurity/chain-bench)
    - An open-source tool for auditing your software supply chain stack for security compliance based on a new CIS Software Supply Chain benchmark.
    - language: **Go** &nbsp;&nbsp; stars: **371** &nbsp;&nbsp; folks: **33**  &nbsp;&nbsp; `64 stars today`
...
1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **22,904** &nbsp;&nbsp; folks: **3,334**  &nbsp;&nbsp; `765 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **208,348** &nbsp;&nbsp; folks: **23,734**  &nbsp;&nbsp; `1,395 stars this week`
...
1. [ultralytics / yolov5](https://github.com/ultralytics/yolov5)
    - YOLOv5 🚀 in PyTorch > ONNX > CoreML > TFLite
    - language: **Python** &nbsp;&nbsp; stars: **28,531** &nbsp;&nbsp; folks: **10,106**  &nbsp;&nbsp; `475 stars this week`
...
1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **58,053** &nbsp;&nbsp; folks: **5,593**  &nbsp;&nbsp; `3,891 stars this week`
...
1. [borisdayma / dalle-mini](https://github.com/borisdayma/dalle-mini)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,354** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `7,456 stars this month`
...
1. [saharmor / dalle-playground](https://github.com/saharmor/dalle-playground)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,163** &nbsp;&nbsp; folks: **462**  &nbsp;&nbsp; `1,590 stars this month`
...
1. [digitalocean / nginxconfig.io](https://github.com/digitalocean/nginxconfig.io)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,039** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `3,260 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **98,751** &nbsp;&nbsp; folks: **10,372**  &nbsp;&nbsp; `2,555 stars this month`
...
1. [BuilderIO / qwik](https://github.com/BuilderIO/qwik)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,640** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `1,057 stars this month`
