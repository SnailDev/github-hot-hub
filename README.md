...
1. [kabinspace / AstroVim](https://github.com/kabinspace/AstroVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **800** &nbsp;&nbsp; folks: **33**  &nbsp;&nbsp; `288 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **80,410** &nbsp;&nbsp; folks: **7,178**  &nbsp;&nbsp; `191 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **134,187** &nbsp;&nbsp; folks: **22,073**  &nbsp;&nbsp; `137 stars today`

1. [ethereum / EIPs](https://github.com/ethereum/EIPs)
    - The Ethereum Improvement Proposal repository
    - language: **Solidity** &nbsp;&nbsp; stars: **8,902** &nbsp;&nbsp; folks: **3,226**  &nbsp;&nbsp; `54 stars today`

1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **30,896** &nbsp;&nbsp; folks: **2,308**  &nbsp;&nbsp; `167 stars today`

1. [Kindelia / HVM](https://github.com/Kindelia/HVM)
    - A massively parallel, optimal functional runtime in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **2,957** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `486 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **135,418** &nbsp;&nbsp; folks: **20,503**  &nbsp;&nbsp; `177 stars today`
...
1. [imDazui / Tvlist-awesome-m3u-m3u8](https://github.com/imDazui/Tvlist-awesome-m3u-m3u8)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,114** &nbsp;&nbsp; folks: **1,066**  &nbsp;&nbsp; `140 stars today`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **68,281** &nbsp;&nbsp; folks: **3,836**  &nbsp;&nbsp; `215 stars today`
...
1. [serverless-stack / serverless-stack](https://github.com/serverless-stack/serverless-stack)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,894** &nbsp;&nbsp; folks: **327**  &nbsp;&nbsp; `73 stars today`
...
1. [tobspr / shapez.io](https://github.com/tobspr/shapez.io)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,685** &nbsp;&nbsp; folks: **952**  &nbsp;&nbsp; `104 stars today`

1. [danielkrupinski / Osiris](https://github.com/danielkrupinski/Osiris)
    - Free open-source game cheat for Counter-Strike: Global Offensive, written in modern C++. GUI powered by Dear ImGui.
    - language: **C++** &nbsp;&nbsp; stars: **1,964** &nbsp;&nbsp; folks: **773**  &nbsp;&nbsp; `40 stars today`
...
1. [cwackerfuss / react-wordle](https://github.com/cwackerfuss/react-wordle)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,226** &nbsp;&nbsp; folks: **724**  &nbsp;&nbsp; `552 stars this week`

1. [psf / black](https://github.com/psf/black)
    - The uncompromising Python code formatter
    - language: **Python** &nbsp;&nbsp; stars: **25,229** &nbsp;&nbsp; folks: **1,600**  &nbsp;&nbsp; `628 stars this week`

1. [nextui-org / nextui](https://github.com/nextui-org/nextui)
    - 🚀 Beautiful, fast and modern React UI library.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,568** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `1,086 stars this week`
...
1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Budibase is an open-source low-code platform for creating internal apps in minutes. Supports PostgreSQL, MySQL, MSSQL, MongoDB, Rest API, Docker, K8s 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,879** &nbsp;&nbsp; folks: **511**  &nbsp;&nbsp; `1,161 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **207,085** &nbsp;&nbsp; folks: **55,845**  &nbsp;&nbsp; `1,741 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,215** &nbsp;&nbsp; folks: **784**  &nbsp;&nbsp; `179 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,989** &nbsp;&nbsp; folks: **4,759**  &nbsp;&nbsp; `701 stars this week`
...
1. [facebookresearch / mae](https://github.com/facebookresearch/mae)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,567** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `2,398 stars this month`

1. [wmjordan / PDFPatcher](https://github.com/wmjordan/PDFPatcher)
    - PDF补丁丁——PDF工具箱，可以编辑书签、剪裁旋转页面、解除限制、提取或合并文档，探查文档结构，提取图片、转成图片等等
    - language: **C#** &nbsp;&nbsp; stars: **3,638** &nbsp;&nbsp; folks: **679**  &nbsp;&nbsp; `2,348 stars this month`
...
1. [Textualize / textual](https://github.com/Textualize/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **7,983** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `1,176 stars this month`
...
1. [octocat / Spoon-Knife](https://github.com/octocat/Spoon-Knife)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **10,754** &nbsp;&nbsp; folks: **122,824**  &nbsp;&nbsp; `113 stars this month`
