...
`更新时间：2021-05-01 03:15:22 +0800`

## 今日热门仓库

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,193** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `270 stars today`

1. [livewire / livewire](https://github.com/livewire/livewire)
    - A full-stack framework for Laravel that takes the pain out of building dynamic UIs.
    - language: **Blade** &nbsp;&nbsp; stars: **11,044** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `26 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,962** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `678 stars today`

1. [UnityTechnologies / open-project-1](https://github.com/UnityTechnologies/open-project-1)
    - Unity Open Project #1: Chop Chop
    - language: **C#** &nbsp;&nbsp; stars: **3,513** &nbsp;&nbsp; folks: **1,217**  &nbsp;&nbsp; `156 stars today`

1. [flashlight / flashlight](https://github.com/flashlight/flashlight)
    - A C++ standalone library for machine learning
    - language: **C++** &nbsp;&nbsp; stars: **3,197** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `79 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,304** &nbsp;&nbsp; folks: **29,519**  &nbsp;&nbsp; `468 stars today`

1. [dani-garcia / vaultwarden](https://github.com/dani-garcia/vaultwarden)
    - Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs
    - language: **Rust** &nbsp;&nbsp; stars: **8,594** &nbsp;&nbsp; folks: **502**  &nbsp;&nbsp; `76 stars today`

1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    - Magnificent app which corrects your previous console command.
    - language: **Python** &nbsp;&nbsp; stars: **60,342** &nbsp;&nbsp; folks: **2,856**  &nbsp;&nbsp; `69 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,638** &nbsp;&nbsp; folks: **17,477**  &nbsp;&nbsp; `372 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **3,512** &nbsp;&nbsp; folks: **851**  &nbsp;&nbsp; `307 stars today`

1. [mlflow / mlflow](https://github.com/mlflow/mlflow)
    - Open source platform for the machine learning lifecycle
    - language: **Python** &nbsp;&nbsp; stars: **9,181** &nbsp;&nbsp; folks: **2,003**  &nbsp;&nbsp; `49 stars today`
...
1. [tensorflow / tensorboard](https://github.com/tensorflow/tensorboard)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,429** &nbsp;&nbsp; folks: **1,394**  &nbsp;&nbsp; `10 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **23,447** &nbsp;&nbsp; folks: **4,941**  &nbsp;&nbsp; `22 stars today`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,513** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `191 stars today`

1. [storj / drpc](https://github.com/storj/drpc)
    - drpc is a lightweight, drop-in replacement for gRPC
    - language: **Go** &nbsp;&nbsp; stars: **527** &nbsp;&nbsp; folks: **10**  &nbsp;&nbsp; `66 stars today`
...
1. [huggingface / datasets](https://github.com/huggingface/datasets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,537** &nbsp;&nbsp; folks: **873**  &nbsp;&nbsp; `11 stars today`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,513** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `1,243 stars this week`
...
1. [RH12503 / triangula](https://github.com/RH12503/triangula)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,708** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `1,906 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,304** &nbsp;&nbsp; folks: **29,519**  &nbsp;&nbsp; `2,790 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **186,013** &nbsp;&nbsp; folks: **41,884**  &nbsp;&nbsp; `2,668 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,193** &nbsp;&nbsp; folks: **576**  &nbsp;&nbsp; `830 stars this week`

1. [Alamofire / Alamofire](https://github.com/Alamofire/Alamofire)
    - Elegant HTTP Networking in Swift
    - language: **Swift** &nbsp;&nbsp; stars: **35,645** &nbsp;&nbsp; folks: **6,669**  &nbsp;&nbsp; `97 stars this week`
...
1. [ericaltendorf / plotman](https://github.com/ericaltendorf/plotman)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **279** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `109 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,738** &nbsp;&nbsp; folks: **8,065**  &nbsp;&nbsp; `1,150 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **157,531** &nbsp;&nbsp; folks: **22,846**  &nbsp;&nbsp; `2,408 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,304** &nbsp;&nbsp; folks: **29,519**  &nbsp;&nbsp; `4,105 stars this month`
...
1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,410** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `840 stars this month`
