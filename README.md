...
`更新时间：2024-12-11 15:14:49 +0800`

## 今日热门仓库

1. [soxoj / maigret](https://github.com/soxoj/maigret)
    - 🕵️‍♂️ Collect a dossier on a person by username from thousands of sites
    - language: **Python** &nbsp;&nbsp; stars: **12,042** &nbsp;&nbsp; folks: **869**  &nbsp;&nbsp; `79 stars today`

1. [astral-sh / uv](https://github.com/astral-sh/uv)
    - An extremely fast Python package and project manager, written in Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **31,459** &nbsp;&nbsp; folks: **852**  &nbsp;&nbsp; `1,728 stars today`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, Mistral, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **102,181** &nbsp;&nbsp; folks: **8,151**  &nbsp;&nbsp; `335 stars today`

1. [Alamofire / Alamofire](https://github.com/Alamofire/Alamofire)
    - Elegant HTTP Networking in Swift
    - language: **Swift** &nbsp;&nbsp; stars: **41,365** &nbsp;&nbsp; folks: **7,564**  &nbsp;&nbsp; `9 stars today`

1. [al1abb / invoify](https://github.com/al1abb/invoify)
    - An invoice generator app built using Next.js, Typescript, and Shadcn
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,444** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `353 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop and mobile applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **86,760** &nbsp;&nbsp; folks: **2,628**  &nbsp;&nbsp; `112 stars today`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **80,491** &nbsp;&nbsp; folks: **36,532**  &nbsp;&nbsp; `125 stars today`

1. [leerob / next-saas-starter](https://github.com/leerob/next-saas-starter)
    - Get started quickly with Next.js, Postgres, Stripe, and shadcn/ui.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,096** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `47 stars today`
...
1. [pydantic / pydantic-ai](https://github.com/pydantic/pydantic-ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,471** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `2,472 stars this week`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **26,239** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `2,521 stars this week`

1. [fishaudio / fish-speech](https://github.com/fishaudio/fish-speech)
    - SOTA Open Source TTS
    - language: **Python** &nbsp;&nbsp; stars: **16,666** &nbsp;&nbsp; folks: **1,255**  &nbsp;&nbsp; `1,783 stars this week`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **48,643** &nbsp;&nbsp; folks: **10,554**  &nbsp;&nbsp; `1,944 stars this week`

1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **6,016** &nbsp;&nbsp; folks: **1,081**  &nbsp;&nbsp; `1,405 stars this week`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **102,954** &nbsp;&nbsp; folks: **12,908**  &nbsp;&nbsp; `1,477 stars this week`
...
1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    ...
    - language: **Svelte** &nbsp;&nbsp; stars: **19,197** &nbsp;&nbsp; folks: **1,551**  &nbsp;&nbsp; `1,465 stars this week`

1. [calcom / cal.com](https://github.com/calcom/cal.com)
    - Scheduling infrastructure for absolutely everyone.
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,872** &nbsp;&nbsp; folks: **8,189**  &nbsp;&nbsp; `187 stars this week`
...
1. [0voice / expert_readed_books](https://github.com/0voice/expert_readed_books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,966** &nbsp;&nbsp; folks: **2,757**  &nbsp;&nbsp; `311 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,720** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `933 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,720** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `3,122 stars this month`

1. [dockur / macos](https://github.com/dockur/macos)
    - OSX (macOS) inside a Docker container.
    - language: **Python** &nbsp;&nbsp; stars: **9,511** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `8,493 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **20,938** &nbsp;&nbsp; folks: **1,484**  &nbsp;&nbsp; `7,181 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **65,252** &nbsp;&nbsp; folks: **7,943**  &nbsp;&nbsp; `6,178 stars this month`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **32,134** &nbsp;&nbsp; folks: **6,473**  &nbsp;&nbsp; `3,405 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **102,954** &nbsp;&nbsp; folks: **12,908**  &nbsp;&nbsp; `5,035 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,622** &nbsp;&nbsp; folks: **1,839**  &nbsp;&nbsp; `4,299 stars this month`

1. [microsoft / autogen](https://github.com/microsoft/autogen)
    - A programming framework for agentic AI 🤖 (PyPi: autogen-agentchat)
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,691** &nbsp;&nbsp; folks: **5,158**  &nbsp;&nbsp; `2,647 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **30,733** &nbsp;&nbsp; folks: **2,089**  &nbsp;&nbsp; `10,624 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,409** &nbsp;&nbsp; folks: **1,818**  &nbsp;&nbsp; `3,528 stars this month`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **21,616** &nbsp;&nbsp; folks: **4,170**  &nbsp;&nbsp; `1,880 stars this month`
