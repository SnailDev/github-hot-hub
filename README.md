...
1. [curated-intel / Ukraine-Cyber-Operations](https://github.com/curated-intel/Ukraine-Cyber-Operations)
    ...
    - language: **YARA** &nbsp;&nbsp; stars: **504** &nbsp;&nbsp; folks: **43**  &nbsp;&nbsp; `120 stars today`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,211** &nbsp;&nbsp; folks: **2,926**  &nbsp;&nbsp; `7,174 stars this week`

1. [MHProDev / MHDDoS](https://github.com/MHProDev/MHDDoS)
    - Best DDoS Attack Script Python3, Cyber Attack With 40 Methods
    - language: **Python** &nbsp;&nbsp; stars: **2,098** &nbsp;&nbsp; folks: **517**  &nbsp;&nbsp; `1,251 stars this week`

1. [QMHTMY / RustBook](https://github.com/QMHTMY/RustBook)
    - A book about Rust Data Structures and Algorithms.
    - language: **Rust** &nbsp;&nbsp; stars: **1,218** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `885 stars this week`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **61,276** &nbsp;&nbsp; folks: **16,689**  &nbsp;&nbsp; `505 stars this week`
...
1. [jakevdp / PythonDataScienceHandbook](https://github.com/jakevdp/PythonDataScienceHandbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **33,296** &nbsp;&nbsp; folks: **14,909**  &nbsp;&nbsp; `307 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    ...
    - language: **C** &nbsp;&nbsp; stars: **58,281** &nbsp;&nbsp; folks: **5,205**  &nbsp;&nbsp; `455 stars this week`

1. [alibaba / lowcode-engine](https://github.com/alibaba/lowcode-engine)
    - 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,456** &nbsp;&nbsp; folks: **170**  &nbsp;&nbsp; `604 stars this week`
...
1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **109,342** &nbsp;&nbsp; folks: **15,041**  &nbsp;&nbsp; `800 stars this week`
...
1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    ...
    - language: **无** &nbsp;&nbsp; stars: **133,613** &nbsp;&nbsp; folks: **12,616**  &nbsp;&nbsp; `1,159 stars this week`
...
1. [fatedier / frp](https://github.com/fatedier/frp)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **53,784** &nbsp;&nbsp; folks: **9,795**  &nbsp;&nbsp; `246 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,041** &nbsp;&nbsp; folks: **908**  &nbsp;&nbsp; `1,974 stars this month`

1. [medusajs / medusa](https://github.com/medusajs/medusa)
    - The open-source Shopify alternative ⚡️
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,139** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `2,853 stars this month`

1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,595** &nbsp;&nbsp; folks: **3,218**  &nbsp;&nbsp; `4,425 stars this month`

1. [ThioJoe / YT-Spammer-Purge](https://github.com/ThioJoe/YT-Spammer-Purge)
    - Allows you easily scan for and delete scam comments using several methods.
    - language: **Python** &nbsp;&nbsp; stars: **3,219** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `1,064 stars this month`
...
1. [Jxck-S / plane-notify](https://github.com/Jxck-S/plane-notify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,542** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `656 stars this month`
...
1. [chiru-labs / ERC721A](https://github.com/chiru-labs/ERC721A)
    - https://ERC721A.org
    - language: **Solidity** &nbsp;&nbsp; stars: **853** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `405 stars this month`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **211,027** &nbsp;&nbsp; folks: **57,228**  &nbsp;&nbsp; `5,585 stars this month`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,515** &nbsp;&nbsp; folks: **517**  &nbsp;&nbsp; `1,619 stars this month`

1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test LinkedIn test questions and answers
    - language: **无** &nbsp;&nbsp; stars: **10,233** &nbsp;&nbsp; folks: **6,216**  &nbsp;&nbsp; `1,263 stars this month`
...
1. [YunaiV / ruoyi-vue-pro](https://github.com/YunaiV/ruoyi-vue-pro)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,148** &nbsp;&nbsp; folks: **1,076**  &nbsp;&nbsp; `820 stars this month`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,523** &nbsp;&nbsp; folks: **4,707**  &nbsp;&nbsp; `2,059 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **137,007** &nbsp;&nbsp; folks: **20,914**  &nbsp;&nbsp; `2,513 stars this month`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **61,276** &nbsp;&nbsp; folks: **16,689**  &nbsp;&nbsp; `1,691 stars this month`
...
1. [mastodon / mastodon](https://github.com/mastodon/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **26,843** &nbsp;&nbsp; folks: **4,360**  &nbsp;&nbsp; `489 stars this month`
