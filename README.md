...
`更新时间：2022-12-22 01:10:39 +0800`

## 今日热门仓库

1. [pocketbase / pocketbase](https://github.com/pocketbase/pocketbase)
    - Open Source realtime backend in 1 file
    - language: **Go** &nbsp;&nbsp; stars: **17,790** &nbsp;&nbsp; folks: **654**  &nbsp;&nbsp; `159 stars today`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》一本动画图解、能运行、可提问的数据结构与算法入门书
    - language: **Java** &nbsp;&nbsp; stars: **2,904** &nbsp;&nbsp; folks: **337**  &nbsp;&nbsp; `390 stars today`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **2,457** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `625 stars today`

1. [nvim-lua / kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim)
    - A launch point for your personal nvim configuration
    - language: **Lua** &nbsp;&nbsp; stars: **1,829** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `260 stars today`
...
1. [score-spec / spec](https://github.com/score-spec/spec)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,781** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `381 stars today`
...
1. [jassics / security-study-plan](https://github.com/jassics/security-study-plan)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,838** &nbsp;&nbsp; folks: **214**  &nbsp;&nbsp; `274 stars today`
...
1. [facebook / zstd](https://github.com/facebook/zstd)
    ...
    - language: **C** &nbsp;&nbsp; stars: **19,067** &nbsp;&nbsp; folks: **1,811**  &nbsp;&nbsp; `182 stars today`
...
1. [H4de5-7 / powershell-obfuscation](https://github.com/H4de5-7/powershell-obfuscation)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **226** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `77 stars today`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》一本动画图解、能运行、可提问的数据结构与算法入门书
    - language: **Java** &nbsp;&nbsp; stars: **2,904** &nbsp;&nbsp; folks: **337**  &nbsp;&nbsp; `1,817 stars this week`
...
1. [nvim-lua / kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim)
    - A launch point for your personal nvim configuration
    - language: **Lua** &nbsp;&nbsp; stars: **1,829** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `1,061 stars this week`
...
1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **23,641** &nbsp;&nbsp; folks: **3,230**  &nbsp;&nbsp; `9,206 stars this month`

1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **4,309** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `3,101 stars this month`

1. [filipedeschamps / tabnews.com.br](https://github.com/filipedeschamps/tabnews.com.br)
    - Conteúdos para quem trabalha com Programação e Tecnologia.
    - language: **HTML** &nbsp;&nbsp; stars: **2,916** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `2,917 stars this month`

1. [gbj / leptos](https://github.com/gbj/leptos)
    - Build fast web applications with Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **3,622** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `2,521 stars this month`
...
1. [invoke-ai / InvokeAI](https://github.com/invoke-ai/InvokeAI)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,657** &nbsp;&nbsp; folks: **979**  &nbsp;&nbsp; `3,219 stars this month`
...
1. [openai / openai-python](https://github.com/openai/openai-python)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,523** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `638 stars this month`
...
1. [musescore / MuseScore](https://github.com/musescore/MuseScore)
    - MuseScore is an open source and free music notation software. For support, contribution, bug reports, visit MuseScore.org. Fork and make pull requests!
    - language: **C++** &nbsp;&nbsp; stars: **8,458** &nbsp;&nbsp; folks: **2,038**  &nbsp;&nbsp; `771 stars this month`

1. [louislam / uptime-kuma](https://github.com/louislam/uptime-kuma)
    - A fancy self-hosted monitoring tool
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,220** &nbsp;&nbsp; folks: **2,173**  &nbsp;&nbsp; `2,878 stars this month`
...
1. [kubeshark / kubeshark](https://github.com/kubeshark/kubeshark)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,545** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `3,340 stars this month`
...
1. [nektos / act](https://github.com/nektos/act)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **33,214** &nbsp;&nbsp; folks: **834**  &nbsp;&nbsp; `3,709 stars this month`
...
1. [sveltejs / kit](https://github.com/sveltejs/kit)
    - web development, streamlined
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,100** &nbsp;&nbsp; folks: **1,099**  &nbsp;&nbsp; `923 stars this month`

1. [Aircoookie / WLED](https://github.com/Aircoookie/WLED)
    - Control WS2812B and many more types of digital RGB LEDs with an ESP8266 or ESP32 over WiFi!
    - language: **C++** &nbsp;&nbsp; stars: **10,315** &nbsp;&nbsp; folks: **2,074**  &nbsp;&nbsp; `421 stars this month`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **19,540** &nbsp;&nbsp; folks: **3,531**  &nbsp;&nbsp; `1,449 stars this month`

1. [sundowndev / phoneinfoga](https://github.com/sundowndev/phoneinfoga)
    - Information gathering framework for phone numbers
    - language: **Go** &nbsp;&nbsp; stars: **8,330** &nbsp;&nbsp; folks: **2,437**  &nbsp;&nbsp; `347 stars this month`

1. [carson-katri / dream-textures](https://github.com/carson-katri/dream-textures)
    - Stable Diffusion built-in to the Blender shader editor
    - language: **Python** &nbsp;&nbsp; stars: **4,905** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `1,422 stars this month`
