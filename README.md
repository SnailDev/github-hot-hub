...
`更新时间：2022-09-26 21:49:23 +0800`

## 今日热门仓库

1. [jzimmerman / langcc](https://github.com/jzimmerman/langcc)
    - langcc: A Next-Generation Compiler Compiler
    - language: **无** &nbsp;&nbsp; stars: **944** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `173 stars today`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **66,309** &nbsp;&nbsp; folks: **17,639**  &nbsp;&nbsp; `126 stars today`
...
1. [AppFlowy-IO / AppFlowy](https://github.com/AppFlowy-IO/AppFlowy)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **27,471** &nbsp;&nbsp; folks: **1,489**  &nbsp;&nbsp; `52 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **353,978** &nbsp;&nbsp; folks: **29,546**  &nbsp;&nbsp; `116 stars today`

1. [trimstray / the-book-of-secret-knowledge](https://github.com/trimstray/the-book-of-secret-knowledge)
    - A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more.
    - language: **无** &nbsp;&nbsp; stars: **78,631** &nbsp;&nbsp; folks: **6,361**  &nbsp;&nbsp; `352 stars today`
...
1. [octocat / Spoon-Knife](https://github.com/octocat/Spoon-Knife)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **11,284** &nbsp;&nbsp; folks: **129,686**  &nbsp;&nbsp; `18 stars today`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **42,137** &nbsp;&nbsp; folks: **8,398**  &nbsp;&nbsp; `36 stars today`

1. [LSPosed / MagiskOnWSALocal](https://github.com/LSPosed/MagiskOnWSALocal)
    - 无
    - language: **Shell** &nbsp;&nbsp; stars: **1,664** &nbsp;&nbsp; folks: **4,403**  &nbsp;&nbsp; `37 stars today`

1. [yewstack / yew](https://github.com/yewstack/yew)
    - Rust / Wasm framework for building client web apps
    - language: **Rust** &nbsp;&nbsp; stars: **23,821** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `35 stars today`
...
1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **125,411** &nbsp;&nbsp; folks: **46,992**  &nbsp;&nbsp; `82 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **17,817** &nbsp;&nbsp; folks: **3,732**  &nbsp;&nbsp; `137 stars today`
...
1. [steven-tey / dub](https://github.com/steven-tey/dub)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,020** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `429 stars today`
...
1. [termux / termux-app](https://github.com/termux/termux-app)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **15,982** &nbsp;&nbsp; folks: **2,025**  &nbsp;&nbsp; `31 stars today`

1. [dragonflydb / dragonfly](https://github.com/dragonflydb/dragonfly)
    - A modern replacement for Redis and Memcached
    - language: **C++** &nbsp;&nbsp; stars: **12,364** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `66 stars today`
...
1. [Launch-X-Latam / OnBoarding](https://github.com/Launch-X-Latam/OnBoarding)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **307** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `37 stars today`
...
1. [hsutter / cppfront](https://github.com/hsutter/cppfront)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,911** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `1,037 stars this week`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **66,309** &nbsp;&nbsp; folks: **17,639**  &nbsp;&nbsp; `635 stars this week`

1. [bytecodealliance / wasmtime](https://github.com/bytecodealliance/wasmtime)
    - A fast and secure runtime for WebAssembly
    - language: **Rust** &nbsp;&nbsp; stars: **9,682** &nbsp;&nbsp; folks: **801**  &nbsp;&nbsp; `1,269 stars this week`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    - Implementation of Dreambooth (https://arxiv.org/abs/2208.12242) with Stable Diffusion
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **956** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `514 stars this week`

1. [TheAlgorithms / JavaScript](https://github.com/TheAlgorithms/JavaScript)
    - Algorithms and Data Structures implemented in JavaScript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,781** &nbsp;&nbsp; folks: **3,913**  &nbsp;&nbsp; `682 stars this week`

1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    - Stable Diffusion web UI
    - language: **Python** &nbsp;&nbsp; stars: **4,539** &nbsp;&nbsp; folks: **525**  &nbsp;&nbsp; `1,096 stars this week`
...
1. [apache / arrow](https://github.com/apache/arrow)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,347** &nbsp;&nbsp; folks: **2,543**  &nbsp;&nbsp; `192 stars this week`
...
1. [AykutSarac / jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,255** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `2,491 stars this week`

1. [milvus-io / milvus](https://github.com/milvus-io/milvus)
    - Vector database for scalable similarity search and AI applications.
    - language: **Go** &nbsp;&nbsp; stars: **13,678** &nbsp;&nbsp; folks: **1,832**  &nbsp;&nbsp; `986 stars this week`
...
1. [AykutSarac / jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com)
    - 🔮 Seamlessly visualize your JSON data instantly into graphs; paste, import or fetch!
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,255** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `10,198 stars this month`
...
1. [total-typescript / beginners-typescript-tutorial](https://github.com/total-typescript/beginners-typescript-tutorial)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,423** &nbsp;&nbsp; folks: **542**  &nbsp;&nbsp; `4,617 stars this month`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **18,088** &nbsp;&nbsp; folks: **2,792**  &nbsp;&nbsp; `1,188 stars this month`
