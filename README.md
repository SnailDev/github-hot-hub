...
1. [activeloopai / Hub](https://github.com/activeloopai/Hub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,297** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `164 stars today`

1. [open-guides / og-aws](https://github.com/open-guides/og-aws)
    - 📙 Amazon Web Services — a practical guide
    - language: **Shell** &nbsp;&nbsp; stars: **28,756** &nbsp;&nbsp; folks: **2,925**  &nbsp;&nbsp; `137 stars today`
...
1. [aaronwangy / Data-Science-Cheatsheet](https://github.com/aaronwangy/Data-Science-Cheatsheet)
    ...
    - language: **TeX** &nbsp;&nbsp; stars: **897** &nbsp;&nbsp; folks: **81**  &nbsp;&nbsp; `175 stars today`
...
1. [huiyadanli / RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,800** &nbsp;&nbsp; folks: **1,025**  &nbsp;&nbsp; `32 stars today`
...
1. [conwnet / github1s](https://github.com/conwnet/github1s)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,236** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `5,744 stars this week`
...
1. [JonnyBurger / remotion](https://github.com/JonnyBurger/remotion)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,625** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `1,761 stars this week`
...
1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **22,521** &nbsp;&nbsp; folks: **654**  &nbsp;&nbsp; `1,384 stars this week`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,689** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `881 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **35,358** &nbsp;&nbsp; folks: **6,879**  &nbsp;&nbsp; `3,284 stars this month`
...
1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,492** &nbsp;&nbsp; folks: **610**  &nbsp;&nbsp; `1,871 stars this month`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle （practical ultra lightweight OCR system, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices）
    - language: **Python** &nbsp;&nbsp; stars: **10,898** &nbsp;&nbsp; folks: **2,090**  &nbsp;&nbsp; `2,538 stars this month`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **6,091** &nbsp;&nbsp; folks: **1,543**  &nbsp;&nbsp; `1,148 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,397** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `2,843 stars this month`
...
1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,828** &nbsp;&nbsp; folks: **1,329**  &nbsp;&nbsp; `362 stars this month`
...
1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,200** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `811 stars this month`
...
1. [justauth / JustAuth](https://github.com/justauth/JustAuth)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **10,604** &nbsp;&nbsp; folks: **1,866**  &nbsp;&nbsp; `797 stars this month`

1. [micropython / micropython](https://github.com/micropython/micropython)
    - MicroPython - a lean and efficient Python implementation for microcontrollers and constrained systems
    - language: **C** &nbsp;&nbsp; stars: **12,037** &nbsp;&nbsp; folks: **4,101**  &nbsp;&nbsp; `375 stars this month`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,966** &nbsp;&nbsp; folks: **2,288**  &nbsp;&nbsp; `1,502 stars this month`

1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    - RandomX, CryptoNight, AstroBWT and Argon2 CPU/GPU miner
    - language: **C++** &nbsp;&nbsp; stars: **3,818** &nbsp;&nbsp; folks: **1,776**  &nbsp;&nbsp; `242 stars this month`
