...
1. [SheetJS / sheetjs](https://github.com/SheetJS/sheetjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,873** &nbsp;&nbsp; folks: **6,915**  &nbsp;&nbsp; `228 stars today`
...
1. [OAI / OpenAPI-Specification](https://github.com/OAI/OpenAPI-Specification)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,611** &nbsp;&nbsp; folks: **7,648**  &nbsp;&nbsp; `83 stars today`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,238** &nbsp;&nbsp; folks: **3,669**  &nbsp;&nbsp; `814 stars today`

1. [apache / apisix](https://github.com/apache/apisix)
    - The Cloud-Native API Gateway
    - language: **Lua** &nbsp;&nbsp; stars: **5,977** &nbsp;&nbsp; folks: **1,150**  &nbsp;&nbsp; `129 stars today`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,570** &nbsp;&nbsp; folks: **5,275**  &nbsp;&nbsp; `235 stars today`
...
1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,433** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `418 stars today`
...
1. [alyssaxuu / mapus](https://github.com/alyssaxuu/mapus)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,308** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `686 stars today`
...
1. [Apress / Ray-Tracing-Gems-II](https://github.com/Apress/Ray-Tracing-Gems-II)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **318** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `177 stars today`
...
1. [chuzhixin / vue-admin-beautiful-pro](https://github.com/chuzhixin/vue-admin-beautiful-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,865** &nbsp;&nbsp; folks: **2,253**  &nbsp;&nbsp; `112 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **58,126** &nbsp;&nbsp; folks: **3,172**  &nbsp;&nbsp; `297 stars today`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **14,596** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `597 stars today`
...
1. [actions / virtual-environments](https://github.com/actions/virtual-environments)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **3,767** &nbsp;&nbsp; folks: **1,369**  &nbsp;&nbsp; `58 stars today`
...
1. [metersphere / metersphere](https://github.com/metersphere/metersphere)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,147** &nbsp;&nbsp; folks: **1,186**  &nbsp;&nbsp; `59 stars today`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,890** &nbsp;&nbsp; folks: **4,178**  &nbsp;&nbsp; `212 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **27,612** &nbsp;&nbsp; folks: **5,336**  &nbsp;&nbsp; `766 stars today`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,141** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,191 stars this week`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **27,612** &nbsp;&nbsp; folks: **5,336**  &nbsp;&nbsp; `1,540 stars this week`
...
1. [openai / triton](https://github.com/openai/triton)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,836** &nbsp;&nbsp; folks: **202**  &nbsp;&nbsp; `1,027 stars this week`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,570** &nbsp;&nbsp; folks: **5,275**  &nbsp;&nbsp; `562 stars this week`
...
1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **14,596** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `1,932 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,238** &nbsp;&nbsp; folks: **3,669**  &nbsp;&nbsp; `10,433 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,141** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,508 stars this month`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **7,987** &nbsp;&nbsp; folks: **1,873**  &nbsp;&nbsp; `3,051 stars this month`
...
1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    ...
    - language: **C** &nbsp;&nbsp; stars: **22,578** &nbsp;&nbsp; folks: **1,683**  &nbsp;&nbsp; `3,858 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,881** &nbsp;&nbsp; folks: **4,465**  &nbsp;&nbsp; `3,600 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,570** &nbsp;&nbsp; folks: **5,275**  &nbsp;&nbsp; `836 stars this month`
...
1. [outline / outline](https://github.com/outline/outline)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,268** &nbsp;&nbsp; folks: **929**  &nbsp;&nbsp; `451 stars this month`
