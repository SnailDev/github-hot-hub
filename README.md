...
1. [bytedance / btrace](https://github.com/bytedance/btrace)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **637** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `57 stars today`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **20,655** &nbsp;&nbsp; folks: **5,285**  &nbsp;&nbsp; `92 stars today`
...
1. [google / gvisor](https://github.com/google/gvisor)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **12,185** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `84 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native applications using React
    - language: **JavaScript** &nbsp;&nbsp; stars: **100,188** &nbsp;&nbsp; folks: **21,590**  &nbsp;&nbsp; `56 stars today`

1. [hibiken / asynq](https://github.com/hibiken/asynq)
    - Asynq: simple, reliable, and efficient distributed task queue in Go
    - language: **Go** &nbsp;&nbsp; stars: **2,160** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `101 stars today`
...
1. [skyline-emu / skyline](https://github.com/skyline-emu/skyline)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,479** &nbsp;&nbsp; folks: **472**  &nbsp;&nbsp; `75 stars today`
...
1. [norvig / pytudes](https://github.com/norvig/pytudes)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,852** &nbsp;&nbsp; folks: **2,091**  &nbsp;&nbsp; `632 stars this week`
...
1. [codenotary / immudb](https://github.com/codenotary/immudb)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,427** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `1,192 stars this week`
...
1. [openai / glide-text2im](https://github.com/openai/glide-text2im)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,239** &nbsp;&nbsp; folks: **106**  &nbsp;&nbsp; `481 stars this week`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **11,325** &nbsp;&nbsp; folks: **2,520**  &nbsp;&nbsp; `391 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **90,507** &nbsp;&nbsp; folks: **9,565**  &nbsp;&nbsp; `1,204 stars this week`

1. [sxyu / svox2](https://github.com/sxyu/svox2)
    - Plenoxels: Radiance Fields without Neural Networks, Code release WIP
    - language: **Python** &nbsp;&nbsp; stars: **923** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `305 stars this week`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，Go，JavaScript等多语言版本，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **20,655** &nbsp;&nbsp; folks: **5,285**  &nbsp;&nbsp; `1,039 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **131,208** &nbsp;&nbsp; folks: **21,501**  &nbsp;&nbsp; `1,617 stars this week`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,481** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `1,740 stars this week`
...
1. [wader / fq](https://github.com/wader/fq)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,996** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `815 stars this week`
...
1. [Dapp-Learning-DAO / Dapp-Learning](https://github.com/Dapp-Learning-DAO/Dapp-Learning)
    ...
    - language: **Solidity** &nbsp;&nbsp; stars: **861** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `158 stars this week`

1. [bytedance / btrace](https://github.com/bytedance/btrace)
    - 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Systrace, it support to define custom events automatically during building apk and using bhook to provider more native events like IO.
    - language: **Kotlin** &nbsp;&nbsp; stars: **637** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `209 stars this week`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,414** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `7,402 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **181,995** &nbsp;&nbsp; folks: **26,151**  &nbsp;&nbsp; `5,016 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,795** &nbsp;&nbsp; folks: **28,944**  &nbsp;&nbsp; `5,348 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **133,778** &nbsp;&nbsp; folks: **20,009**  &nbsp;&nbsp; `1,420 stars this month`

1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    - Low code project to build admin panels, internal tools, and dashboards. Connect to 15+ database integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,942** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `2,488 stars this month`
...
1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,167** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `373 stars this month`
