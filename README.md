...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **606** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `169 stars today`
...
1. [obsproject / obs-studio](https://github.com/obsproject/obs-studio)
    ...
    - language: **C** &nbsp;&nbsp; stars: **35,730** &nbsp;&nbsp; folks: **5,579**  &nbsp;&nbsp; `70 stars today`

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **16,124** &nbsp;&nbsp; folks: **780**  &nbsp;&nbsp; `200 stars today`
...
1. [scaffold-eth / scaffold-eth](https://github.com/scaffold-eth/scaffold-eth)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **5,572** &nbsp;&nbsp; folks: **1,770**  &nbsp;&nbsp; `161 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,308** &nbsp;&nbsp; folks: **40,354**  &nbsp;&nbsp; `25 stars today`
...
1. [veler / DevToys](https://github.com/veler/DevToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,105** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `2,953 stars this week`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **11,833** &nbsp;&nbsp; folks: **2,229**  &nbsp;&nbsp; `1,754 stars this week`

1. [khuedoan / homelab](https://github.com/khuedoan/homelab)
    - My self-hosting infrastructure, fully automated from empty disk to operating services
    - language: **Python** &nbsp;&nbsp; stars: **5,011** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `1,416 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **178,471** &nbsp;&nbsp; folks: **20,552**  &nbsp;&nbsp; `1,482 stars this week`
...
1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,782** &nbsp;&nbsp; folks: **4,086**  &nbsp;&nbsp; `292 stars this week`

1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,421** &nbsp;&nbsp; folks: **5,571**  &nbsp;&nbsp; `854 stars this week`

1. [flxzt / rnote](https://github.com/flxzt/rnote)
    - A simple drawing application to create handwritten notes.
    - language: **Rust** &nbsp;&nbsp; stars: **1,765** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `641 stars this week`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    - Project Cider. A new look into listening and enjoying Apple Music in style and performance. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **606** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `247 stars this week`
...
1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **C** &nbsp;&nbsp; stars: **126,134** &nbsp;&nbsp; folks: **41,174**  &nbsp;&nbsp; `1,773 stars this week`

1. [vercel / platforms](https://github.com/vercel/platforms)
    - A template for site builders and low-code tools.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,291** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `357 stars this week`
...
1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,165** &nbsp;&nbsp; folks: **9,045**  &nbsp;&nbsp; `756 stars this week`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,705** &nbsp;&nbsp; folks: **1,121**  &nbsp;&nbsp; `424 stars this week`

1. [abiosoft / colima](https://github.com/abiosoft/colima)
    - Container runtimes on macOS (and Linux) with minimal setup
    - language: **Go** &nbsp;&nbsp; stars: **1,976** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `537 stars this week`
