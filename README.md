...
1. [bepass-org / oblivion-desktop](https://github.com/bepass-org/oblivion-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,184** &nbsp;&nbsp; folks: **249**  &nbsp;&nbsp; `286 stars today`
...
1. [neovim / neovim](https://github.com/neovim/neovim)
    ...
    - language: **Vim Script** &nbsp;&nbsp; stars: **78,245** &nbsp;&nbsp; folks: **5,404**  &nbsp;&nbsp; `717 stars today`

1. [practical-tutorials / project-based-learning](https://github.com/practical-tutorials/project-based-learning)
    - Curated list of project-based tutorials
    - language: **无** &nbsp;&nbsp; stars: **172,629** &nbsp;&nbsp; folks: **22,754**  &nbsp;&nbsp; `282 stars today`
...
1. [ngc660sec / NGCBot](https://github.com/ngc660sec/NGCBot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,206** &nbsp;&nbsp; folks: **152**  &nbsp;&nbsp; `119 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **27,180** &nbsp;&nbsp; folks: **1,924**  &nbsp;&nbsp; `190 stars today`
...
1. [poteto / hiring-without-whiteboards](https://github.com/poteto/hiring-without-whiteboards)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **42,039** &nbsp;&nbsp; folks: **3,362**  &nbsp;&nbsp; `79 stars today`
...
1. [N64Recomp / N64Recomp](https://github.com/N64Recomp/N64Recomp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **5,465** &nbsp;&nbsp; folks: **338**  &nbsp;&nbsp; `3,806 stars this week`
...
1. [Zelda64Recomp / Zelda64Recomp](https://github.com/Zelda64Recomp/Zelda64Recomp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,149** &nbsp;&nbsp; folks: **217**  &nbsp;&nbsp; `2,158 stars this week`

1. [glanceapp / glance](https://github.com/glanceapp/glance)
    - A self-hosted dashboard that puts all your feeds in one place
    - language: **Go** &nbsp;&nbsp; stars: **5,233** &nbsp;&nbsp; folks: **151**  &nbsp;&nbsp; `3,022 stars this week`

1. [alan2207 / bulletproof-react](https://github.com/alan2207/bulletproof-react)
    - 🛡️ ⚛️ A simple, scalable, and powerful architecture for building production ready React applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,390** &nbsp;&nbsp; folks: **2,279**  &nbsp;&nbsp; `1,436 stars this week`
...
1. [google-research / timesfm](https://github.com/google-research/timesfm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,376** &nbsp;&nbsp; folks: **156**  &nbsp;&nbsp; `709 stars this week`

1. [neovim / neovim](https://github.com/neovim/neovim)
    - Vim-fork focused on extensibility and usability
    - language: **Vim Script** &nbsp;&nbsp; stars: **78,245** &nbsp;&nbsp; folks: **5,404**  &nbsp;&nbsp; `686 stars this week`

1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    - fabric is an open-source framework for augmenting humans using AI. It provides a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
    - language: **Python** &nbsp;&nbsp; stars: **10,572** &nbsp;&nbsp; folks: **1,114**  &nbsp;&nbsp; `494 stars this week`
...
1. [DataTalksClub / mlops-zoomcamp](https://github.com/DataTalksClub/mlops-zoomcamp)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,121** &nbsp;&nbsp; folks: **1,904**  &nbsp;&nbsp; `767 stars this week`
...
1. [bepass-org / oblivion-desktop](https://github.com/bepass-org/oblivion-desktop)
    - Oblivion Desktop - Unofficial Warp Client for Windows/Mac/Linux
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,184** &nbsp;&nbsp; folks: **249**  &nbsp;&nbsp; `1,257 stars this week`

1. [aamini / introtodeeplearning](https://github.com/aamini/introtodeeplearning)
    - Lab Materials for MIT 6.S191: Introduction to Deep Learning
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,956** &nbsp;&nbsp; folks: **3,506**  &nbsp;&nbsp; `30 stars this week`
...
1. [ChatGPTNextWeb / ChatGPT-Next-Web](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,238** &nbsp;&nbsp; folks: **56,277**  &nbsp;&nbsp; `1,048 stars this week`

1. [phidatahq / phidata](https://github.com/phidatahq/phidata)
    - Build AI Assistants with memory, knowledge and tools.
    - language: **Python** &nbsp;&nbsp; stars: **8,461** &nbsp;&nbsp; folks: **1,221**  &nbsp;&nbsp; `2,487 stars this week`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **51,666** &nbsp;&nbsp; folks: **6,263**  &nbsp;&nbsp; `1,133 stars this week`

1. [lllyasviel / Fooocus](https://github.com/lllyasviel/Fooocus)
    - Focus on prompting and generating
    - language: **Python** &nbsp;&nbsp; stars: **36,333** &nbsp;&nbsp; folks: **4,618**  &nbsp;&nbsp; `772 stars this week`

1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    - Neovim config for the lazy
    - language: **Lua** &nbsp;&nbsp; stars: **13,558** &nbsp;&nbsp; folks: **902**  &nbsp;&nbsp; `394 stars this week`
...
1. [myshell-ai / OpenVoice](https://github.com/myshell-ai/OpenVoice)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,698** &nbsp;&nbsp; folks: **2,411**  &nbsp;&nbsp; `8,556 stars this month`
...
1. [wandb / openui](https://github.com/wandb/openui)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **14,519** &nbsp;&nbsp; folks: **1,221**  &nbsp;&nbsp; `8,449 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly WebUI for LLMs (Formerly Ollama WebUI)
    - language: **Svelte** &nbsp;&nbsp; stars: **23,019** &nbsp;&nbsp; folks: **2,388**  &nbsp;&nbsp; `8,928 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,328** &nbsp;&nbsp; folks: **3,952**  &nbsp;&nbsp; `7,591 stars this month`
...
1. [pagefaultgames / pokerogue](https://github.com/pagefaultgames/pokerogue)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,222** &nbsp;&nbsp; folks: **939**  &nbsp;&nbsp; `1,537 stars this month`

1. [Doriandarko / maestro](https://github.com/Doriandarko/maestro)
    - A framework for Claude Opus to intelligently orchestrate subagents.
    - language: **Python** &nbsp;&nbsp; stars: **1,891** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `1,221 stars this month`
...
1. [massgravel / Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts)
    ...
    - language: **Batchfile** &nbsp;&nbsp; stars: **79,750** &nbsp;&nbsp; folks: **7,774**  &nbsp;&nbsp; `8,473 stars this month`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3, Mistral & Gemma LLMs 2-5x faster with 80% less memory
    - language: **Python** &nbsp;&nbsp; stars: **10,059** &nbsp;&nbsp; folks: **627**  &nbsp;&nbsp; `4,129 stars this month`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **27,180** &nbsp;&nbsp; folks: **1,924**  &nbsp;&nbsp; `5,329 stars this month`

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,587** &nbsp;&nbsp; folks: **1,301**  &nbsp;&nbsp; `4,293 stars this month`

1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    - GPT based autonomous agent that does online comprehensive research on any given topic
    - language: **Python** &nbsp;&nbsp; stars: **11,129** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `2,616 stars this month`

1. [hiyouga / LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)
    - Unify Efficient Fine-Tuning of 100+ LLMs
    - language: **Python** &nbsp;&nbsp; stars: **22,624** &nbsp;&nbsp; folks: **2,719**  &nbsp;&nbsp; `5,820 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3, Mistral, Gemma, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **68,138** &nbsp;&nbsp; folks: **4,966**  &nbsp;&nbsp; `11,248 stars this month`

1. [meta-llama / llama3](https://github.com/meta-llama/llama3)
    - The official Meta Llama 3 GitHub site
    - language: **Python** &nbsp;&nbsp; stars: **20,718** &nbsp;&nbsp; folks: **2,001**  &nbsp;&nbsp; `14,434 stars this month`

1. [NaiboWang / EasySpider](https://github.com/NaiboWang/EasySpider)
    - A visual no-code/code-free web crawler/spider易采集：一个可视化浏览器自动化测试/数据采集/爬虫软件，可以无代码图形化的设计和执行爬虫任务。别名：ServiceWrapper面向Web应用的智能化服务封装系统。
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,868** &nbsp;&nbsp; folks: **2,945**  &nbsp;&nbsp; `3,181 stars this month`
...
1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,155** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `5,017 stars this month`
...
1. [InternLM / xtuner](https://github.com/InternLM/xtuner)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,781** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `1,370 stars this month`
