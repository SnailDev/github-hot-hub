...
`更新时间：2022-03-24 16:15:53 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,927** &nbsp;&nbsp; folks: **4,277**  &nbsp;&nbsp; `525 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,990** &nbsp;&nbsp; folks: **745**  &nbsp;&nbsp; `249 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,348** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `980 stars today`
...
1. [nocodb / nocodb](https://github.com/nocodb/nocodb)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **24,186** &nbsp;&nbsp; folks: **1,452**  &nbsp;&nbsp; `281 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,593** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `2,577 stars this week`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,348** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `1,376 stars this week`
...
1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,990** &nbsp;&nbsp; folks: **745**  &nbsp;&nbsp; `1,408 stars this week`
...
1. [cat-milk / Anime-Girls-Holding-Programming-Books](https://github.com/cat-milk/Anime-Girls-Holding-Programming-Books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,964** &nbsp;&nbsp; folks: **627**  &nbsp;&nbsp; `3,510 stars this month`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,927** &nbsp;&nbsp; folks: **4,277**  &nbsp;&nbsp; `14,676 stars this month`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,593** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `4,261 stars this month`

1. [alibaba / lowcode-engine](https://github.com/alibaba/lowcode-engine)
    - An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,893** &nbsp;&nbsp; folks: **366**  &nbsp;&nbsp; `2,046 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **227,385** &nbsp;&nbsp; folks: **48,002**  &nbsp;&nbsp; `5,301 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **44,722** &nbsp;&nbsp; folks: **6,462**  &nbsp;&nbsp; `3,920 stars this month`

1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    - 👽 Open source API development ecosystem - https://hoppscotch.io
    - language: **Vue** &nbsp;&nbsp; stars: **40,685** &nbsp;&nbsp; folks: **2,765**  &nbsp;&nbsp; `4,083 stars this month`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **61,896** &nbsp;&nbsp; folks: **16,844**  &nbsp;&nbsp; `1,295 stars this month`

1. [iamadamdev / bypass-paywalls-chrome](https://github.com/iamadamdev/bypass-paywalls-chrome)
    - Bypass Paywalls web browser extension for Chrome and Firefox.
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,319** &nbsp;&nbsp; folks: **1,748**  &nbsp;&nbsp; `1,898 stars this month`

1. [vulhub / vulhub](https://github.com/vulhub/vulhub)
    - Pre-Built Vulnerable Environments Based on Docker-Compose
    - language: **Dockerfile** &nbsp;&nbsp; stars: **9,854** &nbsp;&nbsp; folks: **3,349**  &nbsp;&nbsp; `443 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,517** &nbsp;&nbsp; folks: **619**  &nbsp;&nbsp; `2,258 stars this month`
...
1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **18,236** &nbsp;&nbsp; folks: **2,218**  &nbsp;&nbsp; `1,272 stars this month`
...
1. [facebook / react](https://github.com/facebook/react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **184,820** &nbsp;&nbsp; folks: **37,875**  &nbsp;&nbsp; `2,512 stars this month`
...
1. [vuejs / vue](https://github.com/vuejs/vue)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **194,377** &nbsp;&nbsp; folks: **31,756**  &nbsp;&nbsp; `1,474 stars this month`
...
1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    ...
    - language: **无** &nbsp;&nbsp; stars: **136,258** &nbsp;&nbsp; folks: **12,956**  &nbsp;&nbsp; `4,083 stars this month`
