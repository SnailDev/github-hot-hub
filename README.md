...
`更新时间：2022-03-25 22:11:47 +0800`

## 今日热门仓库

1. [Arriven / db1000n](https://github.com/Arriven/db1000n)
    - 无
    - language: **Go** &nbsp;&nbsp; stars: **845** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `77 stars today`

1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    - Magnificent app which corrects your previous console command.
    - language: **Python** &nbsp;&nbsp; stars: **68,933** &nbsp;&nbsp; folks: **3,133**  &nbsp;&nbsp; `376 stars today`

1. [alibaba / lowcode-engine](https://github.com/alibaba/lowcode-engine)
    - An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,298** &nbsp;&nbsp; folks: **424**  &nbsp;&nbsp; `309 stars today`

1. [python-poetry / poetry](https://github.com/python-poetry/poetry)
    - Python dependency management and packaging made easy.
    - language: **Python** &nbsp;&nbsp; stars: **18,797** &nbsp;&nbsp; folks: **1,577**  &nbsp;&nbsp; `23 stars today`
...
1. [jonkpirateboy / Pass-fur-alle](https://github.com/jonkpirateboy/Pass-fur-alle)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **122** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `37 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,997** &nbsp;&nbsp; folks: **1,522**  &nbsp;&nbsp; `505 stars today`

1. [awesome-selfhosted / awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)
    - A list of Free Software network services and web applications which can be hosted on your own servers
    - language: **JavaScript** &nbsp;&nbsp; stars: **82,171** &nbsp;&nbsp; folks: **5,586**  &nbsp;&nbsp; `904 stars today`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,528** &nbsp;&nbsp; folks: **3,267**  &nbsp;&nbsp; `171 stars today`

1. [HarbourMasters / Shipwright](https://github.com/HarbourMasters/Shipwright)
    - 无
    - language: **C** &nbsp;&nbsp; stars: **537** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `130 stars today`

1. [googlefonts / morisawa-biz-ud-mincho](https://github.com/googlefonts/morisawa-biz-ud-mincho)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **253** &nbsp;&nbsp; folks: **2**  &nbsp;&nbsp; `35 stars today`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **10,640** &nbsp;&nbsp; folks: **1,018**  &nbsp;&nbsp; `365 stars today`
...
1. [amplication / amplication](https://github.com/amplication/amplication)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,788** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `458 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,424** &nbsp;&nbsp; folks: **4,367**  &nbsp;&nbsp; `555 stars today`
...
1. [BetaSu / fe-hunter](https://github.com/BetaSu/fe-hunter)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **449** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `80 stars today`

1. [alibaba / lowcode-demo](https://github.com/alibaba/lowcode-demo)
    - An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **116** &nbsp;&nbsp; folks: **43**  &nbsp;&nbsp; `12 stars today`
...
1. [kognise / arpchat](https://github.com/kognise/arpchat)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `340 stars today`
...
1. [apache / hudi](https://github.com/apache/hudi)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,929** &nbsp;&nbsp; folks: **1,307**  &nbsp;&nbsp; `11 stars today`

1. [cosmos / cosmos-sdk](https://github.com/cosmos/cosmos-sdk)
    - ⛓️ A Framework for Building High Value Public Blockchains ✨
    - language: **Go** &nbsp;&nbsp; stars: **3,642** &nbsp;&nbsp; folks: **1,587**  &nbsp;&nbsp; `9 stars today`

1. [meilisearch / meilisearch](https://github.com/meilisearch/meilisearch)
    - Powerful, fast, and an easy to use search engine
    - language: **Rust** &nbsp;&nbsp; stars: **24,550** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `374 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,772** &nbsp;&nbsp; folks: **214**  &nbsp;&nbsp; `1,852 stars this week`
...
1. [meilisearch / meilisearch](https://github.com/meilisearch/meilisearch)
    - Powerful, fast, and an easy to use search engine
    - language: **Rust** &nbsp;&nbsp; stars: **24,550** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `1,707 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,424** &nbsp;&nbsp; folks: **4,367**  &nbsp;&nbsp; `13,360 stars this month`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,772** &nbsp;&nbsp; folks: **214**  &nbsp;&nbsp; `4,440 stars this month`
...
1. [meilisearch / meilisearch](https://github.com/meilisearch/meilisearch)
    - Powerful, fast, and an easy to use search engine
    - language: **Rust** &nbsp;&nbsp; stars: **24,550** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `1,983 stars this month`
