...
1. [actions / virtual-environments](https://github.com/actions/virtual-environments)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **3,169** &nbsp;&nbsp; folks: **1,195**  &nbsp;&nbsp; `78 stars today`

1. [CaffeineMC / sodium-fabric](https://github.com/CaffeineMC/sodium-fabric)
    - A Fabric mod designed to improve frame rates and reduce micro-stutter
    - language: **Java** &nbsp;&nbsp; stars: **1,533** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `75 stars today`
...
1. [OATML / non-parametric-transformers](https://github.com/OATML/non-parametric-transformers)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **164** &nbsp;&nbsp; folks: **13**  &nbsp;&nbsp; `50 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **176,877** &nbsp;&nbsp; folks: **48,136**  &nbsp;&nbsp; `643 stars today`

1. [iamadamdev / bypass-paywalls-chrome](https://github.com/iamadamdev/bypass-paywalls-chrome)
    - Bypass Paywalls web browser extension for Chrome and Firefox.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,134** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `168 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **17,739** &nbsp;&nbsp; folks: **4,017**  &nbsp;&nbsp; `94 stars today`

1. [PaddlePaddle / PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)
    - An NLP library with Awesome pre-trained Transformer models and easy-to-use interface, supporting wide-range of NLP tasks from research to industrial applications.
    - language: **Python** &nbsp;&nbsp; stars: **1,209** &nbsp;&nbsp; folks: **336**  &nbsp;&nbsp; `110 stars today`

1. [peng-zhihui / HoloCubic](https://github.com/peng-zhihui/HoloCubic)
    - 带网络功能的伪全息透明显示桌面站
    - language: **C** &nbsp;&nbsp; stars: **2,042** &nbsp;&nbsp; folks: **359**  &nbsp;&nbsp; `72 stars today`
...
1. [megaease / easegress](https://github.com/megaease/easegress)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,616** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `515 stars this week`

1. [jynew / jynew](https://github.com/jynew/jynew)
    - 金庸群侠传3D重制版
    - language: **C#** &nbsp;&nbsp; stars: **875** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `677 stars this week`
...
1. [slidevjs / slidev](https://github.com/slidevjs/slidev)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,752** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `7,597 stars this month`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **68,160** &nbsp;&nbsp; folks: **21,260**  &nbsp;&nbsp; `2,515 stars this month`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **38,907** &nbsp;&nbsp; folks: **12,765**  &nbsp;&nbsp; `1,797 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,511** &nbsp;&nbsp; folks: **2,703**  &nbsp;&nbsp; `3,780 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **192,209** &nbsp;&nbsp; folks: **42,662**  &nbsp;&nbsp; `5,213 stars this month`
