...
`更新时间：2022-11-11 03:11:56 +0800`

## 今日热门仓库

1. [ilovexjp / health-code-index](https://github.com/ilovexjp/health-code-index)
    - 健康码模拟 - 索引
    - language: **HTML** &nbsp;&nbsp; stars: **1,620** &nbsp;&nbsp; folks: **246**  &nbsp;&nbsp; `541 stars today`

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Colossal-AI: A Unified Deep Learning System for Big Model Era
    - language: **Python** &nbsp;&nbsp; stars: **5,813** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `249 stars today`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,186** &nbsp;&nbsp; folks: **6,729**  &nbsp;&nbsp; `88 stars today`

1. [projectdiscovery / katana](https://github.com/projectdiscovery/katana)
    - A next-generation crawling and spidering framework.
    - language: **Go** &nbsp;&nbsp; stars: **2,304** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `819 stars today`
...
1. [binwiederhier / ntfy](https://github.com/binwiederhier/ntfy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,069** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `691 stars today`

1. [NVIDIA-Omniverse / PhysX](https://github.com/NVIDIA-Omniverse/PhysX)
    - NVIDIA PhysX SDK
    - language: **C++** &nbsp;&nbsp; stars: **1,018** &nbsp;&nbsp; folks: **66**  &nbsp;&nbsp; `191 stars today`

1. [cozodb / cozo](https://github.com/cozodb/cozo)
    - A general-purpose, transactional, relational database that uses Datalog and focuses on graph data and algorithms
    - language: **Rust** &nbsp;&nbsp; stars: **1,282** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `254 stars today`
...
1. [Zeal8bit / Zeal-8-bit-OS](https://github.com/Zeal8bit/Zeal-8-bit-OS)
    ...
    - language: **Assembly** &nbsp;&nbsp; stars: **243** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `46 stars today`
...
1. [oceanbase / oceanbase](https://github.com/oceanbase/oceanbase)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,906** &nbsp;&nbsp; folks: **1,086**  &nbsp;&nbsp; `45 stars today`

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **35,965** &nbsp;&nbsp; folks: **6,073**  &nbsp;&nbsp; `77 stars today`
...
1. [mastodon / mastodon](https://github.com/mastodon/mastodon)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **33,653** &nbsp;&nbsp; folks: **5,042**  &nbsp;&nbsp; `2,426 stars this week`

1. [geohot / tinygrad](https://github.com/geohot/tinygrad)
    - You like pytorch? You like micrograd? You love tinygrad! ❤️
    - language: **Python** &nbsp;&nbsp; stars: **8,667** &nbsp;&nbsp; folks: **799**  &nbsp;&nbsp; `1,388 stars this week`

1. [Sanster / lama-cleaner](https://github.com/Sanster/lama-cleaner)
    - Image inpainting tool powered by SOTA AI Model. Remove any unwanted object, defect, people from your pictures or erase and replace(powered by stable diffusion) any thing on your pictures.
    - language: **Python** &nbsp;&nbsp; stars: **3,479** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `1,120 stars this week`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,867** &nbsp;&nbsp; folks: **6,739**  &nbsp;&nbsp; `473 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,186** &nbsp;&nbsp; folks: **6,729**  &nbsp;&nbsp; `231 stars this week`

1. [milanm / DevOps-Roadmap](https://github.com/milanm/DevOps-Roadmap)
    - DevOps Roadmap for 2022. with learning resources
    - language: **无** &nbsp;&nbsp; stars: **3,095** &nbsp;&nbsp; folks: **169**  &nbsp;&nbsp; `1,502 stars this week`

1. [binwiederhier / ntfy](https://github.com/binwiederhier/ntfy)
    - Send push notifications to your phone or desktop using PUT/POST
    - language: **Go** &nbsp;&nbsp; stars: **6,069** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `2,294 stars this week`
...
1. [SheerSt / pokewilds](https://github.com/SheerSt/pokewilds)
    ...
    - language: **Assembly** &nbsp;&nbsp; stars: **1,139** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `441 stars this week`

1. [algorithm-visualizer / algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer)
    - 🎆Interactive Online Platform that Visualizes Algorithms from Code
    - language: **JavaScript** &nbsp;&nbsp; stars: **40,215** &nbsp;&nbsp; folks: **6,509**  &nbsp;&nbsp; `897 stars this week`
...
1. [The-Run-Philosophy-Organization / run](https://github.com/The-Run-Philosophy-Organization/run)
    - 润学全球官方指定GITHUB，整理润学宗旨、纲领、理论和各类润之实例；解决为什么润，润去哪里，怎么润三大问题； 并成为新中国人的核心宗教，核心信念。
    - language: **无** &nbsp;&nbsp; stars: **23,602** &nbsp;&nbsp; folks: **1,940**  &nbsp;&nbsp; `1,147 stars this week`
...
1. [algorithm-visualizer / algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer)
    - 🎆Interactive Online Platform that Visualizes Algorithms from Code
    - language: **JavaScript** &nbsp;&nbsp; stars: **40,215** &nbsp;&nbsp; folks: **6,509**  &nbsp;&nbsp; `1,027 stars this month`
