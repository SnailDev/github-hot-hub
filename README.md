...
`更新时间：2023-04-01 11:11:41 +0800`

## 今日热门仓库

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **25,220** &nbsp;&nbsp; folks: **2,817**  &nbsp;&nbsp; `1,294 stars today`

1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    - gpt4all: a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
    - language: **Python** &nbsp;&nbsp; stars: **14,953** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `2,937 stars today`

1. [ZrrSkywalker / LLaMA-Adapter](https://github.com/ZrrSkywalker/LLaMA-Adapter)
    - Fine-tuning LLaMA to follow instructions within 1 Hour and 1.2M Parameters
    - language: **Python** &nbsp;&nbsp; stars: **1,312** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `337 stars today`
...
1. [binary-husky / chatgpt_academic](https://github.com/binary-husky/chatgpt_academic)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,332** &nbsp;&nbsp; folks: **1,640**  &nbsp;&nbsp; `2,154 stars today`
...
1. [Yidadaa / ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,014** &nbsp;&nbsp; folks: **2,749**  &nbsp;&nbsp; `976 stars today`
...
1. [vocodedev / vocode-python](https://github.com/vocodedev/vocode-python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **617** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `122 stars today`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,567** &nbsp;&nbsp; folks: **3,414**  &nbsp;&nbsp; `531 stars today`
...
1. [yzfly / awesome-chatgpt-zh](https://github.com/yzfly/awesome-chatgpt-zh)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,935** &nbsp;&nbsp; folks: **99**  &nbsp;&nbsp; `556 stars today`
...
1. [openai / chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,112** &nbsp;&nbsp; folks: **1,492**  &nbsp;&nbsp; `6,464 stars this week`

1. [getcursor / cursor](https://github.com/getcursor/cursor)
    - An editor made for programming with AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,185** &nbsp;&nbsp; folks: **748**  &nbsp;&nbsp; `8,969 stars this week`
...
1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **25,220** &nbsp;&nbsp; folks: **2,817**  &nbsp;&nbsp; `5,998 stars this week`
...
1. [BlinkDL / RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,629** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `1,043 stars this week`
...
1. [typst / typst](https://github.com/typst/typst)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **13,066** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `4,121 stars this week`
...
1. [willwulfken / MidJourney-Styles-and-Keywords-Reference](https://github.com/willwulfken/MidJourney-Styles-and-Keywords-Reference)
    ...
    - language: **无** &nbsp;&nbsp; stars: **7,477** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `1,911 stars this week`

1. [LianjiaTech / BELLE](https://github.com/LianjiaTech/BELLE)
    - BELLE: Be Everyone's Large Language model Engine（开源中文对话大模型）
    - language: **Python** &nbsp;&nbsp; stars: **2,787** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,048 stars this week`

1. [logspace-ai / langflow](https://github.com/logspace-ai/langflow)
    - ⛓️ LangFlow is a UI for LangChain, designed with react-flow to provide an effortless way to experiment and prototype flows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,975** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `1,256 stars this week`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **57,550** &nbsp;&nbsp; folks: **6,821**  &nbsp;&nbsp; `6,787 stars this week`
...
1. [tloen / alpaca-lora](https://github.com/tloen/alpaca-lora)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,661** &nbsp;&nbsp; folks: **900**  &nbsp;&nbsp; `1,989 stars this week`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,085** &nbsp;&nbsp; folks: **3,957**  &nbsp;&nbsp; `11,436 stars this month`
...
1. [facebookresearch / llama](https://github.com/facebookresearch/llama)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,461** &nbsp;&nbsp; folks: **2,429**  &nbsp;&nbsp; `10,025 stars this month`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,567** &nbsp;&nbsp; folks: **3,414**  &nbsp;&nbsp; `10,798 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT better.
    - language: **HTML** &nbsp;&nbsp; stars: **57,550** &nbsp;&nbsp; folks: **6,821**  &nbsp;&nbsp; `24,105 stars this month`
...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,960** &nbsp;&nbsp; folks: **1,818**  &nbsp;&nbsp; `4,547 stars this month`

1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **19,631** &nbsp;&nbsp; folks: **1,528**  &nbsp;&nbsp; `9,603 stars this month`
...
1. [huggingface / transformers](https://github.com/huggingface/transformers)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **89,093** &nbsp;&nbsp; folks: **19,093**  &nbsp;&nbsp; `6,374 stars this month`
...
1. [camenduru / stable-diffusion-webui-colab](https://github.com/camenduru/stable-diffusion-webui-colab)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,369** &nbsp;&nbsp; folks: **1,048**  &nbsp;&nbsp; `4,314 stars this month`

1. [BlinkDL / RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
    - RWKV is an RNN with transformer-level LLM performance. It can be directly trained like a GPT (parallelizable). So it's combining the best of RNN and transformer - great performance, fast inference, saves VRAM, fast training, "infinite" ctx_len, and free sentence embedding.
    - language: **Python** &nbsp;&nbsp; stars: **4,629** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `2,564 stars this month`
