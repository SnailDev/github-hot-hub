...
`更新时间：2021-02-22 18:09:54 +0800`

## 今日热门仓库

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **4,504** &nbsp;&nbsp; folks: **546**  &nbsp;&nbsp; `630 stars today`
...
1. [stypr / clubhouse-py](https://github.com/stypr/clubhouse-py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,016** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `379 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **11,189** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `847 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,620** &nbsp;&nbsp; folks: **33,659**  &nbsp;&nbsp; `190 stars today`

1. [ai-eks / OpenClubhouse](https://github.com/ai-eks/OpenClubhouse)
    - A third-part web application based on flask to play Clubhouse audio.
    - language: **JavaScript** &nbsp;&nbsp; stars: **646** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `355 stars today`
...
1. [activeloopai / Hub](https://github.com/activeloopai/Hub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,175** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `225 stars today`

1. [electron / electron](https://github.com/electron/electron)
    - Build cross-platform desktop apps with JavaScript, HTML, and CSS
    - language: **C++** &nbsp;&nbsp; stars: **90,346** &nbsp;&nbsp; folks: **12,020**  &nbsp;&nbsp; `579 stars today`

1. [mrdoob / three.js](https://github.com/mrdoob/three.js)
    - JavaScript 3D library.
    - language: **JavaScript** &nbsp;&nbsp; stars: **67,710** &nbsp;&nbsp; folks: **26,718**  &nbsp;&nbsp; `102 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,935** &nbsp;&nbsp; folks: **1,320**  &nbsp;&nbsp; `82 stars today`
...
1. [FranckNdame / swiftui.builds](https://github.com/FranckNdame/swiftui.builds)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **281** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `51 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,557** &nbsp;&nbsp; folks: **13,568**  &nbsp;&nbsp; `124 stars today`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,775** &nbsp;&nbsp; folks: **190**  &nbsp;&nbsp; `970 stars this week`

1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **23,385** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `2,260 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **11,189** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `2,352 stars this week`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,695** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `1,549 stars this week`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,686** &nbsp;&nbsp; folks: **1,086**  &nbsp;&nbsp; `1,584 stars this week`

1. [bitwarden / server](https://github.com/bitwarden/server)
    - The core infrastructure backend (API, database, Docker, etc).
    - language: **C#** &nbsp;&nbsp; stars: **7,030** &nbsp;&nbsp; folks: **597**  &nbsp;&nbsp; `228 stars this week`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,404** &nbsp;&nbsp; folks: **1,839**  &nbsp;&nbsp; `387 stars this week`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,918** &nbsp;&nbsp; folks: **1,362**  &nbsp;&nbsp; `146 stars this week`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,206** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `1,175 stars this week`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,686** &nbsp;&nbsp; folks: **1,086**  &nbsp;&nbsp; `3,815 stars this month`
...
1. [RustPython / RustPython](https://github.com/RustPython/RustPython)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **7,277** &nbsp;&nbsp; folks: **493**  &nbsp;&nbsp; `947 stars this month`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,206** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `2,698 stars this month`
...
1. [justauth / JustAuth](https://github.com/justauth/JustAuth)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **10,713** &nbsp;&nbsp; folks: **1,889**  &nbsp;&nbsp; `785 stars this month`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,695** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `1,980 stars this month`
