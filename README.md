...
`更新时间：2021-02-19 13:10:11 +0800`

## 今日热门仓库

1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **878** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `279 stars today`
...
1. [mitmath / 18S191](https://github.com/mitmath/18S191)
    ...
    - language: **Julia** &nbsp;&nbsp; stars: **1,540** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `59 stars today`
...
1. [MManoah / league-profile-tool](https://github.com/MManoah/league-profile-tool)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **210** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `44 stars today`

1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,374** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `207 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **97,281** &nbsp;&nbsp; folks: **16,193**  &nbsp;&nbsp; `311 stars today`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,779** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `156 stars today`

1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    - 🌈 A UI Design Language and React UI library
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,184** &nbsp;&nbsp; folks: **26,619**  &nbsp;&nbsp; `826 stars today`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **19,847** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `281 stars today`
...
1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **878** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `707 stars this week`

1. [conwnet / github1s](https://github.com/conwnet/github1s)
    - One second to read GitHub code with VS Code.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,667** &nbsp;&nbsp; folks: **312**  &nbsp;&nbsp; `3,779 stars this week`
...
1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,374** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `799 stars this week`

1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **22,914** &nbsp;&nbsp; folks: **661**  &nbsp;&nbsp; `1,824 stars this week`
...
1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,845** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `112 stars this week`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,115** &nbsp;&nbsp; folks: **1,553**  &nbsp;&nbsp; `1,152 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,588** &nbsp;&nbsp; folks: **1,043**  &nbsp;&nbsp; `2,979 stars this month`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,845** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `368 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,062** &nbsp;&nbsp; folks: **13,498**  &nbsp;&nbsp; `1,170 stars this month`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **19,847** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `2,433 stars this month`
