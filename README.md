...
1. [hikari-no-yume / touchHLE](https://github.com/hikari-no-yume/touchHLE)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **659** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `158 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **210,671** &nbsp;&nbsp; folks: **37,673**  &nbsp;&nbsp; `117 stars today`

1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    - 💯 Curated coding interview preparation materials for busy software engineers
    - language: **TypeScript** &nbsp;&nbsp; stars: **85,894** &nbsp;&nbsp; folks: **11,254**  &nbsp;&nbsp; `106 stars today`

1. [OpenBB-finance / OpenBBTerminal](https://github.com/OpenBB-finance/OpenBBTerminal)
    - Investment Research for Everyone, Anywhere.
    - language: **Python** &nbsp;&nbsp; stars: **19,113** &nbsp;&nbsp; folks: **1,994**  &nbsp;&nbsp; `56 stars today`

1. [home-assistant / core](https://github.com/home-assistant/core)
    - 🏡 Open source home automation that puts local control and privacy first.
    - language: **Python** &nbsp;&nbsp; stars: **57,877** &nbsp;&nbsp; folks: **21,832**  &nbsp;&nbsp; `103 stars today`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **237,452** &nbsp;&nbsp; folks: **24,872**  &nbsp;&nbsp; `188 stars today`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **68,089** &nbsp;&nbsp; folks: **33,738**  &nbsp;&nbsp; `45 stars today`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **5,861** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `79 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **188,161** &nbsp;&nbsp; folks: **18,164**  &nbsp;&nbsp; `480 stars today`

1. [TheAlgorithms / JavaScript](https://github.com/TheAlgorithms/JavaScript)
    - Algorithms and Data Structures implemented in JavaScript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,868** &nbsp;&nbsp; folks: **4,303**  &nbsp;&nbsp; `88 stars today`

1. [techiescamp / kubernetes-learning-path](https://github.com/techiescamp/kubernetes-learning-path)
    - A roadmap to learn Kubernetes from scratch (Beginner to Advanced level)
    - language: **无** &nbsp;&nbsp; stars: **3,221** &nbsp;&nbsp; folks: **269**  &nbsp;&nbsp; `320 stars today`

1. [vasanthk / how-web-works](https://github.com/vasanthk/how-web-works)
    - What happens behind the scenes when we type www.google.com in a browser?
    - language: **无** &nbsp;&nbsp; stars: **12,937** &nbsp;&nbsp; folks: **1,456**  &nbsp;&nbsp; `138 stars today`
...
1. [microsoft / BioGPT](https://github.com/microsoft/BioGPT)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,332** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `269 stars today`
...
1. [fathyb / carbonyl](https://github.com/fathyb/carbonyl)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,684** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `5,203 stars this week`

1. [apitable / apitable](https://github.com/apitable/apitable)
    - 🚀🎉📚 APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,270** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `3,889 stars this week`
...
1. [acheong08 / ChatGPT](https://github.com/acheong08/ChatGPT)
    - Reverse engineered ChatGPT API
    - language: **Python** &nbsp;&nbsp; stars: **12,957** &nbsp;&nbsp; folks: **1,790**  &nbsp;&nbsp; `2,631 stars this week`
...
1. [karpathy / nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,388** &nbsp;&nbsp; folks: **541**  &nbsp;&nbsp; `652 stars this week`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **188,161** &nbsp;&nbsp; folks: **18,164**  &nbsp;&nbsp; `2,149 stars this week`
...
1. [TheAlgorithms / Rust](https://github.com/TheAlgorithms/Rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,281** &nbsp;&nbsp; folks: **1,413**  &nbsp;&nbsp; `565 stars this week`
...
1. [jerryjliu / gpt_index](https://github.com/jerryjliu/gpt_index)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,384** &nbsp;&nbsp; folks: **259**  &nbsp;&nbsp; `2,612 stars this month`
...
1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **11,686** &nbsp;&nbsp; folks: **848**  &nbsp;&nbsp; `8,267 stars this month`
...
1. [apitable / apitable](https://github.com/apitable/apitable)
    - 🚀🎉📚 APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,270** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `4,193 stars this month`

1. [sourcegraph / conc](https://github.com/sourcegraph/conc)
    - Better structured concurrency for go
    - language: **Go** &nbsp;&nbsp; stars: **5,543** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `3,879 stars this month`
...
1. [neonbjb / tortoise-tts](https://github.com/neonbjb/tortoise-tts)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,039** &nbsp;&nbsp; folks: **429**  &nbsp;&nbsp; `1,204 stars this month`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **162,621** &nbsp;&nbsp; folks: **26,897**  &nbsp;&nbsp; `4,581 stars this month`

1. [withastro / astro](https://github.com/withastro/astro)
    - Build faster websites with Astro's next-gen island architecture 🏝✨
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,580** &nbsp;&nbsp; folks: **1,253**  &nbsp;&nbsp; `2,533 stars this month`
