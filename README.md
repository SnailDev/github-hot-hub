...
1. [coderQuad / New-Grad-Positions-2023](https://github.com/coderQuad/New-Grad-Positions-2023)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,733** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `87 stars today`
...
1. [pittcsc / Summer2023-Internships](https://github.com/pittcsc/Summer2023-Internships)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,606** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `176 stars today`

1. [satwikkansal / wtfpython](https://github.com/satwikkansal/wtfpython)
    - What the f*ck Python? 😱
    - language: **Python** &nbsp;&nbsp; stars: **30,465** &nbsp;&nbsp; folks: **2,435**  &nbsp;&nbsp; `289 stars today`

1. [HazyResearch / flash-attention](https://github.com/HazyResearch/flash-attention)
    - 无
    - language: **C++** &nbsp;&nbsp; stars: **376** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `61 stars today`

1. [OpenIMSDK / Open-IM-Server](https://github.com/OpenIMSDK/Open-IM-Server)
    - 即时通讯IM
    - language: **Go** &nbsp;&nbsp; stars: **8,220** &nbsp;&nbsp; folks: **1,288**  &nbsp;&nbsp; `43 stars today`
...
1. [DavidBrightSparc / Tenets-of-IT](https://github.com/DavidBrightSparc/Tenets-of-IT)
    ...
    - language: **无** &nbsp;&nbsp; stars: **195** &nbsp;&nbsp; folks: **10**  &nbsp;&nbsp; `47 stars today`
...
1. [Threekiii / Awesome-Redteam](https://github.com/Threekiii/Awesome-Redteam)
    - 一个红队知识仓库
    - language: **Python** &nbsp;&nbsp; stars: **611** &nbsp;&nbsp; folks: **107**  &nbsp;&nbsp; `72 stars today`

1. [faif / python-patterns](https://github.com/faif/python-patterns)
    - A collection of design patterns/idioms in Python
    - language: **Python** &nbsp;&nbsp; stars: **33,101** &nbsp;&nbsp; folks: **6,383**  &nbsp;&nbsp; `291 stars today`

1. [akaunting / akaunting](https://github.com/akaunting/akaunting)
    - Free and Online Accounting Software
    - language: **PHP** &nbsp;&nbsp; stars: **5,152** &nbsp;&nbsp; folks: **1,800**  &nbsp;&nbsp; `59 stars today`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **19,471** &nbsp;&nbsp; folks: **2,133**  &nbsp;&nbsp; `120 stars today`

1. [THUDM / CogVideo](https://github.com/THUDM/CogVideo)
    - Text-to-video generation.
    - language: **无** &nbsp;&nbsp; stars: **829** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `212 stars today`
...
1. [Akebi-Group / Akebi-GC](https://github.com/Akebi-Group/Akebi-GC)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **316** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `66 stars today`

1. [ag-grid / ag-grid](https://github.com/ag-grid/ag-grid)
    - The best JavaScript Data Table for building Enterprise Applications. Supports React / Angular / Vue / Plain JavaScript.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,678** &nbsp;&nbsp; folks: **1,482**  &nbsp;&nbsp; `86 stars today`

1. [psf / black](https://github.com/psf/black)
    - The uncompromising Python code formatter
    - language: **Python** &nbsp;&nbsp; stars: **27,645** &nbsp;&nbsp; folks: **1,760**  &nbsp;&nbsp; `85 stars today`

1. [android / nowinandroid](https://github.com/android/nowinandroid)
    - A fully functional Android app built entirely with Kotlin and Jetpack Compose
    - language: **Kotlin** &nbsp;&nbsp; stars: **4,172** &nbsp;&nbsp; folks: **319**  &nbsp;&nbsp; `88 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond
    - language: **Dart** &nbsp;&nbsp; stars: **141,379** &nbsp;&nbsp; folks: **22,290**  &nbsp;&nbsp; `158 stars today`
...
1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **19,471** &nbsp;&nbsp; folks: **2,133**  &nbsp;&nbsp; `1,349 stars this week`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,723** &nbsp;&nbsp; folks: **3,236**  &nbsp;&nbsp; `1,565 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,201** &nbsp;&nbsp; folks: **4,763**  &nbsp;&nbsp; `642 stars this week`
...
1. [pyscript / pyscript](https://github.com/pyscript/pyscript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,293** &nbsp;&nbsp; folks: **823**  &nbsp;&nbsp; `9,407 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **21,091** &nbsp;&nbsp; folks: **1,930**  &nbsp;&nbsp; `4,613 stars this month`

1. [Grasscutters / Grasscutter](https://github.com/Grasscutters/Grasscutter)
    - A server software reimplementation for a certain anime game.
    - language: **Java** &nbsp;&nbsp; stars: **7,944** &nbsp;&nbsp; folks: **2,789**  &nbsp;&nbsp; `4,340 stars this month`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,003** &nbsp;&nbsp; folks: **7,608**  &nbsp;&nbsp; `5,853 stars this month`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,723** &nbsp;&nbsp; folks: **3,236**  &nbsp;&nbsp; `2,085 stars this month`

1. [alembics / disco-diffusion](https://github.com/alembics/disco-diffusion)
    - 无
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,440** &nbsp;&nbsp; folks: **391**  &nbsp;&nbsp; `1,134 stars this month`
...
1. [Vonng / ddia](https://github.com/Vonng/ddia)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,494** &nbsp;&nbsp; folks: **3,160**  &nbsp;&nbsp; `1,209 stars this month`

1. [faif / python-patterns](https://github.com/faif/python-patterns)
    - A collection of design patterns/idioms in Python
    - language: **Python** &nbsp;&nbsp; stars: **33,101** &nbsp;&nbsp; folks: **6,383**  &nbsp;&nbsp; `1,870 stars this month`
