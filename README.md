...
1. [alura-challenges / alurakut](https://github.com/alura-challenges/alurakut)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **420** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `111 stars today`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **7,697** &nbsp;&nbsp; folks: **1,110**  &nbsp;&nbsp; `487 stars today`
...
1. [AkashSingh3031 / The-Complete-FAANG-Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,278** &nbsp;&nbsp; folks: **561**  &nbsp;&nbsp; `92 stars today`

1. [sogou / workflow](https://github.com/sogou/workflow)
    - C++ Parallel Computing and Asynchronous Networking Engine
    - language: **C++** &nbsp;&nbsp; stars: **4,730** &nbsp;&nbsp; folks: **895**  &nbsp;&nbsp; `63 stars today`
...
1. [AstraZeneca / awesome-explainable-graph-reasoning](https://github.com/AstraZeneca/awesome-explainable-graph-reasoning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **283** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `129 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **138,383** &nbsp;&nbsp; folks: **25,309**  &nbsp;&nbsp; `140 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **18,580** &nbsp;&nbsp; folks: **4,139**  &nbsp;&nbsp; `90 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **40,265** &nbsp;&nbsp; folks: **7,376**  &nbsp;&nbsp; `73 stars today`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,757** &nbsp;&nbsp; folks: **8,641**  &nbsp;&nbsp; `370 stars today`

1. [Jack-Cherish / Machine-Learning](https://github.com/Jack-Cherish/Machine-Learning)
    - ⚡机器学习实战（Python3）：kNN、决策树、贝叶斯、逻辑回归、SVM、线性回归、树回归
    - language: **Python** &nbsp;&nbsp; stars: **4,643** &nbsp;&nbsp; folks: **3,785**  &nbsp;&nbsp; `129 stars today`
...
1. [o3de / o3de](https://github.com/o3de/o3de)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,931** &nbsp;&nbsp; folks: **619**  &nbsp;&nbsp; `1,451 stars this week`
...
1. [tenacityteam / tenacity](https://github.com/tenacityteam/tenacity)
    ...
    - language: **C** &nbsp;&nbsp; stars: **4,508** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `1,215 stars this week`

1. [SmartKeyerror / Psyduck](https://github.com/SmartKeyerror/Psyduck)
    - Record CS knowlegement with XMind, version 2.0. 使用 XMind 记录 Linux 操作系统，网络，C++，Golang 以及数据库的一些设计
    - language: **Go** &nbsp;&nbsp; stars: **3,046** &nbsp;&nbsp; folks: **287**  &nbsp;&nbsp; `1,224 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 24 lessons, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,108** &nbsp;&nbsp; folks: **2,500**  &nbsp;&nbsp; `3,554 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,757** &nbsp;&nbsp; folks: **8,641**  &nbsp;&nbsp; `1,617 stars this week`
...
1. [cmuratori / refterm](https://github.com/cmuratori/refterm)
    ...
    - language: **C** &nbsp;&nbsp; stars: **708** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `242 stars this week`
...
1. [MustangYM / WeChatExtension-ForMac](https://github.com/MustangYM/WeChatExtension-ForMac)
    ...
    - language: **Objective-C** &nbsp;&nbsp; stars: **18,224** &nbsp;&nbsp; folks: **2,785**  &nbsp;&nbsp; `639 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **6,110** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `532 stars this week`
...
1. [SigNoz / signoz](https://github.com/SigNoz/signoz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,254** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `2,475 stars this month`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,167** &nbsp;&nbsp; folks: **4,054**  &nbsp;&nbsp; `4,153 stars this month`
...
1. [laynH / Anime-Girls-Holding-Programming-Books](https://github.com/laynH/Anime-Girls-Holding-Programming-Books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,562** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `1,515 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,539** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `2,343 stars this month`
