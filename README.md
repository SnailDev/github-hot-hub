...
1. [fishaudio / fish-speech](https://github.com/fishaudio/fish-speech)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,118** &nbsp;&nbsp; folks: **1,167**  &nbsp;&nbsp; `221 stars today`
...
1. [nodejs / node](https://github.com/nodejs/node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **108,134** &nbsp;&nbsp; folks: **29,869**  &nbsp;&nbsp; `32 stars today`
...
1. [spaceandtimelabs / sxt-proof-of-sql](https://github.com/spaceandtimelabs/sxt-proof-of-sql)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,995** &nbsp;&nbsp; folks: **105**  &nbsp;&nbsp; `72 stars today`
...
1. [skills / github-pages](https://github.com/skills/github-pages)
    ...
    - language: **无** &nbsp;&nbsp; stars: **998** &nbsp;&nbsp; folks: **433**  &nbsp;&nbsp; `182 stars today`
...
1. [aidenybai / react-scan](https://github.com/aidenybai/react-scan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,855** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `3,125 stars this week`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,730** &nbsp;&nbsp; folks: **1,687**  &nbsp;&nbsp; `1,248 stars this week`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **47,797** &nbsp;&nbsp; folks: **10,419**  &nbsp;&nbsp; `2,050 stars this week`
...
1. [0voice / expert_readed_books](https://github.com/0voice/expert_readed_books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,735** &nbsp;&nbsp; folks: **2,718**  &nbsp;&nbsp; `575 stars this week`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **315,954** &nbsp;&nbsp; folks: **29,310**  &nbsp;&nbsp; `2,381 stars this week`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,797** &nbsp;&nbsp; folks: **7,896**  &nbsp;&nbsp; `2,233 stars this week`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **300,224** &nbsp;&nbsp; folks: **39,437**  &nbsp;&nbsp; `1,620 stars this week`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **30,475** &nbsp;&nbsp; folks: **2,075**  &nbsp;&nbsp; `12,357 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,058** &nbsp;&nbsp; folks: **860**  &nbsp;&nbsp; `2,502 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,797** &nbsp;&nbsp; folks: **7,896**  &nbsp;&nbsp; `6,775 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **20,387** &nbsp;&nbsp; folks: **1,446**  &nbsp;&nbsp; `6,809 stars this month`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,769** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `3,775 stars this month`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,427** &nbsp;&nbsp; folks: **622**  &nbsp;&nbsp; `8,142 stars this month`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,304** &nbsp;&nbsp; folks: **1,816**  &nbsp;&nbsp; `4,455 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **16,906** &nbsp;&nbsp; folks: **910**  &nbsp;&nbsp; `5,976 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **18,727** &nbsp;&nbsp; folks: **2,858**  &nbsp;&nbsp; `1,976 stars this month`
...
1. [coaidev / coai](https://github.com/coaidev/coai)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,386** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `3,868 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **101,944** &nbsp;&nbsp; folks: **12,794**  &nbsp;&nbsp; `4,091 stars this month`

1. [ItzCrazyKns / Perplexica](https://github.com/ItzCrazyKns/Perplexica)
    - Perplexica is an AI-powered search engine. It is an Open source alternative to Perplexity AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,027** &nbsp;&nbsp; folks: **1,585**  &nbsp;&nbsp; `2,593 stars this month`
...
1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **26,719** &nbsp;&nbsp; folks: **1,995**  &nbsp;&nbsp; `2,385 stars this month`

1. [GoogleCloudPlatform / generative-ai](https://github.com/GoogleCloudPlatform/generative-ai)
    - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,310** &nbsp;&nbsp; folks: **2,337**  &nbsp;&nbsp; `1,040 stars this month`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **21,406** &nbsp;&nbsp; folks: **4,154**  &nbsp;&nbsp; `1,726 stars this month`
