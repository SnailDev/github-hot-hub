...
1. [athensresearch / athens](https://github.com/athensresearch/athens)
    ...
    - language: **Clojure** &nbsp;&nbsp; stars: **2,853** &nbsp;&nbsp; folks: **175**  &nbsp;&nbsp; `220 stars today`

1. [aws / aws-sdk-go](https://github.com/aws/aws-sdk-go)
    - AWS SDK for the Go programming language.
    - language: **Go** &nbsp;&nbsp; stars: **6,604** &nbsp;&nbsp; folks: **1,636**  &nbsp;&nbsp; `84 stars today`

1. [firebase / firebase-ios-sdk](https://github.com/firebase/firebase-ios-sdk)
    - Firebase iOS SDK
    - language: **Objective-C** &nbsp;&nbsp; stars: **2,522** &nbsp;&nbsp; folks: **749**  &nbsp;&nbsp; `35 stars today`
...
1. [extreme-assistant / CVPR2021-Paper-Code-Interpretation](https://github.com/extreme-assistant/CVPR2021-Paper-Code-Interpretation)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,789** &nbsp;&nbsp; folks: **1,403**  &nbsp;&nbsp; `48 stars today`

1. [adobe / brackets](https://github.com/adobe/brackets)
    - An open source code editor for the web, written in JavaScript, HTML and CSS.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,790** &nbsp;&nbsp; folks: **6,858**  &nbsp;&nbsp; `48 stars today`

1. [influxdata / influxdb](https://github.com/influxdata/influxdb)
    - Scalable datastore for metrics, events, and real-time analytics
    - language: **Go** &nbsp;&nbsp; stars: **20,750** &nbsp;&nbsp; folks: **2,899**  &nbsp;&nbsp; `143 stars today`
...
1. [jart / cosmopolitan](https://github.com/jart/cosmopolitan)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,825** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `2,526 stars this week`
...
1. [pyroscope-io / pyroscope](https://github.com/pyroscope-io/pyroscope)
    - 🔥 Continuous Profiling Platform 🔥 Debug performance issues down to a single line of code
    - language: **Go** &nbsp;&nbsp; stars: **1,635** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `604 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **20,950** &nbsp;&nbsp; folks: **7,250**  &nbsp;&nbsp; `309 stars this week`
...
1. [achannarasappa / ticker](https://github.com/achannarasappa/ticker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,331** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `1,842 stars this month`
...
1. [jart / cosmopolitan](https://github.com/jart/cosmopolitan)
    - fast portable static native textmode containers
    - language: **C** &nbsp;&nbsp; stars: **3,825** &nbsp;&nbsp; folks: **97**  &nbsp;&nbsp; `2,665 stars this month`
