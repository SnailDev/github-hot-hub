...
`更新时间：2021-04-25 17:15:18 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **561** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `301 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **119,217** &nbsp;&nbsp; folks: **16,964**  &nbsp;&nbsp; `244 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,508** &nbsp;&nbsp; folks: **540**  &nbsp;&nbsp; `262 stars today`

1. [ueberdosis / tiptap](https://github.com/ueberdosis/tiptap)
    - The headless editor framework for web artisans.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,158** &nbsp;&nbsp; folks: **986**  &nbsp;&nbsp; `384 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,831** &nbsp;&nbsp; folks: **7,396**  &nbsp;&nbsp; `104 stars today`

1. [microsoft / wslg](https://github.com/microsoft/wslg)
    - Enabling the Windows Subsystem for Linux to include support for Wayland and X server related scenarios
    - language: **C++** &nbsp;&nbsp; stars: **1,758** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `488 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,998** &nbsp;&nbsp; folks: **20,737**  &nbsp;&nbsp; `140 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,063** &nbsp;&nbsp; folks: **7,971**  &nbsp;&nbsp; `319 stars today`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,261** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `402 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,271** &nbsp;&nbsp; folks: **89**  &nbsp;&nbsp; `491 stars today`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,835** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `377 stars today`

1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    - A list of awesome applications, software, tools and other materials for Linux distros.
    - language: **Python** &nbsp;&nbsp; stars: **15,441** &nbsp;&nbsp; folks: **1,581**  &nbsp;&nbsp; `237 stars today`
...
1. [gh0stkey / Binary-Learning](https://github.com/gh0stkey/Binary-Learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **277** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `59 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **82,122** &nbsp;&nbsp; folks: **11,689**  &nbsp;&nbsp; `513 stars today`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **14,196** &nbsp;&nbsp; folks: **1,477**  &nbsp;&nbsp; `207 stars today`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **102,078** &nbsp;&nbsp; folks: **40,901**  &nbsp;&nbsp; `150 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,900** &nbsp;&nbsp; folks: **4,069**  &nbsp;&nbsp; `379 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **208** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `163 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,606** &nbsp;&nbsp; folks: **465**  &nbsp;&nbsp; `2,238 stars this week`
...
1. [nasa / fprime](https://github.com/nasa/fprime)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **7,769** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `865 stars this week`
...
1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,844** &nbsp;&nbsp; folks: **9,413**  &nbsp;&nbsp; `344 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,227** &nbsp;&nbsp; folks: **605**  &nbsp;&nbsp; `1,777 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,063** &nbsp;&nbsp; folks: **7,971**  &nbsp;&nbsp; `2,305 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,435** &nbsp;&nbsp; folks: **45,720**  &nbsp;&nbsp; `2,598 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,247** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `1,523 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,328** &nbsp;&nbsp; folks: **4,810**  &nbsp;&nbsp; `1,100 stars this week`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,261** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `741 stars this week`
...
1. [jarun / nnn](https://github.com/jarun/nnn)
    ...
    - language: **C** &nbsp;&nbsp; stars: **11,220** &nbsp;&nbsp; folks: **442**  &nbsp;&nbsp; `343 stars this week`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,528** &nbsp;&nbsp; folks: **15,525**  &nbsp;&nbsp; `777 stars this week`

1. [UKPLab / sentence-transformers](https://github.com/UKPLab/sentence-transformers)
    - Sentence Embeddings with BERT & XLNet
    - language: **Python** &nbsp;&nbsp; stars: **4,837** &nbsp;&nbsp; folks: **912**  &nbsp;&nbsp; `113 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,831** &nbsp;&nbsp; folks: **7,396**  &nbsp;&nbsp; `204 stars this week`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **22,132** &nbsp;&nbsp; folks: **8,542**  &nbsp;&nbsp; `402 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,354** &nbsp;&nbsp; folks: **436**  &nbsp;&nbsp; `1,393 stars this month`
