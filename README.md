...
`更新时间：2026-07-19 06:43:49 +0800`

## 今日热门仓库

1. [Robbyant / lingbot-map](https://github.com/Robbyant/lingbot-map)
    - A feed-forward 3D foundation model for reconstructing scenes from streaming data
    - language: **Python** &nbsp;&nbsp; stars: **12,877** &nbsp;&nbsp; folks: **1,340**  &nbsp;&nbsp; `827 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **58,851** &nbsp;&nbsp; folks: **9,609**  &nbsp;&nbsp; `15,885 stars this month`

1. [stablyai / orca](https://github.com/stablyai/orca)
    - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop and mobile.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,761** &nbsp;&nbsp; folks: **1,568**  &nbsp;&nbsp; `16,048 stars this month`

1. [ogulcancelik / herdr](https://github.com/ogulcancelik/herdr)
    - agent multiplexer that lives in your terminal.
    - language: **Rust** &nbsp;&nbsp; stars: **17,987** &nbsp;&nbsp; folks: **1,150**  &nbsp;&nbsp; `11,568 stars this month`
...
1. [Zackriya-Solutions / meetily](https://github.com/Zackriya-Solutions/meetily)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **25,438** &nbsp;&nbsp; folks: **2,550**  &nbsp;&nbsp; `12,699 stars this month`
...
1. [diegosouzapw / OmniRoute](https://github.com/diegosouzapw/OmniRoute)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,794** &nbsp;&nbsp; folks: **2,688**  &nbsp;&nbsp; `12,026 stars this month`

1. [alibaba / page-agent](https://github.com/alibaba/page-agent)
    - JavaScript in-page GUI agent. Control web interfaces with natural language.
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,031** &nbsp;&nbsp; folks: **2,365**  &nbsp;&nbsp; `8,521 stars this month`

1. [interviewstreet / hiring-agent](https://github.com/interviewstreet/hiring-agent)
    - AI agent to evaluate and score resumes.
    - language: **Python** &nbsp;&nbsp; stars: **6,094** &nbsp;&nbsp; folks: **1,081**  &nbsp;&nbsp; `4,955 stars this month`

1. [Panniantong / Agent-Reach](https://github.com/Panniantong/Agent-Reach)
    - Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.
    - language: **Python** &nbsp;&nbsp; stars: **57,743** &nbsp;&nbsp; folks: **4,627**  &nbsp;&nbsp; `25,126 stars this month`
...
1. [simplex-chat / simplex-chat](https://github.com/simplex-chat/simplex-chat)
    ...
    - language: **Haskell** &nbsp;&nbsp; stars: **18,731** &nbsp;&nbsp; folks: **1,173**  &nbsp;&nbsp; `7,662 stars this month`
...
1. [iOfficeAI / OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)
    - OfficeCLI is the first and best Office suite purpose-built for AI agents to read, edit, and automate Word, Excel, and PowerPoint files. Free, open-source, single binary, no Office installation required.
    - language: **C#** &nbsp;&nbsp; stars: **19,278** &nbsp;&nbsp; folks: **1,296**  &nbsp;&nbsp; `11,556 stars this month`

1. [wonderwhy-er / DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)
    - This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,507** &nbsp;&nbsp; folks: **940**  &nbsp;&nbsp; `2,389 stars this month`

1. [Nutlope / hallmark](https://github.com/Nutlope/hallmark)
    - Anti-AI-slop design skill for Claude Code, Cursor, and Codex.
    - language: **CSS** &nbsp;&nbsp; stars: **12,818** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `8,775 stars this month`

1. [OpenCut-app / OpenCut](https://github.com/OpenCut-app/OpenCut)
    - The open-source CapCut alternative
    - language: **TypeScript** &nbsp;&nbsp; stars: **75,397** &nbsp;&nbsp; folks: **7,591**  &nbsp;&nbsp; `18,999 stars this month`

1. [topoteretes / cognee](https://github.com/topoteretes/cognee)
    - Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term memory across sessions with a self-hosted knowledge graph engine.
    - language: **Python** &nbsp;&nbsp; stars: **28,178** &nbsp;&nbsp; folks: **2,690**  &nbsp;&nbsp; `10,292 stars this month`

1. [bradautomates / claude-video](https://github.com/bradautomates/claude-video)
    - Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude.
    - language: **Python** &nbsp;&nbsp; stars: **9,114** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `6,862 stars this month`
