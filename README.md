...
`更新时间：2022-03-24 12:16:59 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,784** &nbsp;&nbsp; folks: **4,246**  &nbsp;&nbsp; `412 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,915** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `304 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,289** &nbsp;&nbsp; folks: **1,499**  &nbsp;&nbsp; `981 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,490** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `279 stars today`
...
1. [jonkpirateboy / Pass-fur-alle](https://github.com/jonkpirateboy/Pass-fur-alle)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **77** &nbsp;&nbsp; folks: **17**  &nbsp;&nbsp; `18 stars today`

1. [CodeEditApp / CodeEdit](https://github.com/CodeEditApp/CodeEdit)
    - CodeEdit App for macOS – Elevate your code editing experience. Open source, free forever.
    - language: **Swift** &nbsp;&nbsp; stars: **4,594** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `430 stars today`

1. [openmlsys / openmlsys-zh](https://github.com/openmlsys/openmlsys-zh)
    - 《Machine Learning Systems: Design and Implementation》- Chinese Version
    - language: **TeX** &nbsp;&nbsp; stars: **882** &nbsp;&nbsp; folks: **118**  &nbsp;&nbsp; `79 stars today`

1. [datawhalechina / easy-rl](https://github.com/datawhalechina/easy-rl)
    - 强化学习中文教程（蘑菇书），在线阅读地址：https://datawhalechina.github.io/easy-rl/
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **4,031** &nbsp;&nbsp; folks: **1,023**  &nbsp;&nbsp; `106 stars today`

1. [meilisearch / meilisearch](https://github.com/meilisearch/meilisearch)
    - Powerful, fast, and an easy to use search engine
    - language: **Rust** &nbsp;&nbsp; stars: **24,035** &nbsp;&nbsp; folks: **832**  &nbsp;&nbsp; `291 stars today`
...
1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **40,628** &nbsp;&nbsp; folks: **2,764**  &nbsp;&nbsp; `335 stars today`
...
1. [mrd0x / BITB](https://github.com/mrd0x/BITB)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,066** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `108 stars today`
...
1. [peng-zhihui / Dummy-Robot](https://github.com/peng-zhihui/Dummy-Robot)
    - 我的超迷你机械臂机器人项目。
    - language: **C** &nbsp;&nbsp; stars: **6,820** &nbsp;&nbsp; folks: **1,341**  &nbsp;&nbsp; `255 stars this week`

1. [peng-zhihui / ElectronBot](https://github.com/peng-zhihui/ElectronBot)
    - 无
    - language: **C** &nbsp;&nbsp; stars: **3,371** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `732 stars this week`
...
1. [samber / lo](https://github.com/samber/lo)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,040** &nbsp;&nbsp; folks: **116**  &nbsp;&nbsp; `771 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,885** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `353 stars this week`

1. [curl / curl](https://github.com/curl/curl)
    - A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP, FTPS, GOPHER, GOPHERS, HTTP, HTTPS, IMAP, IMAPS, LDAP, LDAPS, MQTT, POP3, POP3S, RTMP, RTMPS, RTSP, SCP, SFTP, SMB, SMBS, SMTP, SMTPS, TELNET and TFTP. libcurl offers a myriad of powerful features
    - language: **C** &nbsp;&nbsp; stars: **24,411** &nbsp;&nbsp; folks: **4,969**  &nbsp;&nbsp; `399 stars this week`
...
1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,915** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `1,408 stars this week`
...
1. [scottbez1 / smartknob](https://github.com/scottbez1/smartknob)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,027** &nbsp;&nbsp; folks: **123**  &nbsp;&nbsp; `692 stars this week`
...
1. [libre-tube / LibreTube](https://github.com/libre-tube/LibreTube)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **1,032** &nbsp;&nbsp; folks: **48**  &nbsp;&nbsp; `292 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,784** &nbsp;&nbsp; folks: **4,246**  &nbsp;&nbsp; `14,904 stars this month`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,583** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `4,253 stars this month`

1. [alibaba / lowcode-engine](https://github.com/alibaba/lowcode-engine)
    - An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,841** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `1,814 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **227,360** &nbsp;&nbsp; folks: **47,997**  &nbsp;&nbsp; `5,301 stars this month`
...
1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    - 👽 Open source API development ecosystem - https://hoppscotch.io
    - language: **Vue** &nbsp;&nbsp; stars: **40,628** &nbsp;&nbsp; folks: **2,764**  &nbsp;&nbsp; `4,014 stars this month`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **61,892** &nbsp;&nbsp; folks: **16,843**  &nbsp;&nbsp; `1,232 stars this month`

1. [iamadamdev / bypass-paywalls-chrome](https://github.com/iamadamdev/bypass-paywalls-chrome)
    - Bypass Paywalls web browser extension for Chrome and Firefox.
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,315** &nbsp;&nbsp; folks: **1,748**  &nbsp;&nbsp; `1,896 stars this month`

1. [vulhub / vulhub](https://github.com/vulhub/vulhub)
    - Pre-Built Vulnerable Environments Based on Docker-Compose
    - language: **Dockerfile** &nbsp;&nbsp; stars: **9,851** &nbsp;&nbsp; folks: **3,348**  &nbsp;&nbsp; `444 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,490** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `2,233 stars this month`
...
1. [mdn / content](https://github.com/mdn/content)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **4,962** &nbsp;&nbsp; folks: **7,535**  &nbsp;&nbsp; `669 stars this month`

1. [facebook / react](https://github.com/facebook/react)
    - A declarative, efficient, and flexible JavaScript library for building user interfaces.
    - language: **JavaScript** &nbsp;&nbsp; stars: **184,807** &nbsp;&nbsp; folks: **37,873**  &nbsp;&nbsp; `2,511 stars this month`
...
1. [vuejs / vue](https://github.com/vuejs/vue)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **194,374** &nbsp;&nbsp; folks: **31,752**  &nbsp;&nbsp; `1,476 stars this month`
