...
1. [grishka / Houseclub](https://github.com/grishka/Houseclub)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,323** &nbsp;&nbsp; folks: **202**  &nbsp;&nbsp; `221 stars today`
...
1. [ai-eks / OpenClubhouse-Worker](https://github.com/ai-eks/OpenClubhouse-Worker)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **83** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `20 stars today`

1. [davidcallanan / os-series](https://github.com/davidcallanan/os-series)
    - 无
    - language: **Assembly** &nbsp;&nbsp; stars: **229** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `50 stars today`
...
1. [Snowtrack / SnowFS](https://github.com/Snowtrack/SnowFS)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **437** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `121 stars today`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **24,465** &nbsp;&nbsp; folks: **4,671**  &nbsp;&nbsp; `107 stars today`

1. [huggingface / transformers](https://github.com/huggingface/transformers)
    - 🤗Transformers: State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0.
    - language: **Python** &nbsp;&nbsp; stars: **41,301** &nbsp;&nbsp; folks: **10,023**  &nbsp;&nbsp; `123 stars today`

1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,446** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `958 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **12,256** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `637 stars today`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,446** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `2,851 stars this week`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,003** &nbsp;&nbsp; folks: **687**  &nbsp;&nbsp; `2,063 stars this week`
...
1. [WerWolv / ImHex](https://github.com/WerWolv/ImHex)
    - A Hex Editor for Reverse Engineers, Programmers and people that value their eye sight when working at 3 AM.
    - language: **C++** &nbsp;&nbsp; stars: **9,640** &nbsp;&nbsp; folks: **419**  &nbsp;&nbsp; `1,148 stars this week`

1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,673** &nbsp;&nbsp; folks: **671**  &nbsp;&nbsp; `732 stars this week`
...
1. [bitwarden / server](https://github.com/bitwarden/server)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,078** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `237 stars this week`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,920** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `433 stars this week`

1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,913** &nbsp;&nbsp; folks: **1,635**  &nbsp;&nbsp; `533 stars this week`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,357** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `1,075 stars this week`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,570** &nbsp;&nbsp; folks: **7,564**  &nbsp;&nbsp; `623 stars this week`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,875** &nbsp;&nbsp; folks: **33,747**  &nbsp;&nbsp; `969 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **12,256** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `4,381 stars this month`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **11,003** &nbsp;&nbsp; folks: **687**  &nbsp;&nbsp; `2,286 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,446** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `3,234 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **35,566** &nbsp;&nbsp; folks: **6,916**  &nbsp;&nbsp; `2,815 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **24,465** &nbsp;&nbsp; folks: **4,671**  &nbsp;&nbsp; `1,296 stars this month`

1. [bitwarden / server](https://github.com/bitwarden/server)
    - The core infrastructure backend (API, database, Docker, etc).
    - language: **C#** &nbsp;&nbsp; stars: **7,078** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `423 stars this month`
