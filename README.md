...
1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,128** &nbsp;&nbsp; folks: **6,090**  &nbsp;&nbsp; `15,978 stars this week`

1. [frankbria / ralph-claude-code](https://github.com/frankbria/ralph-claude-code)
    - Autonomous AI development loop for Claude Code with intelligent exit detection
    - language: **Shell** &nbsp;&nbsp; stars: **2,972** &nbsp;&nbsp; folks: **197**  &nbsp;&nbsp; `2,199 stars this week`
...
1. [MiroMindAI / MiroThinker](https://github.com/MiroMindAI/MiroThinker)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,927** &nbsp;&nbsp; folks: **334**  &nbsp;&nbsp; `2,394 stars this week`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,709** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `3,207 stars this week`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - Claude Code superpowers: core skills library
    - language: **Shell** &nbsp;&nbsp; stars: **23,056** &nbsp;&nbsp; folks: **1,729**  &nbsp;&nbsp; `7,358 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **56,688** &nbsp;&nbsp; folks: **4,140**  &nbsp;&nbsp; `4,087 stars this week`

1. [OpenBMB / ChatDev](https://github.com/OpenBMB/ChatDev)
    - ChatDev 2.0: Dev All through LLM-powered Multi-Agent Collaboration
    - language: **Python** &nbsp;&nbsp; stars: **28,667** &nbsp;&nbsp; folks: **3,616**  &nbsp;&nbsp; `615 stars this week`

1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    - 🕵️‍♂️ All-in-one OSINT tool for analysing any website
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,876** &nbsp;&nbsp; folks: **2,375**  &nbsp;&nbsp; `1,554 stars this week`

1. [ChromeDevTools / chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)
    - Chrome DevTools for coding agents
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,030** &nbsp;&nbsp; folks: **1,264**  &nbsp;&nbsp; `2,037 stars this week`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **77,841** &nbsp;&nbsp; folks: **11,355**  &nbsp;&nbsp; `1,017 stars this week`

1. [NevaMind-AI / memU](https://github.com/NevaMind-AI/memU)
    - Memory infrastructure for LLMs and AI agents
    - language: **Python** &nbsp;&nbsp; stars: **4,611** &nbsp;&nbsp; folks: **316**  &nbsp;&nbsp; `1,077 stars this week`

1. [memvid / memvid](https://github.com/memvid/memvid)
    - Memory layer for AI Agents. Replace complex RAG pipelines with a serverless, single-file memory layer. Give your agents instant retrieval and long-term memory.
    - language: **Rust** &nbsp;&nbsp; stars: **12,326** &nbsp;&nbsp; folks: **1,037**  &nbsp;&nbsp; `1,052 stars this week`
...
1. [google / A2UI](https://github.com/google/A2UI)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,926** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `9,877 stars this month`

1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,128** &nbsp;&nbsp; folks: **6,090**  &nbsp;&nbsp; `30,313 stars this month`

1. [anthropics / skills](https://github.com/anthropics/skills)
    - Public repository for Agent Skills
    - language: **Python** &nbsp;&nbsp; stars: **41,256** &nbsp;&nbsp; folks: **3,792**  &nbsp;&nbsp; `19,658 stars this month`

1. [BloopAI / vibe-kanban](https://github.com/BloopAI/vibe-kanban)
    - Get 10X more out of Claude Code, Codex or any coding agent
    - language: **Rust** &nbsp;&nbsp; stars: **16,123** &nbsp;&nbsp; folks: **1,492**  &nbsp;&nbsp; `9,484 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **56,688** &nbsp;&nbsp; folks: **4,140**  &nbsp;&nbsp; `10,838 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **39,989** &nbsp;&nbsp; folks: **2,700**  &nbsp;&nbsp; `7,308 stars this month`
...
1. [danielmiessler / Personal_AI_Infrastructure](https://github.com/danielmiessler/Personal_AI_Infrastructure)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,640** &nbsp;&nbsp; folks: **756**  &nbsp;&nbsp; `3,241 stars this month`

1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    - SoTA open-source TTS
    - language: **Python** &nbsp;&nbsp; stars: **21,482** &nbsp;&nbsp; folks: **2,805**  &nbsp;&nbsp; `6,531 stars this month`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - Claude Code superpowers: core skills library
    - language: **Shell** &nbsp;&nbsp; stars: **23,056** &nbsp;&nbsp; folks: **1,729**  &nbsp;&nbsp; `11,958 stars this month`

1. [usememos / memos](https://github.com/usememos/memos)
    - An open-source, self-hosted note-taking service. Your thoughts, your data, your control — no tracking, no ads, no subscription fees.
    - language: **Go** &nbsp;&nbsp; stars: **54,206** &nbsp;&nbsp; folks: **3,896**  &nbsp;&nbsp; `7,100 stars this month`

1. [steveyegge / beads](https://github.com/steveyegge/beads)
    - Beads - A memory upgrade for your coding agent
    - language: **Go** &nbsp;&nbsp; stars: **10,297** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `5,159 stars this month`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,709** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `3,792 stars this month`
...
1. [shareAI-lab / learn-claude-code](https://github.com/shareAI-lab/learn-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,250** &nbsp;&nbsp; folks: **3,325**  &nbsp;&nbsp; `2,633 stars this month`

1. [thedotmack / claude-mem](https://github.com/thedotmack/claude-mem)
    - A Claude Code plugin that automatically captures everything Claude does during your coding sessions, compresses it with AI (using Claude's agent-sdk), and injects relevant context back into future sessions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,871** &nbsp;&nbsp; folks: **905**  &nbsp;&nbsp; `8,386 stars this month`

1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    - 🕵️‍♂️ All-in-one OSINT tool for analysing any website
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,876** &nbsp;&nbsp; folks: **2,375**  &nbsp;&nbsp; `2,822 stars this month`

1. [KeygraphHQ / shannon](https://github.com/KeygraphHQ/shannon)
    - Fully autonomous AI hacker to find actual exploits in your web apps. Shannon has achieved a 96.15% success rate on the hint-free, source-aware XBOW Benchmark.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,814** &nbsp;&nbsp; folks: **543**  &nbsp;&nbsp; `3,343 stars this month`
