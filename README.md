...
`更新时间：2022-11-11 04:16:06 +0800`

## 今日热门仓库

1. [ilovexjp / health-code-index](https://github.com/ilovexjp/health-code-index)
    - 健康码模拟 - 索引
    - language: **HTML** &nbsp;&nbsp; stars: **1,622** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `544 stars today`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,191** &nbsp;&nbsp; folks: **6,729**  &nbsp;&nbsp; `40 stars today`

1. [projectdiscovery / katana](https://github.com/projectdiscovery/katana)
    - A next-generation crawling and spidering framework.
    - language: **Go** &nbsp;&nbsp; stars: **2,362** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `551 stars today`

1. [The-Run-Philosophy-Organization / run](https://github.com/The-Run-Philosophy-Organization/run)
    - 润学全球官方指定GITHUB，整理润学宗旨、纲领、理论和各类润之实例；解决为什么润，润去哪里，怎么润三大问题； 并成为新中国人的核心宗教，核心信念。
    - language: **无** &nbsp;&nbsp; stars: **23,603** &nbsp;&nbsp; folks: **1,940**  &nbsp;&nbsp; `472 stars today`

1. [binwiederhier / ntfy](https://github.com/binwiederhier/ntfy)
    - Send push notifications to your phone or desktop using PUT/POST
    - language: **Go** &nbsp;&nbsp; stars: **6,103** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `1,096 stars today`

1. [NVIDIA-Omniverse / PhysX](https://github.com/NVIDIA-Omniverse/PhysX)
    - NVIDIA PhysX SDK
    - language: **C++** &nbsp;&nbsp; stars: **1,022** &nbsp;&nbsp; folks: **66**  &nbsp;&nbsp; `232 stars today`

1. [cozodb / cozo](https://github.com/cozodb/cozo)
    - A general-purpose, transactional, relational database that uses Datalog and focuses on graph data and algorithms
    - language: **Rust** &nbsp;&nbsp; stars: **1,299** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `321 stars today`
...
1. [karpathy / nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,344** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `74 stars today`
...
1. [Zeal8bit / Zeal-8-bit-OS](https://github.com/Zeal8bit/Zeal-8-bit-OS)
    ...
    - language: **Assembly** &nbsp;&nbsp; stars: **246** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `40 stars today`
...
1. [MubertAI / Mubert-Text-to-Music](https://github.com/MubertAI/Mubert-Text-to-Music)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,936** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `155 stars today`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **81,619** &nbsp;&nbsp; folks: **4,657**  &nbsp;&nbsp; `1,019 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,191** &nbsp;&nbsp; folks: **6,729**  &nbsp;&nbsp; `231 stars this week`
...
1. [binwiederhier / ntfy](https://github.com/binwiederhier/ntfy)
    - Send push notifications to your phone or desktop using PUT/POST
    - language: **Go** &nbsp;&nbsp; stars: **6,103** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `2,294 stars this week`
...
1. [algorithm-visualizer / algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer)
    - 🎆Interactive Online Platform that Visualizes Algorithms from Code
    - language: **JavaScript** &nbsp;&nbsp; stars: **40,218** &nbsp;&nbsp; folks: **6,509**  &nbsp;&nbsp; `1,026 stars this month`

1. [python / cpython](https://github.com/python/cpython)
    - The Python programming language
    - language: **Python** &nbsp;&nbsp; stars: **48,784** &nbsp;&nbsp; folks: **24,812**  &nbsp;&nbsp; `873 stars this month`
