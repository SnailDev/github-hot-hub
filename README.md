...
1. [google / model_search](https://github.com/google/model_search)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,918** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `359 stars today`
...
1. [airbnb / javascript](https://github.com/airbnb/javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,336** &nbsp;&nbsp; folks: **20,421**  &nbsp;&nbsp; `211 stars today`
...
1. [nextcloud / server](https://github.com/nextcloud/server)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **13,464** &nbsp;&nbsp; folks: **2,439**  &nbsp;&nbsp; `183 stars today`

1. [dockere / jd-base](https://github.com/dockere/jd-base)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **360** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `29 stars today`
...
1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,004** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `118 stars today`
...
1. [VeryGoodOpenSource / very_good_cli](https://github.com/VeryGoodOpenSource/very_good_cli)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **417** &nbsp;&nbsp; folks: **9**  &nbsp;&nbsp; `144 stars today`
...
1. [WerWolv / ImHex](https://github.com/WerWolv/ImHex)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,760** &nbsp;&nbsp; folks: **428**  &nbsp;&nbsp; `1,309 stars this week`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,197** &nbsp;&nbsp; folks: **1,123**  &nbsp;&nbsp; `1,914 stars this week`
...
1. [coder2gwy / coder2gwy](https://github.com/coder2gwy/coder2gwy)
    ...
    - language: **无** &nbsp;&nbsp; stars: **15,654** &nbsp;&nbsp; folks: **2,323**  &nbsp;&nbsp; `1,626 stars this week`

1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    - 基于代码生成器的低代码平台，超越传统商业平台！前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis-plus，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新低代码开发模式OnlineCoding->代码生成->手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高开发效率，帮助公司节省成本，同时又不失灵活性。
    - language: **Java** &nbsp;&nbsp; stars: **19,634** &nbsp;&nbsp; folks: **7,590**  &nbsp;&nbsp; `676 stars this week`
...
1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,004** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `642 stars this week`
...
1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **97,980** &nbsp;&nbsp; folks: **33,783**  &nbsp;&nbsp; `1,064 stars this week`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,197** &nbsp;&nbsp; folks: **1,123**  &nbsp;&nbsp; `4,194 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,656** &nbsp;&nbsp; folks: **312**  &nbsp;&nbsp; `3,399 stars this month`
...
1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,004** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `763 stars this month`
