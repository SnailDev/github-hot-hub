...
`更新时间：2022-03-24 05:09:42 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,604** &nbsp;&nbsp; folks: **4,220**  &nbsp;&nbsp; `462 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **HTML** &nbsp;&nbsp; stars: **4,820** &nbsp;&nbsp; folks: **730**  &nbsp;&nbsp; `294 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,166** &nbsp;&nbsp; folks: **1,496**  &nbsp;&nbsp; `792 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,422** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `329 stars today`
...
1. [CodeEditApp / CodeEdit](https://github.com/CodeEditApp/CodeEdit)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **4,510** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `830 stars today`
...
1. [meilisearch / meilisearch](https://github.com/meilisearch/meilisearch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **23,933** &nbsp;&nbsp; folks: **830**  &nbsp;&nbsp; `257 stars today`
...
1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **40,536** &nbsp;&nbsp; folks: **2,760**  &nbsp;&nbsp; `374 stars today`

1. [guzzle / guzzle](https://github.com/guzzle/guzzle)
    - Guzzle, an extensible PHP HTTP client
    - language: **PHP** &nbsp;&nbsp; stars: **21,623** &nbsp;&nbsp; folks: **2,282**  &nbsp;&nbsp; `22 stars today`

1. [home-assistant / core](https://github.com/home-assistant/core)
    - 🏡 Open source home automation that puts local control and privacy first.
    - language: **Python** &nbsp;&nbsp; stars: **51,006** &nbsp;&nbsp; folks: **17,578**  &nbsp;&nbsp; `230 stars today`

1. [mrd0x / BITB](https://github.com/mrd0x/BITB)
    - Browser In The Browser (BITB) Templates
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,023** &nbsp;&nbsp; folks: **184**  &nbsp;&nbsp; `128 stars today`
...
1. [AI4Finance-Foundation / FinRL](https://github.com/AI4Finance-Foundation/FinRL)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,607** &nbsp;&nbsp; folks: **1,007**  &nbsp;&nbsp; `38 stars today`
...
1. [trustwallet / assets](https://github.com/trustwallet/assets)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,519** &nbsp;&nbsp; folks: **12,164**  &nbsp;&nbsp; `69 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,565** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `2,483 stars this week`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Secure Backend Server for Web, Mobile & Flutter Developers 🚀 AKA the 100% open-source Firebase alternative.
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,166** &nbsp;&nbsp; folks: **1,496**  &nbsp;&nbsp; `1,072 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,859** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `316 stars this week`

1. [curl / curl](https://github.com/curl/curl)
    - A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP, FTPS, GOPHER, GOPHERS, HTTP, HTTPS, IMAP, IMAPS, LDAP, LDAPS, MQTT, POP3, POP3S, RTMP, RTMPS, RTSP, SCP, SFTP, SMB, SMBS, SMTP, SMTPS, TELNET and TFTP. libcurl offers a myriad of powerful features
    - language: **C** &nbsp;&nbsp; stars: **24,406** &nbsp;&nbsp; folks: **4,969**  &nbsp;&nbsp; `453 stars this week`
...
1. [arthurspk / guiadevbrasil](https://github.com/arthurspk/guiadevbrasil)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,902** &nbsp;&nbsp; folks: **700**  &nbsp;&nbsp; `544 stars this week`
...
1. [cat-milk / Anime-Girls-Holding-Programming-Books](https://github.com/cat-milk/Anime-Girls-Holding-Programming-Books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,920** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `3,579 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **227,332** &nbsp;&nbsp; folks: **47,991**  &nbsp;&nbsp; `5,297 stars this month`
...
1. [hoppscotch / hoppscotch](https://github.com/hoppscotch/hoppscotch)
    - 👽 Open source API development ecosystem - https://hoppscotch.io
    - language: **Vue** &nbsp;&nbsp; stars: **40,536** &nbsp;&nbsp; folks: **2,760**  &nbsp;&nbsp; `3,683 stars this month`
...
1. [OpenIMSDK / Open-IM-Server](https://github.com/OpenIMSDK/Open-IM-Server)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,986** &nbsp;&nbsp; folks: **1,064**  &nbsp;&nbsp; `503 stars this month`
...
1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **61,886** &nbsp;&nbsp; folks: **16,841**  &nbsp;&nbsp; `1,284 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,422** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `2,173 stars this month`
...
1. [mdn / content](https://github.com/mdn/content)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **4,957** &nbsp;&nbsp; folks: **7,526**  &nbsp;&nbsp; `639 stars this month`

1. [facebook / react](https://github.com/facebook/react)
    - A declarative, efficient, and flexible JavaScript library for building user interfaces.
    - language: **JavaScript** &nbsp;&nbsp; stars: **184,783** &nbsp;&nbsp; folks: **37,869**  &nbsp;&nbsp; `2,494 stars this month`

1. [ultralytics / yolov5](https://github.com/ultralytics/yolov5)
    - YOLOv5 🚀 in PyTorch > ONNX > CoreML > TFLite
    - language: **Python** &nbsp;&nbsp; stars: **23,713** &nbsp;&nbsp; folks: **8,453**  &nbsp;&nbsp; `1,401 stars this month`
...
1. [type-challenges / type-challenges](https://github.com/type-challenges/type-challenges)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,827** &nbsp;&nbsp; folks: **1,135**  &nbsp;&nbsp; `1,791 stars this month`

1. [danistefanovic / build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
    - 🤓 Build your own (insert technology here)
    - language: **无** &nbsp;&nbsp; stars: **136,202** &nbsp;&nbsp; folks: **12,951**  &nbsp;&nbsp; `4,059 stars this month`
