...
`更新时间：2024-06-24 13:12:19 +0800`

## 今日热门仓库

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **277,169** &nbsp;&nbsp; folks: **26,066**  &nbsp;&nbsp; `418 stars today`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - The platform for building AI from enterprise data
    - language: **Python** &nbsp;&nbsp; stars: **22,209** &nbsp;&nbsp; folks: **2,945**  &nbsp;&nbsp; `140 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **261,614** &nbsp;&nbsp; folks: **44,398**  &nbsp;&nbsp; `141 stars today`

1. [karpathy / micrograd](https://github.com/karpathy/micrograd)
    - A tiny scalar-valued autograd engine and a neural net library on top of it with PyTorch-like API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,185** &nbsp;&nbsp; folks: **1,256**  &nbsp;&nbsp; `132 stars today`
...
1. [danny-avila / LibreChat](https://github.com/danny-avila/LibreChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,524** &nbsp;&nbsp; folks: **2,431**  &nbsp;&nbsp; `2,153 stars this week`

1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **19,303** &nbsp;&nbsp; folks: **1,841**  &nbsp;&nbsp; `1,864 stars this week`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **62,287** &nbsp;&nbsp; folks: **8,421**  &nbsp;&nbsp; `1,121 stars this week`

1. [Stability-AI / StableSwarmUI](https://github.com/Stability-AI/StableSwarmUI)
    - StableSwarmUI, A Modular Stable Diffusion Web-User-Interface, with an emphasis on making powertools easily accessible, high performance, and extensibility.
    - language: **C#** &nbsp;&nbsp; stars: **3,890** &nbsp;&nbsp; folks: **322**  &nbsp;&nbsp; `665 stars this week`

1. [projectdiscovery / katana](https://github.com/projectdiscovery/katana)
    - A next-generation crawling and spidering framework.
    - language: **Go** &nbsp;&nbsp; stars: **9,602** &nbsp;&nbsp; folks: **498**  &nbsp;&nbsp; `610 stars this week`

1. [bigskysoftware / htmx](https://github.com/bigskysoftware/htmx)
    - </> htmx - high power tools for HTML
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,745** &nbsp;&nbsp; folks: **1,152**  &nbsp;&nbsp; `471 stars this week`

1. [pocketbase / pocketbase](https://github.com/pocketbase/pocketbase)
    - Open Source realtime backend in 1 file
    - language: **Go** &nbsp;&nbsp; stars: **35,591** &nbsp;&nbsp; folks: **1,594**  &nbsp;&nbsp; `859 stars this week`

1. [NVIDIA / warp](https://github.com/NVIDIA/warp)
    - A Python framework for high performance GPU simulation and graphics
    - language: **Python** &nbsp;&nbsp; stars: **3,428** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `818 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,460** &nbsp;&nbsp; folks: **1,989**  &nbsp;&nbsp; `852 stars this week`

1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - The most widely used, high performance Minecraft server that aims to fix gameplay and mechanics inconsistencies
    - language: **Java** &nbsp;&nbsp; stars: **9,308** &nbsp;&nbsp; folks: **2,186**  &nbsp;&nbsp; `286 stars this week`
...
1. [labmlai / annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **50,632** &nbsp;&nbsp; folks: **5,242**  &nbsp;&nbsp; `679 stars this week`
...
1. [vanna-ai / vanna](https://github.com/vanna-ai/vanna)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,649** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `650 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop, and alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **67,233** &nbsp;&nbsp; folks: **7,424**  &nbsp;&nbsp; `1,272 stars this week`

1. [Anjok07 / ultimatevocalremovergui](https://github.com/Anjok07/ultimatevocalremovergui)
    - GUI for a Vocal Remover that uses Deep Neural Networks.
    - language: **Python** &nbsp;&nbsp; stars: **16,331** &nbsp;&nbsp; folks: **1,230**  &nbsp;&nbsp; `646 stars this week`
...
1. [paul-gauthier / aider](https://github.com/paul-gauthier/aider)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,156** &nbsp;&nbsp; folks: **1,156**  &nbsp;&nbsp; `381 stars this week`

1. [practical-tutorials / project-based-learning](https://github.com/practical-tutorials/project-based-learning)
    - Curated list of project-based tutorials
    - language: **无** &nbsp;&nbsp; stars: **178,838** &nbsp;&nbsp; folks: **23,464**  &nbsp;&nbsp; `1,907 stars this week`
...
1. [coollabsio / coolify](https://github.com/coollabsio/coolify)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,409** &nbsp;&nbsp; folks: **1,291**  &nbsp;&nbsp; `8,930 stars this month`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **277,169** &nbsp;&nbsp; folks: **26,066**  &nbsp;&nbsp; `13,050 stars this month`

1. [duckdb / duckdb](https://github.com/duckdb/duckdb)
    - DuckDB is an analytical in-process SQL database management system
    - language: **C++** &nbsp;&nbsp; stars: **20,072** &nbsp;&nbsp; folks: **1,621**  &nbsp;&nbsp; `2,778 stars this month`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,870** &nbsp;&nbsp; folks: **4,244**  &nbsp;&nbsp; `4,292 stars this month`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-Llama3-V 2.5: A GPT-4V Level Multimodal LLM on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **7,518** &nbsp;&nbsp; folks: **521**  &nbsp;&nbsp; `4,482 stars this month`

1. [Stability-AI / StableSwarmUI](https://github.com/Stability-AI/StableSwarmUI)
    - StableSwarmUI, A Modular Stable Diffusion Web-User-Interface, with an emphasis on making powertools easily accessible, high performance, and extensibility.
    - language: **C#** &nbsp;&nbsp; stars: **3,890** &nbsp;&nbsp; folks: **322**  &nbsp;&nbsp; `1,291 stars this month`
...
1. [JanDeDobbeleer / oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,545** &nbsp;&nbsp; folks: **2,279**  &nbsp;&nbsp; `1,134 stars this month`

1. [k2-fsa / sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx)
    - Speech-to-text, text-to-speech, and speaker recognition using next-gen Kaldi with onnxruntime without Internet connection. Support embedded systems, Android, iOS, Raspberry Pi, RISC-V, x86_64 servers, websocket server/client, C/C++, Python, Kotlin, C#, Go, NodeJS, Java, Swift, Dart, JavaScript, Flutter
    - language: **C++** &nbsp;&nbsp; stars: **2,038** &nbsp;&nbsp; folks: **263**  &nbsp;&nbsp; `1,075 stars this month`

1. [vanna-ai / vanna](https://github.com/vanna-ai/vanna)
    - 🤖 Chat with your SQL database 📊. Accurate Text-to-SQL Generation via LLMs using RAG 🔄.
    - language: **Python** &nbsp;&nbsp; stars: **8,649** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `1,267 stars this month`
...
1. [VikParuchuri / marker](https://github.com/VikParuchuri/marker)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,213** &nbsp;&nbsp; folks: **658**  &nbsp;&nbsp; `4,204 stars this month`
