...
1. [Tencent / tdesign-react](https://github.com/Tencent/tdesign-react)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **209** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `36 stars today`

1. [fanux / sealos](https://github.com/fanux/sealos)
    - 一条命令离线安装高可用kubernetes，3min装完，700M，100年证书，版本不要太全，生产环境稳如老狗
    - language: **Go** &nbsp;&nbsp; stars: **5,658** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `74 stars today`
...
1. [wailsapp / wails](https://github.com/wailsapp/wails)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,255** &nbsp;&nbsp; folks: **263**  &nbsp;&nbsp; `169 stars today`

1. [ssssssss-team / spider-flow](https://github.com/ssssssss-team/spider-flow)
    - 新一代爬虫平台，以图形化方式定义爬虫流程，不写代码即可完成爬虫。
    - language: **Java** &nbsp;&nbsp; stars: **3,712** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `78 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **89,648** &nbsp;&nbsp; folks: **9,535**  &nbsp;&nbsp; `212 stars today`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **50,045** &nbsp;&nbsp; folks: **4,886**  &nbsp;&nbsp; `348 stars today`

1. [wader / fq](https://github.com/wader/fq)
    - jq for binary formats
    - language: **Go** &nbsp;&nbsp; stars: **2,548** &nbsp;&nbsp; folks: **40**  &nbsp;&nbsp; `257 stars today`

1. [easychen / pushdeer](https://github.com/easychen/pushdeer)
    - 开放源码的无App推送服务，🚧 WIP
    - language: **PHP** &nbsp;&nbsp; stars: **360** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `31 stars today`

1. [airbnb / javascript](https://github.com/airbnb/javascript)
    - JavaScript Style Guide
    - language: **JavaScript** &nbsp;&nbsp; stars: **117,638** &nbsp;&nbsp; folks: **22,445**  &nbsp;&nbsp; `113 stars today`

1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **15,880** &nbsp;&nbsp; folks: **1,973**  &nbsp;&nbsp; `39 stars today`

1. [prisma / prisma](https://github.com/prisma/prisma)
    - Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite & MongoDB (Preview)
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,947** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `183 stars today`

1. [Tencent / tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next)
    - A Vue3.x UI components lib for TDesign.
    - language: **TypeScript** &nbsp;&nbsp; stars: **133** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `30 stars today`
...
1. [freeCodeCamp / LearnToCodeRPG](https://github.com/freeCodeCamp/LearnToCodeRPG)
    ...
    - language: **Ren'Py** &nbsp;&nbsp; stars: **292** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `83 stars today`
...
1. [parallel101 / course](https://github.com/parallel101/course)
    - 高性能并行编程与优化 - 课件
    - language: **C++** &nbsp;&nbsp; stars: **648** &nbsp;&nbsp; folks: **81**  &nbsp;&nbsp; `173 stars this week`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,162** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `1,310 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    - GFPGAN aims at developing Practical Algorithms for Real-world Face Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **13,838** &nbsp;&nbsp; folks: **2,041**  &nbsp;&nbsp; `10,119 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Roadmap to becoming a developer in 2021
    - language: **TypeScript** &nbsp;&nbsp; stars: **181,474** &nbsp;&nbsp; folks: **26,066**  &nbsp;&nbsp; `5,255 stars this month`
...
1. [phoboslab / qoi](https://github.com/phoboslab/qoi)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,782** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `2,478 stars this month`
...
1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **13,774** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `5,785 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **217,088** &nbsp;&nbsp; folks: **46,587**  &nbsp;&nbsp; `5,903 stars this month`
...
1. [remix-run / remix](https://github.com/remix-run/remix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,464** &nbsp;&nbsp; folks: **564**  &nbsp;&nbsp; `3,805 stars this month`

1. [pengzhiliang / MAE-pytorch](https://github.com/pengzhiliang/MAE-pytorch)
    - Unofficial PyTorch implementation of Masked Autoencoders Are Scalable Vision Learners
    - language: **Python** &nbsp;&nbsp; stars: **1,740** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `883 stars this month`

1. [elastic / elasticsearch](https://github.com/elastic/elasticsearch)
    - Free and Open, Distributed, RESTful Search Engine
    - language: **Java** &nbsp;&nbsp; stars: **57,880** &nbsp;&nbsp; folks: **21,046**  &nbsp;&nbsp; `596 stars this month`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,482** &nbsp;&nbsp; folks: **950**  &nbsp;&nbsp; `3,119 stars this month`
