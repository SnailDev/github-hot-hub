...
1. [zijie0 / HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,154** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `838 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,967** &nbsp;&nbsp; folks: **4,726**  &nbsp;&nbsp; `114 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,395** &nbsp;&nbsp; folks: **3,166**  &nbsp;&nbsp; `308 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-js](https://github.com/smartcontractkit/full-blockchain-solidity-course-js)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,509** &nbsp;&nbsp; folks: **271**  &nbsp;&nbsp; `309 stars today`
...
1. [xianfei / SysMocap](https://github.com/xianfei/SysMocap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **455** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `129 stars today`
...
1. [cookiecutter / cookiecutter](https://github.com/cookiecutter/cookiecutter)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,031** &nbsp;&nbsp; folks: **1,654**  &nbsp;&nbsp; `22 stars today`

1. [skyline-emu / skyline](https://github.com/skyline-emu/skyline)
    - Run Nintendo Switch homebrew & games on your Android device!
    - language: **C++** &nbsp;&nbsp; stars: **8,080** &nbsp;&nbsp; folks: **1,176**  &nbsp;&nbsp; `113 stars today`
...
1. [lensapp / lens](https://github.com/lensapp/lens)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,436** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `843 stars this week`
...
1. [PaddlePaddle / PaddleSpeech](https://github.com/PaddlePaddle/PaddleSpeech)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,036** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `653 stars this week`
...
1. [nocobase / nocobase](https://github.com/nocobase/nocobase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,124** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `955 stars this week`

1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,395** &nbsp;&nbsp; folks: **3,166**  &nbsp;&nbsp; `1,263 stars this week`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **19,260** &nbsp;&nbsp; folks: **2,107**  &nbsp;&nbsp; `1,538 stars this week`
...
1. [deepmind / mujoco](https://github.com/deepmind/mujoco)
    ...
    - language: **C** &nbsp;&nbsp; stars: **4,283** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `503 stars this week`

1. [microsoft / Data-Science-For-Beginners](https://github.com/microsoft/Data-Science-For-Beginners)
    - 10 Weeks, 20 Lessons, Data Science for All!
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,250** &nbsp;&nbsp; folks: **2,160**  &nbsp;&nbsp; `1,168 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **142,823** &nbsp;&nbsp; folks: **23,591**  &nbsp;&nbsp; `1,371 stars this week`
...
1. [ansh / bionic-reading](https://github.com/ansh/bionic-reading)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,279** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `818 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **194,729** &nbsp;&nbsp; folks: **22,435**  &nbsp;&nbsp; `919 stars this week`
...
1. [pyscript / pyscript](https://github.com/pyscript/pyscript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,127** &nbsp;&nbsp; folks: **815**  &nbsp;&nbsp; `11,399 stars this month`
...
1. [Grasscutters / Grasscutter](https://github.com/Grasscutters/Grasscutter)
    - A server software reimplementation for a certain anime game.
    - language: **Java** &nbsp;&nbsp; stars: **7,763** &nbsp;&nbsp; folks: **2,760**  &nbsp;&nbsp; `4,636 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,945** &nbsp;&nbsp; folks: **1,915**  &nbsp;&nbsp; `4,484 stars this month`
...
1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,376** &nbsp;&nbsp; folks: **4,564**  &nbsp;&nbsp; `2,194 stars this month`
...
1. [lensapp / lens](https://github.com/lensapp/lens)
    - Lens - The way the world runs Kubernetes
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,436** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `1,007 stars this month`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,395** &nbsp;&nbsp; folks: **3,166**  &nbsp;&nbsp; `1,797 stars this month`
