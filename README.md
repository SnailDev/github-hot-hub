...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,260** &nbsp;&nbsp; folks: **434**  &nbsp;&nbsp; `131 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **193** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `133 stars today`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **12,008** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `362 stars today`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **无** &nbsp;&nbsp; stars: **110,102** &nbsp;&nbsp; folks: **36,797**  &nbsp;&nbsp; `226 stars today`

1. [Alamofire / Alamofire](https://github.com/Alamofire/Alamofire)
    - Elegant HTTP Networking in Swift
    - language: **Swift** &nbsp;&nbsp; stars: **35,615** &nbsp;&nbsp; folks: **6,649**  &nbsp;&nbsp; `69 stars today`

1. [gatsbyjs / gatsby](https://github.com/gatsbyjs/gatsby)
    - Build blazing fast, modern apps and websites with React
    - language: **JavaScript** &nbsp;&nbsp; stars: **49,971** &nbsp;&nbsp; folks: **9,494**  &nbsp;&nbsp; `113 stars today`

1. [microsoft / wslg](https://github.com/microsoft/wslg)
    - Enabling the Windows Subsystem for Linux to include support for Wayland and X server related scenarios
    - language: **C++** &nbsp;&nbsp; stars: **1,412** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `440 stars today`

1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,759** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `102 stars today`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **22,083** &nbsp;&nbsp; folks: **8,524**  &nbsp;&nbsp; `88 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **38,288** &nbsp;&nbsp; folks: **7,113**  &nbsp;&nbsp; `116 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,473** &nbsp;&nbsp; folks: **446**  &nbsp;&nbsp; `2,329 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,726** &nbsp;&nbsp; folks: **887**  &nbsp;&nbsp; `832 stars this week`

1. [calendso / calendso](https://github.com/calendso/calendso)
    - The open-source Calendly alternative.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,195** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `1,791 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,179** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `2,072 stars this week`
...
1. [ferib / D2R-Offline](https://github.com/ferib/D2R-Offline)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **489** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `274 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,969** &nbsp;&nbsp; folks: **579**  &nbsp;&nbsp; `1,514 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **165,181** &nbsp;&nbsp; folks: **45,669**  &nbsp;&nbsp; `2,412 stars this week`

1. [peterq / pan-light](https://github.com/peterq/pan-light)
    - 百度网盘不限速客户端, golang + qt5, 跨平台图形界面
    - language: **Go** &nbsp;&nbsp; stars: **11,490** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `314 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,276** &nbsp;&nbsp; folks: **4,806**  &nbsp;&nbsp; `1,055 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,830** &nbsp;&nbsp; folks: **7,959**  &nbsp;&nbsp; `2,093 stars this week`
...
1. [vectorizedio / redpanda](https://github.com/vectorizedio/redpanda)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,103** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `102 stars this week`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,564** &nbsp;&nbsp; folks: **2,113**  &nbsp;&nbsp; `146 stars this week`
...
1. [Kethku / neovide](https://github.com/Kethku/neovide)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,490** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `1,287 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,425** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `1,196 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,548** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `2,780 stars this month`
...
1. [Uniswap / uniswap-v3-core](https://github.com/Uniswap/uniswap-v3-core)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **620** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `445 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,830** &nbsp;&nbsp; folks: **7,959**  &nbsp;&nbsp; `3,265 stars this month`
