...
1. [sharkdp / fd](https://github.com/sharkdp/fd)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **18,425** &nbsp;&nbsp; folks: **467**  &nbsp;&nbsp; `100 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **108,805** &nbsp;&nbsp; folks: **37,360**  &nbsp;&nbsp; `93 stars today`
...
1. [PeterWang512 / GANSketching](https://github.com/PeterWang512/GANSketching)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **254** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `57 stars today`

1. [arendst / Tasmota](https://github.com/arendst/Tasmota)
    - Alternative firmware for ESP8266 with easy configuration using webUI, OTA updates, automation using timers or rules, expandability and entirely local control over MQTT, HTTP, Serial or KNX. Full documentation at
    - language: **C** &nbsp;&nbsp; stars: **15,893** &nbsp;&nbsp; folks: **3,463**  &nbsp;&nbsp; `99 stars today`
...
1. [tmrts / go-patterns](https://github.com/tmrts/go-patterns)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **16,144** &nbsp;&nbsp; folks: **1,516**  &nbsp;&nbsp; `135 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **93,408** &nbsp;&nbsp; folks: **12,779**  &nbsp;&nbsp; `242 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **116,100** &nbsp;&nbsp; folks: **19,164**  &nbsp;&nbsp; `236 stars today`
...
1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,314** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `391 stars this week`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **2,926** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `1,475 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,850** &nbsp;&nbsp; folks: **5,322**  &nbsp;&nbsp; `746 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **28,437** &nbsp;&nbsp; folks: **5,363**  &nbsp;&nbsp; `2,031 stars this week`

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **2,039** &nbsp;&nbsp; folks: **93**  &nbsp;&nbsp; `1,190 stars this week`
...
1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    ...
    - language: **无** &nbsp;&nbsp; stars: **15,122** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `1,605 stars this week`
...
1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,561** &nbsp;&nbsp; folks: **1,457**  &nbsp;&nbsp; `192 stars this week`
...
1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,194** &nbsp;&nbsp; folks: **1,498**  &nbsp;&nbsp; `403 stars this week`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,389** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `762 stars this week`
...
1. [facebookresearch / droidlet](https://github.com/facebookresearch/droidlet)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **608** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `154 stars this week`
...
1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,622** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `6,338 stars this month`
...
1. [quii / learn-go-with-tests](https://github.com/quii/learn-go-with-tests)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,063** &nbsp;&nbsp; folks: **1,916**  &nbsp;&nbsp; `447 stars this month`
