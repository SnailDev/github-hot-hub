...
`更新时间：2021-04-14 08:43:37 +0800`

## 今日热门仓库

1. [foxlet / macOS-Simple-KVM](https://github.com/foxlet/macOS-Simple-KVM)
    - Tools to set up a quick macOS VM in QEMU, accelerated by KVM.
    - language: **Shell** &nbsp;&nbsp; stars: **10,223** &nbsp;&nbsp; folks: **838**  &nbsp;&nbsp; `110 stars today`
...
1. [Layout-Parser / layout-parser](https://github.com/Layout-Parser/layout-parser)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,612** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `150 stars today`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **1,372** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `116 stars today`
...
1. [DidierRLopes / GamestonkTerminal](https://github.com/DidierRLopes/GamestonkTerminal)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,797** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `125 stars today`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **22,482** &nbsp;&nbsp; folks: **5,576**  &nbsp;&nbsp; `181 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **14,421** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `215 stars today`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,500** &nbsp;&nbsp; folks: **2,262**  &nbsp;&nbsp; `217 stars today`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,787** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `336 stars today`
...
1. [nordicgiant2 / awesome-landing-page](https://github.com/nordicgiant2/awesome-landing-page)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,502** &nbsp;&nbsp; folks: **108**  &nbsp;&nbsp; `305 stars today`
...
1. [leonardomso / 33-js-concepts](https://github.com/leonardomso/33-js-concepts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,742** &nbsp;&nbsp; folks: **4,737**  &nbsp;&nbsp; `148 stars today`

1. [lydiahallie / javascript-questions](https://github.com/lydiahallie/javascript-questions)
    - A long list of (advanced) JavaScript questions, and their explanations ✨
    - language: **无** &nbsp;&nbsp; stars: **32,076** &nbsp;&nbsp; folks: **4,202**  &nbsp;&nbsp; `271 stars today`
...
1. [signalapp / Signal-Server](https://github.com/signalapp/Signal-Server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **6,507** &nbsp;&nbsp; folks: **1,515**  &nbsp;&nbsp; `584 stars this week`
...
1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,640** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `1,092 stars this week`
...
1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,105** &nbsp;&nbsp; folks: **441**  &nbsp;&nbsp; `613 stars this week`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,500** &nbsp;&nbsp; folks: **2,262**  &nbsp;&nbsp; `674 stars this week`

1. [streamich / react-use](https://github.com/streamich/react-use)
    - React Hooks — 👍
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,412** &nbsp;&nbsp; folks: **1,508**  &nbsp;&nbsp; `740 stars this week`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,787** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `1,131 stars this week`
...
1. [johnBuffer / AntSimulator](https://github.com/johnBuffer/AntSimulator)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,225** &nbsp;&nbsp; folks: **175**  &nbsp;&nbsp; `190 stars this week`
...
1. [react-hook-form / react-hook-form](https://github.com/react-hook-form/react-hook-form)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,986** &nbsp;&nbsp; folks: **913**  &nbsp;&nbsp; `290 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **37,770** &nbsp;&nbsp; folks: **7,163**  &nbsp;&nbsp; `1,525 stars this week`
...
1. [scikit-learn / scikit-learn](https://github.com/scikit-learn/scikit-learn)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,344** &nbsp;&nbsp; folks: **21,304**  &nbsp;&nbsp; `236 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **1,372** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `247 stars this week`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Roadmap to becoming a web developer in 2021
    - language: **无** &nbsp;&nbsp; stars: **154,231** &nbsp;&nbsp; folks: **22,540**  &nbsp;&nbsp; `832 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **10,521** &nbsp;&nbsp; folks: **1,243**  &nbsp;&nbsp; `4,923 stars this month`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **1,372** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `999 stars this month`
...
1. [nasa / openmct](https://github.com/nasa/openmct)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,698** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `712 stars this month`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,230** &nbsp;&nbsp; folks: **1,089**  &nbsp;&nbsp; `3,411 stars this month`
...
1. [OpenZeppelin / openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,896** &nbsp;&nbsp; folks: **4,474**  &nbsp;&nbsp; `481 stars this month`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,500** &nbsp;&nbsp; folks: **2,262**  &nbsp;&nbsp; `921 stars this month`
