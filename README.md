...
`更新时间：2022-02-01 14:14:14 +0800`

## 今日热门仓库

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **16,461** &nbsp;&nbsp; folks: **792**  &nbsp;&nbsp; `351 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,571** &nbsp;&nbsp; folks: **4,697**  &nbsp;&nbsp; `214 stars today`

1. [nodejs / node](https://github.com/nodejs/node)
    - Node.js JavaScript runtime ✨🐢🚀✨
    - language: **JavaScript** &nbsp;&nbsp; stars: **84,947** &nbsp;&nbsp; folks: **22,602**  &nbsp;&nbsp; `138 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **18,208** &nbsp;&nbsp; folks: **1,298**  &nbsp;&nbsp; `185 stars today`

1. [nextui-org / nextui](https://github.com/nextui-org/nextui)
    - 🚀 Beautiful, fast and modern React UI library.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,024** &nbsp;&nbsp; folks: **156**  &nbsp;&nbsp; `474 stars today`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **785** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `188 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,662** &nbsp;&nbsp; folks: **5,604**  &nbsp;&nbsp; `250 stars today`
...
1. [Koenkk / zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,524** &nbsp;&nbsp; folks: **1,217**  &nbsp;&nbsp; `70 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **30,313** &nbsp;&nbsp; folks: **4,456**  &nbsp;&nbsp; `485 stars today`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,686** &nbsp;&nbsp; folks: **1,861**  &nbsp;&nbsp; `62 stars today`
...
1. [veler / DevToys](https://github.com/veler/DevToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,187** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `1,904 stars this week`

1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,662** &nbsp;&nbsp; folks: **5,604**  &nbsp;&nbsp; `1,098 stars this week`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **52,870** &nbsp;&nbsp; folks: **4,409**  &nbsp;&nbsp; `727 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **178,585** &nbsp;&nbsp; folks: **20,558**  &nbsp;&nbsp; `1,182 stars this week`
...
1. [akutz / go-generics-the-hard-way](https://github.com/akutz/go-generics-the-hard-way)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,295** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `413 stars this week`
...
1. [DustinBrett / daedalOS](https://github.com/DustinBrett/daedalOS)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,808** &nbsp;&nbsp; folks: **184**  &nbsp;&nbsp; `796 stars this week`
...
1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,375** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `516 stars this week`

1. [khuedoan / homelab](https://github.com/khuedoan/homelab)
    - My self-hosting infrastructure, fully automated from empty disk to operating services
    - language: **Python** &nbsp;&nbsp; stars: **5,061** &nbsp;&nbsp; folks: **259**  &nbsp;&nbsp; `782 stars this week`

1. [imcuttle / mometa](https://github.com/imcuttle/mometa)
    - 🛠 [Beta] 面向研发的低代码元编程，代码可视编辑，辅助编码工具
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,984** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `406 stars this week`

1. [nektos / act](https://github.com/nektos/act)
    - Run your GitHub Actions locally 🚀
    - language: **Go** &nbsp;&nbsp; stars: **21,121** &nbsp;&nbsp; folks: **554**  &nbsp;&nbsp; `341 stars this week`
...
1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,686** &nbsp;&nbsp; folks: **1,861**  &nbsp;&nbsp; `1,190 stars this month`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,662** &nbsp;&nbsp; folks: **5,604**  &nbsp;&nbsp; `1,618 stars this month`
