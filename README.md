...
`更新时间：2021-07-03 01:19:09 +0800`

## 今日热门仓库

1. [CorentinJ / Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)
    - Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **26,273** &nbsp;&nbsp; folks: **4,966**  &nbsp;&nbsp; `525 stars today`
...
1. [Shopify / dawn](https://github.com/Shopify/dawn)
    ...
    - language: **Liquid** &nbsp;&nbsp; stars: **608** &nbsp;&nbsp; folks: **435**  &nbsp;&nbsp; `202 stars today`
...
1. [mirumee / saleor](https://github.com/mirumee/saleor)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,655** &nbsp;&nbsp; folks: **3,756**  &nbsp;&nbsp; `7 stars today`

1. [mhadidg / software-architecture-books](https://github.com/mhadidg/software-architecture-books)
    - A comprehensive list of books on Software Architecture.
    - language: **无** &nbsp;&nbsp; stars: **3,405** &nbsp;&nbsp; folks: **153**  &nbsp;&nbsp; `472 stars today`

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **27,269** &nbsp;&nbsp; folks: **4,331**  &nbsp;&nbsp; `178 stars today`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **4,230** &nbsp;&nbsp; folks: **1,314**  &nbsp;&nbsp; `48 stars today`
...
1. [solidjs / solid](https://github.com/solidjs/solid)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,300** &nbsp;&nbsp; folks: **206**  &nbsp;&nbsp; `446 stars today`
...
1. [CorentinJ / Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)
    - Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **26,273** &nbsp;&nbsp; folks: **4,966**  &nbsp;&nbsp; `1,389 stars this week`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **28,309** &nbsp;&nbsp; folks: **3,828**  &nbsp;&nbsp; `2,035 stars this week`
...
1. [facebook / docusaurus](https://github.com/facebook/docusaurus)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,850** &nbsp;&nbsp; folks: **3,179**  &nbsp;&nbsp; `666 stars this week`

1. [fent / node-ytdl-core](https://github.com/fent/node-ytdl-core)
    - YouTube video downloader in javascript.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,656** &nbsp;&nbsp; folks: **446**  &nbsp;&nbsp; `257 stars this week`
...
1. [PyTorchLightning / pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,359** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `389 stars this week`
...
1. [JDHelloWorld / jd_scripts](https://github.com/JDHelloWorld/jd_scripts)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **763** &nbsp;&nbsp; folks: **407**  &nbsp;&nbsp; `163 stars this week`

1. [curtinlv / JD-Script](https://github.com/curtinlv/JD-Script)
    - 菜鸟写的脚本，仅供参考。
    - language: **Python** &nbsp;&nbsp; stars: **556** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `142 stars this week`

1. [mui-org / material-ui](https://github.com/mui-org/material-ui)
    - Material-UI is a simple and customizable component library to build faster, beautiful, and more accessible React applications. Follow your own design system, or start with Material Design.
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,115** &nbsp;&nbsp; folks: **22,713**  &nbsp;&nbsp; `215 stars this week`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **105,434** &nbsp;&nbsp; folks: **41,858**  &nbsp;&nbsp; `392 stars this week`

1. [lensapp / lens](https://github.com/lensapp/lens)
    - Lens - The Kubernetes IDE
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,968** &nbsp;&nbsp; folks: **722**  &nbsp;&nbsp; `545 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **27,269** &nbsp;&nbsp; folks: **4,331**  &nbsp;&nbsp; `749 stars this week`
...
1. [pytorch / pytorch](https://github.com/pytorch/pytorch)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **49,214** &nbsp;&nbsp; folks: **13,349**  &nbsp;&nbsp; `177 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **137,262** &nbsp;&nbsp; folks: **25,047**  &nbsp;&nbsp; `821 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **78,978** &nbsp;&nbsp; folks: **8,520**  &nbsp;&nbsp; `1,024 stars this week`

1. [JaidedAI / EasyOCR](https://github.com/JaidedAI/EasyOCR)
    - Ready-to-use OCR with 80+ supported languages and all popular writing scripts including Latin, Chinese, Arabic, Devanagari, Cyrillic and etc.
    - language: **Python** &nbsp;&nbsp; stars: **11,881** &nbsp;&nbsp; folks: **1,398**  &nbsp;&nbsp; `103 stars this week`
...
1. [biancangming / wtv](https://github.com/biancangming/wtv)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,936** &nbsp;&nbsp; folks: **480**  &nbsp;&nbsp; `1,188 stars this month`
