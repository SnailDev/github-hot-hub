...
`更新时间：2022-01-19 18:12:28 +0800`

## 今日热门仓库

1. [DataTalksClub / data-engineering-zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
    - Code for Data Engineer Zoomcamp course
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,105** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `247 stars today`

1. [XProger / OpenLara](https://github.com/XProger/OpenLara)
    - Classic Tomb Raider open-source engine
    - language: **C** &nbsp;&nbsp; stars: **3,330** &nbsp;&nbsp; folks: **287**  &nbsp;&nbsp; `190 stars today`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,736** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `103 stars today`

1. [sivan / heti](https://github.com/sivan/heti)
    - 赫蹏（hètí）是专为中文内容展示设计的排版样式增强。它基于通行的中文排版规范而来，可以为网站的读者带来更好的文章阅读体验。
    - language: **SCSS** &nbsp;&nbsp; stars: **3,144** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `568 stars today`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **27,499** &nbsp;&nbsp; folks: **1,959**  &nbsp;&nbsp; `239 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **175,099** &nbsp;&nbsp; folks: **20,229**  &nbsp;&nbsp; `411 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,392** &nbsp;&nbsp; folks: **113**  &nbsp;&nbsp; `173 stars today`
...
1. [NVlabs / instant-ngp](https://github.com/NVlabs/instant-ngp)
    ...
    - language: **Cuda** &nbsp;&nbsp; stars: **1,767** &nbsp;&nbsp; folks: **126**  &nbsp;&nbsp; `281 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-py](https://github.com/smartcontractkit/full-blockchain-solidity-course-py)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,247** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `157 stars today`
...
1. [revoxhere / duino-coin](https://github.com/revoxhere/duino-coin)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **569** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `17 stars today`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **5,809** &nbsp;&nbsp; folks: **603**  &nbsp;&nbsp; `1,397 stars this week`

1. [faker-js / faker](https://github.com/faker-js/faker)
    - Generate massive amounts of fake data in the browser and node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,325** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `1,495 stars this week`
...
1. [Textualize / rich](https://github.com/Textualize/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,534** &nbsp;&nbsp; folks: **1,078**  &nbsp;&nbsp; `1,403 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,488** &nbsp;&nbsp; folks: **2,973**  &nbsp;&nbsp; `846 stars this week`
...
1. [facebookresearch / mae](https://github.com/facebookresearch/mae)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,172** &nbsp;&nbsp; folks: **197**  &nbsp;&nbsp; `671 stars this week`
...
1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,736** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `422 stars this week`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,168** &nbsp;&nbsp; folks: **621**  &nbsp;&nbsp; `81 stars this week`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **27,499** &nbsp;&nbsp; folks: **1,959**  &nbsp;&nbsp; `4,785 stars this month`
...
1. [QSCTech / zju-icicles](https://github.com/QSCTech/zju-icicles)
    - 浙江大学课程攻略共享计划
    - language: **HTML** &nbsp;&nbsp; stars: **24,954** &nbsp;&nbsp; folks: **7,327**  &nbsp;&nbsp; `1,138 stars this month`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,071** &nbsp;&nbsp; folks: **1,187**  &nbsp;&nbsp; `3,638 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **158,917** &nbsp;&nbsp; folks: **29,368**  &nbsp;&nbsp; `4,720 stars this month`
