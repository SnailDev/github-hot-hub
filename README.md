...
1. [grishka / Houseclub](https://github.com/grishka/Houseclub)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,338** &nbsp;&nbsp; folks: **202**  &nbsp;&nbsp; `206 stars today`
...
1. [Snowtrack / SnowFS](https://github.com/Snowtrack/SnowFS)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **465** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `205 stars today`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **24,495** &nbsp;&nbsp; folks: **4,674**  &nbsp;&nbsp; `131 stars today`

1. [huggingface / transformers](https://github.com/huggingface/transformers)
    - 🤗Transformers: State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0.
    - language: **Python** &nbsp;&nbsp; stars: **41,322** &nbsp;&nbsp; folks: **10,024**  &nbsp;&nbsp; `155 stars today`

1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,489** &nbsp;&nbsp; folks: **304**  &nbsp;&nbsp; `889 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **12,293** &nbsp;&nbsp; folks: **233**  &nbsp;&nbsp; `654 stars today`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,489** &nbsp;&nbsp; folks: **304**  &nbsp;&nbsp; `2,904 stars this week`

1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **1,558** &nbsp;&nbsp; folks: **224**  &nbsp;&nbsp; `1,236 stars this week`

1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **11,015** &nbsp;&nbsp; folks: **689**  &nbsp;&nbsp; `2,093 stars this week`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **12,293** &nbsp;&nbsp; folks: **233**  &nbsp;&nbsp; `3,366 stars this week`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,050** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `646 stars this week`

1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **23,486** &nbsp;&nbsp; folks: **679**  &nbsp;&nbsp; `1,552 stars this week`

1. [WerWolv / ImHex](https://github.com/WerWolv/ImHex)
    - A Hex Editor for Reverse Engineers, Programmers and people that value their eye sight when working at 3 AM.
    - language: **C++** &nbsp;&nbsp; stars: **9,668** &nbsp;&nbsp; folks: **419**  &nbsp;&nbsp; `1,171 stars this week`

1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,678** &nbsp;&nbsp; folks: **672**  &nbsp;&nbsp; `733 stars this week`
...
1. [bitwarden / server](https://github.com/bitwarden/server)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,083** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `235 stars this week`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,047** &nbsp;&nbsp; folks: **1,119**  &nbsp;&nbsp; `1,892 stars this week`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,922** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `423 stars this week`

1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,919** &nbsp;&nbsp; folks: **1,636**  &nbsp;&nbsp; `548 stars this week`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **20,360** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `1,070 stars this week`

1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,972** &nbsp;&nbsp; folks: **1,377**  &nbsp;&nbsp; `169 stars this week`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **19,577** &nbsp;&nbsp; folks: **7,567**  &nbsp;&nbsp; `634 stars this week`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,883** &nbsp;&nbsp; folks: **33,753**  &nbsp;&nbsp; `969 stars this week`
...
1. [itdevbooks / pdf](https://github.com/itdevbooks/pdf)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,720** &nbsp;&nbsp; folks: **1,137**  &nbsp;&nbsp; `887 stars this week`
...
1. [peng-zhihui / HoloCubic](https://github.com/peng-zhihui/HoloCubic)
    - 透明小电视
    - language: **C** &nbsp;&nbsp; stars: **1,346** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `1,075 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **12,293** &nbsp;&nbsp; folks: **233**  &nbsp;&nbsp; `4,417 stars this month`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,047** &nbsp;&nbsp; folks: **1,119**  &nbsp;&nbsp; `4,090 stars this month`

1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **11,015** &nbsp;&nbsp; folks: **689**  &nbsp;&nbsp; `2,298 stars this month`
...
1. [williamfiset / Algorithms](https://github.com/williamfiset/Algorithms)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,110** &nbsp;&nbsp; folks: **2,317**  &nbsp;&nbsp; `1,602 stars this month`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    - API, CLI & Web App for analyzing & finding a person's profile across 350+ social media websites (Detections are updated regularly)
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,489** &nbsp;&nbsp; folks: **304**  &nbsp;&nbsp; `3,277 stars this month`

1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **35,566** &nbsp;&nbsp; folks: **6,918**  &nbsp;&nbsp; `2,816 stars this month`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,907** &nbsp;&nbsp; folks: **1,806**  &nbsp;&nbsp; `288 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍「算法面试+算法知识」针对小白的算法训练 | 还包括：1、阿里、字节、滴滴 百篇大厂面经汇总 2、千本开源电子书 3、百张思维导图 （右侧来个 star 吧 🌹，English version supported）
    - language: **Java** &nbsp;&nbsp; stars: **24,495** &nbsp;&nbsp; folks: **4,674**  &nbsp;&nbsp; `1,324 stars this month`
