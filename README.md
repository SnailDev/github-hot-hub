...
1. [microsoft / magentic-ui](https://github.com/microsoft/magentic-ui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,527** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `472 stars this week`
...
1. [anthropics / claude-quickstarts](https://github.com/anthropics/claude-quickstarts)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,585** &nbsp;&nbsp; folks: **1,931**  &nbsp;&nbsp; `216 stars this week`
...
1. [arhamkhnz / next-shadcn-admin-dashboard](https://github.com/arhamkhnz/next-shadcn-admin-dashboard)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,073** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `435 stars this week`

1. [penpot / penpot](https://github.com/penpot/penpot)
    - Penpot: The open-source design tool for design and code collaboration
    - language: **Clojure** &nbsp;&nbsp; stars: **43,049** &nbsp;&nbsp; folks: **2,370**  &nbsp;&nbsp; `1,422 stars this week`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **95,596** &nbsp;&nbsp; folks: **10,809**  &nbsp;&nbsp; `926 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **44,590** &nbsp;&nbsp; folks: **3,089**  &nbsp;&nbsp; `908 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **194,824** &nbsp;&nbsp; folks: **31,047**  &nbsp;&nbsp; `668 stars this week`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **12,664** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `570 stars this week`
...
1. [danielmiessler / Fabric](https://github.com/danielmiessler/Fabric)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,929** &nbsp;&nbsp; folks: **3,565**  &nbsp;&nbsp; `345 stars this week`
...
1. [oven-sh / bun](https://github.com/oven-sh/bun)
    - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
    - language: **Zig** &nbsp;&nbsp; stars: **83,447** &nbsp;&nbsp; folks: **3,680**  &nbsp;&nbsp; `692 stars this week`
...
1. [kavishdevar / librepods](https://github.com/kavishdevar/librepods)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **19,028** &nbsp;&nbsp; folks: **890**  &nbsp;&nbsp; `17,464 stars this month`
...
1. [666ghj / BettaFish](https://github.com/666ghj/BettaFish)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,851** &nbsp;&nbsp; folks: **5,908**  &nbsp;&nbsp; `20,199 stars this month`
...
1. [microsoft / magentic-ui](https://github.com/microsoft/magentic-ui)
    - A research prototype of a human-centered web agent
    - language: **Python** &nbsp;&nbsp; stars: **8,527** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `625 stars this month`
...
1. [ValveSoftware / Proton](https://github.com/ValveSoftware/Proton)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **28,974** &nbsp;&nbsp; folks: **1,259**  &nbsp;&nbsp; `914 stars this month`
...
1. [lima-vm / lima](https://github.com/lima-vm/lima)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,613** &nbsp;&nbsp; folks: **779**  &nbsp;&nbsp; `1,264 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **85,809** &nbsp;&nbsp; folks: **9,783**  &nbsp;&nbsp; `4,794 stars this month`

1. [QuantConnect / Lean](https://github.com/QuantConnect/Lean)
    - Lean Algorithmic Trading Engine by QuantConnect (Python, C#)
    - language: **C#** &nbsp;&nbsp; stars: **13,508** &nbsp;&nbsp; folks: **3,950**  &nbsp;&nbsp; `830 stars this month`
