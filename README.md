...
`更新时间：2021-08-04 20:18:03 +0800`

## 今日热门仓库

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **1,064** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `432 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **26,573** &nbsp;&nbsp; folks: **5,306**  &nbsp;&nbsp; `210 stars today`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,109** &nbsp;&nbsp; folks: **3,544**  &nbsp;&nbsp; `677 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **140,315** &nbsp;&nbsp; folks: **25,796**  &nbsp;&nbsp; `118 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,496** &nbsp;&nbsp; folks: **4,393**  &nbsp;&nbsp; `300 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,646** &nbsp;&nbsp; folks: **22,386**  &nbsp;&nbsp; `41 stars today`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **13,718** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `375 stars today`
...
1. [chuzhixin / vue-admin-beautiful-pro](https://github.com/chuzhixin/vue-admin-beautiful-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,663** &nbsp;&nbsp; folks: **2,237**  &nbsp;&nbsp; `23 stars today`
...
1. [prometheus / alertmanager](https://github.com/prometheus/alertmanager)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,239** &nbsp;&nbsp; folks: **1,581**  &nbsp;&nbsp; `59 stars today`
...
1. [Azure / azure-sdk-for-net](https://github.com/Azure/azure-sdk-for-net)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,495** &nbsp;&nbsp; folks: **2,835**  &nbsp;&nbsp; `21 stars today`

1. [Hiroshiba / voicevox](https://github.com/Hiroshiba/voicevox)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **373** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `76 stars today`

1. [akullpp / awesome-java](https://github.com/akullpp/awesome-java)
    - A curated list of awesome frameworks, libraries and software for the Java programming language.
    - language: **无** &nbsp;&nbsp; stars: **29,469** &nbsp;&nbsp; folks: **6,382**  &nbsp;&nbsp; `29 stars today`
...
1. [CryptoBlades / cryptoblades](https://github.com/CryptoBlades/cryptoblades)
    - 无
    - language: **Vue** &nbsp;&nbsp; stars: **398** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `111 stars this week`
...
1. [doocs / source-code-hunter](https://github.com/doocs/source-code-hunter)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,388** &nbsp;&nbsp; folks: **1,026**  &nbsp;&nbsp; `507 stars this week`

1. [FASTSHIFT / X-TRACK](https://github.com/FASTSHIFT/X-TRACK)
    - A GPS bicycle speedometer that supports offline maps and track recording
    - language: **C** &nbsp;&nbsp; stars: **1,885** &nbsp;&nbsp; folks: **385**  &nbsp;&nbsp; `435 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **7,809** &nbsp;&nbsp; folks: **1,805**  &nbsp;&nbsp; `3,324 stars this month`
...
1. [PlummersSoftwareLLC / Primes](https://github.com/PlummersSoftwareLLC/Primes)
    ...
    - language: **C** &nbsp;&nbsp; stars: **1,355** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `826 stars this month`
