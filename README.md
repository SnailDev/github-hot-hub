...
`更新时间：2021-09-13 22:10:47 +0800`

## 今日热门仓库

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **19,699** &nbsp;&nbsp; folks: **4,287**  &nbsp;&nbsp; `297 stars today`
...
1. [Python-World / python-mini-projects](https://github.com/Python-World/python-mini-projects)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,411** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `52 stars today`
...
1. [Jam3 / math-as-code](https://github.com/Jam3/math-as-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **12,941** &nbsp;&nbsp; folks: **936**  &nbsp;&nbsp; `295 stars today`
...
1. [TaKO8Ki / gobang](https://github.com/TaKO8Ki/gobang)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,083** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `241 stars today`
...
1. [f9webltd / laravel-api-response-helpers](https://github.com/f9webltd/laravel-api-response-helpers)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **170** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `44 stars today`

1. [esphome / esphome](https://github.com/esphome/esphome)
    - ESPHome is a system to control your ESP8266/ESP32 by simple yet powerful configuration files and control them remotely through Home Automation systems.
    - language: **C++** &nbsp;&nbsp; stars: **3,757** &nbsp;&nbsp; folks: **1,139**  &nbsp;&nbsp; `4 stars today`
...
1. [jupyter-naas / awesome-notebooks](https://github.com/jupyter-naas/awesome-notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **401** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `22 stars today`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,536** &nbsp;&nbsp; folks: **1,765**  &nbsp;&nbsp; `2,292 stars this week`

1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    - Create generative art by using the canvas api and node js, feel free to contribute to this repo with new ideas.
    - language: **JavaScript** &nbsp;&nbsp; stars: **705** &nbsp;&nbsp; folks: **246**  &nbsp;&nbsp; `330 stars this week`
...
1. [cloudwego / kitex](https://github.com/cloudwego/kitex)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,406** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `1,015 stars this week`

1. [lootproject / website](https://github.com/lootproject/website)
    - Loot Project website
    - language: **TypeScript** &nbsp;&nbsp; stars: **290** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `135 stars this week`

1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    - Real-ESRGAN aims at developing Practical Algorithms for General Image Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **2,307** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `970 stars this week`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **118,025** &nbsp;&nbsp; folks: **31,575**  &nbsp;&nbsp; `1,665 stars this week`
...
1. [lima-vm / lima](https://github.com/lima-vm/lima)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,962** &nbsp;&nbsp; folks: **76**  &nbsp;&nbsp; `394 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **19,699** &nbsp;&nbsp; folks: **4,287**  &nbsp;&nbsp; `2,167 stars this week`

1. [GTAmodding / re3](https://github.com/GTAmodding/re3)
    - GTA III, Vice City
    - language: **C++** &nbsp;&nbsp; stars: **6,763** &nbsp;&nbsp; folks: **838**  &nbsp;&nbsp; `376 stars this week`
...
1. [metaplex-foundation / metaplex](https://github.com/metaplex-foundation/metaplex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,013** &nbsp;&nbsp; folks: **1,730**  &nbsp;&nbsp; `197 stars this week`

1. [khanhas / spicetify-cli](https://github.com/khanhas/spicetify-cli)
    - Commandline tool to customize Spotify client. Supports Windows, MacOS and Linux.
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,217** &nbsp;&nbsp; folks: **308**  &nbsp;&nbsp; `508 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **84,113** &nbsp;&nbsp; folks: **8,966**  &nbsp;&nbsp; `1,623 stars this week`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,079** &nbsp;&nbsp; folks: **2,383**  &nbsp;&nbsp; `815 stars this week`
...
1. [huggingface / datasets](https://github.com/huggingface/datasets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,760** &nbsp;&nbsp; folks: **1,152**  &nbsp;&nbsp; `876 stars this week`
...
1. [HashLips / generative-art-node](https://github.com/HashLips/generative-art-node)
    - Create generative art by using the canvas api and node js
    - language: **JavaScript** &nbsp;&nbsp; stars: **909** &nbsp;&nbsp; folks: **260**  &nbsp;&nbsp; `332 stars this week`
