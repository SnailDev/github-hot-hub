...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **594** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `161 stars today`
...
1. [veler / DevToys](https://github.com/veler/DevToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,098** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `2,953 stars this week`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **11,830** &nbsp;&nbsp; folks: **2,229**  &nbsp;&nbsp; `1,762 stars this week`

1. [khuedoan / homelab](https://github.com/khuedoan/homelab)
    - My self-hosting infrastructure, fully automated from empty disk to operating services
    - language: **Python** &nbsp;&nbsp; stars: **5,008** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `1,416 stars this week`
...
1. [akutz / go-generics-the-hard-way](https://github.com/akutz/go-generics-the-hard-way)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,213** &nbsp;&nbsp; folks: **74**  &nbsp;&nbsp; `496 stars this week`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **178,460** &nbsp;&nbsp; folks: **20,550**  &nbsp;&nbsp; `1,493 stars this week`
...
1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **52,837** &nbsp;&nbsp; folks: **4,408**  &nbsp;&nbsp; `825 stars this week`
...
1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,779** &nbsp;&nbsp; folks: **4,086**  &nbsp;&nbsp; `292 stars this week`

1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments, LinkedIn test, questions and answers (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test
    - language: **无** &nbsp;&nbsp; stars: **8,398** &nbsp;&nbsp; folks: **5,564**  &nbsp;&nbsp; `854 stars this week`

1. [flxzt / rnote](https://github.com/flxzt/rnote)
    - A simple drawing application to create handwritten notes.
    - language: **Rust** &nbsp;&nbsp; stars: **1,763** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `641 stars this week`

1. [yuzu-emu / yuzu](https://github.com/yuzu-emu/yuzu)
    - Nintendo Switch Emulator
    - language: **C++** &nbsp;&nbsp; stars: **18,442** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `449 stars this week`

1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    - Project Cider. A new look into listening and enjoying Apple Music in style and performance. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **594** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `247 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **11,116** &nbsp;&nbsp; folks: **1,339**  &nbsp;&nbsp; `289 stars this week`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **C** &nbsp;&nbsp; stars: **126,116** &nbsp;&nbsp; folks: **41,171**  &nbsp;&nbsp; `1,773 stars this week`

1. [vercel / platforms](https://github.com/vercel/platforms)
    - A template for site builders and low-code tools.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,289** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `357 stars this week`
...
1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,695** &nbsp;&nbsp; folks: **1,121**  &nbsp;&nbsp; `424 stars this week`

1. [abiosoft / colima](https://github.com/abiosoft/colima)
    - Container runtimes on macOS (and Linux) with minimal setup
    - language: **Go** &nbsp;&nbsp; stars: **1,970** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `537 stars this week`

1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    - A Python framework for creating reproducible, maintainable and modular data science code.
    - language: **Python** &nbsp;&nbsp; stars: **6,351** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `785 stars this week`

1. [microsoft / playwright](https://github.com/microsoft/playwright)
    - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,646** &nbsp;&nbsp; folks: **1,473**  &nbsp;&nbsp; `1,085 stars this week`

1. [scikit-learn / scikit-learn](https://github.com/scikit-learn/scikit-learn)
    - scikit-learn: machine learning in Python
    - language: **Python** &nbsp;&nbsp; stars: **48,838** &nbsp;&nbsp; folks: **22,579**  &nbsp;&nbsp; `245 stars this week`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **4,912** &nbsp;&nbsp; folks: **899**  &nbsp;&nbsp; `666 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,938** &nbsp;&nbsp; folks: **2,933**  &nbsp;&nbsp; `839 stars this month`

1. [dwyl / english-words](https://github.com/dwyl/english-words)
    - 📝 A text file containing 479k English words for all your dictionary/word-based projects e.g: auto-completion / autosuggestion
    - language: **Python** &nbsp;&nbsp; stars: **6,260** &nbsp;&nbsp; folks: **1,282**  &nbsp;&nbsp; `413 stars this month`
