...
1. [mxgmn / MarkovJunior](https://github.com/mxgmn/MarkovJunior)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,398** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `418 stars today`
...
1. [anasty17 / mirror-leech-telegram-bot](https://github.com/anasty17/mirror-leech-telegram-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,370** &nbsp;&nbsp; folks: **3,343**  &nbsp;&nbsp; `48 stars today`
...
1. [sveltejs / svelte](https://github.com/sveltejs/svelte)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **58,744** &nbsp;&nbsp; folks: **2,881**  &nbsp;&nbsp; `124 stars today`

1. [OAI / OpenAPI-Specification](https://github.com/OAI/OpenAPI-Specification)
    - The OpenAPI Specification Repository
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,944** &nbsp;&nbsp; folks: **8,336**  &nbsp;&nbsp; `46 stars today`
...
1. [helix-editor / helix](https://github.com/helix-editor/helix)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,564** &nbsp;&nbsp; folks: **569**  &nbsp;&nbsp; `531 stars this week`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Free and Open-source Headless CMS and Application Framework built with TypeScript, Node.js, React and MongoDB
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,594** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `902 stars this week`
...
1. [iina / iina](https://github.com/iina/iina)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **30,203** &nbsp;&nbsp; folks: **2,279**  &nbsp;&nbsp; `142 stars this week`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **14,339** &nbsp;&nbsp; folks: **4,200**  &nbsp;&nbsp; `864 stars this week`
...
1. [Tencent / tmagic-editor](https://github.com/Tencent/tmagic-editor)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,044** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `1,571 stars this month`

1. [education / GitHubGraduation-2022](https://github.com/education/GitHubGraduation-2022)
    - Join the GitHub Graduation Yearbook and "walk the stage" on June 11.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,352** &nbsp;&nbsp; folks: **6,707**  &nbsp;&nbsp; `1,001 stars this month`
...
1. [Grasscutters / Grasscutter](https://github.com/Grasscutters/Grasscutter)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,049** &nbsp;&nbsp; folks: **2,821**  &nbsp;&nbsp; `3,738 stars this month`
...
1. [PaddlePaddle / PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,395** &nbsp;&nbsp; folks: **1,275**  &nbsp;&nbsp; `1,187 stars this month`

1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,917** &nbsp;&nbsp; folks: **3,282**  &nbsp;&nbsp; `2,201 stars this month`
...
1. [pyscript / pyscript](https://github.com/pyscript/pyscript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,425** &nbsp;&nbsp; folks: **831**  &nbsp;&nbsp; `6,560 stars this month`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,300** &nbsp;&nbsp; folks: **4,782**  &nbsp;&nbsp; `1,832 stars this month`
...
1. [heartexlabs / label-studio](https://github.com/heartexlabs/label-studio)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,018** &nbsp;&nbsp; folks: **1,067**  &nbsp;&nbsp; `879 stars this month`
