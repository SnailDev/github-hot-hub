...
1. [delta-io / delta](https://github.com/delta-io/delta)
    ...
    - language: **Scala** &nbsp;&nbsp; stars: **4,598** &nbsp;&nbsp; folks: **1,079**  &nbsp;&nbsp; `71 stars today`

1. [denoland / fresh](https://github.com/denoland/fresh)
    - The next-gen web framework.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,591** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `612 stars today`
...
1. [dair-ai / ML-Course-Notes](https://github.com/dair-ai/ML-Course-Notes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,929** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `38 stars today`
...
1. [edoardottt / awesome-hacker-search-engines](https://github.com/edoardottt/awesome-hacker-search-engines)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,917** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `621 stars today`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,243** &nbsp;&nbsp; folks: **5,705**  &nbsp;&nbsp; `452 stars today`
...
1. [D3Ext / WEF](https://github.com/D3Ext/WEF)
    ...
    - language: **Hack** &nbsp;&nbsp; stars: **823** &nbsp;&nbsp; folks: **74**  &nbsp;&nbsp; `112 stars today`

1. [remix-run / remix](https://github.com/remix-run/remix)
    - Build Better Websites. Create modern, resilient user experiences with web fundamentals.
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,620** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `22 stars today`
...
1. [Hack-with-Github / Awesome-Hacking](https://github.com/Hack-with-Github/Awesome-Hacking)
    ...
    - language: **无** &nbsp;&nbsp; stars: **52,379** &nbsp;&nbsp; folks: **7,963**  &nbsp;&nbsp; `104 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,952** &nbsp;&nbsp; folks: **2,528**  &nbsp;&nbsp; `16 stars today`
...
1. [qiangmzsx / Software-Engineering-at-Google](https://github.com/qiangmzsx/Software-Engineering-at-Google)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,245** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `294 stars today`
...
1. [Tencent / spring-cloud-tencent](https://github.com/Tencent/spring-cloud-tencent)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,797** &nbsp;&nbsp; folks: **265**  &nbsp;&nbsp; `958 stars this week`

1. [still-scene / t3](https://github.com/still-scene/t3)
    - Tooll 3 is an open source software to create realtime motion graphics.
    - language: **C#** &nbsp;&nbsp; stars: **1,424** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `844 stars this week`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
    - language: **Python** &nbsp;&nbsp; stars: **27,243** &nbsp;&nbsp; folks: **5,705**  &nbsp;&nbsp; `1,196 stars this week`

1. [girliemac / a-picture-is-worth-a-1000-words](https://github.com/girliemac/a-picture-is-worth-a-1000-words)
    - I am trying to describe complex matters in simple doodles!
    - language: **无** &nbsp;&nbsp; stars: **5,749** &nbsp;&nbsp; folks: **408**  &nbsp;&nbsp; `981 stars this week`

1. [mingrammer / diagrams](https://github.com/mingrammer/diagrams)
    - 🎨 Diagram as Code for prototyping cloud system architectures
    - language: **Python** &nbsp;&nbsp; stars: **23,732** &nbsp;&nbsp; folks: **1,436**  &nbsp;&nbsp; `2,227 stars this week`
...
1. [delta-io / delta](https://github.com/delta-io/delta)
    - An open-source storage framework that enables building a Lakehouse architecture with compute engines including Spark, PrestoDB, Flink, Trino, and Hive and APIs for Scala, Java, Rust, Ruby, and Python.
    - language: **Scala** &nbsp;&nbsp; stars: **4,598** &nbsp;&nbsp; folks: **1,079**  &nbsp;&nbsp; `85 stars this week`
...
1. [Z4nzu / hackingtool](https://github.com/Z4nzu/hackingtool)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,233** &nbsp;&nbsp; folks: **2,344**  &nbsp;&nbsp; `1,202 stars this week`

1. [calcom / cal.com](https://github.com/calcom/cal.com)
    - Scheduling infrastructure for absolutely everyone.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,170** &nbsp;&nbsp; folks: **1,394**  &nbsp;&nbsp; `125 stars this week`

1. [denoland / fresh](https://github.com/denoland/fresh)
    - The next-gen web framework.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,591** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `1,641 stars this week`

1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    - Full reference of LinkedIn answers 2022 for skill assessments (aws-lambda, rest-api, javascript, react, git, html, jquery, mongodb, java, Go, python, machine-learning, power-point) linkedin excel test lösungen, linkedin machine learning test LinkedIn test questions and answers
    - language: **无** &nbsp;&nbsp; stars: **15,796** &nbsp;&nbsp; folks: **8,676**  &nbsp;&nbsp; `334 stars this week`

1. [pterodactyl / panel](https://github.com/pterodactyl/panel)
    - Pterodactyl® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security in mind, Pterodactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive UI to end users.
    - language: **PHP** &nbsp;&nbsp; stars: **3,830** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `176 stars this week`
...
1. [dragonflydb / dragonfly](https://github.com/dragonflydb/dragonfly)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **8,509** &nbsp;&nbsp; folks: **158**  &nbsp;&nbsp; `7,579 stars this month`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **45,420** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `4,087 stars this month`
