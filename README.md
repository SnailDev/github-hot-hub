...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,343** &nbsp;&nbsp; folks: **6,380**  &nbsp;&nbsp; `1,569 stars this week`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,415** &nbsp;&nbsp; folks: **1,757**  &nbsp;&nbsp; `2,495 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,192** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `772 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **339,872** &nbsp;&nbsp; folks: **61,820**  &nbsp;&nbsp; `1,424 stars this week`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,728** &nbsp;&nbsp; folks: **2,347**  &nbsp;&nbsp; `1,507 stars this week`

1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    - The Bluesky Social application for Web, iOS, and Android
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,846** &nbsp;&nbsp; folks: **1,633**  &nbsp;&nbsp; `1,226 stars this week`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **10,194** &nbsp;&nbsp; folks: **607**  &nbsp;&nbsp; `1,228 stars this week`
...
1. [blacklanternsecurity / bbot](https://github.com/blacklanternsecurity/bbot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,034** &nbsp;&nbsp; folks: **531**  &nbsp;&nbsp; `1,076 stars this week`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **21,017** &nbsp;&nbsp; folks: **4,126**  &nbsp;&nbsp; `1,134 stars this week`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,099** &nbsp;&nbsp; folks: **540**  &nbsp;&nbsp; `10,251 stars this month`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **61,867** &nbsp;&nbsp; folks: **7,554**  &nbsp;&nbsp; `4,777 stars this month`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **31,343** &nbsp;&nbsp; folks: **6,380**  &nbsp;&nbsp; `2,781 stars this month`

1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    - 🙌 OpenHands: Code Less, Make More
    - language: **Python** &nbsp;&nbsp; stars: **37,445** &nbsp;&nbsp; folks: **4,238**  &nbsp;&nbsp; `4,349 stars this month`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,198** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `3,377 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,415** &nbsp;&nbsp; folks: **1,757**  &nbsp;&nbsp; `3,584 stars this month`

1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    - The Bluesky Social application for Web, iOS, and Android
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,846** &nbsp;&nbsp; folks: **1,633**  &nbsp;&nbsp; `3,342 stars this month`

1. [microsoft / autogen](https://github.com/microsoft/autogen)
    - A programming framework for agentic AI 🤖
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **34,850** &nbsp;&nbsp; folks: **5,047**  &nbsp;&nbsp; `2,605 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **16,109** &nbsp;&nbsp; folks: **855**  &nbsp;&nbsp; `5,321 stars this month`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,721** &nbsp;&nbsp; folks: **1,067**  &nbsp;&nbsp; `2,296 stars this month`

1. [GoogleCloudPlatform / generative-ai](https://github.com/GoogleCloudPlatform/generative-ai)
    - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,200** &nbsp;&nbsp; folks: **2,321**  &nbsp;&nbsp; `1,028 stars this month`
...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,376** &nbsp;&nbsp; folks: **203**  &nbsp;&nbsp; `2,418 stars this month`

1. [AmruthPillai / Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume)
    - A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,973** &nbsp;&nbsp; folks: **2,662**  &nbsp;&nbsp; `2,603 stars this month`
