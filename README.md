...
`更新时间：2022-01-12 02:15:09 +0800`

## 今日热门仓库

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,545** &nbsp;&nbsp; folks: **2,811**  &nbsp;&nbsp; `555 stars today`
...
1. [Marak / faker.js](https://github.com/Marak/faker.js)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,127** &nbsp;&nbsp; folks: **505**  &nbsp;&nbsp; `169 stars today`

1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    - 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub.
    - language: **Python** &nbsp;&nbsp; stars: **51,174** &nbsp;&nbsp; folks: **7,358**  &nbsp;&nbsp; `186 stars today`

1. [Marak / colors.js](https://github.com/Marak/colors.js)
    - get colors in your node.js console
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,554** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `130 stars today`

1. [DataTalksClub / data-engineering-zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
    - Code for Data Engineer Zoomcamp course
    - language: **HCL** &nbsp;&nbsp; stars: **1,016** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `96 stars today`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **4,230** &nbsp;&nbsp; folks: **407**  &nbsp;&nbsp; `227 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **66,546** &nbsp;&nbsp; folks: **3,718**  &nbsp;&nbsp; `253 stars today`
...
1. [StarRocks / starrocks](https://github.com/StarRocks/starrocks)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,970** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `23 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **127,058** &nbsp;&nbsp; folks: **33,821**  &nbsp;&nbsp; `216 stars today`
...
1. [tharsis / evmos](https://github.com/tharsis/evmos)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **936** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `29 stars today`

1. [irbigdata / data-dockerfiles](https://github.com/irbigdata/data-dockerfiles)
    - a curated list of docker-compose files prepared for testing data engineering tools, databases and open source libraries.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **353** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `78 stars today`
...
1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **338,876** &nbsp;&nbsp; folks: **27,724**  &nbsp;&nbsp; `859 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **7,399** &nbsp;&nbsp; folks: **5,235**  &nbsp;&nbsp; `196 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,536** &nbsp;&nbsp; folks: **2,429**  &nbsp;&nbsp; `10,509 stars this month`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,327** &nbsp;&nbsp; folks: **1,649**  &nbsp;&nbsp; `5,497 stars this month`
...
1. [christophetd / log4shell-vulnerable-app](https://github.com/christophetd/log4shell-vulnerable-app)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **894** &nbsp;&nbsp; folks: **351**  &nbsp;&nbsp; `690 stars this month`
...
1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,331** &nbsp;&nbsp; folks: **3,055**  &nbsp;&nbsp; `517 stars this month`

1. [anchore / grype](https://github.com/anchore/grype)
    - A vulnerability scanner for container images and filesystems
    - language: **Go** &nbsp;&nbsp; stars: **2,642** &nbsp;&nbsp; folks: **163**  &nbsp;&nbsp; `1,477 stars this month`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,545** &nbsp;&nbsp; folks: **2,811**  &nbsp;&nbsp; `2,262 stars this month`
...
1. [Neo23x0 / log4shell-detector](https://github.com/Neo23x0/log4shell-detector)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **694** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `644 stars this month`
...
1. [vercel / turborepo](https://github.com/vercel/turborepo)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,010** &nbsp;&nbsp; folks: **172**  &nbsp;&nbsp; `3,209 stars this month`
...
1. [apache / logging-log4j2](https://github.com/apache/logging-log4j2)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,627** &nbsp;&nbsp; folks: **1,269**  &nbsp;&nbsp; `1,035 stars this month`
