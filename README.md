...
1. [Azure / azure-sdk-for-net](https://github.com/Azure/azure-sdk-for-net)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,711** &nbsp;&nbsp; folks: **2,848**  &nbsp;&nbsp; `140 stars today`

1. [SheetJS / sheetjs](https://github.com/SheetJS/sheetjs)
    - 📗 SheetJS Community Edition -- Spreadsheet Data Toolkit
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,813** &nbsp;&nbsp; folks: **6,913**  &nbsp;&nbsp; `228 stars today`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,140** &nbsp;&nbsp; folks: **3,660**  &nbsp;&nbsp; `741 stars today`

1. [apache / apisix](https://github.com/apache/apisix)
    - The Cloud-Native API Gateway
    - language: **Lua** &nbsp;&nbsp; stars: **5,957** &nbsp;&nbsp; folks: **1,149**  &nbsp;&nbsp; `129 stars today`
...
1. [datafuselabs / datafuse](https://github.com/datafuselabs/datafuse)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,400** &nbsp;&nbsp; folks: **131**  &nbsp;&nbsp; `418 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **76,291** &nbsp;&nbsp; folks: **6,816**  &nbsp;&nbsp; `136 stars today`

1. [alyssaxuu / mapus](https://github.com/alyssaxuu/mapus)
    - A map tool with real-time collaboration 🗺️
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,216** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `686 stars today`
...
1. [MoienTajik / AspNetCore-Developer-Roadmap](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **7,160** &nbsp;&nbsp; folks: **1,160**  &nbsp;&nbsp; `314 stars today`
...
1. [Apress / Ray-Tracing-Gems-II](https://github.com/Apress/Ray-Tracing-Gems-II)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **298** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `177 stars today`
...
1. [chuzhixin / vue-admin-beautiful-pro](https://github.com/chuzhixin/vue-admin-beautiful-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **9,848** &nbsp;&nbsp; folks: **2,252**  &nbsp;&nbsp; `112 stars today`
...
1. [metersphere / metersphere](https://github.com/metersphere/metersphere)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,134** &nbsp;&nbsp; folks: **1,183**  &nbsp;&nbsp; `59 stars today`

1. [JetBrains / compose-jb](https://github.com/JetBrains/compose-jb)
    - Jetpack Compose for Desktop and Web, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,453** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `377 stars today`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,851** &nbsp;&nbsp; folks: **4,176**  &nbsp;&nbsp; `212 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **27,481** &nbsp;&nbsp; folks: **5,333**  &nbsp;&nbsp; `766 stars today`
...
1. [SJang1 / korea-covid-19-remaining-vaccine-macro](https://github.com/SJang1/korea-covid-19-remaining-vaccine-macro)
    - 잔여백신 조회 및 예약 매크로
    - language: **Python** &nbsp;&nbsp; stars: **561** &nbsp;&nbsp; folks: **201**  &nbsp;&nbsp; `349 stars this week`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **27,481** &nbsp;&nbsp; folks: **5,333**  &nbsp;&nbsp; `1,409 stars this week`
...
1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **14,561** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `1,894 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **7,967** &nbsp;&nbsp; folks: **1,868**  &nbsp;&nbsp; `1,016 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,140** &nbsp;&nbsp; folks: **3,660**  &nbsp;&nbsp; `10,335 stars this month`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **7,967** &nbsp;&nbsp; folks: **1,868**  &nbsp;&nbsp; `3,030 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,540** &nbsp;&nbsp; folks: **5,268**  &nbsp;&nbsp; `804 stars this month`
