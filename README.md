...
`更新时间：2024-06-22 09:56:05 +0800`

## 今日热门仓库

1. [omnivore-app / omnivore](https://github.com/omnivore-app/omnivore)
    - Omnivore is a complete, open source read-it-later solution for people who like reading.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,561** &nbsp;&nbsp; folks: **538**  &nbsp;&nbsp; `291 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop, and alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **67,062** &nbsp;&nbsp; folks: **7,405**  &nbsp;&nbsp; `258 stars today`
...
1. [danny-avila / LibreChat](https://github.com/danny-avila/LibreChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,153** &nbsp;&nbsp; folks: **2,398**  &nbsp;&nbsp; `786 stars today`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design LLMs/AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Bedrock / Azure / Mistral / Perplexity ), Multi-Modals (Vision/TTS) and plugin system. One-click FREE deployment of your private ChatGPT chat application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,208** &nbsp;&nbsp; folks: **7,831**  &nbsp;&nbsp; `76 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **61,931** &nbsp;&nbsp; folks: **8,391**  &nbsp;&nbsp; `236 stars today`
...
1. [MrKai77 / Loop](https://github.com/MrKai77/Loop)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **4,623** &nbsp;&nbsp; folks: **90**  &nbsp;&nbsp; `255 stars today`

1. [bleedline / aimoneyhunter](https://github.com/bleedline/aimoneyhunter)
    - ai副业赚钱大集合，教你如何利用ai做一些副业项目，赚取更多额外收益。The Ultimate Guide to Making Money with AI Side Hustles: Learn how to leverage AI for some cool side gigs and rake in some extra cash. Check out the English version for more insights.
    - language: **无** &nbsp;&nbsp; stars: **10,741** &nbsp;&nbsp; folks: **990**  &nbsp;&nbsp; `371 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **296,496** &nbsp;&nbsp; folks: **74,726**  &nbsp;&nbsp; `114 stars today`
...
1. [tencentmusic / supersonic](https://github.com/tencentmusic/supersonic)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,130** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `141 stars today`
...
1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,109** &nbsp;&nbsp; folks: **1,751**  &nbsp;&nbsp; `6,608 stars this month`
...
1. [coollabsio / coolify](https://github.com/coollabsio/coolify)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,221** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `8,836 stars this month`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **无** &nbsp;&nbsp; stars: **276,227** &nbsp;&nbsp; folks: **25,988**  &nbsp;&nbsp; `13,067 stars this month`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,621** &nbsp;&nbsp; folks: **4,209**  &nbsp;&nbsp; `4,253 stars this month`
...
1. [k2-fsa / sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,990** &nbsp;&nbsp; folks: **257**  &nbsp;&nbsp; `1,042 stars this month`

1. [JanDeDobbeleer / oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh)
    - The most customisable and low-latency cross platform/shell prompt renderer
    - language: **Go** &nbsp;&nbsp; stars: **15,485** &nbsp;&nbsp; folks: **2,281**  &nbsp;&nbsp; `1,091 stars this month`
...
1. [ente-io / ente](https://github.com/ente-io/ente)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **9,711** &nbsp;&nbsp; folks: **542**  &nbsp;&nbsp; `1,987 stars this month`
