...
`更新时间：2021-04-24 18:15:39 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **287** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `89 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **119,006** &nbsp;&nbsp; folks: **16,955**  &nbsp;&nbsp; `150 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,269** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `144 stars today`

1. [ueberdosis / tiptap](https://github.com/ueberdosis/tiptap)
    - The headless editor framework for web artisans.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,797** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `377 stars today`
...
1. [microsoft / wslg](https://github.com/microsoft/wslg)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,438** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `481 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,879** &nbsp;&nbsp; folks: **20,735**  &nbsp;&nbsp; `38 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,851** &nbsp;&nbsp; folks: **7,960**  &nbsp;&nbsp; `315 stars today`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,036** &nbsp;&nbsp; folks: **641**  &nbsp;&nbsp; `403 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **1,975** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `505 stars today`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **14,061** &nbsp;&nbsp; folks: **1,467**  &nbsp;&nbsp; `215 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,529** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `4 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **51** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `11 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,481** &nbsp;&nbsp; folks: **447**  &nbsp;&nbsp; `2,344 stars this week`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,885** &nbsp;&nbsp; folks: **1,399**  &nbsp;&nbsp; `1,429 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,185** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `2,077 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,995** &nbsp;&nbsp; folks: **583**  &nbsp;&nbsp; `1,514 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,851** &nbsp;&nbsp; folks: **7,960**  &nbsp;&nbsp; `2,114 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,193** &nbsp;&nbsp; folks: **45,673**  &nbsp;&nbsp; `2,423 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,199** &nbsp;&nbsp; folks: **181**  &nbsp;&nbsp; `1,797 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,295** &nbsp;&nbsp; folks: **4,808**  &nbsp;&nbsp; `1,080 stars this week`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,036** &nbsp;&nbsp; folks: **641**  &nbsp;&nbsp; `503 stars this week`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,375** &nbsp;&nbsp; folks: **3,106**  &nbsp;&nbsp; `83 stars this week`
...
1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,344** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `869 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,427** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `1,198 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,852** &nbsp;&nbsp; folks: **7,960**  &nbsp;&nbsp; `3,289 stars this month`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,375** &nbsp;&nbsp; folks: **3,106**  &nbsp;&nbsp; `231 stars this month`
...
1. [php / php-src](https://github.com/php/php-src)
    - The PHP Interpreter
    - language: **C** &nbsp;&nbsp; stars: **30,498** &nbsp;&nbsp; folks: **6,624**  &nbsp;&nbsp; `891 stars this month`
