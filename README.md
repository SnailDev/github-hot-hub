...
1. [comet-ml / opik](https://github.com/comet-ml/opik)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,272** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `292 stars today`

1. [github / CopilotForXcode](https://github.com/github/CopilotForXcode)
    - Xcode extension for GitHub Copilot
    - language: **Swift** &nbsp;&nbsp; stars: **2,209** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `65 stars today`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,944** &nbsp;&nbsp; folks: **1,062**  &nbsp;&nbsp; `3,155 stars this week`

1. [tursodatabase / limbo](https://github.com/tursodatabase/limbo)
    - Limbo is a work-in-progress, in-process OLTP database management system, compatible with SQLite.
    - language: **Rust** &nbsp;&nbsp; stars: **7,372** &nbsp;&nbsp; folks: **232**  &nbsp;&nbsp; `3,607 stars this week`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **9,970** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `5,318 stars this week`
...
1. [mherrmann / helium](https://github.com/mherrmann/helium)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,858** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `808 stars this week`
...
1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,175** &nbsp;&nbsp; folks: **2,141**  &nbsp;&nbsp; `448 stars this week`
...
1. [junegunn / fzf](https://github.com/junegunn/fzf)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **66,445** &nbsp;&nbsp; folks: **2,417**  &nbsp;&nbsp; `224 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,410** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `1,301 stars this week`
...
1. [go-gitea / gitea](https://github.com/go-gitea/gitea)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **46,051** &nbsp;&nbsp; folks: **5,557**  &nbsp;&nbsp; `434 stars this week`
...
1. [comet-ml / opik](https://github.com/comet-ml/opik)
    - From RAG chatbots to code assistants to complex agentic pipelines and beyond, build LLM systems that run better, faster, and cheaper with tracing, evaluations, and dashboards.
    - language: **Python** &nbsp;&nbsp; stars: **3,272** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `210 stars this week`

1. [firefly-iii / firefly-iii](https://github.com/firefly-iii/firefly-iii)
    - Firefly III: a personal finances manager
    - language: **PHP** &nbsp;&nbsp; stars: **16,741** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `123 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,410** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `3,725 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **9,970** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `7,996 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **65,901** &nbsp;&nbsp; folks: **8,008**  &nbsp;&nbsp; `6,022 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,284** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `2,993 stars this month`
...
1. [bluesky-social / atproto](https://github.com/bluesky-social/atproto)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,794** &nbsp;&nbsp; folks: **571**  &nbsp;&nbsp; `1,038 stars this month`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **80,913** &nbsp;&nbsp; folks: **36,611**  &nbsp;&nbsp; `1,425 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **39,875** &nbsp;&nbsp; folks: **4,513**  &nbsp;&nbsp; `5,287 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **342,186** &nbsp;&nbsp; folks: **62,058**  &nbsp;&nbsp; `4,012 stars this month`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,329** &nbsp;&nbsp; folks: **1,894**  &nbsp;&nbsp; `4,583 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,958** &nbsp;&nbsp; folks: **2,373**  &nbsp;&nbsp; `1,925 stars this month`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,849** &nbsp;&nbsp; folks: **808**  &nbsp;&nbsp; `5,792 stars this month`

1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    - The Bluesky Social application for Web, iOS, and Android
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,151** &nbsp;&nbsp; folks: **1,834**  &nbsp;&nbsp; `2,741 stars this month`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,118** &nbsp;&nbsp; folks: **1,048**  &nbsp;&nbsp; `1,253 stars this month`
