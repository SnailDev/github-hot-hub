...
1. [stypr / clubhouse-py](https://github.com/stypr/clubhouse-py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **492** &nbsp;&nbsp; folks: **69**  &nbsp;&nbsp; `191 stars today`

1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    - 🌈 A UI Design Language and React UI library
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,890** &nbsp;&nbsp; folks: **26,661**  &nbsp;&nbsp; `717 stars today`

1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,009** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `511 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,314** &nbsp;&nbsp; folks: **13,536**  &nbsp;&nbsp; `88 stars today`
...
1. [surfcodes / surf](https://github.com/surfcodes/surf)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,513** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `459 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,298** &nbsp;&nbsp; folks: **33,581**  &nbsp;&nbsp; `117 stars today`

1. [elixir-nx / nx](https://github.com/elixir-nx/nx)
    - Numerical Elixir and Elixir XLA bindings for CPU/GPU/TPU
    - language: **Elixir** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `133 stars today`

1. [nodejs / undici](https://github.com/nodejs/undici)
    - An HTTP/1.1 client, written from scratch for Node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,272** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `156 stars today`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,125** &nbsp;&nbsp; folks: **1,072**  &nbsp;&nbsp; `293 stars today`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,912** &nbsp;&nbsp; folks: **415**  &nbsp;&nbsp; `135 stars today`
...
1. [raycast / script-commands](https://github.com/raycast/script-commands)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **944** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `52 stars today`
...
1. [itdevbooks / pdf](https://github.com/itdevbooks/pdf)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,392** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `118 stars today`
...
1. [conwnet / github1s](https://github.com/conwnet/github1s)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,115** &nbsp;&nbsp; folks: **338**  &nbsp;&nbsp; `2,895 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,825** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,049 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of 5000+ publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **28,231** &nbsp;&nbsp; folks: **947**  &nbsp;&nbsp; `801 stars this week`
...
1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,559** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `1,911 stars this month`
...
1. [ethereum-mining / ethminer](https://github.com/ethereum-mining/ethminer)
    - Ethereum miner with OpenCL, CUDA and stratum support
    - language: **C++** &nbsp;&nbsp; stars: **3,876** &nbsp;&nbsp; folks: **1,343**  &nbsp;&nbsp; `381 stars this month`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,061** &nbsp;&nbsp; folks: **1,417**  &nbsp;&nbsp; `2,025 stars this month`
...
1. [justauth / JustAuth](https://github.com/justauth/JustAuth)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **10,680** &nbsp;&nbsp; folks: **1,881**  &nbsp;&nbsp; `856 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    - 深度学习500问，以问答形式对常用的概率知识、线性代数、机器学习、深度学习、计算机视觉等热点问题进行阐述，以帮助自己及有需要的读者。 全书分为18个章节，50余万字。由于水平有限，书中不妥之处恳请广大读者批评指正。 未完待续............ 如有意合作，联系scutjy2015@163.com 版权所有，违权必究 Tan 2018.06
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,314** &nbsp;&nbsp; folks: **13,536**  &nbsp;&nbsp; `1,384 stars this month`
