...
1. [sampotts / plyr](https://github.com/sampotts/plyr)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,950** &nbsp;&nbsp; folks: **2,895**  &nbsp;&nbsp; `26 stars today`

1. [nlohmann / json](https://github.com/nlohmann/json)
    - JSON for Modern C++
    - language: **C++** &nbsp;&nbsp; stars: **41,157** &nbsp;&nbsp; folks: **6,570**  &nbsp;&nbsp; `21 stars today`

1. [ChrisTitusTech / winutil](https://github.com/ChrisTitusTech/winutil)
    - Chris Titus Tech's Windows Utility - Install Programs, Tweaks, Fixes, and Updates
    - language: **PowerShell** &nbsp;&nbsp; stars: **15,347** &nbsp;&nbsp; folks: **998**  &nbsp;&nbsp; `604 stars today`

1. [shadcn-ui / ui](https://github.com/shadcn-ui/ui)
    - Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.
    - language: **TypeScript** &nbsp;&nbsp; stars: **62,436** &nbsp;&nbsp; folks: **3,508**  &nbsp;&nbsp; `406 stars today`

1. [astral-sh / uv](https://github.com/astral-sh/uv)
    - An extremely fast Python package installer and resolver, written in Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **13,054** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `74 stars today`

1. [stacks-network / stacks-core](https://github.com/stacks-network/stacks-core)
    - The Stacks blockchain implementation
    - language: **Rust** &nbsp;&nbsp; stars: **2,997** &nbsp;&nbsp; folks: **658**  &nbsp;&nbsp; `11 stars today`

1. [snipe / snipe-it](https://github.com/snipe/snipe-it)
    - A free open source IT asset/license management system
    - language: **PHP** &nbsp;&nbsp; stars: **10,197** &nbsp;&nbsp; folks: **3,046**  &nbsp;&nbsp; `155 stars today`

1. [NVIDIA / NeMo](https://github.com/NVIDIA/NeMo)
    - A scalable generative AI framework built for researchers and developers working on Large Language Models, Multimodal, and Speech AI (Automatic Speech Recognition and Text-to-Speech)
    - language: **Python** &nbsp;&nbsp; stars: **10,787** &nbsp;&nbsp; folks: **2,257**  &nbsp;&nbsp; `32 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,378** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `377 stars today`

1. [langfuse / langfuse](https://github.com/langfuse/langfuse)
    - 🪢 Open source LLM engineering platform: Observability, metrics, evals, prompt management, playground, datasets. Integrates with LlamaIndex, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,514** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `30 stars today`
...
1. [danny-avila / LibreChat](https://github.com/danny-avila/LibreChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,011** &nbsp;&nbsp; folks: **2,493**  &nbsp;&nbsp; `919 stars this week`

1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    - 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
    - language: **Rust** &nbsp;&nbsp; stars: **11,192** &nbsp;&nbsp; folks: **261**  &nbsp;&nbsp; `1,242 stars this week`
...
1. [swisskyrepo / PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **58,069** &nbsp;&nbsp; folks: **14,144**  &nbsp;&nbsp; `246 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **325,283** &nbsp;&nbsp; folks: **60,391**  &nbsp;&nbsp; `1,316 stars this week`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **63,012** &nbsp;&nbsp; folks: **8,491**  &nbsp;&nbsp; `1,147 stars this week`
...
1. [snipe / snipe-it](https://github.com/snipe/snipe-it)
    - A free open source IT asset/license management system
    - language: **PHP** &nbsp;&nbsp; stars: **10,197** &nbsp;&nbsp; folks: **3,046**  &nbsp;&nbsp; `219 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **262,360** &nbsp;&nbsp; folks: **44,501**  &nbsp;&nbsp; `1,445 stars this week`

1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    - 🕵️‍♂️ All-in-one OSINT tool for analysing any website
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,546** &nbsp;&nbsp; folks: **1,522**  &nbsp;&nbsp; `967 stars this week`

1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **19,882** &nbsp;&nbsp; folks: **1,883**  &nbsp;&nbsp; `804 stars this week`

1. [LLaVA-VL / LLaVA-NeXT](https://github.com/LLaVA-VL/LLaVA-NeXT)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **964** &nbsp;&nbsp; folks: **53**  &nbsp;&nbsp; `145 stars this week`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **无** &nbsp;&nbsp; stars: **280,153** &nbsp;&nbsp; folks: **26,293**  &nbsp;&nbsp; `13,514 stars this month`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular stable diffusion GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **40,498** &nbsp;&nbsp; folks: **4,314**  &nbsp;&nbsp; `4,505 stars this month`

1. [duckdb / duckdb](https://github.com/duckdb/duckdb)
    - DuckDB is an analytical in-process SQL database management system
    - language: **C++** &nbsp;&nbsp; stars: **20,384** &nbsp;&nbsp; folks: **1,650**  &nbsp;&nbsp; `2,988 stars this month`
...
1. [Stability-AI / StableSwarmUI](https://github.com/Stability-AI/StableSwarmUI)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,020** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `1,395 stars this month`

1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    - Neovim config for the lazy
    - language: **Lua** &nbsp;&nbsp; stars: **15,227** &nbsp;&nbsp; folks: **1,047**  &nbsp;&nbsp; `1,582 stars this month`
...
1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **19,882** &nbsp;&nbsp; folks: **1,883**  &nbsp;&nbsp; `2,799 stars this month`

1. [omnivore-app / omnivore](https://github.com/omnivore-app/omnivore)
    - Omnivore is a complete, open source read-it-later solution for people who like reading.
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,164** &nbsp;&nbsp; folks: **578**  &nbsp;&nbsp; `1,877 stars this month`

1. [vanna-ai / vanna](https://github.com/vanna-ai/vanna)
    - 🤖 Chat with your SQL database 📊. Accurate Text-to-SQL Generation via LLMs using RAG 🔄.
    - language: **Python** &nbsp;&nbsp; stars: **8,961** &nbsp;&nbsp; folks: **657**  &nbsp;&nbsp; `1,492 stars this month`
