...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **19,070** &nbsp;&nbsp; folks: **4,092**  &nbsp;&nbsp; `122 stars today`
...
1. [hua1995116 / awesome-ai-painting](https://github.com/hua1995116/awesome-ai-painting)
    ...
    - language: **无** &nbsp;&nbsp; stars: **987** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `96 stars today`

1. [halfrost / LeetCode-Go](https://github.com/halfrost/LeetCode-Go)
    - ✅ Solutions to LeetCode by Go, 100% test coverage, runtime beats 100% / LeetCode 题解
    - language: **Go** &nbsp;&nbsp; stars: **27,124** &nbsp;&nbsp; folks: **4,984**  &nbsp;&nbsp; `54 stars today`
...
1. [sea-protocol / seaprotocol](https://github.com/sea-protocol/seaprotocol)
    ...
    - language: **Move** &nbsp;&nbsp; stars: **3,312** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `608 stars today`

1. [massalabs / massa](https://github.com/massalabs/massa)
    - The Decentralized and Scaled Blockchain
    - language: **Rust** &nbsp;&nbsp; stars: **928** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `84 stars today`
...
1. [The-Run-Philosophy-Organization / run](https://github.com/The-Run-Philosophy-Organization/run)
    ...
    - language: **无** &nbsp;&nbsp; stars: **21,862** &nbsp;&nbsp; folks: **1,741**  &nbsp;&nbsp; `546 stars this week`

1. [koishijs / novelai-bot](https://github.com/koishijs/novelai-bot)
    - Generate images by NovelAI | 基于 NovelAI 的画图机器人
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,452** &nbsp;&nbsp; folks: **124**  &nbsp;&nbsp; `421 stars this week`
...
1. [danielgatis / rembg](https://github.com/danielgatis/rembg)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,500** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `342 stars this week`
...
1. [halfrost / LeetCode-Go](https://github.com/halfrost/LeetCode-Go)
    - ✅ Solutions to LeetCode by Go, 100% test coverage, runtime beats 100% / LeetCode 题解
    - language: **Go** &nbsp;&nbsp; stars: **27,124** &nbsp;&nbsp; folks: **4,984**  &nbsp;&nbsp; `266 stars this week`
...
1. [cisagov / RedEye](https://github.com/cisagov/RedEye)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,751** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `1,184 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,391** &nbsp;&nbsp; folks: **2,774**  &nbsp;&nbsp; `2,808 stars this week`

1. [PaddlePaddle / PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR)
    - Awesome multilingual OCR toolkits based on PaddlePaddle (practical ultra lightweight OCR system, support 80+ languages recognition, provide data annotation and synthesis tools, support training and deployment among server, mobile, embedded and IoT devices)
    - language: **Python** &nbsp;&nbsp; stars: **25,772** &nbsp;&nbsp; folks: **5,277**  &nbsp;&nbsp; `344 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    - Stable Diffusion web UI
    - language: **Python** &nbsp;&nbsp; stars: **16,391** &nbsp;&nbsp; folks: **2,774**  &nbsp;&nbsp; `12,388 stars this month`
...
1. [openai / whisper](https://github.com/openai/whisper)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,256** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `7,865 stars this month`

1. [firstcontributions / first-contributions](https://github.com/firstcontributions/first-contributions)
    - 🚀✨ Help beginners to contribute to open source projects
    - language: **无** &nbsp;&nbsp; stars: **29,289** &nbsp;&nbsp; folks: **53,189**  &nbsp;&nbsp; `3,172 stars this month`

1. [BuilderIO / qwik](https://github.com/BuilderIO/qwik)
    - The HTML-first framework. Instant apps of any size with ~ 1kb JS
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,197** &nbsp;&nbsp; folks: **489**  &nbsp;&nbsp; `3,812 stars this month`
...
1. [inancgumus / learngo](https://github.com/inancgumus/learngo)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **16,119** &nbsp;&nbsp; folks: **2,106**  &nbsp;&nbsp; `1,722 stars this month`

1. [TheAlgorithms / C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)
    - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ for educational purposes.
    - language: **C++** &nbsp;&nbsp; stars: **22,027** &nbsp;&nbsp; folks: **5,907**  &nbsp;&nbsp; `1,187 stars this month`
...
1. [xkcoding / spring-boot-demo](https://github.com/xkcoding/spring-boot-demo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **27,635** &nbsp;&nbsp; folks: **9,671**  &nbsp;&nbsp; `996 stars this month`

1. [dragonflydb / dragonfly](https://github.com/dragonflydb/dragonfly)
    - A modern replacement for Redis and Memcached
    - language: **C++** &nbsp;&nbsp; stars: **15,356** &nbsp;&nbsp; folks: **476**  &nbsp;&nbsp; `3,360 stars this month`
...
1. [alist-org / alist](https://github.com/alist-org/alist)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **10,974** &nbsp;&nbsp; folks: **1,690**  &nbsp;&nbsp; `1,711 stars this month`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **67,298** &nbsp;&nbsp; folks: **17,817**  &nbsp;&nbsp; `1,807 stars this month`
...
1. [TheAlgorithms / JavaScript](https://github.com/TheAlgorithms/JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,439** &nbsp;&nbsp; folks: **4,062**  &nbsp;&nbsp; `1,127 stars this month`
