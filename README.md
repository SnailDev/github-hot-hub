...
1. [QianMo / Real-Time-Rendering-4th-Bibliography-Collection](https://github.com/QianMo/Real-Time-Rendering-4th-Bibliography-Collection)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,692** &nbsp;&nbsp; folks: **550**  &nbsp;&nbsp; `274 stars today`
...
1. [fox-it / log4j-finder](https://github.com/fox-it/log4j-finder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **67** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `33 stars today`
...
1. [NCSC-NL / log4shell](https://github.com/NCSC-NL/log4shell)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,161** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `433 stars today`
...
1. [cisagov / log4j-affected-db](https://github.com/cisagov/log4j-affected-db)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **414** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `201 stars today`

1. [PKUFlyingPig / cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning)
    - 计算机自学指南
    - language: **无** &nbsp;&nbsp; stars: **1,359** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `209 stars today`

1. [rui314 / mold](https://github.com/rui314/mold)
    - mold: A Modern Linker
    - language: **C++** &nbsp;&nbsp; stars: **3,771** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `405 stars today`

1. [fullhunt / log4j-scan](https://github.com/fullhunt/log4j-scan)
    - A fully automated, accurate, and extensive scanner for finding log4j RCE CVE-2021-44228
    - language: **Python** &nbsp;&nbsp; stars: **1,531** &nbsp;&nbsp; folks: **334**  &nbsp;&nbsp; `374 stars today`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **2,233** &nbsp;&nbsp; folks: **42**  &nbsp;&nbsp; `263 stars today`
...
1. [RedisJSON / RedisJSON](https://github.com/RedisJSON/RedisJSON)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,748** &nbsp;&nbsp; folks: **149**  &nbsp;&nbsp; `79 stars today`
...
1. [logpresso / CVE-2021-44228-Scanner](https://github.com/logpresso/CVE-2021-44228-Scanner)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **358** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `110 stars today`
...
1. [facebook / create-react-app](https://github.com/facebook/create-react-app)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **92,074** &nbsp;&nbsp; folks: **23,375**  &nbsp;&nbsp; `76 stars today`

1. [anchore / syft](https://github.com/anchore/syft)
    - CLI tool and library for generating a Software Bill of Materials from container images and filesystems
    - language: **Go** &nbsp;&nbsp; stars: **1,310** &nbsp;&nbsp; folks: **108**  &nbsp;&nbsp; `86 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,896** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `64 stars today`

1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    - 清华大学计算机系课程攻略 Guidance for courses in Department of Computer Science and Technology, Tsinghua University
    - language: **HTML** &nbsp;&nbsp; stars: **19,985** &nbsp;&nbsp; folks: **5,484**  &nbsp;&nbsp; `243 stars today`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,166** &nbsp;&nbsp; folks: **1,529**  &nbsp;&nbsp; `5,290 stars this week`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **9,344** &nbsp;&nbsp; folks: **1,827**  &nbsp;&nbsp; `1,143 stars this week`

1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    - A terminal for a more modern age (formerly Terminus)
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,504** &nbsp;&nbsp; folks: **1,332**  &nbsp;&nbsp; `2,284 stars this week`
...
1. [thunlp / WantWords](https://github.com/thunlp/WantWords)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,491** &nbsp;&nbsp; folks: **313**  &nbsp;&nbsp; `1,132 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **180,611** &nbsp;&nbsp; folks: **25,917**  &nbsp;&nbsp; `1,228 stars this week`
...
1. [deepset-ai / haystack](https://github.com/deepset-ai/haystack)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,361** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `468 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    - GFPGAN aims at developing Practical Algorithms for Real-world Face Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **10,166** &nbsp;&nbsp; folks: **1,529**  &nbsp;&nbsp; `6,454 stars this month`

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **12,924** &nbsp;&nbsp; folks: **547**  &nbsp;&nbsp; `11,746 stars this month`

1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    - A terminal for a more modern age (formerly Terminus)
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,504** &nbsp;&nbsp; folks: **1,332**  &nbsp;&nbsp; `4,617 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Roadmap to becoming a developer in 2021
    - language: **TypeScript** &nbsp;&nbsp; stars: **180,611** &nbsp;&nbsp; folks: **25,917**  &nbsp;&nbsp; `4,922 stars this month`
...
1. [Kyome22 / RunCat_for_windows](https://github.com/Kyome22/RunCat_for_windows)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **3,386** &nbsp;&nbsp; folks: **332**  &nbsp;&nbsp; `1,731 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **215,768** &nbsp;&nbsp; folks: **46,404**  &nbsp;&nbsp; `5,165 stars this month`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,727** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `1,968 stars this month`

1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    - 清华大学计算机系课程攻略 Guidance for courses in Department of Computer Science and Technology, Tsinghua University
    - language: **HTML** &nbsp;&nbsp; stars: **19,985** &nbsp;&nbsp; folks: **5,484**  &nbsp;&nbsp; `1,243 stars this month`
