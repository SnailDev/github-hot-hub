...
`更新时间：2021-05-23 08:49:02 +0800`

## 今日热门仓库

1. [minio / minio](https://github.com/minio/minio)
    - High Performance, Kubernetes Native Object Storage
    - language: **Go** &nbsp;&nbsp; stars: **27,757** &nbsp;&nbsp; folks: **3,010**  &nbsp;&nbsp; `88 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **9,562** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `206 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,709** &nbsp;&nbsp; folks: **46**  &nbsp;&nbsp; `1,005 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,805** &nbsp;&nbsp; folks: **1,870**  &nbsp;&nbsp; `456 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,323** &nbsp;&nbsp; folks: **1,693**  &nbsp;&nbsp; `279 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,395** &nbsp;&nbsp; folks: **3,157**  &nbsp;&nbsp; `270 stars today`

1. [Aayush9029 / Native-Youtube](https://github.com/Aayush9029/Native-Youtube)
    - Personal APp
    - language: **Swift** &nbsp;&nbsp; stars: **130** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `48 stars today`

1. [juce-framework / JUCE](https://github.com/juce-framework/JUCE)
    - JUCE is an open-source cross-platform C++ application framework for desktop and mobile applications, including VST, VST3, AU, AUv3, RTAS and AAX audio plug-ins.
    - language: **C++** &nbsp;&nbsp; stars: **2,987** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `93 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,397** &nbsp;&nbsp; folks: **676**  &nbsp;&nbsp; `329 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **120,963** &nbsp;&nbsp; folks: **17,232**  &nbsp;&nbsp; `185 stars today`
...
1. [anncwb / vue-vben-admin](https://github.com/anncwb/vue-vben-admin)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **4,119** &nbsp;&nbsp; folks: **1,041**  &nbsp;&nbsp; `30 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,515** &nbsp;&nbsp; folks: **866**  &nbsp;&nbsp; `130 stars today`

1. [lyswhut / lx-music-mobile](https://github.com/lyswhut/lx-music-mobile)
    - 一个基于 React native 开发的音乐软件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **189** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `59 stars today`

1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,711** &nbsp;&nbsp; folks: **10,017**  &nbsp;&nbsp; `94 stars today`

1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    - Awesome Docker Compose samples
    - language: **HTML** &nbsp;&nbsp; stars: **11,280** &nbsp;&nbsp; folks: **1,367**  &nbsp;&nbsp; `147 stars today`
...
1. [alfonsrv / impf-botpy](https://github.com/alfonsrv/impf-botpy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **91** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `29 stars today`

1. [hashicorp / vault](https://github.com/hashicorp/vault)
    - A tool for secrets management, encryption as a service, and privileged access management
    - language: **Go** &nbsp;&nbsp; stars: **20,991** &nbsp;&nbsp; folks: **2,913**  &nbsp;&nbsp; `293 stars today`
...
1. [WeChat-Big-Data-Challenge-2021 / WeChat_Big_Data_Challenge](https://github.com/WeChat-Big-Data-Challenge-2021/WeChat_Big_Data_Challenge)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **134** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `30 stars today`

1. [golang / go](https://github.com/golang/go)
    - The Go programming language
    - language: **Go** &nbsp;&nbsp; stars: **85,930** &nbsp;&nbsp; folks: **12,554**  &nbsp;&nbsp; `77 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,568** &nbsp;&nbsp; folks: **20,825**  &nbsp;&nbsp; `126 stars today`
...
1. [sonnysangha / Amazon-starter-template-nextjs](https://github.com/sonnysangha/Amazon-starter-template-nextjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `20 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **66,978** &nbsp;&nbsp; folks: **21,047**  &nbsp;&nbsp; `1,182 stars this week`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,291** &nbsp;&nbsp; folks: **229**  &nbsp;&nbsp; `308 stars this week`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    - A lightweight RTSP/RTMP/HTTP/HLS/HTTP-FLV/WebSocket-FLV/HTTP-TS/HTTP-fMP4/WebSocket-TS/WebSocket-fMP4/GB28181/WebRTC server and client framework based on C++11
    - language: **C++** &nbsp;&nbsp; stars: **3,477** &nbsp;&nbsp; folks: **1,045**  &nbsp;&nbsp; `323 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **10,430** &nbsp;&nbsp; folks: **1,881**  &nbsp;&nbsp; `3,767 stars this month`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **7,652** &nbsp;&nbsp; folks: **990**  &nbsp;&nbsp; `3,661 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,919** &nbsp;&nbsp; folks: **2,280**  &nbsp;&nbsp; `3,771 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **107,989** &nbsp;&nbsp; folks: **29,938**  &nbsp;&nbsp; `5,854 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,258** &nbsp;&nbsp; folks: **8,262**  &nbsp;&nbsp; `4,258 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **188,409** &nbsp;&nbsp; folks: **42,193**  &nbsp;&nbsp; `5,441 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,825** &nbsp;&nbsp; folks: **536**  &nbsp;&nbsp; `3,630 stars this month`
