...
1. [mli / paper-reading](https://github.com/mli/paper-reading)
    - 深度学习经典、新论文逐段精读
    - language: **无** &nbsp;&nbsp; stars: **2,266** &nbsp;&nbsp; folks: **107**  &nbsp;&nbsp; `280 stars today`

1. [lihaoyun6 / PD-Runner](https://github.com/lihaoyun6/PD-Runner)
    - A VM launcher for Parallels Desktop
    - language: **Swift** &nbsp;&nbsp; stars: **345** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `66 stars today`
...
1. [swc-project / swc](https://github.com/swc-project/swc)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **16,497** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `73 stars today`
...
1. [arco-design / arco-design](https://github.com/arco-design/arco-design)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,561** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `203 stars today`
...
1. [waydabber / BetterDummy](https://github.com/waydabber/BetterDummy)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **236** &nbsp;&nbsp; folks: **6**  &nbsp;&nbsp; `52 stars today`

1. [diem / diem](https://github.com/diem/diem)
    - Diem’s mission is to build a trusted and innovative financial network that empowers people and businesses around the world.
    - language: **Rust** &nbsp;&nbsp; stars: **16,093** &nbsp;&nbsp; folks: **2,470**  &nbsp;&nbsp; `8 stars today`
...
1. [Footsiefat / zspotify](https://github.com/Footsiefat/zspotify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,097** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `1,258 stars this week`

1. [modern-js-dev / modern.js](https://github.com/modern-js-dev/modern.js)
    - The meta-framework suite designed from scratch for frontend-focused modern web development.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,815** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `1,182 stars this week`
...
1. [deepfakes / faceswap](https://github.com/deepfakes/faceswap)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,339** &nbsp;&nbsp; folks: **11,297**  &nbsp;&nbsp; `421 stars this week`
...
1. [fchollet / deep-learning-with-python-notebooks](https://github.com/fchollet/deep-learning-with-python-notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,920** &nbsp;&nbsp; folks: **6,837**  &nbsp;&nbsp; `147 stars this week`

1. [cloudreve / Cloudreve](https://github.com/cloudreve/Cloudreve)
    - 🌩支持多家云存储的云盘系统 (Self-deployed file management and sharing system, supports multiple storage providers)
    - language: **Go** &nbsp;&nbsp; stars: **11,513** &nbsp;&nbsp; folks: **1,980**  &nbsp;&nbsp; `336 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **125,520** &nbsp;&nbsp; folks: **20,426**  &nbsp;&nbsp; `1,488 stars this week`

1. [neovim / neovim](https://github.com/neovim/neovim)
    - Vim-fork focused on extensibility and usability
    - language: **Vim script** &nbsp;&nbsp; stars: **47,968** &nbsp;&nbsp; folks: **3,497**  &nbsp;&nbsp; `233 stars this week`
...
1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **52,642** &nbsp;&nbsp; folks: **5,423**  &nbsp;&nbsp; `269 stars this week`
...
1. [topjohnwu / Magisk](https://github.com/topjohnwu/Magisk)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **21,367** &nbsp;&nbsp; folks: **4,580**  &nbsp;&nbsp; `245 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **125,520** &nbsp;&nbsp; folks: **20,426**  &nbsp;&nbsp; `5,306 stars this month`
