...
1. [expo / expo](https://github.com/expo/expo)
    ...
    - language: **Objective-C** &nbsp;&nbsp; stars: **14,425** &nbsp;&nbsp; folks: **2,637**  &nbsp;&nbsp; `149 stars today`
...
1. [RPCS3 / rpcs3](https://github.com/RPCS3/rpcs3)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,789** &nbsp;&nbsp; folks: **1,496**  &nbsp;&nbsp; `101 stars today`

1. [sharkdp / fd](https://github.com/sharkdp/fd)
    - A simple, fast and user-friendly alternative to 'find'
    - language: **Rust** &nbsp;&nbsp; stars: **18,450** &nbsp;&nbsp; folks: **467**  &nbsp;&nbsp; `98 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **108,824** &nbsp;&nbsp; folks: **37,364**  &nbsp;&nbsp; `87 stars today`
...
1. [PeterWang512 / GANSketching](https://github.com/PeterWang512/GANSketching)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **262** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `59 stars today`

1. [arendst / Tasmota](https://github.com/arendst/Tasmota)
    - Alternative firmware for ESP8266 with easy configuration using webUI, OTA updates, automation using timers or rules, expandability and entirely local control over MQTT, HTTP, Serial or KNX. Full documentation at
    - language: **C** &nbsp;&nbsp; stars: **15,907** &nbsp;&nbsp; folks: **3,462**  &nbsp;&nbsp; `90 stars today`
...
1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,320** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `393 stars this week`

1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **2,970** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `1,488 stars this week`

1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    - 🌍 针对小白的算法训练 | 包括四部分：①.算法基础 ②.力扣图解 ③.大厂面经 ④.CS_汇总 | 附：1、千本开源电子书 2、百张技术思维导图（项目花了上百小时，希望可以点 star 支持，🌹感谢~）
    - language: **Java** &nbsp;&nbsp; stars: **27,856** &nbsp;&nbsp; folks: **5,323**  &nbsp;&nbsp; `741 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **28,444** &nbsp;&nbsp; folks: **5,363**  &nbsp;&nbsp; `2,029 stars this week`
...
1. [JetBrains / compose-jb](https://github.com/JetBrains/compose-jb)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,784** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `754 stars this week`
...
1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    ...
    - language: **无** &nbsp;&nbsp; stars: **15,138** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `1,605 stars this week`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,311** &nbsp;&nbsp; folks: **4,201**  &nbsp;&nbsp; `713 stars this week`
...
1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **11,173** &nbsp;&nbsp; folks: **1,629**  &nbsp;&nbsp; `125 stars this week`
...
1. [sveltejs / kit](https://github.com/sveltejs/kit)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,324** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `97 stars this week`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,396** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `763 stars this week`
...
1. [microsoft / IoT-For-Beginners](https://github.com/microsoft/IoT-For-Beginners)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,656** &nbsp;&nbsp; folks: **638**  &nbsp;&nbsp; `6,356 stars this month`
...
1. [facebookresearch / ParlAI](https://github.com/facebookresearch/ParlAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,159** &nbsp;&nbsp; folks: **1,621**  &nbsp;&nbsp; `878 stars this month`
...
1. [shufflewzc / faker2](https://github.com/shufflewzc/faker2)
    - 不知名大佬备份
    - language: **JavaScript** &nbsp;&nbsp; stars: **837** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `739 stars this month`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,380** &nbsp;&nbsp; folks: **14,194**  &nbsp;&nbsp; `582 stars this month`
