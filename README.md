...
`更新时间：2025-05-15 21:26:21 +0800`

## 今日热门仓库

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **14,444** &nbsp;&nbsp; folks: **3,017**  &nbsp;&nbsp; `4,103 stars today`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,101** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `1,019 stars today`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **30,218** &nbsp;&nbsp; folks: **2,911**  &nbsp;&nbsp; `679 stars today`
...
1. [overleaf / overleaf](https://github.com/overleaf/overleaf)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,425** &nbsp;&nbsp; folks: **1,585**  &nbsp;&nbsp; `26 stars today`

1. [airweave-ai / airweave](https://github.com/airweave-ai/airweave)
    - Airweave lets agents search any app
    - language: **Python** &nbsp;&nbsp; stars: **1,837** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `399 stars today`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **51,268** &nbsp;&nbsp; folks: **5,494**  &nbsp;&nbsp; `347 stars today`
...
1. [happycola233 / tchMaterial-parser](https://github.com/happycola233/tchMaterial-parser)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **976** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `262 stars today`

1. [alibaba / spring-ai-alibaba](https://github.com/alibaba/spring-ai-alibaba)
    - Agentic AI Framework for Java Developers
    - language: **Java** &nbsp;&nbsp; stars: **3,143** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `136 stars today`

1. [trycua / cua](https://github.com/trycua/cua)
    - c/ua is the Docker Container for Computer-Use AI Agents.
    - language: **Python** &nbsp;&nbsp; stars: **6,614** &nbsp;&nbsp; folks: **263**  &nbsp;&nbsp; `288 stars today`
...
1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,373** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `6,443 stars this week`

1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    - 🚀从聊天记录创造数字分身的一站式解决方案💡 使用聊天记录微调大语言模型，让大模型有“那味儿”，并绑定到聊天机器人，实现自己的数字分身。 数字克隆/数字分身/数字永生/LLM/聊天机器人/LoRA
    - language: **Python** &nbsp;&nbsp; stars: **8,101** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `4,047 stars this week`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **30,218** &nbsp;&nbsp; folks: **2,911**  &nbsp;&nbsp; `832 stars this week`

1. [longbridge / gpui-component](https://github.com/longbridge/gpui-component)
    - UI components for building fantastic desktop application by using GPUI.
    - language: **Rust** &nbsp;&nbsp; stars: **2,703** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `1,444 stars this week`
...
1. [zed-industries / zed](https://github.com/zed-industries/zed)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **59,718** &nbsp;&nbsp; folks: **4,208**  &nbsp;&nbsp; `1,595 stars this week`

1. [alibaba / spring-ai-alibaba](https://github.com/alibaba/spring-ai-alibaba)
    - Agentic AI Framework for Java Developers
    - language: **Java** &nbsp;&nbsp; stars: **3,143** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `388 stars this week`

1. [GoogleCloudPlatform / kubectl-ai](https://github.com/GoogleCloudPlatform/kubectl-ai)
    - AI powered Kubernetes Assistant
    - language: **Go** &nbsp;&nbsp; stars: **5,120** &nbsp;&nbsp; folks: **390**  &nbsp;&nbsp; `2,368 stars this week`
...
1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **62,486** &nbsp;&nbsp; folks: **3,349**  &nbsp;&nbsp; `3,488 stars this week`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **51,268** &nbsp;&nbsp; folks: **5,494**  &nbsp;&nbsp; `950 stars this week`
...
1. [NVIDIA / NeMo](https://github.com/NVIDIA/NeMo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,401** &nbsp;&nbsp; folks: **2,864**  &nbsp;&nbsp; `508 stars this week`
...
1. [comet-ml / opik](https://github.com/comet-ml/opik)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,071** &nbsp;&nbsp; folks: **541**  &nbsp;&nbsp; `723 stars this week`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **67,129** &nbsp;&nbsp; folks: **9,387**  &nbsp;&nbsp; `17,163 stars this month`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **84,493** &nbsp;&nbsp; folks: **9,937**  &nbsp;&nbsp; `14,126 stars this month`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **7,383** &nbsp;&nbsp; folks: **881**  &nbsp;&nbsp; `4,989 stars this month`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,924** &nbsp;&nbsp; folks: **614**  &nbsp;&nbsp; `5,060 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **320,778** &nbsp;&nbsp; folks: **41,454**  &nbsp;&nbsp; `7,347 stars this month`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,853** &nbsp;&nbsp; folks: **536**  &nbsp;&nbsp; `5,111 stars this month`

1. [bytedance / UI-TARS](https://github.com/bytedance/UI-TARS)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,945** &nbsp;&nbsp; folks: **388**  &nbsp;&nbsp; `2,017 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **93,778** &nbsp;&nbsp; folks: **25,687**  &nbsp;&nbsp; `12,684 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero
    - language: **Python** &nbsp;&nbsp; stars: **23,513** &nbsp;&nbsp; folks: **2,014**  &nbsp;&nbsp; `3,306 stars this month`

1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    - Free, simple, and intuitive online database diagram editor and SQL generator.
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,079** &nbsp;&nbsp; folks: **2,108**  &nbsp;&nbsp; `3,274 stars this month`
