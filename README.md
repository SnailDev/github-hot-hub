...
`更新时间：2021-12-25 03:10:09 +0800`

## 今日热门仓库

1. [cisagov / log4j-scanner](https://github.com/cisagov/log4j-scanner)
    - log4j-scanner is a project derived from other members of the open-source community by CISA to help organizations identify potentially vulnerable web services affected by the log4j vulnerabilities.
    - language: **Java** &nbsp;&nbsp; stars: **499** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `163 stars today`

1. [airbnb / javascript](https://github.com/airbnb/javascript)
    - JavaScript Style Guide
    - language: **JavaScript** &nbsp;&nbsp; stars: **117,494** &nbsp;&nbsp; folks: **22,437**  &nbsp;&nbsp; `66 stars today`

1. [codenotary / immudb](https://github.com/codenotary/immudb)
    - immudb - world’s fastest immutable database, built on a zero trust model
    - language: **Go** &nbsp;&nbsp; stars: **5,271** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `237 stars today`
...
1. [wader / fq](https://github.com/wader/fq)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,189** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `466 stars today`

1. [Tencent / tdesign](https://github.com/Tencent/tdesign)
    - Enterprise Design System
    - language: **无** &nbsp;&nbsp; stars: **751** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `330 stars today`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **49,599** &nbsp;&nbsp; folks: **4,863**  &nbsp;&nbsp; `171 stars today`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **14,891** &nbsp;&nbsp; folks: **3,184**  &nbsp;&nbsp; `141 stars today`
...
1. [kon9chunkit / GitHub-Chinese-Top-Charts](https://github.com/kon9chunkit/GitHub-Chinese-Top-Charts)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **42,767** &nbsp;&nbsp; folks: **6,092**  &nbsp;&nbsp; `166 stars today`

1. [EmbarkStudios / kajiya](https://github.com/EmbarkStudios/kajiya)
    - 💡 Experimental real-time global illumination renderer 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **1,185** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `199 stars today`

1. [zeromicro / go-zero](https://github.com/zeromicro/go-zero)
    - go-zero is a web and rpc framework written in Go. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
    - language: **Go** &nbsp;&nbsp; stars: **13,320** &nbsp;&nbsp; folks: **1,628**  &nbsp;&nbsp; `25 stars today`

1. [jina-ai / jina](https://github.com/jina-ai/jina)
    - Cloud-native neural search framework for 𝙖𝙣𝙮 kind of data
    - language: **Python** &nbsp;&nbsp; stars: **12,800** &nbsp;&nbsp; folks: **1,733**  &nbsp;&nbsp; `95 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **89,396** &nbsp;&nbsp; folks: **9,527**  &nbsp;&nbsp; `111 stars today`
...
1. [dani-garcia / vaultwarden](https://github.com/dani-garcia/vaultwarden)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **12,799** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `88 stars today`

1. [tiangolo / sqlmodel](https://github.com/tiangolo/sqlmodel)
    - SQL databases in Python, designed for simplicity, compatibility, and robustness.
    - language: **Python** &nbsp;&nbsp; stars: **6,285** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `159 stars today`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,821** &nbsp;&nbsp; folks: **1,692**  &nbsp;&nbsp; `397 stars today`
...
1. [microsoft / unilm](https://github.com/microsoft/unilm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,177** &nbsp;&nbsp; folks: **820**  &nbsp;&nbsp; `41 stars today`
...
1. [codenotary / immudb](https://github.com/codenotary/immudb)
    - immudb - world’s fastest immutable database, built on a zero trust model
    - language: **Go** &nbsp;&nbsp; stars: **5,271** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `1,827 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,486** &nbsp;&nbsp; folks: **2,008**  &nbsp;&nbsp; `2,808 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    - GFPGAN aims at developing Practical Algorithms for Real-world Face Restoration.
    - language: **Python** &nbsp;&nbsp; stars: **13,486** &nbsp;&nbsp; folks: **2,008**  &nbsp;&nbsp; `9,772 stars this month`

1. [phoboslab / qoi](https://github.com/phoboslab/qoi)
    - The “Quite OK Image Format” for fast, lossless image compression
    - language: **C** &nbsp;&nbsp; stars: **3,697** &nbsp;&nbsp; folks: **155**  &nbsp;&nbsp; `3,324 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **181,373** &nbsp;&nbsp; folks: **26,050**  &nbsp;&nbsp; `5,226 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,417** &nbsp;&nbsp; folks: **1,327**  &nbsp;&nbsp; `3,014 stars this month`
...
1. [remix-run / remix](https://github.com/remix-run/remix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,407** &nbsp;&nbsp; folks: **560**  &nbsp;&nbsp; `4,958 stars this month`

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **13,718** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `5,943 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **216,973** &nbsp;&nbsp; folks: **46,572**  &nbsp;&nbsp; `5,896 stars this month`
...
1. [ytdl-org / youtube-dl](https://github.com/ytdl-org/youtube-dl)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **103,938** &nbsp;&nbsp; folks: **6,639**  &nbsp;&nbsp; `1,637 stars this month`

1. [spring-projects / spring-boot](https://github.com/spring-projects/spring-boot)
    - Spring Boot
    - language: **Java** &nbsp;&nbsp; stars: **58,816** &nbsp;&nbsp; folks: **35,222**  &nbsp;&nbsp; `673 stars this month`
