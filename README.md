...
`更新时间：2021-08-28 14:12:50 +0800`

## 今日热门仓库

1. [marceloprates / prettymaps](https://github.com/marceloprates/prettymaps)
    - A small set of Python functions to draw pretty maps from OpenStreetMap data. Based on osmnx, matplotlib and shapely libraries.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **4,419** &nbsp;&nbsp; folks: **135**  &nbsp;&nbsp; `762 stars today`
...
1. [AkashSingh3031 / The-Complete-FAANG-Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **4,856** &nbsp;&nbsp; folks: **922**  &nbsp;&nbsp; `237 stars today`
...
1. [meilisearch / MeiliSearch](https://github.com/meilisearch/MeiliSearch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **17,267** &nbsp;&nbsp; folks: **552**  &nbsp;&nbsp; `329 stars today`

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **3,190** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `262 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,860** &nbsp;&nbsp; folks: **4,671**  &nbsp;&nbsp; `307 stars today`
...
1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,333** &nbsp;&nbsp; folks: **1,634**  &nbsp;&nbsp; `122 stars today`

1. [filebrowser / filebrowser](https://github.com/filebrowser/filebrowser)
    - 📂 Web File Browser
    - language: **Go** &nbsp;&nbsp; stars: **11,970** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `223 stars today`
...
1. [tiangolo / sqlmodel](https://github.com/tiangolo/sqlmodel)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,685** &nbsp;&nbsp; folks: **89**  &nbsp;&nbsp; `723 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **4,665** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `1,014 stars today`
...
1. [benyaminahmed / nft-image-generator](https://github.com/benyaminahmed/nft-image-generator)
    - 无
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **192** &nbsp;&nbsp; folks: **74**  &nbsp;&nbsp; `69 stars today`
...
1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,443** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `1,759 stars this week`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **4,665** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `3,014 stars this week`
...
1. [filebrowser / filebrowser](https://github.com/filebrowser/filebrowser)
    - 📂 Web File Browser
    - language: **Go** &nbsp;&nbsp; stars: **11,970** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `1,248 stars this week`
...
1. [godotengine / godot](https://github.com/godotengine/godot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **41,629** &nbsp;&nbsp; folks: **7,528**  &nbsp;&nbsp; `480 stars this week`
...
1. [fuzhengwei / small-spring](https://github.com/fuzhengwei/small-spring)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,738** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `1,538 stars this month`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **4,665** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `3,549 stars this month`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,980** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `2,209 stars this month`
...
1. [google / zx](https://github.com/google/zx)
    - A tool for writing better scripts
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,527** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `3,370 stars this month`
...
1. [Qv2ray / Qv2ray](https://github.com/Qv2ray/Qv2ray)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **12,299** &nbsp;&nbsp; folks: **2,194**  &nbsp;&nbsp; `984 stars this month`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **21,628** &nbsp;&nbsp; folks: **489**  &nbsp;&nbsp; `3,254 stars this month`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **48,832** &nbsp;&nbsp; folks: **4,184**  &nbsp;&nbsp; `2,191 stars this month`

1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **6,442** &nbsp;&nbsp; folks: **1,556**  &nbsp;&nbsp; `995 stars this month`
...
1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,428** &nbsp;&nbsp; folks: **3,032**  &nbsp;&nbsp; `1,411 stars this month`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **329,163** &nbsp;&nbsp; folks: **26,464**  &nbsp;&nbsp; `2,884 stars this month`
