...
`更新时间：2026-02-20 14:51:29 +0800`

## 今日热门仓库

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **55,600** &nbsp;&nbsp; folks: **4,212**  &nbsp;&nbsp; `889 stars today`
...
1. [RichardAtCT / claude-code-telegram](https://github.com/RichardAtCT/claude-code-telegram)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,076** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `174 stars today`
...
1. [alibaba / zvec](https://github.com/alibaba/zvec)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **5,217** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `4,506 stars this week`

1. [rowboatlabs / rowboat](https://github.com/rowboatlabs/rowboat)
    - Open-source AI coworker, with memory
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,856** &nbsp;&nbsp; folks: **680**  &nbsp;&nbsp; `2,842 stars this week`

1. [p-e-w / heretic](https://github.com/p-e-w/heretic)
    - Fully automatic censorship removal for language models
    - language: **Python** &nbsp;&nbsp; stars: **8,591** &nbsp;&nbsp; folks: **855**  &nbsp;&nbsp; `3,302 stars this week`
...
1. [ruvnet / wifi-densepose](https://github.com/ruvnet/wifi-densepose)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,126** &nbsp;&nbsp; folks: **609**  &nbsp;&nbsp; `1,222 stars this week`
...
1. [openclaw / openclaw](https://github.com/openclaw/openclaw)
    - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞
    - language: **TypeScript** &nbsp;&nbsp; stars: **212,532** &nbsp;&nbsp; folks: **39,479**  &nbsp;&nbsp; `205,829 stars this month`

1. [badlogic / pi-mono](https://github.com/badlogic/pi-mono)
    - AI agent toolkit: coding agent CLI, unified LLM API, TUI & web UI libraries, Slack bot, vLLM pods
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,979** &nbsp;&nbsp; folks: **1,425**  &nbsp;&nbsp; `11,770 stars this month`

1. [KeygraphHQ / shannon](https://github.com/KeygraphHQ/shannon)
    - Fully autonomous AI hacker to find actual exploits in your web apps. Shannon has achieved a 96.15% success rate on the hint-free, source-aware XBOW Benchmark.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,820** &nbsp;&nbsp; folks: **2,359**  &nbsp;&nbsp; `19,782 stars this month`

1. [tobi / qmd](https://github.com/tobi/qmd)
    - mini cli search engine for your docs, knowledge bases, meeting notes, whatever. Tracking current sota approaches while being all local
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,528** &nbsp;&nbsp; folks: **517**  &nbsp;&nbsp; `7,495 stars this month`

1. [openai / skills](https://github.com/openai/skills)
    - Skills Catalog for Codex
    - language: **Python** &nbsp;&nbsp; stars: **9,062** &nbsp;&nbsp; folks: **508**  &nbsp;&nbsp; `7,281 stars this month`

1. [VectifyAI / PageIndex](https://github.com/VectifyAI/PageIndex)
    - 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG
    - language: **Python** &nbsp;&nbsp; stars: **15,628** &nbsp;&nbsp; folks: **1,128**  &nbsp;&nbsp; `10,104 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **HTML** &nbsp;&nbsp; stars: **32,178** &nbsp;&nbsp; folks: **5,119**  &nbsp;&nbsp; `6,997 stars this month`

1. [remotion-dev / remotion](https://github.com/remotion-dev/remotion)
    - 🎥 Make videos programmatically with React
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,276** &nbsp;&nbsp; folks: **2,277**  &nbsp;&nbsp; `11,904 stars this month`

1. [steipete / gogcli](https://github.com/steipete/gogcli)
    - Google Suite CLI: Gmail, GCal, GDrive, GContacts.
    - language: **Go** &nbsp;&nbsp; stars: **4,259** &nbsp;&nbsp; folks: **336**  &nbsp;&nbsp; `3,685 stars this month`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **55,600** &nbsp;&nbsp; folks: **4,212**  &nbsp;&nbsp; `25,898 stars this month`

1. [anthropics / skills](https://github.com/anthropics/skills)
    - Public repository for Agent Skills
    - language: **Python** &nbsp;&nbsp; stars: **72,097** &nbsp;&nbsp; folks: **7,370**  &nbsp;&nbsp; `26,759 stars this month`
...
1. [gsd-build / get-shit-done](https://github.com/gsd-build/get-shit-done)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,335** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `11,323 stars this month`

1. [thedotmack / claude-mem](https://github.com/thedotmack/claude-mem)
    - A Claude Code plugin that automatically captures everything Claude does during your coding sessions, compresses it with AI (using Claude's agent-sdk), and injects relevant context back into future sessions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,389** &nbsp;&nbsp; folks: **1,978**  &nbsp;&nbsp; `14,947 stars this month`

1. [ThePrimeagen / 99](https://github.com/ThePrimeagen/99)
    - Neovim AI agent done right
    - language: **Lua** &nbsp;&nbsp; stars: **3,932** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `2,876 stars this month`

1. [NevaMind-AI / memU](https://github.com/NevaMind-AI/memU)
    - Memory for 24/7 proactive agents like openclaw (moltbot, clawdbot).
    - language: **Python** &nbsp;&nbsp; stars: **9,487** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `4,647 stars this month`

1. [tambo-ai / tambo](https://github.com/tambo-ai/tambo)
    - Generative UI SDK for React
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,795** &nbsp;&nbsp; folks: **521**  &nbsp;&nbsp; `8,344 stars this month`
