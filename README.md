...
`更新时间：2021-02-19 09:35:08 +0800`

## 今日热门仓库

1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **827** &nbsp;&nbsp; folks: **122**  &nbsp;&nbsp; `279 stars today`
...
1. [mitmath / 18S191](https://github.com/mitmath/18S191)
    ...
    - language: **Julia** &nbsp;&nbsp; stars: **1,517** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `59 stars today`
...
1. [MManoah / league-profile-tool](https://github.com/MManoah/league-profile-tool)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **204** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `44 stars today`

1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,344** &nbsp;&nbsp; folks: **651**  &nbsp;&nbsp; `207 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **97,237** &nbsp;&nbsp; folks: **16,190**  &nbsp;&nbsp; `311 stars today`

1. [dani-garcia / bitwarden_rs](https://github.com/dani-garcia/bitwarden_rs)
    - Unofficial Bitwarden compatible server written in Rust
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,758** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `156 stars today`

1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    - 🌈 A UI Design Language and React UI library
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,023** &nbsp;&nbsp; folks: **26,613**  &nbsp;&nbsp; `826 stars today`

1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **19,772** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `281 stars today`
...
1. [edeng23 / binance-trade-bot](https://github.com/edeng23/binance-trade-bot)
    - Automated cryptocurrency trading bot
    - language: **Python** &nbsp;&nbsp; stars: **827** &nbsp;&nbsp; folks: **122**  &nbsp;&nbsp; `707 stars this week`
...
1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,892** &nbsp;&nbsp; folks: **1,044**  &nbsp;&nbsp; `994 stars this week`
...
1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    - Rich is a Python library for rich text and beautiful formatting in the terminal.
    - language: **Python** &nbsp;&nbsp; stars: **22,864** &nbsp;&nbsp; folks: **659**  &nbsp;&nbsp; `1,824 stars this week`
...
1. [greatsuspender / thegreatsuspender](https://github.com/greatsuspender/thegreatsuspender)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,704** &nbsp;&nbsp; folks: **751**  &nbsp;&nbsp; `893 stars this month`
...
1. [flameshot-org / flameshot](https://github.com/flameshot-org/flameshot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,520** &nbsp;&nbsp; folks: **611**  &nbsp;&nbsp; `1,891 stars this month`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,528** &nbsp;&nbsp; folks: **1,042**  &nbsp;&nbsp; `2,921 stars this month`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    - An extremely fast JavaScript bundler and minifier
    - language: **Go** &nbsp;&nbsp; stars: **19,772** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `2,433 stars this month`
...
1. [hashicorp / vault](https://github.com/hashicorp/vault)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,197** &nbsp;&nbsp; folks: **2,805**  &nbsp;&nbsp; `1,294 stars this month`
