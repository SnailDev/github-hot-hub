...
1. [Letscoder / PlayCover](https://github.com/Letscoder/PlayCover)
    ...
    - language: **Objective-C** &nbsp;&nbsp; stars: **871** &nbsp;&nbsp; folks: **37**  &nbsp;&nbsp; `469 stars today`

1. [LingDong- / fishdraw](https://github.com/LingDong-/fishdraw)
    - procedurally generated fish drawings
    - language: **JavaScript** &nbsp;&nbsp; stars: **710** &nbsp;&nbsp; folks: **30**  &nbsp;&nbsp; `498 stars today`

1. [bytedance / bhook](https://github.com/bytedance/bhook)
    - 🔥 bhook is a PLT hook framework for Android app.
    - language: **C** &nbsp;&nbsp; stars: **254** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `96 stars today`

1. [unit8co / darts](https://github.com/unit8co/darts)
    - A python library for easy manipulation and forecasting of time series.
    - language: **Python** &nbsp;&nbsp; stars: **2,108** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `517 stars today`

1. [jlongster / absurd-sql](https://github.com/jlongster/absurd-sql)
    - sqlite3 in ur indexeddb (hopefully a better backend soon)
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,641** &nbsp;&nbsp; folks: **8**  &nbsp;&nbsp; `1,139 stars today`

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **28,213** &nbsp;&nbsp; folks: **4,489**  &nbsp;&nbsp; `158 stars today`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **148,078** &nbsp;&nbsp; folks: **17,091**  &nbsp;&nbsp; `1,040 stars today`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Open source Node.js Headless CMS to easily build customisable APIs
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,808** &nbsp;&nbsp; folks: **4,673**  &nbsp;&nbsp; `530 stars today`
...
1. [swc-project / swc](https://github.com/swc-project/swc)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,890** &nbsp;&nbsp; folks: **382**  &nbsp;&nbsp; `524 stars today`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **50,088** &nbsp;&nbsp; folks: **13,097**  &nbsp;&nbsp; `181 stars today`

1. [tensorflow / tensorflow](https://github.com/tensorflow/tensorflow)
    - An Open Source Machine Learning Framework for Everyone
    - language: **C++** &nbsp;&nbsp; stars: **158,357** &nbsp;&nbsp; folks: **85,341**  &nbsp;&nbsp; `189 stars today`

1. [0xAX / linux-insides](https://github.com/0xAX/linux-insides)
    - A little bit about a linux kernel
    - language: **Python** &nbsp;&nbsp; stars: **23,317** &nbsp;&nbsp; folks: **2,688**  &nbsp;&nbsp; `163 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **116,970** &nbsp;&nbsp; folks: **19,240**  &nbsp;&nbsp; `506 stars today`
...
1. [xxlllq / system_architect](https://github.com/xxlllq/system_architect)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **1,868** &nbsp;&nbsp; folks: **739**  &nbsp;&nbsp; `130 stars today`

1. [rg3dengine / rg3d](https://github.com/rg3dengine/rg3d)
    - 3D and 2D game engine written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **2,410** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `175 stars today`

1. [airbnb / javascript](https://github.com/airbnb/javascript)
    - JavaScript Style Guide
    - language: **JavaScript** &nbsp;&nbsp; stars: **112,953** &nbsp;&nbsp; folks: **21,632**  &nbsp;&nbsp; `186 stars today`

1. [mrthetkhine / PythonFreeCourse](https://github.com/mrthetkhine/PythonFreeCourse)
    - Code for Python Course
    - language: **Python** &nbsp;&nbsp; stars: **88** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `51 stars today`
...
1. [tmrts / go-patterns](https://github.com/tmrts/go-patterns)
    - Curated list of Go design patterns, recipes and idioms
    - language: **Go** &nbsp;&nbsp; stars: **16,629** &nbsp;&nbsp; folks: **1,538**  &nbsp;&nbsp; `709 stars this week`

1. [swc-project / swc](https://github.com/swc-project/swc)
    - swc is a super-fast compiler written in rust; producing widely-supported javascript from modern standards and typescript.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,890** &nbsp;&nbsp; folks: **382**  &nbsp;&nbsp; `762 stars this week`
...
1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **50,088** &nbsp;&nbsp; folks: **13,097**  &nbsp;&nbsp; `371 stars this week`
...
1. [xxlllq / system_architect](https://github.com/xxlllq/system_architect)
    - 💯高质量、最全面、完全免费的系统架构设计师（软考高级）备考资源库。QQ群：系统架构设计师（④群：910582038），系统分析师（②群：699260558），信息系统项目管理师（217144315），纯备考群，非培训群。
    - language: **HTML** &nbsp;&nbsp; stars: **1,868** &nbsp;&nbsp; folks: **739**  &nbsp;&nbsp; `427 stars this month`
