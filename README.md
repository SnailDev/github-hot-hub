...
1. [kh4sh3i / ICS-Pentesting-Tools](https://github.com/kh4sh3i/ICS-Pentesting-Tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **136** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `78 stars today`

1. [jagrosh / MusicBot](https://github.com/jagrosh/MusicBot)
    - 🎶 A Discord music bot that's easy to set up and run yourself!
    - language: **Java** &nbsp;&nbsp; stars: **2,442** &nbsp;&nbsp; folks: **1,183**  &nbsp;&nbsp; `65 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,183** &nbsp;&nbsp; folks: **2,509**  &nbsp;&nbsp; `181 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,713** &nbsp;&nbsp; folks: **4,145**  &nbsp;&nbsp; `205 stars today`
...
1. [ohmyzsh / ohmyzsh](https://github.com/ohmyzsh/ohmyzsh)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **134,150** &nbsp;&nbsp; folks: **22,843**  &nbsp;&nbsp; `393 stars today`
...
1. [Siterizer / new-world-fishing-bot](https://github.com/Siterizer/new-world-fishing-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **140** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `51 stars today`
...
1. [robertdavidgraham / masscan](https://github.com/robertdavidgraham/masscan)
    ...
    - language: **C** &nbsp;&nbsp; stars: **17,628** &nbsp;&nbsp; folks: **2,572**  &nbsp;&nbsp; `1,004 stars this week`
...
1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,805** &nbsp;&nbsp; folks: **767**  &nbsp;&nbsp; `956 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **171,284** &nbsp;&nbsp; folks: **21,774**  &nbsp;&nbsp; `1,270 stars this week`
...
1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,756** &nbsp;&nbsp; folks: **262**  &nbsp;&nbsp; `518 stars this week`
...
1. [salesforce / Merlion](https://github.com/salesforce/Merlion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,781** &nbsp;&nbsp; folks: **113**  &nbsp;&nbsp; `429 stars this week`

1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    - 📚 Learn to write an embedded OS in Rust 🦀
    - language: **Rust** &nbsp;&nbsp; stars: **6,562** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `318 stars this week`

1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    - 🛁 Clean Code concepts adapted for JavaScript
    - language: **JavaScript** &nbsp;&nbsp; stars: **58,231** &nbsp;&nbsp; folks: **7,382**  &nbsp;&nbsp; `1,144 stars this week`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,447** &nbsp;&nbsp; folks: **4,915**  &nbsp;&nbsp; `244 stars this week`
...
1. [xinntao / Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,331** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `2,035 stars this month`

1. [HashLips / generative-art-opensource](https://github.com/HashLips/generative-art-opensource)
    - Create generative art by using the canvas api and node js, feel free to contribute to this repo with new ideas.
    - language: **JavaScript** &nbsp;&nbsp; stars: **841** &nbsp;&nbsp; folks: **327**  &nbsp;&nbsp; `511 stars this month`
...
1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,765** &nbsp;&nbsp; folks: **2,171**  &nbsp;&nbsp; `4,156 stars this month`
