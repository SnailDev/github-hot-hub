...
`更新时间：2021-05-24 10:22:05 +0800`

## 今日热门仓库

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,146** &nbsp;&nbsp; folks: **1,910**  &nbsp;&nbsp; `347 stars today`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,862** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `228 stars today`
...
1. [fireship-io / threejs-scroll-animation-demo](https://github.com/fireship-io/threejs-scroll-animation-demo)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **191** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `121 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,214** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `539 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,491** &nbsp;&nbsp; folks: **1,705**  &nbsp;&nbsp; `188 stars today`

1. [lyswhut / lx-music-mobile](https://github.com/lyswhut/lx-music-mobile)
    - 一个基于 React native 开发的音乐软件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **261** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `53 stars today`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,940** &nbsp;&nbsp; folks: **2,191**  &nbsp;&nbsp; `138 stars today`

1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,295** &nbsp;&nbsp; folks: **3,452**  &nbsp;&nbsp; `206 stars today`

1. [ageron / handson-ml2](https://github.com/ageron/handson-ml2)
    - A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,281** &nbsp;&nbsp; folks: **7,160**  &nbsp;&nbsp; `68 stars today`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,724** &nbsp;&nbsp; folks: **1,052**  &nbsp;&nbsp; `241 stars today`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    - Recovers passwords from pixelized screenshots
    - language: **Python** &nbsp;&nbsp; stars: **18,940** &nbsp;&nbsp; folks: **2,191**  &nbsp;&nbsp; `478 stars this week`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    - A lightweight RTSP/RTMP/HTTP/HLS/HTTP-FLV/WebSocket-FLV/HTTP-TS/HTTP-fMP4/WebSocket-TS/WebSocket-fMP4/GB28181/WebRTC server and client framework based on C++11
    - language: **C++** &nbsp;&nbsp; stars: **3,724** &nbsp;&nbsp; folks: **1,052**  &nbsp;&nbsp; `573 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,146** &nbsp;&nbsp; folks: **1,910**  &nbsp;&nbsp; `1,273 stars this week`
...
1. [parcel-bundler / parcel](https://github.com/parcel-bundler/parcel)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,380** &nbsp;&nbsp; folks: **1,935**  &nbsp;&nbsp; `293 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,699** &nbsp;&nbsp; folks: **1,006**  &nbsp;&nbsp; `3,365 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,995** &nbsp;&nbsp; folks: **2,305**  &nbsp;&nbsp; `3,629 stars this month`
...
1. [thedevdojo / wave](https://github.com/thedevdojo/wave)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,706** &nbsp;&nbsp; folks: **167**  &nbsp;&nbsp; `1,891 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,304** &nbsp;&nbsp; folks: **8,272**  &nbsp;&nbsp; `3,779 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,874** &nbsp;&nbsp; folks: **538**  &nbsp;&nbsp; `3,582 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **188,482** &nbsp;&nbsp; folks: **42,212**  &nbsp;&nbsp; `5,347 stars this month`

1. [kelseyhightower / kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way)
    - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
    - language: **无** &nbsp;&nbsp; stars: **26,798** &nbsp;&nbsp; folks: **8,105**  &nbsp;&nbsp; `1,104 stars this month`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **13,894** &nbsp;&nbsp; folks: **723**  &nbsp;&nbsp; `2,107 stars this month`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **25,314** &nbsp;&nbsp; folks: **5,055**  &nbsp;&nbsp; `2,188 stars this month`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,230** &nbsp;&nbsp; folks: **6,548**  &nbsp;&nbsp; `2,928 stars this month`
