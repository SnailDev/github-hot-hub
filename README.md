...
1. [CyberPunkMetalHead / binance-trading-bot-new-coins](https://github.com/CyberPunkMetalHead/binance-trading-bot-new-coins)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **226** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `135 stars today`
...
1. [AhmadRafiee / Docker_training_with_DockerMe](https://github.com/AhmadRafiee/Docker_training_with_DockerMe)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **124** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `19 stars today`
...
1. [NvChad / NvChad](https://github.com/NvChad/NvChad)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **6,028** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `3,321 stars this month`

1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **3,002** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `2,139 stars this month`

1. [fuzhengwei / small-spring](https://github.com/fuzhengwei/small-spring)
    - 🌱《 Spring 手撸专栏》，本专栏以 Spring 源码学习为目的，通过手写简化版 Spring 框架，了解 Spring 核心原理。在手写的过程中会简化 Spring 源码，摘取整体框架中的核心逻辑，简化代码实现过程，保留核心功能，例如：IOC、AOP、Bean生命周期、上下文、作用域、资源处理等内容实现。
    - language: **Java** &nbsp;&nbsp; stars: **1,759** &nbsp;&nbsp; folks: **368**  &nbsp;&nbsp; `1,286 stars this month`
...
1. [geekxh / hello-algorithm](https://github.com/geekxh/hello-algorithm)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **28,224** &nbsp;&nbsp; folks: **5,400**  &nbsp;&nbsp; `1,256 stars this month`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **48,901** &nbsp;&nbsp; folks: **4,190**  &nbsp;&nbsp; `2,241 stars this month`
...
1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,441** &nbsp;&nbsp; folks: **3,033**  &nbsp;&nbsp; `1,411 stars this month`
...
1. [basarat / typescript-book](https://github.com/basarat/typescript-book)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,455** &nbsp;&nbsp; folks: **1,945**  &nbsp;&nbsp; `1,330 stars this month`
