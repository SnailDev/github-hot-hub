...
1. [zijie0 / HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,190** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `540 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,417** &nbsp;&nbsp; folks: **3,169**  &nbsp;&nbsp; `308 stars today`
...
1. [Cracked5pider / KaynStrike](https://github.com/Cracked5pider/KaynStrike)
    - UDRL for CS
    - language: **C** &nbsp;&nbsp; stars: **161** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `39 stars today`

1. [py-why / dowhy](https://github.com/py-why/dowhy)
    - DoWhy is a Python library for causal inference that supports explicit modeling and testing of causal assumptions. DoWhy is based on a unified language for causal inference, combining causal graphical models and potential outcomes frameworks.
    - language: **Python** &nbsp;&nbsp; stars: **3,944** &nbsp;&nbsp; folks: **627**  &nbsp;&nbsp; `63 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-js](https://github.com/smartcontractkit/full-blockchain-solidity-course-js)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,524** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `309 stars today`

1. [yihong0618 / 2022](https://github.com/yihong0618/2022)
    - 2022 gogogo
    - language: **Python** &nbsp;&nbsp; stars: **146** &nbsp;&nbsp; folks: **9**  &nbsp;&nbsp; `12 stars today`
...
1. [PaddlePaddle / PaddleSpeech](https://github.com/PaddlePaddle/PaddleSpeech)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,037** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `636 stars this week`

1. [singularity-data / risingwave](https://github.com/singularity-data/risingwave)
    - RisingWave: the next-generation streaming database in the cloud.
    - language: **Rust** &nbsp;&nbsp; stars: **2,515** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `822 stars this week`
...
1. [nocobase / nocobase](https://github.com/nocobase/nocobase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,127** &nbsp;&nbsp; folks: **231**  &nbsp;&nbsp; `935 stars this week`

1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,417** &nbsp;&nbsp; folks: **3,169**  &nbsp;&nbsp; `1,282 stars this week`

1. [github / copilot-docs](https://github.com/github/copilot-docs)
    - Documentation for GitHub Copilot
    - language: **Python** &nbsp;&nbsp; stars: **19,284** &nbsp;&nbsp; folks: **2,109**  &nbsp;&nbsp; `1,559 stars this week`
...
1. [adrianhajdin / project_syncfusion_dashboard](https://github.com/adrianhajdin/project_syncfusion_dashboard)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **696** &nbsp;&nbsp; folks: **182**  &nbsp;&nbsp; `231 stars this week`

1. [deepmind / mujoco](https://github.com/deepmind/mujoco)
    - Multi-Joint dynamics with Contact. A general purpose physics simulator.
    - language: **C** &nbsp;&nbsp; stars: **4,283** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `476 stars this week`
...
1. [taviso / 123elf](https://github.com/taviso/123elf)
    ...
    - language: **C** &nbsp;&nbsp; stars: **517** &nbsp;&nbsp; folks: **38**  &nbsp;&nbsp; `167 stars this week`

1. [ansh / jiffyreader.com](https://github.com/ansh/jiffyreader.com)
    - A Chrome Extension for Bionic Reading on ANY website!
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,290** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `791 stars this week`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **54,766** &nbsp;&nbsp; folks: **14,137**  &nbsp;&nbsp; `129 stars this week`
...
1. [requarks / wiki](https://github.com/requarks/wiki)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **17,476** &nbsp;&nbsp; folks: **1,936**  &nbsp;&nbsp; `767 stars this week`
...
1. [pyscript / pyscript](https://github.com/pyscript/pyscript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,141** &nbsp;&nbsp; folks: **814**  &nbsp;&nbsp; `11,295 stars this month`
...
1. [Grasscutters / Grasscutter](https://github.com/Grasscutters/Grasscutter)
    - A server software reimplementation for a certain anime game.
    - language: **Java** &nbsp;&nbsp; stars: **7,781** &nbsp;&nbsp; folks: **2,761**  &nbsp;&nbsp; `4,626 stars this month`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,417** &nbsp;&nbsp; folks: **3,169**  &nbsp;&nbsp; `1,814 stars this month`
...
1. [Vonng / ddia](https://github.com/Vonng/ddia)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,452** &nbsp;&nbsp; folks: **3,156**  &nbsp;&nbsp; `1,238 stars this month`
