...
`更新时间：2022-01-20 03:10:00 +0800`

## 今日热门仓库

1. [DataTalksClub / data-engineering-zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
    - Code for Data Engineer Zoomcamp course
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,186** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `470 stars today`

1. [XProger / OpenLara](https://github.com/XProger/OpenLara)
    - Classic Tomb Raider open-source engine
    - language: **C** &nbsp;&nbsp; stars: **3,394** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `191 stars today`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,866** &nbsp;&nbsp; folks: **617**  &nbsp;&nbsp; `206 stars today`

1. [sivan / heti](https://github.com/sivan/heti)
    - 赫蹏（hètí）是专为中文内容展示设计的排版样式增强。它基于通行的中文排版规范而来，可以为网站的读者带来更好的文章阅读体验。
    - language: **SCSS** &nbsp;&nbsp; stars: **3,238** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `664 stars today`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **27,608** &nbsp;&nbsp; folks: **1,964**  &nbsp;&nbsp; `183 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **175,326** &nbsp;&nbsp; folks: **20,236**  &nbsp;&nbsp; `405 stars today`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,483** &nbsp;&nbsp; folks: **120**  &nbsp;&nbsp; `191 stars today`
...
1. [KurtBestor / Hitomi-Downloader](https://github.com/KurtBestor/Hitomi-Downloader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,377** &nbsp;&nbsp; folks: **529**  &nbsp;&nbsp; `329 stars today`
...
1. [NVlabs / instant-ngp](https://github.com/NVlabs/instant-ngp)
    ...
    - language: **Cuda** &nbsp;&nbsp; stars: **1,820** &nbsp;&nbsp; folks: **131**  &nbsp;&nbsp; `280 stars today`
...
1. [smartcontractkit / full-blockchain-solidity-course-py](https://github.com/smartcontractkit/full-blockchain-solidity-course-py)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,307** &nbsp;&nbsp; folks: **1,270**  &nbsp;&nbsp; `160 stars today`
...
1. [helix-editor / helix](https://github.com/helix-editor/helix)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,385** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `101 stars today`

1. [revoxhere / duino-coin](https://github.com/revoxhere/duino-coin)
    - ᕲ Duino-Coin is a coin that can be mined with almost everything, including Arduino boards.
    - language: **Python** &nbsp;&nbsp; stars: **606** &nbsp;&nbsp; folks: **405**  &nbsp;&nbsp; `11 stars today`
...
1. [sunym1993 / flash-linux0.11-talk](https://github.com/sunym1993/flash-linux0.11-talk)
    ...
    - language: **C** &nbsp;&nbsp; stars: **5,857** &nbsp;&nbsp; folks: **608**  &nbsp;&nbsp; `1,419 stars this week`

1. [faker-js / faker](https://github.com/faker-js/faker)
    - Generate massive amounts of fake data in the browser and node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,373** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `1,426 stars this week`
...
1. [Textualize / rich](https://github.com/Textualize/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,554** &nbsp;&nbsp; folks: **1,079**  &nbsp;&nbsp; `1,408 stars this week`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,518** &nbsp;&nbsp; folks: **2,979**  &nbsp;&nbsp; `850 stars this week`
...
1. [facebookresearch / mae](https://github.com/facebookresearch/mae)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,188** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `669 stars this week`
...
1. [VGVentures / slide_puzzle](https://github.com/VGVentures/slide_puzzle)
    - 无
    - language: **Dart** &nbsp;&nbsp; stars: **260** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `82 stars this week`

1. [mattermost / focalboard](https://github.com/mattermost/focalboard)
    - Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,866** &nbsp;&nbsp; folks: **617**  &nbsp;&nbsp; `354 stars this week`
...
1. [ossu / computer-science](https://github.com/ossu/computer-science)
    ...
    - language: **无** &nbsp;&nbsp; stars: **105,517** &nbsp;&nbsp; folks: **14,507**  &nbsp;&nbsp; `784 stars this week`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,172** &nbsp;&nbsp; folks: **620**  &nbsp;&nbsp; `79 stars this week`
...
1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,518** &nbsp;&nbsp; folks: **2,979**  &nbsp;&nbsp; `3,224 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **158,962** &nbsp;&nbsp; folks: **29,381**  &nbsp;&nbsp; `4,720 stars this month`
