...
`更新时间：2024-08-07 07:13:03 +0800`

## 今日热门仓库

1. [xvzc / SpoofDPI](https://github.com/xvzc/SpoofDPI)
    - A simple and fast anti-censorship tool written in Go
    - language: **Go** &nbsp;&nbsp; stars: **1,675** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `287 stars today`

1. [asg017 / sqlite-vec](https://github.com/asg017/sqlite-vec)
    - A vector search SQLite extension that runs anywhere!
    - language: **C** &nbsp;&nbsp; stars: **2,826** &nbsp;&nbsp; folks: **118**  &nbsp;&nbsp; `242 stars today`
...
1. [trailofbits / multiplier](https://github.com/trailofbits/multiplier)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **212** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `26 stars today`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **91,423** &nbsp;&nbsp; folks: **11,525**  &nbsp;&nbsp; `11,947 stars this month`
...
1. [free-educa / books](https://github.com/free-educa/books)
    - o armazém de livros
    - language: **无** &nbsp;&nbsp; stars: **6,753** &nbsp;&nbsp; folks: **1,338**  &nbsp;&nbsp; `1,611 stars this month`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,299** &nbsp;&nbsp; folks: **923**  &nbsp;&nbsp; `2,055 stars this month`

1. [lipku / metahuman-stream](https://github.com/lipku/metahuman-stream)
    - Real time interactive streaming digital human
    - language: **Python** &nbsp;&nbsp; stars: **2,583** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `1,583 stars this month`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **397,777** &nbsp;&nbsp; folks: **36,639**  &nbsp;&nbsp; `5,280 stars this month`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **35,723** &nbsp;&nbsp; folks: **2,659**  &nbsp;&nbsp; `6,096 stars this month`
...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    ...
    - language: **无** &nbsp;&nbsp; stars: **317,880** &nbsp;&nbsp; folks: **27,490**  &nbsp;&nbsp; `8,516 stars this month`
...
1. [SagerNet / sing-box](https://github.com/SagerNet/sing-box)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **17,212** &nbsp;&nbsp; folks: **2,082**  &nbsp;&nbsp; `1,537 stars this month`
