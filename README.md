...
1. [iOfficeAI / AionUi](https://github.com/iOfficeAI/AionUi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,907** &nbsp;&nbsp; folks: **691**  &nbsp;&nbsp; `562 stars today`

1. [mastra-ai / mastra](https://github.com/mastra-ai/mastra)
    - From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,993** &nbsp;&nbsp; folks: **1,438**  &nbsp;&nbsp; `460 stars today`

1. [microsoft / Data-Science-For-Beginners](https://github.com/microsoft/Data-Science-For-Beginners)
    - 10 Weeks, 20 Lessons, Data Science for All!
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,577** &nbsp;&nbsp; folks: **6,826**  &nbsp;&nbsp; `99 stars today`

1. [virattt / dexter](https://github.com/virattt/dexter)
    - An autonomous agent for deep financial research
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,120** &nbsp;&nbsp; folks: **1,021**  &nbsp;&nbsp; `505 stars today`
...
1. [eigent-ai / eigent](https://github.com/eigent-ai/eigent)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,625** &nbsp;&nbsp; folks: **1,188**  &nbsp;&nbsp; `5,834 stars this week`

1. [iOfficeAI / AionUi](https://github.com/iOfficeAI/AionUi)
    - Free, local, open-source Cowork for Gemini CLI, Claude Code, Codex, Opencode, Qwen Code, Goose Cli, Auggie, and more | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,907** &nbsp;&nbsp; folks: **691**  &nbsp;&nbsp; `4,825 stars this week`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **32,976** &nbsp;&nbsp; folks: **2,485**  &nbsp;&nbsp; `10,471 stars this week`

1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **83,163** &nbsp;&nbsp; folks: **7,430**  &nbsp;&nbsp; `13,360 stars this week`
...
1. [liyupi / ai-guide](https://github.com/liyupi/ai-guide)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,379** &nbsp;&nbsp; folks: **531**  &nbsp;&nbsp; `1,975 stars this week`

1. [frankbria / ralph-claude-code](https://github.com/frankbria/ralph-claude-code)
    - Autonomous AI development loop for Claude Code with intelligent exit detection
    - language: **Shell** &nbsp;&nbsp; stars: **5,060** &nbsp;&nbsp; folks: **344**  &nbsp;&nbsp; `1,943 stars this week`

1. [permissionlesstech / bitchat](https://github.com/permissionlesstech/bitchat)
    - bluetooth mesh chat, IRC vibes
    - language: **Swift** &nbsp;&nbsp; stars: **24,625** &nbsp;&nbsp; folks: **2,297**  &nbsp;&nbsp; `639 stars this week`
...
1. [alirezarezvani / claude-skills](https://github.com/alirezarezvani/claude-skills)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,163** &nbsp;&nbsp; folks: **150**  &nbsp;&nbsp; `486 stars this week`

1. [google / langextract](https://github.com/google/langextract)
    - A Python library for extracting structured information from unstructured text using LLMs with precise source grounding and interactive visualization.
    - language: **Python** &nbsp;&nbsp; stars: **23,467** &nbsp;&nbsp; folks: **1,611**  &nbsp;&nbsp; `2,854 stars this week`
...
1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    - The open source coding agent.
    - language: **TypeScript** &nbsp;&nbsp; stars: **83,163** &nbsp;&nbsp; folks: **7,430**  &nbsp;&nbsp; `41,168 stars this month`

1. [BloopAI / vibe-kanban](https://github.com/BloopAI/vibe-kanban)
    - Get 10X more out of Claude Code, Codex or any coding agent
    - language: **Rust** &nbsp;&nbsp; stars: **18,355** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `11,522 stars this month`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **32,976** &nbsp;&nbsp; folks: **2,485**  &nbsp;&nbsp; `21,166 stars this month`

1. [anthropics / skills](https://github.com/anthropics/skills)
    - Public repository for Agent Skills
    - language: **Python** &nbsp;&nbsp; stars: **48,925** &nbsp;&nbsp; folks: **4,641**  &nbsp;&nbsp; `24,110 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **59,283** &nbsp;&nbsp; folks: **4,392**  &nbsp;&nbsp; `11,609 stars this month`

1. [ComposioHQ / awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)
    - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows
    - language: **Python** &nbsp;&nbsp; stars: **23,914** &nbsp;&nbsp; folks: **2,351**  &nbsp;&nbsp; `15,415 stars this month`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,584** &nbsp;&nbsp; folks: **2,374**  &nbsp;&nbsp; `4,560 stars this month`

1. [usememos / memos](https://github.com/usememos/memos)
    - An open-source, self-hosted note-taking service. Your thoughts, your data, your control — no tracking, no ads, no subscription fees.
    - language: **Go** &nbsp;&nbsp; stars: **55,234** &nbsp;&nbsp; folks: **3,959**  &nbsp;&nbsp; `7,996 stars this month`
...
1. [shareAI-lab / learn-claude-code](https://github.com/shareAI-lab/learn-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,931** &nbsp;&nbsp; folks: **3,389**  &nbsp;&nbsp; `3,210 stars this month`

1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    - 🕵️‍♂️ All-in-one OSINT tool for analysing any website
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,675** &nbsp;&nbsp; folks: **2,413**  &nbsp;&nbsp; `3,609 stars this month`

1. [steveyegge / beads](https://github.com/steveyegge/beads)
    - Beads - A memory upgrade for your coding agent
    - language: **Go** &nbsp;&nbsp; stars: **11,979** &nbsp;&nbsp; folks: **723**  &nbsp;&nbsp; `5,828 stars this month`

1. [danielmiessler / Personal_AI_Infrastructure](https://github.com/danielmiessler/Personal_AI_Infrastructure)
    - Agentic AI Infrastructure for magnifying HUMAN capabilities.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,528** &nbsp;&nbsp; folks: **864**  &nbsp;&nbsp; `3,841 stars this month`

1. [virattt / dexter](https://github.com/virattt/dexter)
    - An autonomous agent for deep financial research
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,120** &nbsp;&nbsp; folks: **1,021**  &nbsp;&nbsp; `3,754 stars this month`

1. [twitter / the-algorithm](https://github.com/twitter/the-algorithm)
    - Source code for the X Recommendation Algorithm
    - language: **Scala** &nbsp;&nbsp; stars: **71,605** &nbsp;&nbsp; folks: **13,112**  &nbsp;&nbsp; `3,286 stars this month`
