...
1. [DearVa / Everywhere](https://github.com/DearVa/Everywhere)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **358** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `84 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **94,784** &nbsp;&nbsp; folks: **10,614**  &nbsp;&nbsp; `56 stars today`

1. [coze-dev / coze-studio](https://github.com/coze-dev/coze-studio)
    - An AI agent development platform with all-in-one visual tools, simplifying agent creation, debugging, and deployment like never before. Coze your way to AI Agent creation.
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,661** &nbsp;&nbsp; folks: **2,446**  &nbsp;&nbsp; `19 stars today`
...
1. [Klavis-AI / klavis](https://github.com/Klavis-AI/klavis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,709** &nbsp;&nbsp; folks: **447**  &nbsp;&nbsp; `47 stars today`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - Transforms complex documents like PDFs into LLM-ready markdown/JSON for your Agentic workflows.
    - language: **Python** &nbsp;&nbsp; stars: **45,742** &nbsp;&nbsp; folks: **3,801**  &nbsp;&nbsp; `68 stars today`
...
1. [Stremio / stremio-web](https://github.com/Stremio/stremio-web)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,450** &nbsp;&nbsp; folks: **844**  &nbsp;&nbsp; `5,686 stars this week`

1. [BeehiveInnovations / zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)
    - The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.
    - language: **Python** &nbsp;&nbsp; stars: **8,714** &nbsp;&nbsp; folks: **729**  &nbsp;&nbsp; `1,276 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,389** &nbsp;&nbsp; folks: **2,352**  &nbsp;&nbsp; `986 stars this week`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **52,987** &nbsp;&nbsp; folks: **11,886**  &nbsp;&nbsp; `2,218 stars this week`
...
1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,105** &nbsp;&nbsp; folks: **1,860**  &nbsp;&nbsp; `1,688 stars this week`

1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    - Best and simplest tool for website change detection, web page monitoring, and website change alerts. Perfect for tracking content changes, price drops, restock alerts, and website defacement monitoring—all for free or enjoy our SaaS plan!
    - language: **Python** &nbsp;&nbsp; stars: **27,763** &nbsp;&nbsp; folks: **1,547**  &nbsp;&nbsp; `1,015 stars this week`

1. [Infisical / infisical](https://github.com/Infisical/infisical)
    - Infisical is the open-source platform for secrets, certificates, and privileged access management.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,544** &nbsp;&nbsp; folks: **1,516**  &nbsp;&nbsp; `2,233 stars this week`

1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    - 🛍️ Typescript E-commerce Platform
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,924** &nbsp;&nbsp; folks: **1,848**  &nbsp;&nbsp; `781 stars this week`

1. [meshery / meshery](https://github.com/meshery/meshery)
    - Meshery, the cloud native manager
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,224** &nbsp;&nbsp; folks: **2,720**  &nbsp;&nbsp; `1,166 stars this week`
...
1. [trycua / cua](https://github.com/trycua/cua)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,656** &nbsp;&nbsp; folks: **583**  &nbsp;&nbsp; `821 stars this week`

1. [TibixDev / winboat](https://github.com/TibixDev/winboat)
    - Run Windows apps on 🐧 Linux with ✨ seamless integration
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,240** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `4,068 stars this week`

1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    - 基于多智能体LLM的中文金融交易框架 - TradingAgents中文增强版
    - language: **Python** &nbsp;&nbsp; stars: **10,278** &nbsp;&nbsp; folks: **2,253**  &nbsp;&nbsp; `1,254 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,054** &nbsp;&nbsp; folks: **1,705**  &nbsp;&nbsp; `869 stars this week`

1. [xyflow / xyflow](https://github.com/xyflow/xyflow)
    - React Flow | Svelte Flow - Powerful open source libraries for building node-based UIs with React (https://reactflow.dev) or Svelte (https://svelteflow.dev). Ready out-of-the-box and infinitely customizable.
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,591** &nbsp;&nbsp; folks: **2,140**  &nbsp;&nbsp; `785 stars this week`

1. [antiwork / gumroad](https://github.com/antiwork/gumroad)
    - Sell stuff and see what sticks
    - language: **Ruby** &nbsp;&nbsp; stars: **7,182** &nbsp;&nbsp; folks: **1,338**  &nbsp;&nbsp; `67 stars this week`
...
1. [Alibaba-NLP / DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,800** &nbsp;&nbsp; folks: **1,183**  &nbsp;&nbsp; `9,382 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **46,152** &nbsp;&nbsp; folks: **6,467**  &nbsp;&nbsp; `6,517 stars this month`

1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    - The best way to get AI coding agents to solve hard problems in complex codebases.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,907** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `3,506 stars this month`

1. [CorentinJ / Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)
    - Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **58,410** &nbsp;&nbsp; folks: **9,335**  &nbsp;&nbsp; `3,491 stars this month`

1. [anthropics / claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,463** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `1,484 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **47,056** &nbsp;&nbsp; folks: **5,666**  &nbsp;&nbsp; `7,074 stars this month`
...
1. [sentient-agi / ROMA](https://github.com/sentient-agi/ROMA)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,906** &nbsp;&nbsp; folks: **582**  &nbsp;&nbsp; `2,556 stars this month`
...
1. [ItzCrazyKns / Perplexica](https://github.com/ItzCrazyKns/Perplexica)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,686** &nbsp;&nbsp; folks: **2,759**  &nbsp;&nbsp; `2,737 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **80,965** &nbsp;&nbsp; folks: **4,493**  &nbsp;&nbsp; `8,021 stars this month`
...
1. [WebGoat / WebGoat](https://github.com/WebGoat/WebGoat)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,567** &nbsp;&nbsp; folks: **6,776**  &nbsp;&nbsp; `855 stars this month`
