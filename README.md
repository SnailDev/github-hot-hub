...
`更新时间：2021-02-21 19:09:46 +0800`

## 今日热门仓库

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **3,943** &nbsp;&nbsp; folks: **490**  &nbsp;&nbsp; `2,734 stars today`
...
1. [stypr / clubhouse-py](https://github.com/stypr/clubhouse-py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **782** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `386 stars today`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **10,483** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `996 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **97,458** &nbsp;&nbsp; folks: **33,618**  &nbsp;&nbsp; `287 stars today`
...
1. [pavlobu / deskreen](https://github.com/pavlobu/deskreen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,779** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `543 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step by step guide to learn JavaScript programming language in 30 days. This challenge may take up to 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,219** &nbsp;&nbsp; folks: **1,431**  &nbsp;&nbsp; `179 stars today`
...
1. [mrcodedev / frontend-developer-resources](https://github.com/mrcodedev/frontend-developer-resources)
    ...
    - language: **无** &nbsp;&nbsp; stars: **406** &nbsp;&nbsp; folks: **37**  &nbsp;&nbsp; `255 stars today`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,379** &nbsp;&nbsp; folks: **1,077**  &nbsp;&nbsp; `715 stars today`
...
1. [minimaxir / big-list-of-naughty-strings](https://github.com/minimaxir/big-list-of-naughty-strings)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,634** &nbsp;&nbsp; folks: **1,806**  &nbsp;&nbsp; `100 stars today`
...
1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,702** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `140 stars today`
...
1. [scutan90 / DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,434** &nbsp;&nbsp; folks: **13,551**  &nbsp;&nbsp; `328 stars today`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **10,483** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `1,965 stars this week`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,272** &nbsp;&nbsp; folks: **657**  &nbsp;&nbsp; `1,252 stars this week`

1. [vitejs / vite](https://github.com/vitejs/vite)
    - Next generation frontend tooling. It's fast!
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,379** &nbsp;&nbsp; folks: **1,077**  &nbsp;&nbsp; `1,418 stars this week`

1. [bitwarden / server](https://github.com/bitwarden/server)
    - The core infrastructure backend (API, database, Docker, etc).
    - language: **C#** &nbsp;&nbsp; stars: **7,012** &nbsp;&nbsp; folks: **594**  &nbsp;&nbsp; `218 stars this week`
...
1. [evanw / esbuild](https://github.com/evanw/esbuild)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,143** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `1,189 stars this week`

1. [MostlyAdequate / mostly-adequate-guide](https://github.com/MostlyAdequate/mostly-adequate-guide)
    - Mostly adequate guide to FP (in javascript)
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,445** &nbsp;&nbsp; folks: **1,611**  &nbsp;&nbsp; `94 stars this week`
...
1. [Dreamacro / clash](https://github.com/Dreamacro/clash)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **14,679** &nbsp;&nbsp; folks: **2,068**  &nbsp;&nbsp; `212 stars this week`
...
1. [CoatiSoftware / Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail)
    - Sourcetrail - free and open-source interactive source explorer
    - language: **C++** &nbsp;&nbsp; stars: **10,460** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `1,062 stars this month`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **10,483** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `2,636 stars this month`
...
1. [dapr / dapr](https://github.com/dapr/dapr)
    - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
    - language: **Go** &nbsp;&nbsp; stars: **10,272** &nbsp;&nbsp; folks: **657**  &nbsp;&nbsp; `1,554 stars this month`
