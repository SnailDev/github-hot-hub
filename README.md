...
1. [RocketChat / Rocket.Chat](https://github.com/RocketChat/Rocket.Chat)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **30,751** &nbsp;&nbsp; folks: **6,941**  &nbsp;&nbsp; `73 stars today`
...
1. [monicahq / monica](https://github.com/monicahq/monica)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **14,377** &nbsp;&nbsp; folks: **1,533**  &nbsp;&nbsp; `279 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,222** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `202 stars today`
...
1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,555** &nbsp;&nbsp; folks: **7,304**  &nbsp;&nbsp; `133 stars today`
...
1. [vinitshahdeo / Hacktoberfest2021](https://github.com/vinitshahdeo/Hacktoberfest2021)
    ...
    - language: **无** &nbsp;&nbsp; stars: **608** &nbsp;&nbsp; folks: **454**  &nbsp;&nbsp; `162 stars today`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **15,787** &nbsp;&nbsp; folks: **1,611**  &nbsp;&nbsp; `53 stars today`
...
1. [willmcgugan / textual](https://github.com/willmcgugan/textual)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,519** &nbsp;&nbsp; folks: **112**  &nbsp;&nbsp; `271 stars today`

1. [Ganapati / RsaCtfTool](https://github.com/Ganapati/RsaCtfTool)
    - RSA attack tool (mainly for ctf) - retreive private key from weak public key and/or uncipher data
    - language: **Python** &nbsp;&nbsp; stars: **2,882** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `59 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,669** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `131 stars today`
...
1. [aristocratos / btop](https://github.com/aristocratos/btop)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,111** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `1,556 stars this week`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,603** &nbsp;&nbsp; folks: **742**  &nbsp;&nbsp; `2,528 stars this week`
...
1. [salesforce / Merlion](https://github.com/salesforce/Merlion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,640** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `743 stars this week`
...
1. [Tencent / secguide](https://github.com/Tencent/secguide)
    - 面向开发人员梳理的代码安全指南
    - language: **无** &nbsp;&nbsp; stars: **8,502** &nbsp;&nbsp; folks: **1,098**  &nbsp;&nbsp; `564 stars this week`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **514** &nbsp;&nbsp; folks: **182**  &nbsp;&nbsp; `224 stars this week`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,222** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `610 stars this week`
...
1. [shengcaishizhan / kkndme_tianya](https://github.com/shengcaishizhan/kkndme_tianya)
    - 天涯 kkndme 神贴聊房价
    - language: **无** &nbsp;&nbsp; stars: **3,807** &nbsp;&nbsp; folks: **772**  &nbsp;&nbsp; `1,625 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,669** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `2,129 stars this month`

1. [containers / podman](https://github.com/containers/podman)
    - Podman: A tool for managing OCI containers and pods.
    - language: **Go** &nbsp;&nbsp; stars: **10,570** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `1,409 stars this month`
