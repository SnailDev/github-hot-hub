...
1. [Tencent / spring-cloud-tencent](https://github.com/Tencent/spring-cloud-tencent)
    - Spring Cloud Tencent is a Spring Boot based Service Governance Framework provided by Tencent, including service discovery, traffic control, circuitbreak, ratelimit, config and so on.
    - language: **Java** &nbsp;&nbsp; stars: **1,313** &nbsp;&nbsp; folks: **206**  &nbsp;&nbsp; `776 stars this week`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,864** &nbsp;&nbsp; folks: **953**  &nbsp;&nbsp; `1,196 stars this week`

1. [still-scene / t3](https://github.com/still-scene/t3)
    - Tooll 3 is an open source software to create realtime motion graphics.
    - language: **C#** &nbsp;&nbsp; stars: **858** &nbsp;&nbsp; folks: **36**  &nbsp;&nbsp; `355 stars this week`
...
1. [rxyhn / dotfiles](https://github.com/rxyhn/dotfiles)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **1,548** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `592 stars this week`

1. [spacedriveapp / spacedrive](https://github.com/spacedriveapp/spacedrive)
    - Spacedrive is an open source cross-platform file explorer, powered by a virtual distributed filesystem written in Rust.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,844** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `1,189 stars this week`
...
1. [ehids / ecapture](https://github.com/ehids/ecapture)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,792** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `307 stars this week`

1. [hashicorp / nomad](https://github.com/hashicorp/nomad)
    - Nomad is an easy-to-use, flexible, and performant workload orchestrator that can deploy a mix of microservice, batch, containerized, and non-containerized applications. Nomad is easy to operate and scale and has native Consul and Vault integrations.
    - language: **Go** &nbsp;&nbsp; stars: **11,668** &nbsp;&nbsp; folks: **1,593**  &nbsp;&nbsp; `488 stars this week`
...
1. [free-audio / clap](https://github.com/free-audio/clap)
    - Audio Plugin API
    - language: **C** &nbsp;&nbsp; stars: **883** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `165 stars this week`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **44,943** &nbsp;&nbsp; folks: **1,115**  &nbsp;&nbsp; `1,539 stars this week`

1. [elastic / eui](https://github.com/elastic/eui)
    - Elastic UI Framework 🙌
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,908** &nbsp;&nbsp; folks: **678**  &nbsp;&nbsp; `614 stars this week`
...
1. [Lightning-AI / lightning](https://github.com/Lightning-AI/lightning)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,133** &nbsp;&nbsp; folks: **2,473**  &nbsp;&nbsp; `368 stars this week`
...
1. [alextran1502 / immich](https://github.com/alextran1502/immich)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **1,867** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `206 stars this week`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Chinese only).
    - language: **Shell** &nbsp;&nbsp; stars: **44,366** &nbsp;&nbsp; folks: **6,723**  &nbsp;&nbsp; `590 stars this week`
...
1. [facebook / lexical](https://github.com/facebook/lexical)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,382** &nbsp;&nbsp; folks: **353**  &nbsp;&nbsp; `813 stars this week`

1. [girliemac / a-picture-is-worth-a-1000-words](https://github.com/girliemac/a-picture-is-worth-a-1000-words)
    - I am trying to describe complex matters in simple doodles!
    - language: **无** &nbsp;&nbsp; stars: **5,154** &nbsp;&nbsp; folks: **370**  &nbsp;&nbsp; `3,015 stars this week`

1. [qier222 / YesPlayMusic](https://github.com/qier222/YesPlayMusic)
    - 高颜值的第三方网易云播放器，支持 Windows / macOS / Linux
    - language: **Vue** &nbsp;&nbsp; stars: **17,923** &nbsp;&nbsp; folks: **2,603**  &nbsp;&nbsp; `172 stars this week`

1. [mingrammer / diagrams](https://github.com/mingrammer/diagrams)
    - 🎨 Diagram as Code for prototyping cloud system architectures
    - language: **Python** &nbsp;&nbsp; stars: **22,968** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `4,419 stars this week`
...
1. [lucidrains / imagen-pytorch](https://github.com/lucidrains/imagen-pytorch)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,575** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `2,965 stars this month`
...
1. [elastic / eui](https://github.com/elastic/eui)
    - Elastic UI Framework 🙌
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,908** &nbsp;&nbsp; folks: **678**  &nbsp;&nbsp; `1,380 stars this month`

1. [topjohnwu / Magisk](https://github.com/topjohnwu/Magisk)
    - The Magic Mask for Android
    - language: **C++** &nbsp;&nbsp; stars: **27,141** &nbsp;&nbsp; folks: **6,811**  &nbsp;&nbsp; `949 stars this month`
