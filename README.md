...
1. [kh4sh3i / ICS-Pentesting-Tools](https://github.com/kh4sh3i/ICS-Pentesting-Tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **72** &nbsp;&nbsp; folks: **10**  &nbsp;&nbsp; `25 stars today`

1. [jagrosh / MusicBot](https://github.com/jagrosh/MusicBot)
    - 🎶 A Discord music bot that's easy to set up and run yourself!
    - language: **Java** &nbsp;&nbsp; stars: **2,390** &nbsp;&nbsp; folks: **1,178**  &nbsp;&nbsp; `18 stars today`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - A repository for All algorithms implemented in Javascript (for educational purposes only)
    - language: **JavaScript** &nbsp;&nbsp; stars: **15,057** &nbsp;&nbsp; folks: **2,500**  &nbsp;&nbsp; `159 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,543** &nbsp;&nbsp; folks: **4,121**  &nbsp;&nbsp; `22 stars today`
...
1. [ShameCom / ShameCom](https://github.com/ShameCom/ShameCom)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,591** &nbsp;&nbsp; folks: **233**  &nbsp;&nbsp; `97 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,313** &nbsp;&nbsp; folks: **27,029**  &nbsp;&nbsp; `100 stars today`
...
1. [Siterizer / new-world-fishing-bot](https://github.com/Siterizer/new-world-fishing-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **99** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `39 stars today`
...
1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,775** &nbsp;&nbsp; folks: **765**  &nbsp;&nbsp; `1,110 stars this week`
...
1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,740** &nbsp;&nbsp; folks: **262**  &nbsp;&nbsp; `635 stars this week`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,531** &nbsp;&nbsp; folks: **1,006**  &nbsp;&nbsp; `870 stars this week`
...
1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,554** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `611 stars this week`

1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    - 🛁 Clean Code concepts adapted for JavaScript
    - language: **JavaScript** &nbsp;&nbsp; stars: **58,076** &nbsp;&nbsp; folks: **7,359**  &nbsp;&nbsp; `997 stars this week`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **559** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `142 stars this week`
...
1. [Sairyss / domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
    - Guide on Domain-Driven Design, Hexagonal architecture, best practices etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,740** &nbsp;&nbsp; folks: **262**  &nbsp;&nbsp; `1,151 stars this month`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,309** &nbsp;&nbsp; folks: **827**  &nbsp;&nbsp; `801 stars this month`
...
1. [YunaiV / ruoyi-vue-pro](https://github.com/YunaiV/ruoyi-vue-pro)
    - 基于SpringBoot，Spring Security，JWT，Vue & Element 的前后端分离权限管理系统
    - language: **Java** &nbsp;&nbsp; stars: **1,354** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `501 stars this month`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,775** &nbsp;&nbsp; folks: **765**  &nbsp;&nbsp; `3,836 stars this month`

1. [VickScarlet / lifeRestart](https://github.com/VickScarlet/lifeRestart)
    - やり直すんだ。そして、次はうまくやる。
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,760** &nbsp;&nbsp; folks: **2,171**  &nbsp;&nbsp; `4,737 stars this month`
