...
`更新时间：2025-10-05 17:13:34 +0800`

## 今日热门仓库

1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    - An open source payments switch written in Rust to make payments fast, reliable and affordable
    - language: **Rust** &nbsp;&nbsp; stars: **35,852** &nbsp;&nbsp; folks: **4,323**  &nbsp;&nbsp; `171 stars today`

1. [meshery / meshery](https://github.com/meshery/meshery)
    - Meshery, the cloud native manager
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,429** &nbsp;&nbsp; folks: **2,671**  &nbsp;&nbsp; `123 stars today`

1. [google / tunix](https://github.com/google/tunix)
    - A JAX-native LLM Post-Training Library
    - language: **Python** &nbsp;&nbsp; stars: **1,512** &nbsp;&nbsp; folks: **131**  &nbsp;&nbsp; `165 stars today`
...
1. [tigerbeetle / tigerbeetle](https://github.com/tigerbeetle/tigerbeetle)
    ...
    - language: **Zig** &nbsp;&nbsp; stars: **13,921** &nbsp;&nbsp; folks: **689**  &nbsp;&nbsp; `74 stars today`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,635** &nbsp;&nbsp; folks: **6,384**  &nbsp;&nbsp; `5,535 stars this week`

1. [tile-ai / tilelang](https://github.com/tile-ai/tilelang)
    - Domain-specific language designed to streamline the development of high-performance GPU/CPU/Accelerators kernels
    - language: **C++** &nbsp;&nbsp; stars: **3,143** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `1,458 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **339,563** &nbsp;&nbsp; folks: **43,042**  &nbsp;&nbsp; `1,985 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **367,451** &nbsp;&nbsp; folks: **38,674**  &nbsp;&nbsp; `1,012 stars this week`
...
1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    - 基于多智能体LLM的中文金融交易框架 - TradingAgents中文增强版
    - language: **Python** &nbsp;&nbsp; stars: **9,131** &nbsp;&nbsp; folks: **2,038**  &nbsp;&nbsp; `1,816 stars this week`
...
1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **22,233** &nbsp;&nbsp; folks: **1,018**  &nbsp;&nbsp; `1,314 stars this week`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **45,635** &nbsp;&nbsp; folks: **6,384**  &nbsp;&nbsp; `6,154 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **45,966** &nbsp;&nbsp; folks: **5,463**  &nbsp;&nbsp; `7,630 stars this month`

1. [CorentinJ / Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)
    - Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **Python** &nbsp;&nbsp; stars: **57,929** &nbsp;&nbsp; folks: **9,304**  &nbsp;&nbsp; `3,062 stars this month`
...
1. [coinbase / x402](https://github.com/coinbase/x402)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,923** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `1,060 stars this month`

1. [ItzCrazyKns / Perplexica](https://github.com/ItzCrazyKns/Perplexica)
    - Perplexica is an AI-powered search engine. It is an Open source alternative to Perplexity AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,302** &nbsp;&nbsp; folks: **2,721**  &nbsp;&nbsp; `2,489 stars this month`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,522** &nbsp;&nbsp; folks: **1,002**  &nbsp;&nbsp; `4,159 stars this month`
