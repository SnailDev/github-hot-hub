...
1. [answerdev / answer](https://github.com/answerdev/answer)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,965** &nbsp;&nbsp; folks: **157**  &nbsp;&nbsp; `705 stars today`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,963** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `1,216 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,601** &nbsp;&nbsp; folks: **1,313**  &nbsp;&nbsp; `108 stars today`
...
1. [bregman-arie / devops-resources](https://github.com/bregman-arie/devops-resources)
    ...
    - language: **Groovy** &nbsp;&nbsp; stars: **5,724** &nbsp;&nbsp; folks: **1,303**  &nbsp;&nbsp; `22 stars today`
...
1. [jetlinks / jetlinks-community](https://github.com/jetlinks/jetlinks-community)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,285** &nbsp;&nbsp; folks: **1,192**  &nbsp;&nbsp; `14 stars today`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,241** &nbsp;&nbsp; folks: **7,000**  &nbsp;&nbsp; `98 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,010** &nbsp;&nbsp; folks: **4,379**  &nbsp;&nbsp; `81 stars today`
...
1. [bumble-tech / private-detector](https://github.com/bumble-tech/private-detector)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **836** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `181 stars today`
...
1. [AbdurRKhalid / Design-Patterns](https://github.com/AbdurRKhalid/Design-Patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **313** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `64 stars today`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turborepo and Turbopack.
    - language: **Rust** &nbsp;&nbsp; stars: **14,963** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `4,859 stars this week`
...
1. [simeydotme / pokemon-cards-css](https://github.com/simeydotme/pokemon-cards-css)
    - A collection of advanced CSS styles to create realistic-looking effects for the faces of Pokemon cards.
    - language: **Svelte** &nbsp;&nbsp; stars: **1,425** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `362 stars this week`
...
1. [TheLastBen / fast-stable-diffusion](https://github.com/TheLastBen/fast-stable-diffusion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,472** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `514 stars this week`
...
1. [Dreamacro / clash](https://github.com/Dreamacro/clash)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **32,414** &nbsp;&nbsp; folks: **4,409**  &nbsp;&nbsp; `307 stars this week`
...
1. [PaddlePaddle / PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)
    - Easy-to-use and powerful NLP library with Awesome model zoo, supporting wide-range of NLP tasks from research to industrial applications, including Text Classificaion, Diffusion, Neural Search, Question Answering, Information Extraction and Sentiment Analysis end-to-end system.
    - language: **Python** &nbsp;&nbsp; stars: **6,074** &nbsp;&nbsp; folks: **1,734**  &nbsp;&nbsp; `153 stars this week`
...
1. [vercel / next.js](https://github.com/vercel/next.js)
    - The React Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,025** &nbsp;&nbsp; folks: **20,864**  &nbsp;&nbsp; `912 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **35,764** &nbsp;&nbsp; folks: **6,012**  &nbsp;&nbsp; `424 stars this week`
...
1. [vaxilu / x-ui](https://github.com/vaxilu/x-ui)
    - 支持多协议多用户的 xray 面板
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,121** &nbsp;&nbsp; folks: **3,148**  &nbsp;&nbsp; `230 stars this week`

1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,010** &nbsp;&nbsp; folks: **4,379**  &nbsp;&nbsp; `387 stars this week`
...
1. [pointfreeco / swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **7,308** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `69 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,824** &nbsp;&nbsp; folks: **3,103**  &nbsp;&nbsp; `12,951 stars this month`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turborepo and Turbopack.
    - language: **Rust** &nbsp;&nbsp; stars: **14,964** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `5,428 stars this month`
...
1. [nocodb / nocodb](https://github.com/nocodb/nocodb)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,015** &nbsp;&nbsp; folks: **1,956**  &nbsp;&nbsp; `1,873 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,601** &nbsp;&nbsp; folks: **1,313**  &nbsp;&nbsp; `1,345 stars this month`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
    - language: **Python** &nbsp;&nbsp; stars: **32,241** &nbsp;&nbsp; folks: **7,000**  &nbsp;&nbsp; `1,784 stars this month`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,026** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `1,500 stars this month`
