...
`更新时间：2021-06-04 05:11:30 +0800`

## 今日热门仓库

1. [black7375 / Firefox-UI-Fix](https://github.com/black7375/Firefox-UI-Fix)
    - 🦊 I respect proton UI and aim to improve it.
    - language: **CSS** &nbsp;&nbsp; stars: **811** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `152 stars today`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **38,332** &nbsp;&nbsp; folks: **12,670**  &nbsp;&nbsp; `215 stars today`

1. [Azure / bicep](https://github.com/Azure/bicep)
    - Bicep is a declarative language for describing and deploying Azure resources
    - language: **Bicep** &nbsp;&nbsp; stars: **1,528** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `30 stars today`

1. [koreader / koreader](https://github.com/koreader/koreader)
    - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats, running on Cervantes, Kindle, Kobo, PocketBook and Android devices
    - language: **Lua** &nbsp;&nbsp; stars: **8,533** &nbsp;&nbsp; folks: **878**  &nbsp;&nbsp; `117 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **108,866** &nbsp;&nbsp; folks: **18,034**  &nbsp;&nbsp; `333 stars today`
...
1. [helix-editor / helix](https://github.com/helix-editor/helix)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,777** &nbsp;&nbsp; folks: **45**  &nbsp;&nbsp; `519 stars today`

1. [obsproject / obs-studio](https://github.com/obsproject/obs-studio)
    - OBS Studio - Free and open source software for live streaming and screen recording
    - language: **C** &nbsp;&nbsp; stars: **29,096** &nbsp;&nbsp; folks: **4,919**  &nbsp;&nbsp; `512 stars today`
...
1. [Rikj000 / MoniGoMani](https://github.com/Rikj000/MoniGoMani)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **563** &nbsp;&nbsp; folks: **51**  &nbsp;&nbsp; `26 stars today`

1. [Awesome-HarmonyOS / HarmonyOS](https://github.com/Awesome-HarmonyOS/HarmonyOS)
    - A curated list of awesome things related to HarmonyOS. 华为鸿蒙操作系统。
    - language: **C** &nbsp;&nbsp; stars: **16,651** &nbsp;&nbsp; folks: **3,102**  &nbsp;&nbsp; `202 stars today`
...
1. [fsnotify / fsnotify](https://github.com/fsnotify/fsnotify)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,643** &nbsp;&nbsp; folks: **624**  &nbsp;&nbsp; `1 stars today`

1. [laurent22 / joplin](https://github.com/laurent22/joplin)
    - Joplin - an open source note taking and to-do application with synchronization capabilities for Windows, macOS, Linux, Android and iOS. Forum: https://discourse.joplinapp.org/
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,568** &nbsp;&nbsp; folks: **2,544**  &nbsp;&nbsp; `41 stars today`

1. [googleapis / googleapis](https://github.com/googleapis/googleapis)
    - Public interface definitions of Google APIs.
    - language: **Starlark** &nbsp;&nbsp; stars: **3,585** &nbsp;&nbsp; folks: **1,506**  &nbsp;&nbsp; `19 stars today`

1. [prisma / prisma](https://github.com/prisma/prisma)
    - Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server & SQLite
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,311** &nbsp;&nbsp; folks: **461**  &nbsp;&nbsp; `316 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **104,992** &nbsp;&nbsp; folks: **36,083**  &nbsp;&nbsp; `151 stars today`
...
1. [roseduan / rosedb](https://github.com/roseduan/rosedb)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **689** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `123 stars today`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **12,926** &nbsp;&nbsp; folks: **1,175**  &nbsp;&nbsp; `1,726 stars this week`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **2,400** &nbsp;&nbsp; folks: **1,637**  &nbsp;&nbsp; `829 stars this week`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,994** &nbsp;&nbsp; folks: **364**  &nbsp;&nbsp; `590 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,030** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `368 stars this week`
...
1. [files-community / Files](https://github.com/files-community/Files)
    - A modern file explorer that pushes the boundaries of the platform.
    - language: **C#** &nbsp;&nbsp; stars: **10,208** &nbsp;&nbsp; folks: **544**  &nbsp;&nbsp; `902 stars this week`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    - All Algorithms implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **38,332** &nbsp;&nbsp; folks: **12,670**  &nbsp;&nbsp; `643 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **11,877** &nbsp;&nbsp; folks: **2,077**  &nbsp;&nbsp; `4,676 stars this month`
...
1. [alacritty / alacritty](https://github.com/alacritty/alacritty)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **32,916** &nbsp;&nbsp; folks: **1,733**  &nbsp;&nbsp; `1,918 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,420** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `2,922 stars this month`
