...
`更新时间：2021-08-04 23:12:50 +0800`

## 今日热门仓库

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **1,119** &nbsp;&nbsp; folks: **65**  &nbsp;&nbsp; `432 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **26,606** &nbsp;&nbsp; folks: **5,308**  &nbsp;&nbsp; `225 stars today`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,168** &nbsp;&nbsp; folks: **3,557**  &nbsp;&nbsp; `632 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **140,345** &nbsp;&nbsp; folks: **25,800**  &nbsp;&nbsp; `126 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,541** &nbsp;&nbsp; folks: **4,396**  &nbsp;&nbsp; `307 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,659** &nbsp;&nbsp; folks: **22,394**  &nbsp;&nbsp; `42 stars today`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **13,778** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `383 stars today`

1. [reviewdog / reviewdog](https://github.com/reviewdog/reviewdog)
    - 🐶 Automated code review tool integrated with any code analysis tools regardless of programming language
    - language: **Go** &nbsp;&nbsp; stars: **3,625** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `111 stars today`

1. [0x727 / ShuiZe_0x727](https://github.com/0x727/ShuiZe_0x727)
    - 信息收集自动化工具
    - language: **无** &nbsp;&nbsp; stars: **472** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `91 stars today`

1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    - Ergonomic and modular web framework built with Tokio, Tower, and Hyper
    - language: **Rust** &nbsp;&nbsp; stars: **1,022** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `163 stars today`
...
1. [open-mmlab / mmcv](https://github.com/open-mmlab/mmcv)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,761** &nbsp;&nbsp; folks: **757**  &nbsp;&nbsp; `6 stars today`
...
1. [Azure / azure-sdk-for-net](https://github.com/Azure/azure-sdk-for-net)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,511** &nbsp;&nbsp; folks: **2,837**  &nbsp;&nbsp; `33 stars today`

1. [Hiroshiba / voicevox](https://github.com/Hiroshiba/voicevox)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **380** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `66 stars today`

1. [akullpp / awesome-java](https://github.com/akullpp/awesome-java)
    - A curated list of awesome frameworks, libraries and software for the Java programming language.
    - language: **无** &nbsp;&nbsp; stars: **29,484** &nbsp;&nbsp; folks: **6,383**  &nbsp;&nbsp; `42 stars today`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,798** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `989 stars this week`

1. [myspaghetti / macos-virtualbox](https://github.com/myspaghetti/macos-virtualbox)
    - Push-button installer of macOS Catalina, Mojave, and High Sierra guests in Virtualbox for Windows, Linux, and macOS
    - language: **Shell** &nbsp;&nbsp; stars: **9,340** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `1,614 stars this week`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **7,823** &nbsp;&nbsp; folks: **1,807**  &nbsp;&nbsp; `1,179 stars this week`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **328,232** &nbsp;&nbsp; folks: **26,290**  &nbsp;&nbsp; `1,616 stars this week`

1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - language: **Python** &nbsp;&nbsp; stars: **23,949** &nbsp;&nbsp; folks: **2,984**  &nbsp;&nbsp; `905 stars this week`
...
1. [doocs / jvm](https://github.com/doocs/jvm)
    - 🤗 JVM 底层原理最全知识总结
    - language: **Java** &nbsp;&nbsp; stars: **5,926** &nbsp;&nbsp; folks: **1,458**  &nbsp;&nbsp; `447 stars this week`

1. [iotexproject / iotex-core](https://github.com/iotexproject/iotex-core)
    - Official implementation of IoTeX blockchain protocol in Go.
    - language: **Go** &nbsp;&nbsp; stars: **1,262** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `395 stars this week`
...
1. [golang-jwt / jwt](https://github.com/golang-jwt/jwt)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **517** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `197 stars this week`
...
1. [erda-project / erda](https://github.com/erda-project/erda)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,508** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `502 stars this week`

1. [bytedance / flutter_ume](https://github.com/bytedance/flutter_ume)
    - UME is an in-app debug kits platform for Flutter. Produced by Flutter Infra team of ByteDance
    - language: **Dart** &nbsp;&nbsp; stars: **1,150** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `600 stars this week`

1. [tailscale / tailscale](https://github.com/tailscale/tailscale)
    - The easiest, most secure way to use WireGuard and 2FA.
    - language: **Go** &nbsp;&nbsp; stars: **5,112** &nbsp;&nbsp; folks: **255**  &nbsp;&nbsp; `442 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **26,606** &nbsp;&nbsp; folks: **5,308**  &nbsp;&nbsp; `531 stars this week`
...
1. [Rapptz / discord.py](https://github.com/Rapptz/discord.py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,109** &nbsp;&nbsp; folks: **2,355**  &nbsp;&nbsp; `86 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,806** &nbsp;&nbsp; folks: **2,816**  &nbsp;&nbsp; `759 stars this week`

1. [axios / axios](https://github.com/axios/axios)
    - Promise based HTTP client for the browser and node.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,562** &nbsp;&nbsp; folks: **8,510**  &nbsp;&nbsp; `453 stars this week`
