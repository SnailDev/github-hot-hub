...
1. [showlab / Tune-A-Video](https://github.com/showlab/Tune-A-Video)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,038** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `88 stars today`
...
1. [nsarrazin / serge](https://github.com/nsarrazin/serge)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,045** &nbsp;&nbsp; folks: **112**  &nbsp;&nbsp; `463 stars today`
...
1. [flipperdevices / flipperzero-firmware](https://github.com/flipperdevices/flipperzero-firmware)
    ...
    - language: **C** &nbsp;&nbsp; stars: **5,942** &nbsp;&nbsp; folks: **1,669**  &nbsp;&nbsp; `14 stars today`
...
1. [Picsart-AI-Research / Text2Video-Zero](https://github.com/Picsart-AI-Research/Text2Video-Zero)
    ...
    - language: **无** &nbsp;&nbsp; stars: **249** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `66 stars today`
...
1. [mckaywrigley / chatbot-ui](https://github.com/mckaywrigley/chatbot-ui)
    - An open-source ChatGPT UI.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,096** &nbsp;&nbsp; folks: **709**  &nbsp;&nbsp; `3,655 stars this week`

1. [cocktailpeanut / dalai](https://github.com/cocktailpeanut/dalai)
    - The simplest way to run LLaMA on your local machine
    - language: **CSS** &nbsp;&nbsp; stars: **6,525** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `3,771 stars this week`
...
1. [GaiZhenbiao / ChuanhuChatGPT](https://github.com/GaiZhenbiao/ChuanhuChatGPT)
    - GUI for ChatGPT API
    - language: **Python** &nbsp;&nbsp; stars: **5,981** &nbsp;&nbsp; folks: **746**  &nbsp;&nbsp; `3,287 stars this week`

1. [tatsu-lab / stanford_alpaca](https://github.com/tatsu-lab/stanford_alpaca)
    - Code and documentation to train Stanford's Alpaca models, and generate the data.
    - language: **Python** &nbsp;&nbsp; stars: **14,684** &nbsp;&nbsp; folks: **1,938**  &nbsp;&nbsp; `5,070 stars this week`
...
1. [THUDM / ChatGLM-6B](https://github.com/THUDM/ChatGLM-6B)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,430** &nbsp;&nbsp; folks: **865**  &nbsp;&nbsp; `3,421 stars this week`

1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    - Port of Facebook's LLaMA model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **13,932** &nbsp;&nbsp; folks: **1,845**  &nbsp;&nbsp; `3,978 stars this week`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,475** &nbsp;&nbsp; folks: **1,366**  &nbsp;&nbsp; `3,399 stars this week`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **51,857** &nbsp;&nbsp; folks: **6,107**  &nbsp;&nbsp; `6,876 stars this week`

1. [BlinkDL / RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
    - RWKV is an RNN with transformer-level LLM performance. It can be directly trained like a GPT (parallelizable). So it's combining the best of RNN and transformer - great performance, fast inference, saves VRAM, fast training, "infinite" ctx_len, and free sentence embedding.
    - language: **Python** &nbsp;&nbsp; stars: **3,983** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `1,423 stars this week`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **10,382** &nbsp;&nbsp; folks: **2,998**  &nbsp;&nbsp; `2,616 stars this week`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    - 用 Express 和 Vue3 搭建的 ChatGPT 演示网页
    - language: **Vue** &nbsp;&nbsp; stars: **10,382** &nbsp;&nbsp; folks: **2,998**  &nbsp;&nbsp; `9,394 stars this month`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **53,585** &nbsp;&nbsp; folks: **9,914**  &nbsp;&nbsp; `13,815 stars this month`
...
1. [usememos / memos](https://github.com/usememos/memos)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,348** &nbsp;&nbsp; folks: **693**  &nbsp;&nbsp; `4,410 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    - ⚡ Building applications with LLMs through composability ⚡
    - language: **Python** &nbsp;&nbsp; stars: **15,475** &nbsp;&nbsp; folks: **1,366**  &nbsp;&nbsp; `7,529 stars this month`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **21,897** &nbsp;&nbsp; folks: **3,041**  &nbsp;&nbsp; `8,303 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT better.
    - language: **HTML** &nbsp;&nbsp; stars: **51,857** &nbsp;&nbsp; folks: **6,107**  &nbsp;&nbsp; `19,803 stars this month`
...
1. [lllyasviel / ControlNet](https://github.com/lllyasviel/ControlNet)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,096** &nbsp;&nbsp; folks: **1,297**  &nbsp;&nbsp; `6,446 stars this month`

1. [BlinkDL / RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
    - RWKV is an RNN with transformer-level LLM performance. It can be directly trained like a GPT (parallelizable). So it's combining the best of RNN and transformer - great performance, fast inference, saves VRAM, fast training, "infinite" ctx_len, and free sentence embedding.
    - language: **Python** &nbsp;&nbsp; stars: **3,983** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `2,149 stars this month`
