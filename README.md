...
1. [vercel / turbo](https://github.com/vercel/turbo)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,721** &nbsp;&nbsp; folks: **825**  &nbsp;&nbsp; `1,216 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,527** &nbsp;&nbsp; folks: **1,308**  &nbsp;&nbsp; `43 stars today`
...
1. [jetlinks / jetlinks-community](https://github.com/jetlinks/jetlinks-community)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,262** &nbsp;&nbsp; folks: **1,191**  &nbsp;&nbsp; `25 stars today`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,178** &nbsp;&nbsp; folks: **6,990**  &nbsp;&nbsp; `96 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,962** &nbsp;&nbsp; folks: **4,373**  &nbsp;&nbsp; `36 stars today`
...
1. [bumble-tech / private-detector](https://github.com/bumble-tech/private-detector)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **779** &nbsp;&nbsp; folks: **51**  &nbsp;&nbsp; `121 stars today`
...
1. [airbnb / javascript](https://github.com/airbnb/javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **128,141** &nbsp;&nbsp; folks: **24,431**  &nbsp;&nbsp; `39 stars today`
...
1. [AbdurRKhalid / Design-Patterns](https://github.com/AbdurRKhalid/Design-Patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **252** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `66 stars today`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turborepo and Turbopack.
    - language: **Rust** &nbsp;&nbsp; stars: **14,721** &nbsp;&nbsp; folks: **825**  &nbsp;&nbsp; `4,729 stars this week`
...
1. [Textualize / textual](https://github.com/Textualize/textual)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,308** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `1,361 stars this week`
...
1. [simeydotme / pokemon-cards-css](https://github.com/simeydotme/pokemon-cards-css)
    - 无
    - language: **CSS** &nbsp;&nbsp; stars: **1,259** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `615 stars this week`

1. [aptos-labs / aptos-core](https://github.com/aptos-labs/aptos-core)
    - A layer 1 for everyone!
    - language: **Rust** &nbsp;&nbsp; stars: **4,460** &nbsp;&nbsp; folks: **2,358**  &nbsp;&nbsp; `278 stars this week`
...
1. [TheLastBen / fast-stable-diffusion](https://github.com/TheLastBen/fast-stable-diffusion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,439** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `495 stars this week`
...
1. [Dreamacro / clash](https://github.com/Dreamacro/clash)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **32,406** &nbsp;&nbsp; folks: **4,408**  &nbsp;&nbsp; `308 stars this week`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **19,347** &nbsp;&nbsp; folks: **4,179**  &nbsp;&nbsp; `516 stars this week`

1. [PaddlePaddle / PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)
    - Easy-to-use and powerful NLP library with Awesome model zoo, supporting wide-range of NLP tasks from research to industrial applications, including Neural Search, Question Answering, Information Extraction and Sentiment Analysis end-to-end system.
    - language: **Python** &nbsp;&nbsp; stars: **6,035** &nbsp;&nbsp; folks: **1,732**  &nbsp;&nbsp; `151 stars this week`
...
1. [vaxilu / x-ui](https://github.com/vaxilu/x-ui)
    - 支持多协议多用户的 xray 面板
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,111** &nbsp;&nbsp; folks: **3,145**  &nbsp;&nbsp; `229 stars this week`

1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    - 30 Days of React challenge is a step by step guide to learn React in 30 days. It requires HTML, CSS, and JavaScript knowledge. You should be comfortable with JavaScript before you start to React. If you are not comfortable with JavaScript check out 30DaysOfJavaScript. This is a continuation of 30 Days Of JS. This challenge may take more than 100…
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,962** &nbsp;&nbsp; folks: **4,373**  &nbsp;&nbsp; `388 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,720** &nbsp;&nbsp; folks: **3,081**  &nbsp;&nbsp; `12,971 stars this month`

1. [lkwq007 / stablediffusion-infinity](https://github.com/lkwq007/stablediffusion-infinity)
    - Outpainting with Stable Diffusion on an infinite canvas
    - language: **Python** &nbsp;&nbsp; stars: **2,444** &nbsp;&nbsp; folks: **172**  &nbsp;&nbsp; `1,681 stars this month`
...
1. [vercel / turbo](https://github.com/vercel/turbo)
    - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turborepo and Turbopack.
    - language: **Rust** &nbsp;&nbsp; stars: **14,721** &nbsp;&nbsp; folks: **825**  &nbsp;&nbsp; `5,193 stars this month`
...
1. [JoePenna / Dreambooth-Stable-Diffusion](https://github.com/JoePenna/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,819** &nbsp;&nbsp; folks: **261**  &nbsp;&nbsp; `1,216 stars this month`
...
1. [SigNoz / signoz](https://github.com/SigNoz/signoz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,267** &nbsp;&nbsp; folks: **547**  &nbsp;&nbsp; `2,472 stars this month`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,740** &nbsp;&nbsp; folks: **2,202**  &nbsp;&nbsp; `1,183 stars this month`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,003** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `1,577 stars this month`
