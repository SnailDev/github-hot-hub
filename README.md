...
1. [SorellaLabs / brontes](https://github.com/SorellaLabs/brontes)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **335** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `92 stars today`
...
1. [mealie-recipes / mealie](https://github.com/mealie-recipes/mealie)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,446** &nbsp;&nbsp; folks: **662**  &nbsp;&nbsp; `187 stars today`
...
1. [ostris / ai-toolkit](https://github.com/ostris/ai-toolkit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,489** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `992 stars this week`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **26,400** &nbsp;&nbsp; folks: **3,586**  &nbsp;&nbsp; `6,574 stars this week`

1. [versotile-org / verso](https://github.com/versotile-org/verso)
    - A web browser that plays old world blues to build new world hope
    - language: **Rust** &nbsp;&nbsp; stars: **3,920** &nbsp;&nbsp; folks: **149**  &nbsp;&nbsp; `2,057 stars this week`

1. [goauthentik / authentik](https://github.com/goauthentik/authentik)
    - The authentication glue you need.
    - language: **Python** &nbsp;&nbsp; stars: **11,461** &nbsp;&nbsp; folks: **803**  &nbsp;&nbsp; `2,632 stars this week`

1. [lllyasviel / stable-diffusion-webui-forge](https://github.com/lllyasviel/stable-diffusion-webui-forge)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,484** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `518 stars this week`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **47,628** &nbsp;&nbsp; folks: **5,021**  &nbsp;&nbsp; `1,510 stars this week`

1. [chen08209 / FlClash](https://github.com/chen08209/FlClash)
    - A multi-platform proxy client based on ClashMeta,simple and easy to use, open-source and ad-free.
    - language: **Dart** &nbsp;&nbsp; stars: **6,041** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `2,459 stars this week`
...
1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **169,815** &nbsp;&nbsp; folks: **78,712**  &nbsp;&nbsp; `1,374 stars this week`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Free and source-available fair-code licensed workflow automation tool. Easily automate tasks across different services.
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,857** &nbsp;&nbsp; folks: **5,842**  &nbsp;&nbsp; `300 stars this week`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,897** &nbsp;&nbsp; folks: **769**  &nbsp;&nbsp; `646 stars this week`

1. [jianchang512 / pyvideotrans](https://github.com/jianchang512/pyvideotrans)
    - Translate the video from one language to another and add dubbing. 将视频从一种语言翻译为另一种语言，并添加配音
    - language: **Python** &nbsp;&nbsp; stars: **9,422** &nbsp;&nbsp; folks: **1,024**  &nbsp;&nbsp; `720 stars this week`
...
1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A one-stop, open-source, high-quality data extraction tool, supports PDF/webpage/e-book extraction.一站式开源高质量数据提取工具，支持PDF/网页/多格式电子书提取。
    - language: **Python** &nbsp;&nbsp; stars: **9,013** &nbsp;&nbsp; folks: **656**  &nbsp;&nbsp; `7,973 stars this month`
...
1. [lipku / metahuman-stream](https://github.com/lipku/metahuman-stream)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,056** &nbsp;&nbsp; folks: **433**  &nbsp;&nbsp; `2,040 stars this month`

1. [chen08209 / FlClash](https://github.com/chen08209/FlClash)
    - A multi-platform proxy client based on ClashMeta,simple and easy to use, open-source and ad-free.
    - language: **Dart** &nbsp;&nbsp; stars: **6,041** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `3,794 stars this month`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **38,501** &nbsp;&nbsp; folks: **2,893**  &nbsp;&nbsp; `8,041 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - The memory layer for Personalized AI
    - language: **Python** &nbsp;&nbsp; stars: **19,889** &nbsp;&nbsp; folks: **1,864**  &nbsp;&nbsp; `9,021 stars this month`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **47,628** &nbsp;&nbsp; folks: **5,021**  &nbsp;&nbsp; `4,965 stars this month`

1. [lllyasviel / stable-diffusion-webui-forge](https://github.com/lllyasviel/stable-diffusion-webui-forge)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,484** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `1,079 stars this month`

1. [Infisical / infisical](https://github.com/Infisical/infisical)
    - ♾ Infisical is the open-source secret management platform: Sync secrets across your team/infrastructure, prevent secret leaks, and manage internal PKI
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,557** &nbsp;&nbsp; folks: **805**  &nbsp;&nbsp; `1,454 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **288,121** &nbsp;&nbsp; folks: **38,232**  &nbsp;&nbsp; `5,188 stars this month`

1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    - Find, verify, and analyze leaked credentials
    - language: **Go** &nbsp;&nbsp; stars: **15,344** &nbsp;&nbsp; folks: **1,609**  &nbsp;&nbsp; `875 stars this month`
...
1. [mingrammer / diagrams](https://github.com/mingrammer/diagrams)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,589** &nbsp;&nbsp; folks: **2,374**  &nbsp;&nbsp; `928 stars this month`

1. [LLaVA-VL / LLaVA-NeXT](https://github.com/LLaVA-VL/LLaVA-NeXT)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,017** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `716 stars this month`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,665** &nbsp;&nbsp; folks: **5,928**  &nbsp;&nbsp; `1,132 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,826** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `2,431 stars this month`
