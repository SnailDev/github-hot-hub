...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    ...
    - language: **无** &nbsp;&nbsp; stars: **182,452** &nbsp;&nbsp; folks: **22,451**  &nbsp;&nbsp; `285 stars today`
...
1. [PaddlePaddle / PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,007** &nbsp;&nbsp; folks: **1,511**  &nbsp;&nbsp; `39 stars today`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **51,331** &nbsp;&nbsp; folks: **4,341**  &nbsp;&nbsp; `209 stars today`

1. [google / python-fire](https://github.com/google/python-fire)
    - Python Fire is a library for automatically generating command line interfaces (CLIs) from absolutely any Python object.
    - language: **Python** &nbsp;&nbsp; stars: **21,386** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `271 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,789** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `338 stars today`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，Go，JavaScript等多语言版本，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **20,651** &nbsp;&nbsp; folks: **5,285**  &nbsp;&nbsp; `89 stars today`

1. [ja-netfilter / ja-netfilter](https://github.com/ja-netfilter/ja-netfilter)
    - A javaagent framework
    - language: **Java** &nbsp;&nbsp; stars: **2,506** &nbsp;&nbsp; folks: **635**  &nbsp;&nbsp; `107 stars today`
...
1. [dfir-iris / iris-web](https://github.com/dfir-iris/iris-web)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **128** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `37 stars today`

1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,164** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `92 stars today`
...
1. [gatsbyjs / gatsby](https://github.com/gatsbyjs/gatsby)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,024** &nbsp;&nbsp; folks: **10,070**  &nbsp;&nbsp; `41 stars today`

1. [google / gvisor](https://github.com/google/gvisor)
    - Application Kernel for Containers
    - language: **Go** &nbsp;&nbsp; stars: **12,177** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `80 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native applications using React
    - language: **JavaScript** &nbsp;&nbsp; stars: **100,186** &nbsp;&nbsp; folks: **21,590**  &nbsp;&nbsp; `56 stars today`

1. [hibiken / asynq](https://github.com/hibiken/asynq)
    - Asynq: simple, reliable, and efficient distributed task queue in Go
    - language: **Go** &nbsp;&nbsp; stars: **2,153** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `99 stars today`

1. [alibaba / formily](https://github.com/alibaba/formily)
    - Alibaba Group Unified Form Solution -- Support React/ReactNative/Vue2/Vue3
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,832** &nbsp;&nbsp; folks: **877**  &nbsp;&nbsp; `78 stars today`

1. [skyline-emu / skyline](https://github.com/skyline-emu/skyline)
    - Run Nintendo Switch homebrew & games on your Android device!
    - language: **C++** &nbsp;&nbsp; stars: **2,476** &nbsp;&nbsp; folks: **472**  &nbsp;&nbsp; `32 stars today`
...
1. [EmbarkStudios / kajiya](https://github.com/EmbarkStudios/kajiya)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,817** &nbsp;&nbsp; folks: **36**  &nbsp;&nbsp; `643 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,789** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `1,883 stars this week`

1. [babysor / MockingBird](https://github.com/babysor/MockingBird)
    - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,139** &nbsp;&nbsp; folks: **2,150**  &nbsp;&nbsp; `1,994 stars this week`

1. [codenotary / immudb](https://github.com/codenotary/immudb)
    - immudb - world’s fastest immutable database, built on a zero trust model
    - language: **Go** &nbsp;&nbsp; stars: **6,425** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `1,190 stars this week`
...
1. [openai / glide-text2im](https://github.com/openai/glide-text2im)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,239** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `485 stars this week`

1. [Vonng / ddia](https://github.com/Vonng/ddia)
    - 《Designing Data-Intensive Application》DDIA中文翻译
    - language: **Python** &nbsp;&nbsp; stars: **11,324** &nbsp;&nbsp; folks: **2,520**  &nbsp;&nbsp; `390 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **90,506** &nbsp;&nbsp; folks: **9,566**  &nbsp;&nbsp; `1,212 stars this week`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，Go，JavaScript等多语言版本，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **20,651** &nbsp;&nbsp; folks: **5,285**  &nbsp;&nbsp; `1,039 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **131,204** &nbsp;&nbsp; folks: **21,501**  &nbsp;&nbsp; `1,621 stars this week`

1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,479** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `1,748 stars this week`

1. [CleverRaven / Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA)
    - Cataclysm - Dark Days Ahead. A turn-based survival game set in a post-apocalyptic world.
    - language: **C++** &nbsp;&nbsp; stars: **6,164** &nbsp;&nbsp; folks: **3,025**  &nbsp;&nbsp; `252 stars this week`

1. [wader / fq](https://github.com/wader/fq)
    - jq for binary formats
    - language: **Go** &nbsp;&nbsp; stars: **2,995** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `830 stars this week`

1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    - A libre lightweight streaming front-end for Android.
    - language: **Java** &nbsp;&nbsp; stars: **16,052** &nbsp;&nbsp; folks: **1,985**  &nbsp;&nbsp; `257 stars this week`
...
1. [bastienwirtz / homer](https://github.com/bastienwirtz/homer)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **3,644** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `219 stars this week`
...
1. [bytedance / btrace](https://github.com/bytedance/btrace)
    - 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Systrace, it support to define custom events automatically during building apk and using bhook to provider more native events like IO.
    - language: **Kotlin** &nbsp;&nbsp; stars: **634** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `210 stars this week`
...
1. [ja-netfilter / ja-netfilter](https://github.com/ja-netfilter/ja-netfilter)
    - A javaagent framework
    - language: **Java** &nbsp;&nbsp; stars: **2,506** &nbsp;&nbsp; folks: **635**  &nbsp;&nbsp; `2,371 stars this month`

1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    - A terminal for a more modern age
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,411** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `7,399 stars this month`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    - 📝A simple and elegant markdown editor, available for Linux, macOS and Windows.
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,479** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `4,751 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **156,789** &nbsp;&nbsp; folks: **28,945**  &nbsp;&nbsp; `5,350 stars this month`
...
1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,403** &nbsp;&nbsp; folks: **1,368**  &nbsp;&nbsp; `612 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **133,776** &nbsp;&nbsp; folks: **20,008**  &nbsp;&nbsp; `1,417 stars this month`
