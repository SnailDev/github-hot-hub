...
`更新时间：2022-02-01 09:58:13 +0800`

## 今日热门仓库

1. [AppFlowy-IO / appflowy](https://github.com/AppFlowy-IO/appflowy)
    - AppFlowy is an open-source alternative to Notion. You are in charge of your data and customizations. Built with Flutter and Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **16,417** &nbsp;&nbsp; folks: **791**  &nbsp;&nbsp; `333 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **45,530** &nbsp;&nbsp; folks: **4,695**  &nbsp;&nbsp; `187 stars today`

1. [nodejs / node](https://github.com/nodejs/node)
    - Node.js JavaScript runtime ✨🐢🚀✨
    - language: **JavaScript** &nbsp;&nbsp; stars: **84,930** &nbsp;&nbsp; folks: **22,600**  &nbsp;&nbsp; `138 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A youtube-dl fork with additional features and fixes
    - language: **Python** &nbsp;&nbsp; stars: **18,169** &nbsp;&nbsp; folks: **1,295**  &nbsp;&nbsp; `169 stars today`

1. [nextui-org / nextui](https://github.com/nextui-org/nextui)
    - 🚀 Beautiful, fast and modern React UI library.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,967** &nbsp;&nbsp; folks: **156**  &nbsp;&nbsp; `489 stars today`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **761** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `197 stars today`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,630** &nbsp;&nbsp; folks: **5,604**  &nbsp;&nbsp; `275 stars today`
...
1. [Jxck-S / plane-notify](https://github.com/Jxck-S/plane-notify)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **289** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `95 stars today`

1. [Koenkk / zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt)
    - Zigbee 🐝 to MQTT bridge 🌉, get rid of your proprietary Zigbee bridges 🔨
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,519** &nbsp;&nbsp; folks: **1,217**  &nbsp;&nbsp; `70 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **30,260** &nbsp;&nbsp; folks: **4,451**  &nbsp;&nbsp; `485 stars today`

1. [HashLips / hashlips_art_engine](https://github.com/HashLips/hashlips_art_engine)
    - HashLips Art Engine is a tool used to create multiple different instances of artworks based on provided layers.
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,679** &nbsp;&nbsp; folks: **1,858**  &nbsp;&nbsp; `75 stars today`
...
1. [IBAX-io / go-ibax](https://github.com/IBAX-io/go-ibax)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,043** &nbsp;&nbsp; folks: **5,774**  &nbsp;&nbsp; `475 stars today`

1. [emilk / egui](https://github.com/emilk/egui)
    - egui: an easy-to-use immediate mode GUI in Rust that runs on both web and native
    - language: **Rust** &nbsp;&nbsp; stars: **7,167** &nbsp;&nbsp; folks: **379**  &nbsp;&nbsp; `62 stars today`
...
1. [uutils / coreutils](https://github.com/uutils/coreutils)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **10,389** &nbsp;&nbsp; folks: **788**  &nbsp;&nbsp; `197 stars today`

1. [ryanoasis / nerd-fonts](https://github.com/ryanoasis/nerd-fonts)
    - Iconic font aggregator, collection, & patcher. 3,600+ icons, 50+ patched fonts: Hack, Source Code Pro, more. Glyph collections: Font Awesome, Material Design Icons, Octicons, & more
    - language: **CSS** &nbsp;&nbsp; stars: **32,971** &nbsp;&nbsp; folks: **2,560**  &nbsp;&nbsp; `184 stars today`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **11,853** &nbsp;&nbsp; folks: **2,230**  &nbsp;&nbsp; `1,603 stars this week`

1. [veler / DevToys](https://github.com/veler/DevToys)
    - A Swiss Army knife for developers.
    - language: **C#** &nbsp;&nbsp; stars: **6,175** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `2,065 stars this week`
...
1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **52,862** &nbsp;&nbsp; folks: **4,408**  &nbsp;&nbsp; `766 stars this week`

1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,977** &nbsp;&nbsp; folks: **2,936**  &nbsp;&nbsp; `450 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **178,570** &nbsp;&nbsp; folks: **20,558**  &nbsp;&nbsp; `1,243 stars this week`
...
1. [DustinBrett / daedalOS](https://github.com/DustinBrett/daedalOS)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,806** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `854 stars this week`
...
1. [kedro-org / kedro](https://github.com/kedro-org/kedro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,371** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `558 stars this week`
...
1. [emilk / egui](https://github.com/emilk/egui)
    - egui: an easy-to-use immediate mode GUI in Rust that runs on both web and native
    - language: **Rust** &nbsp;&nbsp; stars: **7,167** &nbsp;&nbsp; folks: **379**  &nbsp;&nbsp; `1,003 stars this month`
...
1. [TheAlgorithms / Javascript](https://github.com/TheAlgorithms/Javascript)
    - Algorithms implemented in Javascript for beginners, following best practices.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,977** &nbsp;&nbsp; folks: **2,936**  &nbsp;&nbsp; `875 stars this month`
