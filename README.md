...
`更新时间：2022-01-11 08:46:54 +0800`

## 今日热门仓库

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **13,016** &nbsp;&nbsp; folks: **1,156**  &nbsp;&nbsp; `154 stars today`

1. [Asabeneh / 30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
    - 30 days of JavaScript programming challenge is a step-by-step guide to learn JavaScript programming language in 30 days. This challenge may take more than 100 days, please just follow your own pace.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,265** &nbsp;&nbsp; folks: **2,766**  &nbsp;&nbsp; `544 stars today`

1. [QSCTech / zju-icicles](https://github.com/QSCTech/zju-icicles)
    - 浙江大学课程攻略共享计划
    - language: **HTML** &nbsp;&nbsp; stars: **24,387** &nbsp;&nbsp; folks: **7,217**  &nbsp;&nbsp; `75 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **126,872** &nbsp;&nbsp; folks: **33,806**  &nbsp;&nbsp; `206 stars today`

1. [solana-labs / solana](https://github.com/solana-labs/solana)
    - Web-Scale Blockchain for fast, secure, scalable, decentralized apps and marketplaces.
    - language: **Rust** &nbsp;&nbsp; stars: **6,697** &nbsp;&nbsp; folks: **1,398**  &nbsp;&nbsp; `71 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **338,798** &nbsp;&nbsp; folks: **27,721**  &nbsp;&nbsp; `204 stars today`

1. [arendst / Tasmota](https://github.com/arendst/Tasmota)
    - Alternative firmware for ESP8266 with easy configuration using webUI, OTA updates, automation using timers or rules, expandability and entirely local control over MQTT, HTTP, Serial or KNX. Full documentation at
    - language: **C** &nbsp;&nbsp; stars: **16,852** &nbsp;&nbsp; folks: **3,705**  &nbsp;&nbsp; `65 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **66,408** &nbsp;&nbsp; folks: **3,710**  &nbsp;&nbsp; `270 stars today`

1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    - 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub.
    - language: **Python** &nbsp;&nbsp; stars: **51,047** &nbsp;&nbsp; folks: **7,346**  &nbsp;&nbsp; `174 stars today`
...
1. [DarkCoderSc / PowerRemoteDesktop](https://github.com/DarkCoderSc/PowerRemoteDesktop)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **626** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `138 stars today`
...
1. [coding-horror / basic-computer-games](https://github.com/coding-horror/basic-computer-games)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,567** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `1,079 stars this week`
...
1. [adrianhajdin / project_web3.0](https://github.com/adrianhajdin/project_web3.0)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **951** &nbsp;&nbsp; folks: **153**  &nbsp;&nbsp; `278 stars this week`

1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    - Build smaller, faster, and more secure desktop applications with a web frontend.
    - language: **Rust** &nbsp;&nbsp; stars: **27,083** &nbsp;&nbsp; folks: **658**  &nbsp;&nbsp; `1,408 stars this week`
...
1. [bkaradzic / bgfx](https://github.com/bkaradzic/bgfx)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,697** &nbsp;&nbsp; folks: **1,565**  &nbsp;&nbsp; `212 stars this week`

1. [Bugswriter / notflix](https://github.com/Bugswriter/notflix)
    - Notflix is a shell script to search and stream torrent.
    - language: **Shell** &nbsp;&nbsp; stars: **1,292** &nbsp;&nbsp; folks: **106**  &nbsp;&nbsp; `616 stars this week`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **13,016** &nbsp;&nbsp; folks: **1,156**  &nbsp;&nbsp; `403 stars this week`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **66,408** &nbsp;&nbsp; folks: **3,710**  &nbsp;&nbsp; `888 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **126,872** &nbsp;&nbsp; folks: **33,806**  &nbsp;&nbsp; `826 stars this week`
...
1. [YunaiV / ruoyi-vue-pro](https://github.com/YunaiV/ruoyi-vue-pro)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,053** &nbsp;&nbsp; folks: **718**  &nbsp;&nbsp; `92 stars this week`
...
1. [gedoor / legado](https://github.com/gedoor/legado)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **6,023** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `143 stars this week`

1. [coqui-ai / TTS](https://github.com/coqui-ai/TTS)
    - 🐸💬 - a deep learning toolkit for Text-to-Speech, battle-tested in research and production
    - language: **Python** &nbsp;&nbsp; stars: **3,444** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `376 stars this week`
...
1. [TencentARC / GFPGAN](https://github.com/TencentARC/GFPGAN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,487** &nbsp;&nbsp; folks: **2,419**  &nbsp;&nbsp; `11,071 stars this month`

1. [ssssssss-team / spider-flow](https://github.com/ssssssss-team/spider-flow)
    - 新一代爬虫平台，以图形化方式定义爬虫流程，不写代码即可完成爬虫。
    - language: **Java** &nbsp;&nbsp; stars: **5,425** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `2,924 stars this month`
...
1. [Eugeny / tabby](https://github.com/Eugeny/tabby)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,222** &nbsp;&nbsp; folks: **1,637**  &nbsp;&nbsp; `5,495 stars this month`

1. [christophetd / log4shell-vulnerable-app](https://github.com/christophetd/log4shell-vulnerable-app)
    - Spring Boot web application vulnerable to CVE-2021-44228, nicknamed Log4Shell.
    - language: **Java** &nbsp;&nbsp; stars: **888** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `824 stars this month`
...
1. [marktext / marktext](https://github.com/marktext/marktext)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **26,638** &nbsp;&nbsp; folks: **1,903**  &nbsp;&nbsp; `4,350 stars this month`

1. [vercel / turborepo](https://github.com/vercel/turborepo)
    - The High-performance Build System for JavaScript & TypeScript Codebases
    - language: **Go** &nbsp;&nbsp; stars: **4,943** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `3,632 stars this month`
...
1. [PKUanonym / REKCARC-TSC-UHT](https://github.com/PKUanonym/REKCARC-TSC-UHT)
    - 清华大学计算机系课程攻略 Guidance for courses in Department of Computer Science and Technology, Tsinghua University
    - language: **HTML** &nbsp;&nbsp; stars: **21,497** &nbsp;&nbsp; folks: **5,850**  &nbsp;&nbsp; `1,971 stars this month`
...
1. [justjavac / free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN)
    - 📚 免费的计算机编程类中文书籍，欢迎投稿
    - language: **无** &nbsp;&nbsp; stars: **86,367** &nbsp;&nbsp; folks: **24,766**  &nbsp;&nbsp; `1,707 stars this month`

1. [jynew / jynew](https://github.com/jynew/jynew)
    - 金庸群侠传3D重制版
    - language: **C#** &nbsp;&nbsp; stars: **4,039** &nbsp;&nbsp; folks: **839**  &nbsp;&nbsp; `991 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **21,208** &nbsp;&nbsp; folks: **5,453**  &nbsp;&nbsp; `2,234 stars this month`
