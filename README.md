...
`更新时间：2021-05-02 02:21:55 +0800`

## 今日热门仓库

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,718** &nbsp;&nbsp; folks: **415**  &nbsp;&nbsp; `849 stars today`

1. [Kotlin / kmm-production-sample](https://github.com/Kotlin/kmm-production-sample)
    - 无
    - language: **Kotlin** &nbsp;&nbsp; stars: **396** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `136 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **23,787** &nbsp;&nbsp; folks: **4,945**  &nbsp;&nbsp; `267 stars today`
...
1. [flashlight / flashlight](https://github.com/flashlight/flashlight)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,284** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `94 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,851** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `19 stars today`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,641** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `163 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,857** &nbsp;&nbsp; folks: **17,496**  &nbsp;&nbsp; `337 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,231** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `416 stars today`
...
1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **40,700** &nbsp;&nbsp; folks: **6,062**  &nbsp;&nbsp; `105 stars today`

1. [PaddlePaddle / PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)
    - Object detection and instance segmentation toolkit based on PaddlePaddle.
    - language: **Python** &nbsp;&nbsp; stars: **2,978** &nbsp;&nbsp; folks: **799**  &nbsp;&nbsp; `107 stars today`
...
1. [terraform-providers / terraform-provider-azurerm](https://github.com/terraform-providers/terraform-provider-azurerm)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,503** &nbsp;&nbsp; folks: **2,406**  &nbsp;&nbsp; `12 stars today`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,641** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `1,367 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **186,093** &nbsp;&nbsp; folks: **41,889**  &nbsp;&nbsp; `2,713 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,789** &nbsp;&nbsp; folks: **8,068**  &nbsp;&nbsp; `1,065 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,276** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `4,375 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,641** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `1,545 stars this month`
...
1. [johnBuffer / AntSimulator](https://github.com/johnBuffer/AntSimulator)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,414** &nbsp;&nbsp; folks: **189**  &nbsp;&nbsp; `1,224 stars this month`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **7,152** &nbsp;&nbsp; folks: **1,438**  &nbsp;&nbsp; `2,441 stars this month`
...
1. [hagopj13 / node-express-boilerplate](https://github.com/hagopj13/node-express-boilerplate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,364** &nbsp;&nbsp; folks: **500**  &nbsp;&nbsp; `1,433 stars this month`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,561** &nbsp;&nbsp; folks: **5,523**  &nbsp;&nbsp; `1,269 stars this month`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **8,903** &nbsp;&nbsp; folks: **673**  &nbsp;&nbsp; `1,469 stars this month`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,685** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `667 stars this month`
...
1. [zhangdaiscott / JimuReport](https://github.com/zhangdaiscott/JimuReport)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,411** &nbsp;&nbsp; folks: **546**  &nbsp;&nbsp; `768 stars this month`
...
1. [input-output-hk / plutus](https://github.com/input-output-hk/plutus)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **649** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `207 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,789** &nbsp;&nbsp; folks: **8,068**  &nbsp;&nbsp; `3,809 stars this month`

1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    - The Serenity Operating System 🐞
    - language: **C++** &nbsp;&nbsp; stars: **10,914** &nbsp;&nbsp; folks: **1,004**  &nbsp;&nbsp; `1,098 stars this month`

1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    - Source code for Eat The Blocks, a screencast for Ethereum Dapp Developers
    - language: **JavaScript** &nbsp;&nbsp; stars: **711** &nbsp;&nbsp; folks: **705**  &nbsp;&nbsp; `209 stars this month`
