...
1. [abhigyanpatwari / GitNexus](https://github.com/abhigyanpatwari/GitNexus)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,359** &nbsp;&nbsp; folks: **2,635**  &nbsp;&nbsp; `837 stars today`

1. [google-ai-edge / gallery](https://github.com/google-ai-edge/gallery)
    - A gallery that showcases on-device ML/GenAI use cases and allows people to try and use models locally.
    - language: **Kotlin** &nbsp;&nbsp; stars: **17,809** &nbsp;&nbsp; folks: **1,652**  &nbsp;&nbsp; `1,109 stars today`

1. [block / goose](https://github.com/block/goose)
    - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **38,048** &nbsp;&nbsp; folks: **3,674**  &nbsp;&nbsp; `1,514 stars today`

1. [google-ai-edge / LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM)
    - 无
    - language: **C++** &nbsp;&nbsp; stars: **1,971** &nbsp;&nbsp; folks: **208**  &nbsp;&nbsp; `487 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **96,808** &nbsp;&nbsp; folks: **5,284**  &nbsp;&nbsp; `220 stars today`
...
1. [KeygraphHQ / shannon](https://github.com/KeygraphHQ/shannon)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,435** &nbsp;&nbsp; folks: **3,819**  &nbsp;&nbsp; `703 stars today`

1. [NousResearch / hermes-agent](https://github.com/NousResearch/hermes-agent)
    - The agent that grows with you
    - language: **Python** &nbsp;&nbsp; stars: **27,956** &nbsp;&nbsp; folks: **3,681**  &nbsp;&nbsp; `1,721 stars today`

1. [tobi / qmd](https://github.com/tobi/qmd)
    - mini cli search engine for your docs, knowledge bases, meeting notes, whatever. Tracking current sota approaches while being all local
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,678** &nbsp;&nbsp; folks: **1,138**  &nbsp;&nbsp; `526 stars today`

1. [TelegramMessenger / Telegram-iOS](https://github.com/TelegramMessenger/Telegram-iOS)
    - Telegram-iOS
    - language: **Swift** &nbsp;&nbsp; stars: **8,303** &nbsp;&nbsp; folks: **2,525**  &nbsp;&nbsp; `54 stars today`
...
1. [kepano / obsidian-skills](https://github.com/kepano/obsidian-skills)
    ...
    - language: **无** &nbsp;&nbsp; stars: **20,436** &nbsp;&nbsp; folks: **1,269**  &nbsp;&nbsp; `534 stars today`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.
    - language: **Go** &nbsp;&nbsp; stars: **167,646** &nbsp;&nbsp; folks: **15,385**  &nbsp;&nbsp; `263 stars today`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **101,986** &nbsp;&nbsp; folks: **16,461**  &nbsp;&nbsp; `318 stars today`

1. [siddharthvaddem / openscreen](https://github.com/siddharthvaddem/openscreen)
    - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,876** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `1,823 stars today`

1. [NVIDIA / personaplex](https://github.com/NVIDIA/personaplex)
    - PersonaPlex code.
    - language: **Python** &nbsp;&nbsp; stars: **7,292** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `295 stars today`
...
1. [Yeachan-Heo / oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,424** &nbsp;&nbsp; folks: **1,657**  &nbsp;&nbsp; `13,476 stars this week`

1. [siddharthvaddem / openscreen](https://github.com/siddharthvaddem/openscreen)
    - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,876** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `12,682 stars this week`

1. [luongnv89 / claude-howto](https://github.com/luongnv89/claude-howto)
    - A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.
    - language: **Python** &nbsp;&nbsp; stars: **21,282** &nbsp;&nbsp; folks: **2,523**  &nbsp;&nbsp; `15,128 stars this week`

1. [microsoft / VibeVoice](https://github.com/microsoft/VibeVoice)
    - Open-Source Frontier Voice AI
    - language: **Python** &nbsp;&nbsp; stars: **36,840** &nbsp;&nbsp; folks: **4,227**  &nbsp;&nbsp; `10,543 stars this week`

1. [google-research / timesfm](https://github.com/google-research/timesfm)
    - TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
    - language: **Python** &nbsp;&nbsp; stars: **15,175** &nbsp;&nbsp; folks: **1,326**  &nbsp;&nbsp; `4,702 stars this week`

1. [Yeachan-Heo / oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)
    - Teams-first Multi-agent orchestration for Claude Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,005** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `9,112 stars this week`

1. [NousResearch / hermes-agent](https://github.com/NousResearch/hermes-agent)
    - The agent that grows with you
    - language: **Python** &nbsp;&nbsp; stars: **27,956** &nbsp;&nbsp; folks: **3,681**  &nbsp;&nbsp; `9,940 stars this week`

1. [onyx-dot-app / onyx](https://github.com/onyx-dot-app/onyx)
    - Open Source AI Platform - AI Chat with advanced features that works with every LLM
    - language: **Python** &nbsp;&nbsp; stars: **25,437** &nbsp;&nbsp; folks: **3,392**  &nbsp;&nbsp; `4,741 stars this week`

1. [google-ai-edge / gallery](https://github.com/google-ai-edge/gallery)
    - A gallery that showcases on-device ML/GenAI use cases and allows people to try and use models locally.
    - language: **Kotlin** &nbsp;&nbsp; stars: **17,809** &nbsp;&nbsp; folks: **1,652**  &nbsp;&nbsp; `1,286 stars this week`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **80,048** &nbsp;&nbsp; folks: **9,305**  &nbsp;&nbsp; `5,633 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **无** &nbsp;&nbsp; stars: **37,604** &nbsp;&nbsp; folks: **6,196**  &nbsp;&nbsp; `2,235 stars this week`
...
1. [vas3k / TaxHacker](https://github.com/vas3k/TaxHacker)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,817** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `2,204 stars this week`

1. [nvim-treesitter / nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)
    - Nvim Treesitter configurations and abstraction layer
    - language: **Tree-sitter Query** &nbsp;&nbsp; stars: **13,556** &nbsp;&nbsp; folks: **1,218**  &nbsp;&nbsp; `102 stars this week`
