...
`更新时间：2022-02-20 19:11:13 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。
    - language: **无** &nbsp;&nbsp; stars: **3,732** &nbsp;&nbsp; folks: **268**  &nbsp;&nbsp; `955 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **163,005** &nbsp;&nbsp; folks: **30,198**  &nbsp;&nbsp; `187 stars today`
...
1. [cryptotwinsbr / spacecrypto-bot](https://github.com/cryptotwinsbr/spacecrypto-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45** &nbsp;&nbsp; folks: **45**  &nbsp;&nbsp; `4 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **JavaScript** &nbsp;&nbsp; stars: **340,783** &nbsp;&nbsp; folks: **28,000**  &nbsp;&nbsp; `179 stars today`

1. [saadeghi / daisyui](https://github.com/saadeghi/daisyui)
    - ⭐️ ⭐️ ⭐️ ⭐️ ⭐️  Tailwind Components
    - language: **Svelte** &nbsp;&nbsp; stars: **8,476** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `203 stars today`

1. [emilk / egui](https://github.com/emilk/egui)
    - egui: an easy-to-use immediate mode GUI in Rust that runs on both web and native
    - language: **Rust** &nbsp;&nbsp; stars: **7,495** &nbsp;&nbsp; folks: **409**  &nbsp;&nbsp; `17 stars today`
...
1. [spring-projects / spring-petclinic](https://github.com/spring-projects/spring-petclinic)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **5,388** &nbsp;&nbsp; folks: **14,968**  &nbsp;&nbsp; `32 stars today`
...
1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,588** &nbsp;&nbsp; folks: **3,134**  &nbsp;&nbsp; `3,189 stars this week`

1. [bilibili / ailab](https://github.com/bilibili/ailab)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **2,597** &nbsp;&nbsp; folks: **257**  &nbsp;&nbsp; `1,454 stars this week`

1. [ocornut / imgui](https://github.com/ocornut/imgui)
    - Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies
    - language: **C++** &nbsp;&nbsp; stars: **35,605** &nbsp;&nbsp; folks: **6,101**  &nbsp;&nbsp; `691 stars this week`

1. [ethereumbook / ethereumbook](https://github.com/ethereumbook/ethereumbook)
    - Mastering Ethereum, by Andreas M. Antonopoulos, Gavin Wood
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,436** &nbsp;&nbsp; folks: **3,330**  &nbsp;&nbsp; `485 stars this week`

1. [theonedev / onedev](https://github.com/theonedev/onedev)
    - Self-hosted Git Server with Built-in CI/CD
    - language: **Java** &nbsp;&nbsp; stars: **6,543** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `740 stars this week`

1. [doocs / advanced-java](https://github.com/doocs/advanced-java)
    - 😮 Core Interview Questions & Answers For Experienced Java(Backend) Developers | 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识
    - language: **Java** &nbsp;&nbsp; stars: **60,405** &nbsp;&nbsp; folks: **16,535**  &nbsp;&nbsp; `501 stars this week`

1. [ObuchiYuki / DevToysMac](https://github.com/ObuchiYuki/DevToysMac)
    - DevToys For mac
    - language: **Swift** &nbsp;&nbsp; stars: **4,200** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `1,186 stars this week`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **117,198** &nbsp;&nbsp; folks: **39,933**  &nbsp;&nbsp; `547 stars this week`
...
1. [vitejs / vite](https://github.com/vitejs/vite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,910** &nbsp;&nbsp; folks: **2,865**  &nbsp;&nbsp; `498 stars this week`
...
1. [AMAI-GmbH / AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,271** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `1,327 stars this week`

1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    - ⭐⭐⭐⭐秒杀系统设计与实现.互联网工程师进阶与分析🙋🐓
    - language: **Java** &nbsp;&nbsp; stars: **23,815** &nbsp;&nbsp; folks: **6,159**  &nbsp;&nbsp; `356 stars this week`
...
1. [Ebazhanov / linkedin-skill-assessments-quizzes](https://github.com/Ebazhanov/linkedin-skill-assessments-quizzes)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,822** &nbsp;&nbsp; folks: **6,022**  &nbsp;&nbsp; `2,390 stars this month`
...
1. [mermaid-js / mermaid](https://github.com/mermaid-js/mermaid)
    - Generation of diagram and flowchart from text in a similar manner as markdown
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,588** &nbsp;&nbsp; folks: **3,134**  &nbsp;&nbsp; `3,729 stars this month`

1. [ocornut / imgui](https://github.com/ocornut/imgui)
    - Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies
    - language: **C++** &nbsp;&nbsp; stars: **35,605** &nbsp;&nbsp; folks: **6,101**  &nbsp;&nbsp; `1,552 stars this month`

1. [zadam / trilium](https://github.com/zadam/trilium)
    - Build your personal knowledge base with Trilium Notes
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,489** &nbsp;&nbsp; folks: **855**  &nbsp;&nbsp; `1,723 stars this month`
...
1. [psf / black](https://github.com/psf/black)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,682** &nbsp;&nbsp; folks: **1,623**  &nbsp;&nbsp; `1,392 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,160** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `1,488 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **209,744** &nbsp;&nbsp; folks: **56,828**  &nbsp;&nbsp; `7,032 stars this month`

1. [TheAlgorithms / Go](https://github.com/TheAlgorithms/Go)
    - Algorithms implemented in Go for beginners, following best practices.
    - language: **Go** &nbsp;&nbsp; stars: **8,819** &nbsp;&nbsp; folks: **1,635**  &nbsp;&nbsp; `1,228 stars this month`
