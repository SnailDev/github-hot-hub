...
1. [AkashSingh3031 / The-Complete-FAANG-Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,299** &nbsp;&nbsp; folks: **405**  &nbsp;&nbsp; `464 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Free and open fair-code licensed node based Workflow Automation Tool. Easily automate tasks across different services.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,315** &nbsp;&nbsp; folks: **1,353**  &nbsp;&nbsp; `369 stars today`

1. [kwai / DouZero](https://github.com/kwai/DouZero)
    - [ICML 2021] DouZero: Mastering DouDizhu with Self-Play Deep Reinforcement Learning | 斗地主AI
    - language: **Python** &nbsp;&nbsp; stars: **820** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `210 stars today`

1. [vxunderground / MalwareSourceCode](https://github.com/vxunderground/MalwareSourceCode)
    - Collection of malware source code for a variety of platforms in an array of different programming languages.
    - language: **Assembly** &nbsp;&nbsp; stars: **6,016** &nbsp;&nbsp; folks: **587**  &nbsp;&nbsp; `292 stars today`

1. [programthink / zhao](https://github.com/programthink/zhao)
    - 【编程随想】整理的《太子党关系网络》，专门揭露赵国的权贵
    - language: **Python** &nbsp;&nbsp; stars: **8,330** &nbsp;&nbsp; folks: **2,136**  &nbsp;&nbsp; `74 stars today`
...
1. [facebookresearch / AugLy](https://github.com/facebookresearch/AugLy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,446** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `607 stars today`
...
1. [aaronwangy / Data-Science-Cheatsheet](https://github.com/aaronwangy/Data-Science-Cheatsheet)
    ...
    - language: **TeX** &nbsp;&nbsp; stars: **2,333** &nbsp;&nbsp; folks: **302**  &nbsp;&nbsp; `324 stars today`

1. [IanLunn / Hover](https://github.com/IanLunn/Hover)
    - A collection of CSS3 powered hover effects to be applied to links, buttons, logos, SVG, featured images and so on. Easily apply to your own elements, modify or just use for inspiration. Available in CSS, Sass, and LESS.
    - language: **CSS** &nbsp;&nbsp; stars: **24,600** &nbsp;&nbsp; folks: **5,436**  &nbsp;&nbsp; `111 stars today`
...
1. [algorithm-visualizer / algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,473** &nbsp;&nbsp; folks: **5,653**  &nbsp;&nbsp; `307 stars today`
...
1. [academic / awesome-datascience](https://github.com/academic/awesome-datascience)
    ...
    - language: **无** &nbsp;&nbsp; stars: **16,550** &nbsp;&nbsp; folks: **4,543**  &nbsp;&nbsp; `199 stars today`
...
1. [programthink / zhao](https://github.com/programthink/zhao)
    - 【编程随想】整理的《太子党关系网络》，专门揭露赵国的权贵
    - language: **Python** &nbsp;&nbsp; stars: **8,330** &nbsp;&nbsp; folks: **2,136**  &nbsp;&nbsp; `484 stars this week`
...
1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **4,136** &nbsp;&nbsp; folks: **1,044**  &nbsp;&nbsp; `249 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **7,259** &nbsp;&nbsp; folks: **525**  &nbsp;&nbsp; `2,077 stars this week`
...
1. [abuanwar072 / Flutter-Responsive-Admin-Panel-or-Dashboard](https://github.com/abuanwar072/Flutter-Responsive-Admin-Panel-or-Dashboard)
    - Responsive Admin Panel or Dashboard using Flutter
    - language: **Dart** &nbsp;&nbsp; stars: **3,060** &nbsp;&nbsp; folks: **547**  &nbsp;&nbsp; `471 stars this week`
...
1. [tailwindlabs / tailwindcss](https://github.com/tailwindlabs/tailwindcss)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **43,617** &nbsp;&nbsp; folks: **1,990**  &nbsp;&nbsp; `900 stars this week`
...
1. [programthink / zhao](https://github.com/programthink/zhao)
    - 【编程随想】整理的《太子党关系网络》，专门揭露赵国的权贵
    - language: **Python** &nbsp;&nbsp; stars: **8,330** &nbsp;&nbsp; folks: **2,136**  &nbsp;&nbsp; `607 stars this month`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,133** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `719 stars this month`
...
1. [PaperMC / Paper](https://github.com/PaperMC/Paper)
    - High performance Spigot fork that aims to fix gameplay and mechanics inconsistencies
    - language: **Java** &nbsp;&nbsp; stars: **4,136** &nbsp;&nbsp; folks: **1,044**  &nbsp;&nbsp; `855 stars this month`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,643** &nbsp;&nbsp; folks: **1,310**  &nbsp;&nbsp; `2,534 stars this month`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,873** &nbsp;&nbsp; folks: **1,186**  &nbsp;&nbsp; `1,871 stars this month`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - Yet another remote desktop software
    - language: **Rust** &nbsp;&nbsp; stars: **7,259** &nbsp;&nbsp; folks: **525**  &nbsp;&nbsp; `4,776 stars this month`
