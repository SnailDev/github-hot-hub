...
1. [aaPanel / BillionMail](https://github.com/aaPanel/BillionMail)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,261** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `418 stars today`

1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **10,238** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `134 stars today`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,334** &nbsp;&nbsp; folks: **1,103**  &nbsp;&nbsp; `121 stars today`
...
1. [ccxt / ccxt](https://github.com/ccxt/ccxt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **36,585** &nbsp;&nbsp; folks: **7,942**  &nbsp;&nbsp; `65 stars today`
...
1. [coleam00 / local-ai-packaged](https://github.com/coleam00/local-ai-packaged)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,283** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `28 stars today`

1. [KwaiVGI / LivePortrait](https://github.com/KwaiVGI/LivePortrait)
    - Bring portraits to life!
    - language: **Python** &nbsp;&nbsp; stars: **15,564** &nbsp;&nbsp; folks: **1,637**  &nbsp;&nbsp; `307 stars today`

1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity.
    - language: **Python** &nbsp;&nbsp; stars: **13,600** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `812 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **99,945** &nbsp;&nbsp; folks: **15,056**  &nbsp;&nbsp; `185 stars today`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **JavaScript** &nbsp;&nbsp; stars: **127,321** &nbsp;&nbsp; folks: **16,916**  &nbsp;&nbsp; `237 stars today`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity.
    - language: **Python** &nbsp;&nbsp; stars: **13,600** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `9,885 stars this week`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,327** &nbsp;&nbsp; folks: **3,608**  &nbsp;&nbsp; `3,561 stars this week`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **30,864** &nbsp;&nbsp; folks: **5,173**  &nbsp;&nbsp; `2,322 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **10,690** &nbsp;&nbsp; folks: **597**  &nbsp;&nbsp; `1,765 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,334** &nbsp;&nbsp; folks: **1,103**  &nbsp;&nbsp; `564 stars this week`

1. [ccxt / ccxt](https://github.com/ccxt/ccxt)
    - A JavaScript / TypeScript / Python / C# / PHP / Go cryptocurrency trading API with support for more than 100 bitcoin/altcoin exchanges
    - language: **Python** &nbsp;&nbsp; stars: **36,585** &nbsp;&nbsp; folks: **7,942**  &nbsp;&nbsp; `348 stars this week`

1. [ML-GSAI / LLaDA](https://github.com/ML-GSAI/LLaDA)
    - Official PyTorch implementation for "Large Language Diffusion Models"
    - language: **Python** &nbsp;&nbsp; stars: **2,001** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `211 stars this week`

1. [simonw / llm](https://github.com/simonw/llm)
    - Access large language models from the command-line
    - language: **Python** &nbsp;&nbsp; stars: **8,080** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `446 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity.
    - language: **Python** &nbsp;&nbsp; stars: **13,600** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `11,669 stars this month`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,549** &nbsp;&nbsp; folks: **934**  &nbsp;&nbsp; `9,756 stars this month`

1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,435** &nbsp;&nbsp; folks: **1,419**  &nbsp;&nbsp; `10,301 stars this month`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **70,036** &nbsp;&nbsp; folks: **9,895**  &nbsp;&nbsp; `17,517 stars this month`
...
1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **43,108** &nbsp;&nbsp; folks: **1,825**  &nbsp;&nbsp; `5,506 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,750** &nbsp;&nbsp; folks: **334**  &nbsp;&nbsp; `3,069 stars this month`
...
1. [bytedance / flowgram.ai](https://github.com/bytedance/flowgram.ai)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,425** &nbsp;&nbsp; folks: **307**  &nbsp;&nbsp; `3,174 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **33,149** &nbsp;&nbsp; folks: **3,261**  &nbsp;&nbsp; `5,126 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **30,864** &nbsp;&nbsp; folks: **5,173**  &nbsp;&nbsp; `3,037 stars this month`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **8,762** &nbsp;&nbsp; folks: **1,087**  &nbsp;&nbsp; `3,644 stars this month`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,327** &nbsp;&nbsp; folks: **3,608**  &nbsp;&nbsp; `4,292 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **324,659** &nbsp;&nbsp; folks: **41,843**  &nbsp;&nbsp; `8,265 stars this month`
...
1. [QwenLM / Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,125** &nbsp;&nbsp; folks: **769**  &nbsp;&nbsp; `2,012 stars this month`
...
1. [aipotheosis-labs / aci](https://github.com/aipotheosis-labs/aci)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,730** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `3,307 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **JavaScript** &nbsp;&nbsp; stars: **127,321** &nbsp;&nbsp; folks: **16,916**  &nbsp;&nbsp; `3,615 stars this month`
