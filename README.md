...
1. [mvt-project / mvt](https://github.com/mvt-project/mvt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,517** &nbsp;&nbsp; folks: **318**  &nbsp;&nbsp; `338 stars today`
...
1. [loong132 / autojs-script](https://github.com/loong132/autojs-script)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **181** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `37 stars today`
...
1. [microsoft / CBL-Mariner](https://github.com/microsoft/CBL-Mariner)
    - Linux OS for Azure 1P services and edge appliances
    - language: **Go** &nbsp;&nbsp; stars: **2,340** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `1,238 stars this week`
...
1. [dromara / Sa-Token](https://github.com/dromara/Sa-Token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,037** &nbsp;&nbsp; folks: **909**  &nbsp;&nbsp; `379 stars this week`
...
1. [ventoy / Ventoy](https://github.com/ventoy/Ventoy)
    - A new bootable USB solution.
    - language: **C** &nbsp;&nbsp; stars: **21,746** &nbsp;&nbsp; folks: **1,645**  &nbsp;&nbsp; `2,204 stars this week`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **143,928** &nbsp;&nbsp; folks: **16,704**  &nbsp;&nbsp; `3,868 stars this week`
...
1. [CorentinJ / Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,193** &nbsp;&nbsp; folks: **5,117**  &nbsp;&nbsp; `3,362 stars this month`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - An IDE layer for Neovim with sane defaults. Completely free and community driven.
    - language: **Lua** &nbsp;&nbsp; stars: **4,343** &nbsp;&nbsp; folks: **898**  &nbsp;&nbsp; `1,009 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,918** &nbsp;&nbsp; folks: **4,190**  &nbsp;&nbsp; `3,250 stars this month`
...
1. [snowpackjs / astro](https://github.com/snowpackjs/astro)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,752** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `2,546 stars this month`
...
1. [YMFE / yapi](https://github.com/YMFE/yapi)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,803** &nbsp;&nbsp; folks: **3,759**  &nbsp;&nbsp; `603 stars this month`

1. [JDHelloWorld / jd_scripts](https://github.com/JDHelloWorld/jd_scripts)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,059** &nbsp;&nbsp; folks: **596**  &nbsp;&nbsp; `446 stars this month`

1. [mui-org / material-ui](https://github.com/mui-org/material-ui)
    - Material-UI is a simple and customizable component library to build faster, beautiful, and more accessible React applications. Follow your own design system, or start with Material Design.
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,938** &nbsp;&nbsp; folks: **23,136**  &nbsp;&nbsp; `1,294 stars this month`

1. [airbnb / javascript](https://github.com/airbnb/javascript)
    - JavaScript Style Guide
    - language: **JavaScript** &nbsp;&nbsp; stars: **112,336** &nbsp;&nbsp; folks: **21,539**  &nbsp;&nbsp; `2,038 stars this month`

1. [microsoft / vscode](https://github.com/microsoft/vscode)
    - Visual Studio Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **119,184** &nbsp;&nbsp; folks: **19,521**  &nbsp;&nbsp; `1,675 stars this month`

1. [apache / airflow](https://github.com/apache/airflow)
    - Apache Airflow - A platform to programmatically author, schedule, and monitor workflows
    - language: **Python** &nbsp;&nbsp; stars: **22,540** &nbsp;&nbsp; folks: **8,891**  &nbsp;&nbsp; `452 stars this month`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **115,073** &nbsp;&nbsp; folks: **18,979**  &nbsp;&nbsp; `4,187 stars this month`
...
1. [labuladong / fucking-algorithm](https://github.com/labuladong/fucking-algorithm)
    ...
    - language: **无** &nbsp;&nbsp; stars: **93,676** &nbsp;&nbsp; folks: **18,280**  &nbsp;&nbsp; `1,780 stars this month`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **108,079** &nbsp;&nbsp; folks: **37,109**  &nbsp;&nbsp; `2,108 stars this month`
...
1. [IrisShaders / Iris](https://github.com/IrisShaders/Iris)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,018** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `291 stars this month`
