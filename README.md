...
1. [microsoft / magentic-ui](https://github.com/microsoft/magentic-ui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,695** &nbsp;&nbsp; folks: **897**  &nbsp;&nbsp; `537 stars this week`

1. [oven-sh / bun](https://github.com/oven-sh/bun)
    - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
    - language: **Zig** &nbsp;&nbsp; stars: **84,369** &nbsp;&nbsp; folks: **3,738**  &nbsp;&nbsp; `1,664 stars this week`

1. [ostris / ai-toolkit](https://github.com/ostris/ai-toolkit)
    - The ultimate training toolkit for finetuning diffusion models
    - language: **Python** &nbsp;&nbsp; stars: **7,693** &nbsp;&nbsp; folks: **934**  &nbsp;&nbsp; `595 stars this week`

1. [anthropics / claude-quickstarts](https://github.com/anthropics/claude-quickstarts)
    - A collection of projects designed to help developers quickly get started with building deployable applications using the Claude API
    - language: **Python** &nbsp;&nbsp; stars: **10,819** &nbsp;&nbsp; folks: **1,968**  &nbsp;&nbsp; `240 stars this week`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.
    - language: **Rust** &nbsp;&nbsp; stars: **15,087** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `2,083 stars this week`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **12,775** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `595 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **44,834** &nbsp;&nbsp; folks: **3,104**  &nbsp;&nbsp; `942 stars this week`
...
1. [sansan0 / TrendRadar](https://github.com/sansan0/TrendRadar)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,843** &nbsp;&nbsp; folks: **20,085**  &nbsp;&nbsp; `33,109 stars this month`

1. [kavishdevar / librepods](https://github.com/kavishdevar/librepods)
    - AirPods liberated from Apple's ecosystem.
    - language: **Kotlin** &nbsp;&nbsp; stars: **19,482** &nbsp;&nbsp; folks: **925**  &nbsp;&nbsp; `17,748 stars this month`

1. [usestrix / strix](https://github.com/usestrix/strix)
    - Open-source AI agents for penetration testing
    - language: **Python** &nbsp;&nbsp; stars: **16,902** &nbsp;&nbsp; folks: **1,714**  &nbsp;&nbsp; `14,617 stars this month`

1. [MemoriLabs / Memori](https://github.com/MemoriLabs/Memori)
    - Open-Source Memory Engine for LLMs, AI Agents & Multi-Agent Systems
    - language: **Python** &nbsp;&nbsp; stars: **9,464** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `7,870 stars this month`
...
1. [microsoft / magentic-ui](https://github.com/microsoft/magentic-ui)
    - A research prototype of a human-centered web agent
    - language: **Python** &nbsp;&nbsp; stars: **8,695** &nbsp;&nbsp; folks: **897**  &nbsp;&nbsp; `711 stars this month`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **61,069** &nbsp;&nbsp; folks: **13,558**  &nbsp;&nbsp; `6,770 stars this month`
...
1. [opencloud-eu / opencloud](https://github.com/opencloud-eu/opencloud)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,322** &nbsp;&nbsp; folks: **153**  &nbsp;&nbsp; `1,779 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,952** &nbsp;&nbsp; folks: **4,469**  &nbsp;&nbsp; `1,353 stars this month`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,226** &nbsp;&nbsp; folks: **5,407**  &nbsp;&nbsp; `5,498 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **86,075** &nbsp;&nbsp; folks: **9,822**  &nbsp;&nbsp; `4,840 stars this month`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.
    - language: **Rust** &nbsp;&nbsp; stars: **15,087** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `3,005 stars this month`

1. [ValveSoftware / Proton](https://github.com/ValveSoftware/Proton)
    - Compatibility tool for Steam Play based on Wine and additional components
    - language: **C++** &nbsp;&nbsp; stars: **29,067** &nbsp;&nbsp; folks: **1,261**  &nbsp;&nbsp; `970 stars this month`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **TypeScript** &nbsp;&nbsp; stars: **104,646** &nbsp;&nbsp; folks: **4,691**  &nbsp;&nbsp; `6,530 stars this month`

1. [ostris / ai-toolkit](https://github.com/ostris/ai-toolkit)
    - The ultimate training toolkit for finetuning diffusion models
    - language: **Python** &nbsp;&nbsp; stars: **7,693** &nbsp;&nbsp; folks: **934**  &nbsp;&nbsp; `851 stars this month`

1. [QuantConnect / Lean](https://github.com/QuantConnect/Lean)
    - Lean Algorithmic Trading Engine by QuantConnect (Python, C#)
    - language: **C#** &nbsp;&nbsp; stars: **13,629** &nbsp;&nbsp; folks: **3,959**  &nbsp;&nbsp; `916 stars this month`
...
1. [farion1231 / cc-switch](https://github.com/farion1231/cc-switch)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,903** &nbsp;&nbsp; folks: **387**  &nbsp;&nbsp; `2,725 stars this month`

1. [playcanvas / engine](https://github.com/playcanvas/engine)
    - Powerful web graphics runtime built on WebGL, WebGPU, WebXR and glTF
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,119** &nbsp;&nbsp; folks: **1,668**  &nbsp;&nbsp; `3,119 stars this month`
