...
`更新时间：2024-05-25 04:12:42 +0800`

## 今日热门仓库

1. [it-ebooks-0 / geektime-books](https://github.com/it-ebooks-0/geektime-books)
    - 📚 极客时间电子书
    - language: **无** &nbsp;&nbsp; stars: **6,526** &nbsp;&nbsp; folks: **2,145**  &nbsp;&nbsp; `1,240 stars today`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,536** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `436 stars today`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-Llama3-V 2.5: A GPT-4V Level Multimodal LLM on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **3,476** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `345 stars today`

1. [Ph0enixKM / Amber](https://github.com/Ph0enixKM/Amber)
    - 💎 Amber the programming language compiled to bash
    - language: **Rust** &nbsp;&nbsp; stars: **2,155** &nbsp;&nbsp; folks: **33**  &nbsp;&nbsp; `490 stars today`

1. [gothinkster / realworld](https://github.com/gothinkster/realworld)
    - "The mother of all demo apps" — Exemplary fullstack Medium.com clone powered by React, Angular, Node, Django, and many more
    - language: **TypeScript** &nbsp;&nbsp; stars: **79,174** &nbsp;&nbsp; folks: **7,239**  &nbsp;&nbsp; `87 stars today`
...
1. [Codium-ai / cover-agent](https://github.com/Codium-ai/cover-agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,708** &nbsp;&nbsp; folks: **163**  &nbsp;&nbsp; `1,077 stars today`

1. [angular / angular](https://github.com/angular/angular)
    - Deliver web apps with confidence 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **94,810** &nbsp;&nbsp; folks: **24,708**  &nbsp;&nbsp; `30 stars today`

1. [nucleuscloud / neosync](https://github.com/nucleuscloud/neosync)
    - Open source data anonymization and synthetic data orchestration for developers. Create high fidelity synthetic data and sync it across your environments.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,622** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `370 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **31,114** &nbsp;&nbsp; folks: **3,217**  &nbsp;&nbsp; `927 stars today`
...
1. [vulhub / vulhub](https://github.com/vulhub/vulhub)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **16,406** &nbsp;&nbsp; folks: **4,323**  &nbsp;&nbsp; `16 stars today`
...
1. [CADmium-Co / CADmium](https://github.com/CADmium-Co/CADmium)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **603** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `120 stars today`
...
1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    - fabric is an open-source framework for augmenting humans using AI. It provides a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
    - language: **Python** &nbsp;&nbsp; stars: **11,005** &nbsp;&nbsp; folks: **1,150**  &nbsp;&nbsp; `901 stars this week`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **87,330** &nbsp;&nbsp; folks: **26,038**  &nbsp;&nbsp; `622 stars this week`
...
1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,448** &nbsp;&nbsp; folks: **326**  &nbsp;&nbsp; `1,430 stars this week`
...
1. [NaiboWang / EasySpider](https://github.com/NaiboWang/EasySpider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,989** &nbsp;&nbsp; folks: **3,041**  &nbsp;&nbsp; `2,061 stars this week`
...
1. [neovim / neovim](https://github.com/neovim/neovim)
    ...
    - language: **Vim Script** &nbsp;&nbsp; stars: **78,413** &nbsp;&nbsp; folks: **5,414**  &nbsp;&nbsp; `1,363 stars this week`
...
1. [Zelda64Recomp / Zelda64Recomp](https://github.com/Zelda64Recomp/Zelda64Recomp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,348** &nbsp;&nbsp; folks: **226**  &nbsp;&nbsp; `933 stars this week`

1. [N64Recomp / N64Recomp](https://github.com/N64Recomp/N64Recomp)
    - Tool to statically recompile N64 games into native executables
    - language: **C++** &nbsp;&nbsp; stars: **5,672** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `1,222 stars this week`
...
1. [bepass-org / oblivion-desktop](https://github.com/bepass-org/oblivion-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,627** &nbsp;&nbsp; folks: **322**  &nbsp;&nbsp; `1,666 stars this week`
...
1. [pagefaultgames / pokerogue](https://github.com/pagefaultgames/pokerogue)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,415** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `473 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **498** &nbsp;&nbsp; folks: **38**  &nbsp;&nbsp; `159 stars this week`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **105,590** &nbsp;&nbsp; folks: **6,226**  &nbsp;&nbsp; `393 stars this week`

1. [SeleniumHQ / docker-selenium](https://github.com/SeleniumHQ/docker-selenium)
    - Provides a simple way to run Selenium Grid with Chrome, Firefox, and Edge using Docker, making it easier to perform browser automation
    - language: **Shell** &nbsp;&nbsp; stars: **7,624** &nbsp;&nbsp; folks: **2,493**  &nbsp;&nbsp; `173 stars this week`
...
1. [lich0821 / WeChatFerry](https://github.com/lich0821/WeChatFerry)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,690** &nbsp;&nbsp; folks: **500**  &nbsp;&nbsp; `443 stars this week`
...
1. [wandb / openui](https://github.com/wandb/openui)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **14,894** &nbsp;&nbsp; folks: **1,261**  &nbsp;&nbsp; `8,776 stars this month`
...
1. [pagefaultgames / pokerogue](https://github.com/pagefaultgames/pokerogue)
    - A browser based Pokémon fangame heavily inspired by the roguelite genre.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,415** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `1,684 stars this month`
...
1. [CorentinTh / it-tools](https://github.com/CorentinTh/it-tools)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **16,640** &nbsp;&nbsp; folks: **1,941**  &nbsp;&nbsp; `5,790 stars this month`
...
1. [massgravel / Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts)
    ...
    - language: **Batchfile** &nbsp;&nbsp; stars: **80,139** &nbsp;&nbsp; folks: **7,819**  &nbsp;&nbsp; `8,238 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly WebUI for LLMs (Formerly Ollama WebUI)
    - language: **Svelte** &nbsp;&nbsp; stars: **23,637** &nbsp;&nbsp; folks: **2,477**  &nbsp;&nbsp; `8,264 stars this month`
...
1. [Doriandarko / maestro](https://github.com/Doriandarko/maestro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,930** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `1,263 stars this month`

1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    - GPT based autonomous agent that does online comprehensive research on any given topic
    - language: **Python** &nbsp;&nbsp; stars: **11,530** &nbsp;&nbsp; folks: **1,400**  &nbsp;&nbsp; `2,931 stars this month`

1. [NaiboWang / EasySpider](https://github.com/NaiboWang/EasySpider)
    - A visual no-code/code-free web crawler/spider易采集：一个可视化浏览器自动化测试/数据采集/爬虫软件，可以无代码图形化的设计和执行爬虫任务。别名：ServiceWrapper面向Web应用的智能化服务封装系统。
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,989** &nbsp;&nbsp; folks: **3,041**  &nbsp;&nbsp; `4,435 stars this month`

1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl, search and extract with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,448** &nbsp;&nbsp; folks: **326**  &nbsp;&nbsp; `2,721 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,801** &nbsp;&nbsp; folks: **4,037**  &nbsp;&nbsp; `6,979 stars this month`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-Llama3-V 2.5: A GPT-4V Level Multimodal LLM on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **3,476** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `1,821 stars this month`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,344** &nbsp;&nbsp; folks: **650**  &nbsp;&nbsp; `3,586 stars this month`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **87,330** &nbsp;&nbsp; folks: **26,038**  &nbsp;&nbsp; `946 stars this month`
