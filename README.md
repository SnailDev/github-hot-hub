...
`更新时间：2021-08-04 19:09:18 +0800`

## 今日热门仓库

1. [sysprog21 / lkmpg](https://github.com/sysprog21/lkmpg)
    - The Linux Kernel Module Programming Guide (updated for 5.x kernels)
    - language: **TeX** &nbsp;&nbsp; stars: **1,042** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `414 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **26,560** &nbsp;&nbsp; folks: **5,305**  &nbsp;&nbsp; `209 stars today`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,080** &nbsp;&nbsp; folks: **3,541**  &nbsp;&nbsp; `653 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **140,299** &nbsp;&nbsp; folks: **25,795**  &nbsp;&nbsp; `110 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,480** &nbsp;&nbsp; folks: **4,393**  &nbsp;&nbsp; `319 stars today`

1. [github / docs](https://github.com/github/docs)
    - The open-source repo for docs.github.com
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,643** &nbsp;&nbsp; folks: **22,384**  &nbsp;&nbsp; `42 stars today`

1. [ibraheemdev / modern-unix](https://github.com/ibraheemdev/modern-unix)
    - A collection of modern/faster/saner alternatives to common unix commands.
    - language: **无** &nbsp;&nbsp; stars: **13,703** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `353 stars today`

1. [reviewdog / reviewdog](https://github.com/reviewdog/reviewdog)
    - 🐶 Automated code review tool integrated with any code analysis tools regardless of programming language
    - language: **Go** &nbsp;&nbsp; stars: **3,544** &nbsp;&nbsp; folks: **195**  &nbsp;&nbsp; `11 stars today`
...
1. [tokio-rs / axum](https://github.com/tokio-rs/axum)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,000** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `194 stars today`
...
1. [SigmaHQ / sigma](https://github.com/SigmaHQ/sigma)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,821** &nbsp;&nbsp; folks: **1,106**  &nbsp;&nbsp; `9 stars today`

1. [open-mmlab / mmcv](https://github.com/open-mmlab/mmcv)
    - OpenMMLab Computer Vision Foundation
    - language: **Python** &nbsp;&nbsp; stars: **2,748** &nbsp;&nbsp; folks: **757**  &nbsp;&nbsp; `6 stars today`
...
1. [GhostPack / Rubeus](https://github.com/GhostPack/Rubeus)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **1,576** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `25 stars today`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,780** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `979 stars this week`
...
1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,939** &nbsp;&nbsp; folks: **2,983**  &nbsp;&nbsp; `895 stars this week`
...
1. [golang-jwt / jwt](https://github.com/golang-jwt/jwt)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **513** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `221 stars this week`
...
1. [bytedance / flutter_ume](https://github.com/bytedance/flutter_ume)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **1,147** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `634 stars this week`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,800** &nbsp;&nbsp; folks: **2,812**  &nbsp;&nbsp; `764 stars this week`
...
1. [cloudreve / Cloudreve](https://github.com/cloudreve/Cloudreve)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **9,727** &nbsp;&nbsp; folks: **1,739**  &nbsp;&nbsp; `281 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 25 lessons, 50 quizzes, classic Machine Learning for all
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,080** &nbsp;&nbsp; folks: **3,541**  &nbsp;&nbsp; `11,892 stars this month`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **1,780** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `1,165 stars this month`
...
1. [mirumee / saleor](https://github.com/mirumee/saleor)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,693** &nbsp;&nbsp; folks: **3,912**  &nbsp;&nbsp; `1,822 stars this month`

1. [mitmproxy / mitmproxy](https://github.com/mitmproxy/mitmproxy)
    - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
    - language: **Python** &nbsp;&nbsp; stars: **23,939** &nbsp;&nbsp; folks: **2,983**  &nbsp;&nbsp; `1,220 stars this month`
