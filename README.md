...
`更新时间：2026-01-25 11:50:50 +0800`

## 今日热门仓库

1. [remotion-dev / remotion](https://github.com/remotion-dev/remotion)
    - 🎥 Make videos programmatically with React
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,662** &nbsp;&nbsp; folks: **1,781**  &nbsp;&nbsp; `1,171 stars today`

1. [VectifyAI / PageIndex](https://github.com/VectifyAI/PageIndex)
    - 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG
    - language: **Python** &nbsp;&nbsp; stars: **8,466** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `1,374 stars today`
...
1. [iOfficeAI / AionUi](https://github.com/iOfficeAI/AionUi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,269** &nbsp;&nbsp; folks: **789**  &nbsp;&nbsp; `5,447 stars this week`

1. [remotion-dev / remotion](https://github.com/remotion-dev/remotion)
    - 🎥 Make videos programmatically with React
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,662** &nbsp;&nbsp; folks: **1,781**  &nbsp;&nbsp; `3,712 stars this week`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **35,359** &nbsp;&nbsp; folks: **2,693**  &nbsp;&nbsp; `8,266 stars this week`

1. [microsoft / agent-lightning](https://github.com/microsoft/agent-lightning)
    - The absolute trainer to light up AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **11,674** &nbsp;&nbsp; folks: **943**  &nbsp;&nbsp; `1,325 stars this week`

1. [VectifyAI / PageIndex](https://github.com/VectifyAI/PageIndex)
    - 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG
    - language: **Python** &nbsp;&nbsp; stars: **8,466** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `2,362 stars this week`

1. [tobi / try](https://github.com/tobi/try)
    - fresh directories for every vibe
    - language: **Shell** &nbsp;&nbsp; stars: **3,286** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `683 stars this week`
...
1. [eigent-ai / eigent](https://github.com/eigent-ai/eigent)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,265** &nbsp;&nbsp; folks: **1,262**  &nbsp;&nbsp; `3,187 stars this week`
...
1. [anomalyco / opencode](https://github.com/anomalyco/opencode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **86,564** &nbsp;&nbsp; folks: **7,842**  &nbsp;&nbsp; `44,741 stars this month`

1. [BloopAI / vibe-kanban](https://github.com/BloopAI/vibe-kanban)
    - Get 10X more out of Claude Code, Codex or any coding agent
    - language: **Rust** &nbsp;&nbsp; stars: **18,839** &nbsp;&nbsp; folks: **1,751**  &nbsp;&nbsp; `12,116 stars this month`

1. [obra / superpowers](https://github.com/obra/superpowers)
    - An agentic skills framework & software development methodology that works.
    - language: **Shell** &nbsp;&nbsp; stars: **35,359** &nbsp;&nbsp; folks: **2,693**  &nbsp;&nbsp; `23,983 stars this month`

1. [anthropics / skills](https://github.com/anthropics/skills)
    - Public repository for Agent Skills
    - language: **Python** &nbsp;&nbsp; stars: **52,071** &nbsp;&nbsp; folks: **5,039**  &nbsp;&nbsp; `25,497 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **60,337** &nbsp;&nbsp; folks: **4,498**  &nbsp;&nbsp; `12,132 stars this month`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,745** &nbsp;&nbsp; folks: **2,392**  &nbsp;&nbsp; `4,706 stars this month`

1. [usememos / memos](https://github.com/usememos/memos)
    - An open-source, self-hosted note-taking service. Your thoughts, your data, your control — no tracking, no ads, no subscription fees.
    - language: **Go** &nbsp;&nbsp; stars: **55,526** &nbsp;&nbsp; folks: **3,985**  &nbsp;&nbsp; `8,245 stars this month`
