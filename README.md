...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,908** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `1,557 stars today`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **9,311** &nbsp;&nbsp; folks: **491**  &nbsp;&nbsp; `226 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **89,712** &nbsp;&nbsp; folks: **20,822**  &nbsp;&nbsp; `150 stars today`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler & Scrapper
    - language: **Python** &nbsp;&nbsp; stars: **10,482** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `1,195 stars today`
...
1. [mlc-ai / web-llm](https://github.com/mlc-ai/web-llm)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,992** &nbsp;&nbsp; folks: **817**  &nbsp;&nbsp; `123 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **335,162** &nbsp;&nbsp; folks: **61,300**  &nbsp;&nbsp; `99 stars today`

1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
    - language: **MDX** &nbsp;&nbsp; stars: **48,362** &nbsp;&nbsp; folks: **4,709**  &nbsp;&nbsp; `107 stars today`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **58,948** &nbsp;&nbsp; folks: **19,065**  &nbsp;&nbsp; `23 stars today`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **31,234** &nbsp;&nbsp; folks: **2,870**  &nbsp;&nbsp; `298 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **403,095** &nbsp;&nbsp; folks: **37,497**  &nbsp;&nbsp; `92 stars today`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler & Scrapper
    - language: **Python** &nbsp;&nbsp; stars: **10,482** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `6,992 stars this week`

1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **5,908** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `4,007 stars this week`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **9,311** &nbsp;&nbsp; folks: **491**  &nbsp;&nbsp; `2,203 stars this week`
...
1. [DiceDB / dice](https://github.com/DiceDB/dice)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,500** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `946 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **31,234** &nbsp;&nbsp; folks: **2,870**  &nbsp;&nbsp; `799 stars this week`
...
1. [coqui-ai / TTS](https://github.com/coqui-ai/TTS)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,240** &nbsp;&nbsp; folks: **4,146**  &nbsp;&nbsp; `548 stars this week`

1. [meta-llama / llama-stack](https://github.com/meta-llama/llama-stack)
    - Model components of the Llama Stack APIs
    - language: **Python** &nbsp;&nbsp; stars: **2,955** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `2,567 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,398** &nbsp;&nbsp; folks: **688**  &nbsp;&nbsp; `1,701 stars this week`
...
1. [Zeyi-Lin / HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,491** &nbsp;&nbsp; folks: **1,025**  &nbsp;&nbsp; `8,615 stars this month`
...
1. [meta-llama / llama-stack](https://github.com/meta-llama/llama-stack)
    - Model components of the Llama Stack APIs
    - language: **Python** &nbsp;&nbsp; stars: **2,955** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `2,642 stars this month`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **5,908** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `4,368 stars this month`
...
1. [nginx / nginx](https://github.com/nginx/nginx)
    ...
    - language: **C** &nbsp;&nbsp; stars: **24,602** &nbsp;&nbsp; folks: **6,909**  &nbsp;&nbsp; `3,452 stars this month`
...
1. [DiceDB / dice](https://github.com/DiceDB/dice)
    - DiceDB is an in-memory, real-time, and reactive database with Redis and SQL support optimized for modern hardware and building real-time applications.
    - language: **Go** &nbsp;&nbsp; stars: **5,500** &nbsp;&nbsp; folks: **795**  &nbsp;&nbsp; `2,282 stars this month`

1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    - Orchestration and automation platform to execute millions of scheduled and event-driven workflows declaratively in code and from the UI
    - language: **Java** &nbsp;&nbsp; stars: **9,398** &nbsp;&nbsp; folks: **688**  &nbsp;&nbsp; `2,048 stars this month`
...
1. [mainmatter / 100-exercises-to-learn-rust](https://github.com/mainmatter/100-exercises-to-learn-rust)
    - A self-paced course to learn Rust, one exercise at a time.
    - language: **Rust** &nbsp;&nbsp; stars: **4,588** &nbsp;&nbsp; folks: **834**  &nbsp;&nbsp; `988 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **78,677** &nbsp;&nbsp; folks: **36,219**  &nbsp;&nbsp; `1,100 stars this month`
