...
`更新时间：2024-05-25 06:11:38 +0800`

## 今日热门仓库

1. [it-ebooks-0 / geektime-books](https://github.com/it-ebooks-0/geektime-books)
    - 📚 极客时间电子书
    - language: **无** &nbsp;&nbsp; stars: **6,546** &nbsp;&nbsp; folks: **2,152**  &nbsp;&nbsp; `1,240 stars today`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,591** &nbsp;&nbsp; folks: **309**  &nbsp;&nbsp; `436 stars today`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-Llama3-V 2.5: A GPT-4V Level Multimodal LLM on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **3,485** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `345 stars today`

1. [Ph0enixKM / Amber](https://github.com/Ph0enixKM/Amber)
    - 💎 Amber the programming language compiled to bash
    - language: **Rust** &nbsp;&nbsp; stars: **2,185** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `490 stars today`
...
1. [foolstack-omg / block-tech-sharing](https://github.com/foolstack-omg/block-tech-sharing)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **221** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `19 stars today`

1. [CADmium-Co / CADmium](https://github.com/CADmium-Co/CADmium)
    - A CAD program that runs in the browser
    - language: **Rust** &nbsp;&nbsp; stars: **620** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `120 stars today`
...
1. [6677-ai / tap4-ai-webui](https://github.com/6677-ai/tap4-ai-webui)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **245** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `39 stars today`
...
1. [danielmiessler / fabric](https://github.com/danielmiessler/fabric)
    - fabric is an open-source framework for augmenting humans using AI. It provides a modular framework for solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.
    - language: **Python** &nbsp;&nbsp; stars: **11,011** &nbsp;&nbsp; folks: **1,150**  &nbsp;&nbsp; `901 stars this week`

1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)
    - language: **Rust** &nbsp;&nbsp; stars: **50,543** &nbsp;&nbsp; folks: **5,671**  &nbsp;&nbsp; `2,644 stars this week`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **87,334** &nbsp;&nbsp; folks: **26,038**  &nbsp;&nbsp; `622 stars this week`
...
1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,464** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `1,430 stars this week`
...
1. [NaiboWang / EasySpider](https://github.com/NaiboWang/EasySpider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,992** &nbsp;&nbsp; folks: **3,041**  &nbsp;&nbsp; `2,061 stars this week`
...
1. [neovim / neovim](https://github.com/neovim/neovim)
    ...
    - language: **Vim Script** &nbsp;&nbsp; stars: **78,419** &nbsp;&nbsp; folks: **5,412**  &nbsp;&nbsp; `1,363 stars this week`
...
1. [bepass-org / oblivion-desktop](https://github.com/bepass-org/oblivion-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,633** &nbsp;&nbsp; folks: **323**  &nbsp;&nbsp; `1,666 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **183,896** &nbsp;&nbsp; folks: **29,682**  &nbsp;&nbsp; `645 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **502** &nbsp;&nbsp; folks: **38**  &nbsp;&nbsp; `159 stars this week`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **52,126** &nbsp;&nbsp; folks: **6,305**  &nbsp;&nbsp; `1,401 stars this week`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **105,601** &nbsp;&nbsp; folks: **6,225**  &nbsp;&nbsp; `393 stars this week`

1. [SeleniumHQ / docker-selenium](https://github.com/SeleniumHQ/docker-selenium)
    - Provides a simple way to run Selenium Grid with Chrome, Firefox, and Edge using Docker, making it easier to perform browser automation
    - language: **Shell** &nbsp;&nbsp; stars: **7,628** &nbsp;&nbsp; folks: **2,493**  &nbsp;&nbsp; `173 stars this week`
...
1. [aamini / introtodeeplearning](https://github.com/aamini/introtodeeplearning)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,993** &nbsp;&nbsp; folks: **3,510**  &nbsp;&nbsp; `48 stars this week`
...
1. [wandb / openui](https://github.com/wandb/openui)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **14,902** &nbsp;&nbsp; folks: **1,262**  &nbsp;&nbsp; `8,776 stars this month`
...
1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)
    - language: **Rust** &nbsp;&nbsp; stars: **50,543** &nbsp;&nbsp; folks: **5,671**  &nbsp;&nbsp; `3,869 stars this month`

1. [CorentinTh / it-tools](https://github.com/CorentinTh/it-tools)
    - Collection of handy online tools for developers, with great UX.
    - language: **Vue** &nbsp;&nbsp; stars: **16,642** &nbsp;&nbsp; folks: **1,941**  &nbsp;&nbsp; `5,790 stars this month`
...
1. [massgravel / Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts)
    ...
    - language: **Batchfile** &nbsp;&nbsp; stars: **80,145** &nbsp;&nbsp; folks: **7,820**  &nbsp;&nbsp; `8,238 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly WebUI for LLMs (Formerly Ollama WebUI)
    - language: **Svelte** &nbsp;&nbsp; stars: **23,651** &nbsp;&nbsp; folks: **2,478**  &nbsp;&nbsp; `8,264 stars this month`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **27,616** &nbsp;&nbsp; folks: **1,959**  &nbsp;&nbsp; `5,756 stars this month`
...
1. [NaiboWang / EasySpider](https://github.com/NaiboWang/EasySpider)
    - A visual no-code/code-free web crawler/spider易采集：一个可视化浏览器自动化测试/数据采集/爬虫软件，可以无代码图形化的设计和执行爬虫任务。别名：ServiceWrapper面向Web应用的智能化服务封装系统。
    - language: **JavaScript** &nbsp;&nbsp; stars: **25,992** &nbsp;&nbsp; folks: **3,041**  &nbsp;&nbsp; `4,435 stars this month`

1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl, search and extract with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,464** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `2,721 stars this month`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-Llama3-V 2.5: A GPT-4V Level Multimodal LLM on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **3,485** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `1,821 stars this month`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,349** &nbsp;&nbsp; folks: **650**  &nbsp;&nbsp; `3,586 stars this month`
...
1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,350** &nbsp;&nbsp; folks: **732**  &nbsp;&nbsp; `4,637 stars this month`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **87,334** &nbsp;&nbsp; folks: **26,038**  &nbsp;&nbsp; `946 stars this month`
