...
`更新时间：2022-02-04 04:12:21 +0800`

## 今日热门仓库

1. [ThioJoe / YT-Spammer-Purge](https://github.com/ThioJoe/YT-Spammer-Purge)
    - Allows you easily scan for and delete scam comments using several methods.
    - language: **Python** &nbsp;&nbsp; stars: **2,411** &nbsp;&nbsp; folks: **271**  &nbsp;&nbsp; `266 stars today`

1. [psf / black](https://github.com/psf/black)
    - The uncompromising Python code formatter
    - language: **Python** &nbsp;&nbsp; stars: **25,072** &nbsp;&nbsp; folks: **1,592**  &nbsp;&nbsp; `154 stars today`

1. [Kindelia / HVM](https://github.com/Kindelia/HVM)
    - A massively parallel, optimal functional runtime in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **1,666** &nbsp;&nbsp; folks: **40**  &nbsp;&nbsp; `597 stars today`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **10,205** &nbsp;&nbsp; folks: **1,799**  &nbsp;&nbsp; `79 stars today`

1. [Budibase / budibase](https://github.com/Budibase/budibase)
    - Budibase is an open-source low-code platform for creating internal apps in minutes. Supports PostgreSQL, MySQL, MSSQL, MongoDB, Rest API, Docker, K8s 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,089** &nbsp;&nbsp; folks: **488**  &nbsp;&nbsp; `38 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **67,718** &nbsp;&nbsp; folks: **3,801**  &nbsp;&nbsp; `135 stars today`
...
1. [hannahcode / word-guessing-game](https://github.com/hannahcode/word-guessing-game)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,097** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `120 stars today`

1. [solana-labs / solana-pay](https://github.com/solana-labs/solana-pay)
    - A new standard for decentralized payments.
    - language: **TypeScript** &nbsp;&nbsp; stars: **448** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `164 stars today`

1. [vinta / awesome-python](https://github.com/vinta/awesome-python)
    - A curated list of awesome Python frameworks, libraries, software and resources
    - language: **Python** &nbsp;&nbsp; stars: **115,340** &nbsp;&nbsp; folks: **20,646**  &nbsp;&nbsp; `125 stars today`
...
1. [TeamNewPipe / NewPipe](https://github.com/TeamNewPipe/NewPipe)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **16,614** &nbsp;&nbsp; folks: **2,040**  &nbsp;&nbsp; `143 stars today`

1. [flxzt / rnote](https://github.com/flxzt/rnote)
    - A simple drawing application to create handwritten notes.
    - language: **Rust** &nbsp;&nbsp; stars: **2,007** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `96 stars today`
...
1. [mui-org / material-ui](https://github.com/mui-org/material-ui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,124** &nbsp;&nbsp; folks: **25,889**  &nbsp;&nbsp; `34 stars today`
...
1. [ciderapp / Cider](https://github.com/ciderapp/Cider)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **987** &nbsp;&nbsp; folks: **74**  &nbsp;&nbsp; `618 stars this week`

1. [Textualize / textual](https://github.com/Textualize/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **7,836** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `472 stars this week`
...
1. [zadam / trilium](https://github.com/zadam/trilium)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,143** &nbsp;&nbsp; folks: **777**  &nbsp;&nbsp; `234 stars this week`
...
1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,771** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `406 stars this week`

1. [microsoft / playwright](https://github.com/microsoft/playwright)
    - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,797** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `1,076 stars this week`
...
1. [ThioJoe / YT-Spammer-Purge](https://github.com/ThioJoe/YT-Spammer-Purge)
    - Allows you easily scan for and delete scam comments using several methods.
    - language: **Python** &nbsp;&nbsp; stars: **2,411** &nbsp;&nbsp; folks: **271**  &nbsp;&nbsp; `1,451 stars this week`
...
1. [files-community / Files](https://github.com/files-community/Files)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **19,819** &nbsp;&nbsp; folks: **1,077**  &nbsp;&nbsp; `4,422 stars this month`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **30,018** &nbsp;&nbsp; folks: **735**  &nbsp;&nbsp; `4,505 stars this month`
...
1. [adrianhajdin / project_web3.0](https://github.com/adrianhajdin/project_web3.0)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,362** &nbsp;&nbsp; folks: **275**  &nbsp;&nbsp; `719 stars this month`
...
1. [Textualize / textual](https://github.com/Textualize/textual)
    - Textual is a TUI (Text User Interface) framework for Python inspired by modern web development.
    - language: **Python** &nbsp;&nbsp; stars: **7,836** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `1,058 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **206,158** &nbsp;&nbsp; folks: **55,666**  &nbsp;&nbsp; `4,401 stars this month`
