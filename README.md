...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,408** &nbsp;&nbsp; folks: **379**  &nbsp;&nbsp; `538 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,101** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `298 stars today`
...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **647** &nbsp;&nbsp; folks: **65**  &nbsp;&nbsp; `219 stars today`

1. [birchb1024 / frangipanni](https://github.com/birchb1024/frangipanni)
    - Program to convert lines of text into a tree structure.
    - language: **Go** &nbsp;&nbsp; stars: **806** &nbsp;&nbsp; folks: **22**  &nbsp;&nbsp; `170 stars today`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,554** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `190 stars today`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **815** &nbsp;&nbsp; folks: **1,069**  &nbsp;&nbsp; `144 stars today`

1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,266** &nbsp;&nbsp; folks: **2,874**  &nbsp;&nbsp; `340 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,180** &nbsp;&nbsp; folks: **16,884**  &nbsp;&nbsp; `406 stars today`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **47,858** &nbsp;&nbsp; folks: **4,841**  &nbsp;&nbsp; `90 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,869** &nbsp;&nbsp; folks: **1,509**  &nbsp;&nbsp; `172 stars today`

1. [mrdoob / three.js](https://github.com/mrdoob/three.js)
    - JavaScript 3D library.
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,078** &nbsp;&nbsp; folks: **27,157**  &nbsp;&nbsp; `192 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,180** &nbsp;&nbsp; folks: **16,884**  &nbsp;&nbsp; `2,600 stars this week`

1. [php / php-src](https://github.com/php/php-src)
    - The PHP Interpreter
    - language: **C** &nbsp;&nbsp; stars: **30,242** &nbsp;&nbsp; folks: **6,569**  &nbsp;&nbsp; `580 stars this week`
...
1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,044** &nbsp;&nbsp; folks: **9,845**  &nbsp;&nbsp; `463 stars this week`

1. [denoland / deno](https://github.com/denoland/deno)
    - A secure JavaScript and TypeScript runtime
    - language: **Rust** &nbsp;&nbsp; stars: **73,935** &nbsp;&nbsp; folks: **3,880**  &nbsp;&nbsp; `383 stars this week`
...
1. [ChristianChiarulli / nvcode](https://github.com/ChristianChiarulli/nvcode)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **2,053** &nbsp;&nbsp; folks: **505**  &nbsp;&nbsp; `179 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,554** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `581 stars this week`

1. [alibaba / nacos](https://github.com/alibaba/nacos)
    - an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
    - language: **Java** &nbsp;&nbsp; stars: **16,958** &nbsp;&nbsp; folks: **6,600**  &nbsp;&nbsp; `160 stars this week`
...
1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    ...
    - language: **无** &nbsp;&nbsp; stars: **23,570** &nbsp;&nbsp; folks: **5,247**  &nbsp;&nbsp; `299 stars this week`
...
1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,179** &nbsp;&nbsp; folks: **578**  &nbsp;&nbsp; `4,564 stars this month`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,431** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `3,848 stars this month`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,937** &nbsp;&nbsp; folks: **308**  &nbsp;&nbsp; `1,645 stars this month`
...
1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,044** &nbsp;&nbsp; folks: **9,845**  &nbsp;&nbsp; `1,557 stars this month`
...
1. [ChristianChiarulli / nvcode](https://github.com/ChristianChiarulli/nvcode)
    - Truly the Ultimate Neovim Config NVCode
    - language: **Lua** &nbsp;&nbsp; stars: **2,053** &nbsp;&nbsp; folks: **505**  &nbsp;&nbsp; `441 stars this month`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **100,972** &nbsp;&nbsp; folks: **34,766**  &nbsp;&nbsp; `3,048 stars this month`

1. [openjdk / jdk](https://github.com/openjdk/jdk)
    - JDK main-line development
    - language: **Java** &nbsp;&nbsp; stars: **8,750** &nbsp;&nbsp; folks: **2,092**  &nbsp;&nbsp; `868 stars this month`
