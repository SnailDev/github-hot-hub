...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,931** &nbsp;&nbsp; folks: **4,182**  &nbsp;&nbsp; `211 stars today`
...
1. [kubernetes / kompose](https://github.com/kubernetes/kompose)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,563** &nbsp;&nbsp; folks: **553**  &nbsp;&nbsp; `61 stars today`
...
1. [JetBrains / compose-jb](https://github.com/JetBrains/compose-jb)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,522** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `377 stars today`

1. [alyssaxuu / mapus](https://github.com/alyssaxuu/mapus)
    - A map tool with real-time collaboration 🗺️
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,406** &nbsp;&nbsp; folks: **52**  &nbsp;&nbsp; `685 stars today`
...
1. [mytechnotalent / Reverse-Engineering](https://github.com/mytechnotalent/Reverse-Engineering)
    ...
    - language: **C** &nbsp;&nbsp; stars: **5,096** &nbsp;&nbsp; folks: **436**  &nbsp;&nbsp; `261 stars today`
...
1. [testjavascript / nodejs-integration-tests-best-practices](https://github.com/testjavascript/nodejs-integration-tests-best-practices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **530** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `326 stars today`

1. [metabase / metabase](https://github.com/metabase/metabase)
    - The simplest, fastest way to get business intelligence and analytics to everyone in your company 😋
    - language: **Clojure** &nbsp;&nbsp; stars: **25,568** &nbsp;&nbsp; folks: **3,446**  &nbsp;&nbsp; `29 stars today`

1. [Blinue / Magpie](https://github.com/Blinue/Magpie)
    - 使游戏窗口全屏显示
    - language: **HLSL** &nbsp;&nbsp; stars: **208** &nbsp;&nbsp; folks: **17**  &nbsp;&nbsp; `55 stars today`
...
1. [commaai / openpilot](https://github.com/commaai/openpilot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **27,719** &nbsp;&nbsp; folks: **5,339**  &nbsp;&nbsp; `755 stars today`

1. [eugenp / tutorials](https://github.com/eugenp/tutorials)
    - Just Announced - "Learn Spring Security OAuth":
    - language: **Java** &nbsp;&nbsp; stars: **27,043** &nbsp;&nbsp; folks: **43,365**  &nbsp;&nbsp; `114 stars today`

1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants
    - language: **Python** &nbsp;&nbsp; stars: **12,153** &nbsp;&nbsp; folks: **3,641**  &nbsp;&nbsp; `282 stars today`
...
1. [dataease / dataease](https://github.com/dataease/dataease)
    - 人人可用的开源数据可视化分析工具。
    - language: **Java** &nbsp;&nbsp; stars: **2,164** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `1,215 stars this week`
...
1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,483** &nbsp;&nbsp; folks: **1,444**  &nbsp;&nbsp; `214 stars this week`
...
1. [JetBrains / compose-jb](https://github.com/JetBrains/compose-jb)
    - Jetpack Compose for Desktop and Web, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,522** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `531 stars this week`
...
1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    ...
    - language: **CSS** &nbsp;&nbsp; stars: **8,000** &nbsp;&nbsp; folks: **1,881**  &nbsp;&nbsp; `3,063 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,897** &nbsp;&nbsp; folks: **4,470**  &nbsp;&nbsp; `3,615 stars this month`
...
1. [deepmind / deepmind-research](https://github.com/deepmind/deepmind-research)
    - This repository contains implementations and illustrative code to accompany DeepMind publications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,483** &nbsp;&nbsp; folks: **1,444**  &nbsp;&nbsp; `479 stars this month`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **115,679** &nbsp;&nbsp; folks: **19,097**  &nbsp;&nbsp; `3,616 stars this month`
