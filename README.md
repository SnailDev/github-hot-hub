...
`更新时间：2023-03-31 03:08:20 +0800`

## 今日热门仓库

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **23,496** &nbsp;&nbsp; folks: **2,639**  &nbsp;&nbsp; `2,184 stars today`

1. [binary-husky / chatgpt_academic](https://github.com/binary-husky/chatgpt_academic)
    - 科研工作专用ChatGPT拓展，特别优化学术Paper润色体验，支持自定义快捷按钮，支持markdown表格显示，Tex公式双显示，代码显示功能完善，新增本地Python工程剖析功能/自我剖析功能
    - language: **Python** &nbsp;&nbsp; stars: **13,595** &nbsp;&nbsp; folks: **1,250**  &nbsp;&nbsp; `3,685 stars today`
...
1. [Yidadaa / ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,758** &nbsp;&nbsp; folks: **2,140**  &nbsp;&nbsp; `1,776 stars today`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,930** &nbsp;&nbsp; folks: **369**  &nbsp;&nbsp; `870 stars today`
...
1. [Kent0n-Li / ChatDoctor](https://github.com/Kent0n-Li/ChatDoctor)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,270** &nbsp;&nbsp; folks: **120**  &nbsp;&nbsp; `351 stars today`

1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    - gpt4all: a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
    - language: **Python** &nbsp;&nbsp; stars: **10,865** &nbsp;&nbsp; folks: **842**  &nbsp;&nbsp; `5,120 stars today`
...
1. [getcursor / cursor](https://github.com/getcursor/cursor)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,414** &nbsp;&nbsp; folks: **682**  &nbsp;&nbsp; `1,617 stars today`
...
1. [KeXueShangWangkexue / KeXueShangWang_Google_Facebook_Twitter_VPN_VPS_Proxy](https://github.com/KeXueShangWangkexue/KeXueShangWang_Google_Facebook_Twitter_VPN_VPS_Proxy)
    - 科学上网🟢🟢科学上网🔴🔴科学上网🟡🟡科学上网
    - language: **Python** &nbsp;&nbsp; stars: **355** &nbsp;&nbsp; folks: **107**  &nbsp;&nbsp; `40 stars today`
...
1. [mouredev / Hello-Python](https://github.com/mouredev/Hello-Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,260** &nbsp;&nbsp; folks: **715**  &nbsp;&nbsp; `217 stars today`
...
1. [davinci1010 / pinduoduo_backdoor](https://github.com/davinci1010/pinduoduo_backdoor)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,601** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `100 stars today`
...
1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    ...
    - language: **C** &nbsp;&nbsp; stars: **15,821** &nbsp;&nbsp; folks: **2,212**  &nbsp;&nbsp; `3,660 stars this week`
...
1. [intitni / CopilotForXcode](https://github.com/intitni/CopilotForXcode)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **2,101** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `709 stars this week`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT better.
    - language: **HTML** &nbsp;&nbsp; stars: **56,543** &nbsp;&nbsp; folks: **6,690**  &nbsp;&nbsp; `7,142 stars this week`

1. [BlinkDL / ChatRWKV](https://github.com/BlinkDL/ChatRWKV)
    - ChatRWKV is like ChatGPT but powered by RWKV (100% RNN) language model, and open source.
    - language: **Python** &nbsp;&nbsp; stars: **4,754** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `1,000 stars this week`
...
1. [willwulfken / MidJourney-Styles-and-Keywords-Reference](https://github.com/willwulfken/MidJourney-Styles-and-Keywords-Reference)
    ...
    - language: **无** &nbsp;&nbsp; stars: **7,327** &nbsp;&nbsp; folks: **967**  &nbsp;&nbsp; `2,295 stars this week`

1. [Leizhenpeng / feishu-chatgpt](https://github.com/Leizhenpeng/feishu-chatgpt)
    - 🎒飞书 ×（GPT-3.5 + DALL·E + Whisper）= 飞一般的工作体验 🚀 语音对话、角色扮演、多话题讨论、图片创作、表格分析、文档导出 🚀
    - language: **Go** &nbsp;&nbsp; stars: **2,452** &nbsp;&nbsp; folks: **383**  &nbsp;&nbsp; `1,086 stars this week`

1. [tatsu-lab / stanford_alpaca](https://github.com/tatsu-lab/stanford_alpaca)
    - Code and documentation to train Stanford's Alpaca models, and generate the data.
    - language: **Python** &nbsp;&nbsp; stars: **16,825** &nbsp;&nbsp; folks: **2,294**  &nbsp;&nbsp; `3,619 stars this week`
...
1. [labmlai / annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **19,394** &nbsp;&nbsp; folks: **2,069**  &nbsp;&nbsp; `1,283 stars this week`
...
1. [TheR1D / shell_gpt](https://github.com/TheR1D/shell_gpt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,429** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,030 stars this week`

1. [tloen / alpaca-lora](https://github.com/tloen/alpaca-lora)
    - Instruct-tune LLaMA on consumer hardware
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,393** &nbsp;&nbsp; folks: **866**  &nbsp;&nbsp; `2,231 stars this week`

1. [huggingface / transformers](https://github.com/huggingface/transformers)
    - 🤗 Transformers: State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX.
    - language: **Python** &nbsp;&nbsp; stars: **88,771** &nbsp;&nbsp; folks: **19,056**  &nbsp;&nbsp; `1,731 stars this week`

1. [jerryjliu / llama_index](https://github.com/jerryjliu/llama_index)
    - LlamaIndex (GPT Index) is a project that provides a central interface to connect your LLM's with external data.
    - language: **Python** &nbsp;&nbsp; stars: **9,754** &nbsp;&nbsp; folks: **906**  &nbsp;&nbsp; `1,565 stars this week`

1. [dragonflydb / dragonfly](https://github.com/dragonflydb/dragonfly)
    - A modern replacement for Redis and Memcached
    - language: **C++** &nbsp;&nbsp; stars: **18,393** &nbsp;&nbsp; folks: **620**  &nbsp;&nbsp; `786 stars this week`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **12,478** &nbsp;&nbsp; folks: **3,749**  &nbsp;&nbsp; `10,886 stars this month`

1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    - A gradio web UI for running Large Language Models like GPT-J 6B, OPT, GALACTICA, LLaMA, and Pygmalion.
    - language: **Python** &nbsp;&nbsp; stars: **4,749** &nbsp;&nbsp; folks: **408**  &nbsp;&nbsp; `4,353 stars this month`
...
1. [facebookresearch / llama](https://github.com/facebookresearch/llama)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,151** &nbsp;&nbsp; folks: **2,372**  &nbsp;&nbsp; `9,848 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    - ⚡ Building applications with LLMs through composability ⚡
    - language: **Python** &nbsp;&nbsp; stars: **18,053** &nbsp;&nbsp; folks: **1,597**  &nbsp;&nbsp; `9,775 stars this month`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,921** &nbsp;&nbsp; folks: **3,338**  &nbsp;&nbsp; `10,171 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT better.
    - language: **HTML** &nbsp;&nbsp; stars: **56,543** &nbsp;&nbsp; folks: **6,690**  &nbsp;&nbsp; `23,199 stars this month`
...
1. [huggingface / transformers](https://github.com/huggingface/transformers)
    - 🤗 Transformers: State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX.
    - language: **Python** &nbsp;&nbsp; stars: **88,771** &nbsp;&nbsp; folks: **19,056**  &nbsp;&nbsp; `6,080 stars this month`
...
1. [BlinkDL / RWKV-LM](https://github.com/BlinkDL/RWKV-LM)
    - RWKV is an RNN with transformer-level LLM performance. It can be directly trained like a GPT (parallelizable). So it's combining the best of RNN and transformer - great performance, fast inference, saves VRAM, fast training, "infinite" ctx_len, and free sentence embedding.
    - language: **Python** &nbsp;&nbsp; stars: **4,561** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `2,510 stars this month`
