...
1. [rbignon / doctoshotgun](https://github.com/rbignon/doctoshotgun)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **220** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `85 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,354** &nbsp;&nbsp; folks: **7,512**  &nbsp;&nbsp; `108 stars today`

1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,635** &nbsp;&nbsp; folks: **1,952**  &nbsp;&nbsp; `108 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,474** &nbsp;&nbsp; folks: **372**  &nbsp;&nbsp; `132 stars today`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,350** &nbsp;&nbsp; folks: **3,248**  &nbsp;&nbsp; `175 stars today`

1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,498** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `308 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,175** &nbsp;&nbsp; folks: **1,684**  &nbsp;&nbsp; `121 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,591** &nbsp;&nbsp; folks: **1,847**  &nbsp;&nbsp; `331 stars today`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,944** &nbsp;&nbsp; folks: **1,487**  &nbsp;&nbsp; `140 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,208** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `765 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **66,952** &nbsp;&nbsp; folks: **21,044**  &nbsp;&nbsp; `1,152 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **38,351** &nbsp;&nbsp; folks: **3,065**  &nbsp;&nbsp; `1,475 stars this week`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **442** &nbsp;&nbsp; folks: **105**  &nbsp;&nbsp; `230 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,354** &nbsp;&nbsp; folks: **7,512**  &nbsp;&nbsp; `372 stars this week`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,479** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `140 stars this week`
...
1. [khanhas / spicetify-cli](https://github.com/khanhas/spicetify-cli)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,360** &nbsp;&nbsp; folks: **206**  &nbsp;&nbsp; `188 stars this week`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,498** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `1,712 stars this week`
...
1. [input-output-hk / cardano-node](https://github.com/input-output-hk/cardano-node)
    ...
    - language: **Haskell** &nbsp;&nbsp; stars: **1,446** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `95 stars this week`

1. [ericaltendorf / plotman](https://github.com/ericaltendorf/plotman)
    - Chia plotting manager
    - language: **Python** &nbsp;&nbsp; stars: **787** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `154 stars this week`
...
1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,635** &nbsp;&nbsp; folks: **1,952**  &nbsp;&nbsp; `308 stars this week`

1. [wisz2021 / jd_docker](https://github.com/wisz2021/jd_docker)
    - 借用的github账号，仅用查看环境变量文档与教程，反馈issue使用。By lxk0301
    - language: **Shell** &nbsp;&nbsp; stars: **1,369** &nbsp;&nbsp; folks: **763**  &nbsp;&nbsp; `331 stars this week`

1. [parcel-bundler / parcel](https://github.com/parcel-bundler/parcel)
    - 📦🚀 Blazing fast, zero configuration web application bundler
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,332** &nbsp;&nbsp; folks: **1,933**  &nbsp;&nbsp; `234 stars this week`

1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    - 🌈 A UI Design Language and React UI library
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,476** &nbsp;&nbsp; folks: **28,065**  &nbsp;&nbsp; `65,015 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,616** &nbsp;&nbsp; folks: **973**  &nbsp;&nbsp; `3,775 stars this month`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,165** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `2,329 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,797** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `3,767 stars this month`
